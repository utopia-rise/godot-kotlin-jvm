...
class PoolIntArray : NativeCoreType {


    override val coreVariantType: VariantType = VariantType.PoolIntArray
    ...
    fun appendArray(array: PoolIntArray) {
        TransferContext.writeArguments(VariantType.PoolIntArray to Array)
