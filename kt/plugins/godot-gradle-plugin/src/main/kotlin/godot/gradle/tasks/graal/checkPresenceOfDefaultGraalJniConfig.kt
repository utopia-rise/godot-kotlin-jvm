...
fun Project.checkPresenceOfDefaultGraalJniConfigTask(): Task {
    return with(tasks.create("createDefaultGraalJniConfigIfNotPresent")) {
        group = "godot-kotlin-jvm"
        description = "Checks if the default jni config for graalVM native image is present and creates it if it's not"
