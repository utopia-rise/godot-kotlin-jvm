...
class JavaInspectionTest : CodeInsightFixtureTestBase() {
    fun testExplicitFixture() {
        val problems = inspectFixture(
            "src/main/java/godot/inspection/IdeJavaInspectionExplicit.java",
            JavaInspection()
        )
    ...
    fun testInferredFixture() {
        val problems = inspectFixture(
            "src/main/java/godot/inspection/IdeJavaInspectionInferred.java",
            JavaInspection(),
    ...
    fun testAutomaticFixture() {
        val problems = inspectFixture(
            "src/main/java/godot/inspection/IdeJavaInspectionAutomatic.java",
            JavaInspection(),
