...
private const val ENGINE_CLASS_VISUALSHADERNODEVECTORDECOMPOSE_INDEX: Int = 725
...
public open class VisualShaderNodeVectorDecompose : VisualShaderNodeVectorBase() {
  public override fun new(scriptIndex: Int): Unit {
    callConstructor(ENGINE_CLASS_VISUALSHADERNODEVECTORDECOMPOSE_INDEX, scriptIndex)
  }
