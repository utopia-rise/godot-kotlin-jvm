...
public open class CameraAttributesPhysical : CameraAttributes() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    Internals.callConstructor(this, ENGINE_CLASS_CAMERAATTRIBUTESPHYSICAL_INDEX, scriptIndex)
  }

  public final fun setAperture(aperture: Float): Unit {
    Internals.writeArguments(DOUBLE to aperture.toDouble())
    Internals.callMethod(rawPtr, MethodBindings.setAperturePtr, NIL)
  }

  public final fun getAperture(): Float {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getAperturePtr, DOUBLE)
    return (Internals.readReturnValue(DOUBLE) as Double).toFloat()
  }

  public final fun setShutterSpeed(shutterSpeed: Float): Unit {
    Internals.writeArguments(DOUBLE to shutterSpeed.toDouble())
    Internals.callMethod(rawPtr, MethodBindings.setShutterSpeedPtr, NIL)
  }

  public final fun getShutterSpeed(): Float {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getShutterSpeedPtr, DOUBLE)
    return (Internals.readReturnValue(DOUBLE) as Double).toFloat()
  }

  public final fun setFocalLength(focalLength: Float): Unit {
    Internals.writeArguments(DOUBLE to focalLength.toDouble())
    Internals.callMethod(rawPtr, MethodBindings.setFocalLengthPtr, NIL)
  }

  public final fun getFocalLength(): Float {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getFocalLengthPtr, DOUBLE)
    return (Internals.readReturnValue(DOUBLE) as Double).toFloat()
  }

  public final fun setFocusDistance(focusDistance: Float): Unit {
    Internals.writeArguments(DOUBLE to focusDistance.toDouble())
    Internals.callMethod(rawPtr, MethodBindings.setFocusDistancePtr, NIL)
  }

  public final fun getFocusDistance(): Float {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getFocusDistancePtr, DOUBLE)
    return (Internals.readReturnValue(DOUBLE) as Double).toFloat()
  }
  ...
  public final fun setAutoExposureMaxExposureValue(exposureValueMax: Float): Unit {
    Internals.writeArguments(DOUBLE to exposureValueMax.toDouble())
    Internals.callMethod(rawPtr, MethodBindings.setAutoExposureMaxExposureValuePtr, NIL)
  }

  public final fun getAutoExposureMaxExposureValue(): Float {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getAutoExposureMaxExposureValuePtr, DOUBLE)
    return (Internals.readReturnValue(DOUBLE) as Double).toFloat()
  }

  public final fun setAutoExposureMinExposureValue(exposureValueMin: Float): Unit {
    Internals.writeArguments(DOUBLE to exposureValueMin.toDouble())
    Internals.callMethod(rawPtr, MethodBindings.setAutoExposureMinExposureValuePtr, NIL)
  }

  public final fun getAutoExposureMinExposureValue(): Float {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getAutoExposureMinExposureValuePtr, DOUBLE)
    return (Internals.readReturnValue(DOUBLE) as Double).toFloat()
  }
