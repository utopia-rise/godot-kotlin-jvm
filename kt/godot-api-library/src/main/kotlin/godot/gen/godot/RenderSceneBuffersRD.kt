...
public open class RenderSceneBuffersRD : RenderSceneBuffers() {
  public override fun new(scriptIndex: Int): Unit {
    Internals.callConstructor(this, ENGINE_CLASS_RENDERSCENEBUFFERSRD_INDEX, scriptIndex)
  }
  ...
  public final fun hasTexture(context: StringName, name: StringName): Boolean {
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name)
    Internals.callMethod(rawPtr, MethodBindings.hasTexturePtr, BOOL)
  ...
  public final fun createTexture(
    ...
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name, LONG to dataFormat.id, LONG to usageBits, LONG to textureSamples.id, VECTOR2I to size, LONG to layers, LONG to mipmaps, BOOL to unique)
    Internals.callMethod(rawPtr, MethodBindings.createTexturePtr, _RID)
  ...
  public final fun createTextureFromFormat(
    ...
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name, OBJECT to format, OBJECT to view, BOOL to unique)
    Internals.callMethod(rawPtr, MethodBindings.createTextureFromFormatPtr, _RID)
    return (Internals.readReturnValue(_RID) as RID)
  }
  ...
  public final fun createTextureView(
    ...
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name, STRING_NAME to viewName, OBJECT to view)
    Internals.callMethod(rawPtr, MethodBindings.createTextureViewPtr, _RID)
    return (Internals.readReturnValue(_RID) as RID)
  }
  ...
  public final fun getTexture(context: StringName, name: StringName): RID {
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name)
    Internals.callMethod(rawPtr, MethodBindings.getTexturePtr, _RID)
    return (Internals.readReturnValue(_RID) as RID)
  }
  ...
  public final fun getTextureFormat(context: StringName, name: StringName): RDTextureFormat? {
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name)
    Internals.callMethod(rawPtr, MethodBindings.getTextureFormatPtr, OBJECT)
  ...
  public final fun getTextureSlice(
    ...
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name, LONG to layer, LONG to mipmap, LONG to layers, LONG to mipmaps)
    Internals.callMethod(rawPtr, MethodBindings.getTextureSlicePtr, _RID)
    return (Internals.readReturnValue(_RID) as RID)
  }
  ...
  public final fun getTextureSliceView(
    ...
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name, LONG to layer, LONG to mipmap, LONG to layers, LONG to mipmaps, OBJECT to view)
    Internals.callMethod(rawPtr, MethodBindings.getTextureSliceViewPtr, _RID)
    return (Internals.readReturnValue(_RID) as RID)
  }
  ...
  public final fun getTextureSliceSize(
    ...
    Internals.writeArguments(STRING_NAME to context, STRING_NAME to name, LONG to mipmap)
    Internals.callMethod(rawPtr, MethodBindings.getTextureSliceSizePtr, VECTOR2I)
  ...
  public final fun clearContext(context: StringName): Unit {
    Internals.writeArguments(STRING_NAME to context)
    Internals.callMethod(rawPtr, MethodBindings.clearContextPtr, NIL)
  }
  ...
  public final fun getColorTexture(msaa: Boolean = false): RID {
    Internals.writeArguments(BOOL to msaa)
  ...
  public final fun getColorLayer(layer: Long, msaa: Boolean = false): RID {
    Internals.writeArguments(LONG to layer, BOOL to msaa)
    Internals.callMethod(rawPtr, MethodBindings.getColorLayerPtr, _RID)
    return (Internals.readReturnValue(_RID) as RID)
  }
  ...
  public final fun getDepthLayer(layer: Long, msaa: Boolean = false): RID {
    Internals.writeArguments(LONG to layer, BOOL to msaa)
    Internals.callMethod(rawPtr, MethodBindings.getDepthLayerPtr, _RID)
    return (Internals.readReturnValue(_RID) as RID)
  }
  ...
  public final fun getVelocityLayer(layer: Long, msaa: Boolean = false): RID {
    Internals.writeArguments(LONG to layer, BOOL to msaa)
    Internals.callMethod(rawPtr, MethodBindings.getVelocityLayerPtr, _RID)
    return (Internals.readReturnValue(_RID) as RID)
  }
  ...
  public final fun getTextureSamples(): RenderingDevice.TextureSamples {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getTextureSamplesPtr, LONG)
  ...
  public final fun getUseTaa(): Boolean {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getUseTaaPtr, BOOL)
    return (Internals.readReturnValue(BOOL) as Boolean)
  }
