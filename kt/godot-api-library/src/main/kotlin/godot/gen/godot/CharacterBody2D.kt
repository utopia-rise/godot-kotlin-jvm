...
public open class CharacterBody2D : PhysicsBody2D() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    Internals.callConstructor(this, ENGINE_CLASS_CHARACTERBODY2D_INDEX, scriptIndex)
  }
  ...
  public final fun getUpDirection(): Vector2 {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getUpDirectionPtr, VECTOR2)
    return (Internals.readReturnValue(VECTOR2) as Vector2)
  }
  ...
  public final fun getMotionMode(): MotionMode {
    ...
    return CharacterBody2D.MotionMode.from(Internals.readReturnValue(LONG) as Long)
  }
  ...
  public final fun getPlatformOnLeave(): PlatformOnLeave {
    ...
    return CharacterBody2D.PlatformOnLeave.from(Internals.readReturnValue(LONG) as Long)
  }
  ...
  public final fun getFloorNormal(): Vector2 {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getFloorNormalPtr, VECTOR2)
    return (Internals.readReturnValue(VECTOR2) as Vector2)
  }
  ...
  public final fun getWallNormal(): Vector2 {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getWallNormalPtr, VECTOR2)
    return (Internals.readReturnValue(VECTOR2) as Vector2)
  }
  ...
  public final fun getLastMotion(): Vector2 {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getLastMotionPtr, VECTOR2)
    return (Internals.readReturnValue(VECTOR2) as Vector2)
  }
  ...
  public final fun getPositionDelta(): Vector2 {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getPositionDeltaPtr, VECTOR2)
    return (Internals.readReturnValue(VECTOR2) as Vector2)
  }
  ...
  public final fun getRealVelocity(): Vector2 {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getRealVelocityPtr, VECTOR2)
    return (Internals.readReturnValue(VECTOR2) as Vector2)
  }
  ...
  public final fun getPlatformVelocity(): Vector2 {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getPlatformVelocityPtr, VECTOR2)
    return (Internals.readReturnValue(VECTOR2) as Vector2)
  }
  ...
  public final fun getSlideCollision(slideIdx: Int): KinematicCollision2D? {
    ...
    return (Internals.readReturnValue(OBJECT) as KinematicCollision2D?)
  }
