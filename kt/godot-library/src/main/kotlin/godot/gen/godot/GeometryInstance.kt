 ...
 */
@GodotBaseType
public open class GeometryInstance : VisualInstance() {
  /**
   ...
   */
  public open var generateLightmap: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var lightmapScale: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var lodMaxDistance: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   * **Note:** This property currently has no effect.
   */
  public open var lodMaxHysteresis: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   * **Note:** This property currently has no effect.
   */
  public open var lodMinDistance: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   * **Note:** This property currently has no effect.
   */
  public open var lodMinHysteresis: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
  ...
  public companion object {
     ...
     * Unused in this class, exposed for consistency with [enum VisualServer.InstanceFlags].
     */
    public final const val FLAG_DRAW_NEXT_FRAME_IF_VISIBLE: Long = 1
     ...
     * Will allow the GeometryInstance to be used when baking lights using a [godot.GIProbe] or [godot.BakedLightmap].
     */
    public final const val FLAG_USE_BAKED_LIGHT: Long = 0

    /**
     * The generated lightmap texture will have the original size.
     */
    public final const val LIGHTMAP_SCALE_1X: Long = 0

    /**
     * The generated lightmap texture will be twice as large, on each axis.
     */
    public final const val LIGHTMAP_SCALE_2X: Long = 1

    /**
     * The generated lightmap texture will be 4 times as large, on each axis.
     */
    public final const val LIGHTMAP_SCALE_4X: Long = 2

    /**
     * The generated lightmap texture will be 8 times as large, on each axis.
     */
    public final const val LIGHTMAP_SCALE_8X: Long = 3

    /**
     *
     */
    public final const val LIGHTMAP_SCALE_MAX: Long = 4
