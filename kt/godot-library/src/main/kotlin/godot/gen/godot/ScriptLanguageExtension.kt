...
public open class ScriptLanguageExtension : ScriptLanguage() {
  ...
  public open fun _isControlFlowKeyword(keyword: String): Boolean {
    throw
        NotImplementedError("_is_control_flow_keyword is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _getCommentDelimiters(): PackedStringArray {
    throw
        NotImplementedError("_get_comment_delimiters is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _getStringDelimiters(): PackedStringArray {
    throw
        NotImplementedError("_get_string_delimiters is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _getBuiltInTemplates(_object: StringName): VariantArray<Any?> {
    throw
        NotImplementedError("_get_built_in_templates is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _supportsBuiltinMode(): Boolean {
    throw
        NotImplementedError("_supports_builtin_mode is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _supportsDocumentation(): Boolean {
    throw
        NotImplementedError("_supports_documentation is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _canInheritFromFile(): Boolean {
    throw
        NotImplementedError("_can_inherit_from_file is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _openInExternalEditor(
    ...
    throw
        NotImplementedError("_open_in_external_editor is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _overridesExternalEditor(): Boolean {
    throw
        NotImplementedError("_overrides_external_editor is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _debugGetStackLevelCount(): Long {
    throw
        NotImplementedError("_debug_get_stack_level_count is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _debugGetStackLevelLine(level: Long): Long {
    throw
        NotImplementedError("_debug_get_stack_level_line is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _debugGetStackLevelFunction(level: Long): String {
    throw
        NotImplementedError("_debug_get_stack_level_function is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _debugGetStackLevelLocals(
    ...
    throw
        NotImplementedError("_debug_get_stack_level_locals is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _debugGetStackLevelMembers(
    ...
    throw
        NotImplementedError("_debug_get_stack_level_members is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _debugParseStackLevelExpression(
    ...
    throw
        NotImplementedError("_debug_parse_stack_level_expression is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _debugGetCurrentStackInfo(): VariantArray<Any?> {
    throw
        NotImplementedError("_debug_get_current_stack_info is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _getRecognizedExtensions(): PackedStringArray {
    throw
        NotImplementedError("_get_recognized_extensions is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _getPublicFunctions(): VariantArray<Any?> {
    throw
        NotImplementedError("_get_public_functions is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _getPublicConstants(): Dictionary<Any?, Any?> {
    throw
        NotImplementedError("_get_public_constants is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _refcountDecrementedInstanceBinding(_object: Object): Boolean {
    throw
        NotImplementedError("_refcount_decremented_instance_binding is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _handlesGlobalClassType(type: String): Boolean {
    throw
        NotImplementedError("_handles_global_class_type is not implemented for ScriptLanguageExtension")
  }
  ...
  public open fun _getGlobalClassName(path: String): Dictionary<Any?, Any?> {
    throw
        NotImplementedError("_get_global_class_name is not implemented for ScriptLanguageExtension")
  }
