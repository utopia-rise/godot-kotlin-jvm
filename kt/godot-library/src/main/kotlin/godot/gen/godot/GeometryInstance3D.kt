...
public open class GeometryInstance3D : VisualInstance3D() {
   ...
   * have fine control over the [MeshInstance3D]'s bounding box. To use the default AABB, set value to
   * an [AABB] with all fields set to `0.0`. To avoid frustum culling, set [customAabb] to a very large
   * AABB that covers your entire game world such as `AABB(-10000, -10000, -10000, 20000, 20000,
  ...
  public enum class GIMode(
     ...
     * indirect lighting and reflections but the geometry will not be considered in GI baking. When
     * using [LightmapGI], the object will receive indirect lighting using lightmap probes instead of
