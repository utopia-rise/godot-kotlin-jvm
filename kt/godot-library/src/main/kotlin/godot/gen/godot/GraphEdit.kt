...
public open class GraphEdit : Control() {
  ...
  /**
   * Emitted when attempting to remove a GraphNode from the GraphEdit. Provides a list of node names
   * to be removed (all selected nodes, excluding nodes without closing button).
   */
   ...
   * the form `{ from_port: 0, from: "GraphNode name 0", to_port: 1, to: "GraphNode name 1" }`.
   */
