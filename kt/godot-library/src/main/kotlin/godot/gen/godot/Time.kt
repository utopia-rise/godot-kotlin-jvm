 ...
 * UTC depending on the `utc` parameter. However, the [getUnixTimeFromSystem] method always returns the
 * time in UTC.
...
public object Time : Object() {
   ...
   * implemented by the operating system and always returns the time in UTC.
