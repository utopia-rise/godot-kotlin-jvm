 ...
 */
@GodotBaseType
public object ARVRServer : Object() {
  /**
   * Does not reset the orientation of the HMD, only the position of the player gets centered.
   */
  public final const val DONT_RESET_ROTATION: Long = 2

  /**
   * Resets the orientation but keeps the tilt of the device. So if we're looking down, we keep looking down but heading will be reset.
   */
  public final const val RESET_BUT_KEEP_TILT: Long = 1

  /**
   * Fully reset the orientation of the HMD. Regardless of what direction the user is looking to in the real world. The user will look dead ahead in the virtual world.
   */
  public final const val RESET_FULL_ROTATION: Long = 0

  /**
   * The tracker tracks the location and size of an AR anchor.
   */
  public final const val TRACKER_ANCHOR: Long = 4

  /**
   * Used internally to select all trackers.
   */
  public final const val TRACKER_ANY: Long = 255

  /**
   * Used internally to filter trackers of any known type.
   */
  public final const val TRACKER_ANY_KNOWN: Long = 127

  /**
   * The tracker tracks the location of a base station.
   */
  public final const val TRACKER_BASESTATION: Long = 2

  /**
   * The tracker tracks the location of a controller.
   */
  public final const val TRACKER_CONTROLLER: Long = 1

  /**
   * Used internally if we haven't set the tracker type yet.
   */
  public final const val TRACKER_UNKNOWN: Long = 128

  /**
   * Emitted when a new interface has been added.
   */
  public val interfaceAdded: Signal1<String> by signal("interface_name")

  /**
   * Emitted when an interface is removed.
   */
  public val interfaceRemoved: Signal1<String> by signal("interface_name")
   ...
   */
  public val trackerAdded: Signal3<String, Long, Long> by signal("tracker_name", "type", "id")
   ...
   */
  public val trackerRemoved: Signal3<String, Long, Long> by signal("tracker_name", "type", "id")
   ...
   */
  public fun findInterface(name: String): ARVRInterface? {
   ...
   */
  public fun getHmdTransform(): Transform {
    TransferContext.writeArguments()
   ...
   */
  public fun getInterface(idx: Long): ARVRInterface? {
   ...
   */
  public fun getLastCommitUsec(): Long {
    TransferContext.writeArguments()
   ...
   */
  public fun getLastFrameUsec(): Long {
    TransferContext.writeArguments()
   ...
   */
  public fun getLastProcessUsec(): Long {
    TransferContext.writeArguments()
   ...
   */
  public fun getReferenceFrame(): Transform {
    TransferContext.writeArguments()
   ...
   */
  public fun getTracker(idx: Long): ARVRPositionalTracker? {
    TransferContext.writeArguments(LONG to idx)
   ...
   */
  public fun getTrackerCount(): Long {
    TransferContext.writeArguments()
