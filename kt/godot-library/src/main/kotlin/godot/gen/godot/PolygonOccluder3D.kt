...
public open class PolygonOccluder3D : Occluder3D() {
  ...
  public var polygon: PackedVector2Array
    get() {
      ...
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_POLYGONOCCLUDER3D_GET_POLYGON,
          PACKED_VECTOR2_ARRAY.ordinal)
      return TransferContext.readReturnValue(PACKED_VECTOR2_ARRAY, false) as PackedVector2Array
    }
    set(`value`) {
      TransferContext.writeArguments(PACKED_VECTOR2_ARRAY to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_POLYGONOCCLUDER3D_SET_POLYGON,
          NIL.ordinal)
    }

  public override fun __new(): Unit {
    callConstructor(ENGINECLASS_POLYGONOCCLUDER3D)
  }
