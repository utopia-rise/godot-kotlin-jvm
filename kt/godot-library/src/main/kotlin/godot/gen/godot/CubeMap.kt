 ...
 */
@GodotBaseType
public open class CubeMap : Resource() {
  /**
   ...
   */
  public open var lossyStorageQuality: Double
    get() {
      TransferContext.writeArguments()
   ...
   */
  public open var storageMode: Long
    get() {
      TransferContext.writeArguments()
   ...
   */
  public open fun getSide(side: Long): Image? {
   ...
   */
  public open fun setSide(side: Long, image: Image): Unit {
  ...
  public companion object {
     ...
     * Identifier for the back face of the [godot.CubeMap].
     */
    public final const val SIDE_BACK: Long = 5

    /**
     * Identifier for the bottom face of the [godot.CubeMap].
     */
    public final const val SIDE_BOTTOM: Long = 2

    /**
     * Identifier for the front face of the [godot.CubeMap].
     */
    public final const val SIDE_FRONT: Long = 4

    /**
     * Identifier for the left face of the [godot.CubeMap].
     */
    public final const val SIDE_LEFT: Long = 0

    /**
     * Identifier for the right face of the [godot.CubeMap].
     */
    public final const val SIDE_RIGHT: Long = 1

    /**
     * Identifier for the top face of the [godot.CubeMap].
     */
    public final const val SIDE_TOP: Long = 3
