...
public open class RDShaderSource : RefCounted() {
   ...
   *
   */
  public open fun setStageSource(stage: RenderingDevice.ShaderStage, source: String): Unit {
   ...
   *
   */
  public open fun getStageSource(stage: RenderingDevice.ShaderStage): String {
