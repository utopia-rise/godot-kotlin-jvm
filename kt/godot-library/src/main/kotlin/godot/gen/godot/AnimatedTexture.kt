...
public open class AnimatedTexture : Texture2D() {
   ...
   */
  public fun getFrameTexture(frame: Long): Texture2D? {
    TransferContext.writeArguments(LONG to frame)
   ...
   */
  public fun setFrameDuration(frame: Long, duration: Double): Unit {
    TransferContext.writeArguments(LONG to frame, DOUBLE to duration)
   ...
   */
  public fun getFrameDuration(frame: Long): Double {
    TransferContext.writeArguments(LONG to frame)
