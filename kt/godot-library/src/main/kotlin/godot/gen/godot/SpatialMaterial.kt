 ...
 */
@GodotBaseType
public open class SpatialMaterial : Material() {
  /**
   ...
   */
  public open var depthDeepParallax: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var depthFlipBinormal: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var depthFlipTangent: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var depthMaxLayers: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var depthMinLayers: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var depthScale: Double
    get() {
      TransferContext.writeArguments()
   ...
   */
  public open var paramsAlphaScissorThreshold: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsBillboardMode: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsBlendMode: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsCullMode: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsDepthDrawMode: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsDiffuseMode: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsGrow: Boolean
    get() {
      TransferContext.writeArguments()
   ...
   */
  public open var paramsGrowAmount: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsLineWidth: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsPointSize: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var paramsSpecularMode: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
   ...
   */
  public open var transmission: Color
    get() {
      TransferContext.writeArguments()
  ...
  @CoreTypeHelper
  public open fun albedoColor(schedule: Color.() -> Unit): Color = albedoColor.apply{
      schedule(this)
      albedoColor = this
  }
  ...
  @CoreTypeHelper
  public open fun emission(schedule: Color.() -> Unit): Color = emission.apply{
      schedule(this)
      emission = this
  }
  ...
  @CoreTypeHelper
  public open fun transmission(schedule: Color.() -> Unit): Color = transmission.apply{
      schedule(this)
      transmission = this
  }
  ...
  @CoreTypeHelper
  public open fun uv1Offset(schedule: Vector3.() -> Unit): Vector3 = uv1Offset.apply{
      schedule(this)
      uv1Offset = this
  }
  ...
  @CoreTypeHelper
  public open fun uv1Scale(schedule: Vector3.() -> Unit): Vector3 = uv1Scale.apply{
      schedule(this)
      uv1Scale = this
  }
  ...
  @CoreTypeHelper
  public open fun uv2Offset(schedule: Vector3.() -> Unit): Vector3 = uv2Offset.apply{
      schedule(this)
      uv2Offset = this
  }
  ...
  @CoreTypeHelper
  public open fun uv2Scale(schedule: Vector3.() -> Unit): Vector3 = uv2Scale.apply{
      schedule(this)
      uv2Scale = this
  }
  ...
  public companion object {
     ...
     * The object's Z axis will always face the camera.
     */
    public final const val BILLBOARD_ENABLED: Long = 1

    /**
     * The object's X axis will always face the camera.
     */
    public final const val BILLBOARD_FIXED_Y: Long = 2
     ...
     * The [godot.ParticlesMaterial.animSpeed] or [godot.CPUParticles.animSpeed] should also be set to a positive value for the animation to play.
     */
    public final const val BILLBOARD_PARTICLES: Long = 3
     ...
     * Default cull mode. The back of the object is culled when not visible.
     */
    public final const val CULL_BACK: Long = 0

    /**
     * No culling is performed.
     */
    public final const val CULL_DISABLED: Long = 2

    /**
     * The front of the object is culled when not visible.
     */
    public final const val CULL_FRONT: Long = 1

    /**
     * For transparent objects, an opaque pass is made first with the opaque parts, then transparency is drawn.
     */
    public final const val DEPTH_DRAW_ALPHA_OPAQUE_PREPASS: Long = 3

    /**
     * Depth draw is calculated for both opaque and transparent objects.
     */
    public final const val DEPTH_DRAW_ALWAYS: Long = 1

    /**
     * No depth draw.
     */
    public final const val DEPTH_DRAW_DISABLED: Long = 2

    /**
     * Default depth draw mode. Depth is drawn only for opaque objects.
     */
    public final const val DEPTH_DRAW_OPAQUE_ONLY: Long = 0

    /**
     * Use `UV` with the detail texture.
     */
    public final const val DETAIL_UV_1: Long = 0

    /**
     * Use `UV2` with the detail texture.
     */
    public final const val DETAIL_UV_2: Long = 1

    /**
     * Default diffuse scattering algorithm.
     */
    public final const val DIFFUSE_BURLEY: Long = 0

    /**
     * Diffuse scattering ignores roughness.
     */
    public final const val DIFFUSE_LAMBERT: Long = 1

    /**
     * Extends Lambert to cover more than 90 degrees when roughness increases.
     */
    public final const val DIFFUSE_LAMBERT_WRAP: Long = 2

    /**
     * Attempts to use roughness to emulate microsurfacing.
     */
    public final const val DIFFUSE_OREN_NAYAR: Long = 3

    /**
     * Uses a hard cut for lighting, with smoothing affected by roughness.
     */
    public final const val DIFFUSE_TOON: Long = 4

    /**
     * Do not use distance fade.
     */
    public final const val DISTANCE_FADE_DISABLED: Long = 0

    /**
     * Smoothly fades the object out based on the object's distance from the camera using a dither approach. Dithering discards pixels based on a set pattern to smoothly fade without enabling transparency. On certain hardware this can be faster than [DISTANCE_FADE_PIXEL_ALPHA].
     */
    public final const val DISTANCE_FADE_OBJECT_DITHER: Long = 3

    /**
     * Smoothly fades the object out based on each pixel's distance from the camera using the alpha channel.
     */
    public final const val DISTANCE_FADE_PIXEL_ALPHA: Long = 1

    /**
     * Smoothly fades the object out based on each pixel's distance from the camera using a dither approach. Dithering discards pixels based on a set pattern to smoothly fade without enabling transparency. On certain hardware this can be faster than [DISTANCE_FADE_PIXEL_ALPHA].
     */
    public final const val DISTANCE_FADE_PIXEL_DITHER: Long = 2

    /**
     * Adds the emission color to the color from the emission texture.
     */
    public final const val EMISSION_OP_ADD: Long = 0

    /**
     * Multiplies the emission color by the color from the emission texture.
     */
    public final const val EMISSION_OP_MULTIPLY: Long = 1

    /**
     * Constant for setting [aoEnabled].
     */
    public final const val FEATURE_AMBIENT_OCCLUSION: Long = 6

    /**
     * Constant for setting [anisotropyEnabled].
     */
    public final const val FEATURE_ANISOTROPY: Long = 5

    /**
     * Constant for setting [clearcoatEnabled].
     */
    public final const val FEATURE_CLEARCOAT: Long = 4

    /**
     * Constant for setting [depthEnabled].
     */
    public final const val FEATURE_DEPTH_MAPPING: Long = 7

    /**
     * Constant for setting [detailEnabled].
     */
    public final const val FEATURE_DETAIL: Long = 11

    /**
     * Constant for setting [emissionEnabled].
     */
    public final const val FEATURE_EMISSION: Long = 1

    /**
     * Represents the size of the [enum Feature] enum.
     */
    public final const val FEATURE_MAX: Long = 12

    /**
     * Constant for setting [normalEnabled].
     */
    public final const val FEATURE_NORMAL_MAPPING: Long = 2

    /**
     * Constant for setting [refractionEnabled].
     */
    public final const val FEATURE_REFRACTION: Long = 10

    /**
     * Constant for setting [rimEnabled].
     */
    public final const val FEATURE_RIM: Long = 3

    /**
     * Constant for setting [subsurfScatterEnabled].
     */
    public final const val FEATURE_SUBSURACE_SCATTERING: Long = 8

    /**
     * Constant for setting [transmissionEnabled].
     */
    public final const val FEATURE_TRANSMISSION: Long = 9

    /**
     * Constant for setting [flagsTransparent].
     */
    public final const val FEATURE_TRANSPARENT: Long = 0

    /**
     * Set `ALBEDO` to the per-vertex color specified in the mesh.
     */
    public final const val FLAG_ALBEDO_FROM_VERTEX_COLOR: Long = 3
     ...
     * Shader will keep the scale set for the mesh. Otherwise the scale is lost when billboarding. Only applies when [paramsBillboardMode] is [BILLBOARD_ENABLED].
     */
    public final const val FLAG_BILLBOARD_KEEP_SCALE: Long = 7

    /**
     * Disables receiving ambient light.
     */
    public final const val FLAG_DISABLE_AMBIENT_LIGHT: Long = 17
     ...
     * Disables receiving shadows from other objects.
     */
    public final const val FLAG_DONT_RECEIVE_SHADOWS: Long = 15

    /**
     * Use `UV2` coordinates to look up from the [emissionTexture].
     */
    public final const val FLAG_EMISSION_ON_UV2: Long = 12

    /**
     * Ensures that normals appear correct, even with non-uniform scaling.
     */
    public final const val FLAG_ENSURE_CORRECT_NORMALS: Long = 16

    /**
     * Object is scaled by depth so that it always appears the same size on screen.
     */
    public final const val FLAG_FIXED_SIZE: Long = 6
     ...
     * Vertex color is in sRGB space and needs to be converted to linear. Only applies in the GLES3 renderer.
     */
    public final const val FLAG_SRGB_VERTEX_COLOR: Long = 4

    /**
     * Use world coordinates in the triplanar texture lookup instead of local coordinates.
     */
    public final const val FLAG_TRIPLANAR_USE_WORLD: Long = 10

    /**
     * No lighting is used on the object. Color comes directly from `ALBEDO`.
     */
    public final const val FLAG_UNSHADED: Long = 0

    /**
     * Use alpha scissor. Set by [paramsUseAlphaScissor].
     */
    public final const val FLAG_USE_ALPHA_SCISSOR: Long = 13

    /**
     * Uses point size to alter the size of primitive points. Also changes the albedo texture lookup to use `POINT_COORD` instead of `UV`.
     */
    public final const val FLAG_USE_POINT_SIZE: Long = 5

    /**
     * Enables the shadow to opacity feature.
     */
    public final const val FLAG_USE_SHADOW_TO_OPACITY: Long = 18

    /**
     * Lighting is calculated per-vertex rather than per-pixel. This can be used to increase the speed of the shader at the cost of quality.
     */
    public final const val FLAG_USE_VERTEX_LIGHTING: Long = 1

    /**
     * Use triplanar texture lookup for all texture lookups that would normally use `UV`.
     */
    public final const val FLAG_UV1_USE_TRIPLANAR: Long = 8

    /**
     * Use triplanar texture lookup for all texture lookups that would normally use `UV2`.
     */
    public final const val FLAG_UV2_USE_TRIPLANAR: Long = 9

    /**
     * Older specular algorithm, included for compatibility.
     */
    public final const val SPECULAR_BLINN: Long = 1

    /**
     * No specular blob.
     */
    public final const val SPECULAR_DISABLED: Long = 4

    /**
     * Older specular algorithm, included for compatibility.
     */
    public final const val SPECULAR_PHONG: Long = 2

    /**
     * Default specular blob.
     */
    public final const val SPECULAR_SCHLICK_GGX: Long = 0

    /**
     * Toon blob which changes size based on roughness.
     */
    public final const val SPECULAR_TOON: Long = 3

    /**
     * Texture specifying per-pixel color.
     */
    public final const val TEXTURE_ALBEDO: Long = 0

    /**
     * Texture specifying per-pixel ambient occlusion value.
     */
    public final const val TEXTURE_AMBIENT_OCCLUSION: Long = 8

    /**
     * Used to read from the alpha channel of a texture.
     */
    public final const val TEXTURE_CHANNEL_ALPHA: Long = 3

    /**
     * Used to read from the blue channel of a texture.
     */
    public final const val TEXTURE_CHANNEL_BLUE: Long = 2

    /**
     * Currently unused.
     */
    public final const val TEXTURE_CHANNEL_GRAYSCALE: Long = 4

    /**
     * Used to read from the green channel of a texture.
     */
    public final const val TEXTURE_CHANNEL_GREEN: Long = 1

    /**
     * Used to read from the red channel of a texture.
     */
    public final const val TEXTURE_CHANNEL_RED: Long = 0

    /**
     * Texture specifying per-pixel clearcoat value.
     */
    public final const val TEXTURE_CLEARCOAT: Long = 6

    /**
     * Texture specifying per-pixel depth.
     */
    public final const val TEXTURE_DEPTH: Long = 9

    /**
     * Texture specifying per-pixel detail color.
     */
    public final const val TEXTURE_DETAIL_ALBEDO: Long = 14

    /**
     * Texture specifying per-pixel detail mask blending value.
     */
    public final const val TEXTURE_DETAIL_MASK: Long = 13

    /**
     * Texture specifying per-pixel detail normal.
     */
    public final const val TEXTURE_DETAIL_NORMAL: Long = 15

    /**
     * Texture specifying per-pixel emission color.
     */
    public final const val TEXTURE_EMISSION: Long = 3

    /**
     * Texture specifying per-pixel flowmap direction for use with [anisotropy].
     */
    public final const val TEXTURE_FLOWMAP: Long = 7

    /**
     * Represents the size of the [enum TextureParam] enum.
     */
    public final const val TEXTURE_MAX: Long = 16

    /**
     * Texture specifying per-pixel metallic value.
     */
    public final const val TEXTURE_METALLIC: Long = 1

    /**
     * Texture specifying per-pixel normal vector.
     */
    public final const val TEXTURE_NORMAL: Long = 4

    /**
     * Texture specifying per-pixel refraction strength.
     */
    public final const val TEXTURE_REFRACTION: Long = 12

    /**
     * Texture specifying per-pixel rim value.
     */
    public final const val TEXTURE_RIM: Long = 5

    /**
     * Texture specifying per-pixel roughness value.
     */
    public final const val TEXTURE_ROUGHNESS: Long = 2

    /**
     * Texture specifying per-pixel subsurface scattering.
     */
    public final const val TEXTURE_SUBSURFACE_SCATTERING: Long = 10

    /**
     * Texture specifying per-pixel transmission color.
     */
    public final const val TEXTURE_TRANSMISSION: Long = 11
  }
}
