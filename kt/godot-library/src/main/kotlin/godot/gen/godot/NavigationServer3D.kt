...
public object NavigationServer3D : Object() {
   ...
   * Avoidance processing and dispatch of the `safe_velocity` signals is untouched by this function
   ...
   * take place in air, unterwater or space. The 3D using agent only avoids other 3D avoidance using
