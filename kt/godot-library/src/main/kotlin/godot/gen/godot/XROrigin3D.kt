 ...
 * There should be only one of these nodes in your scene and you must have one. All the XRCamera3D,
 * XRController3D and XRAnchor3D nodes should be direct children of this node for spatial tracking to
 * work correctly.
...
public open class XROrigin3D : Node3D() {
  /**
   * Allows you to adjust the scale to your game's units. Most AR/VR platforms assume a scale of 1
   * game world unit = 1 real world meter.
