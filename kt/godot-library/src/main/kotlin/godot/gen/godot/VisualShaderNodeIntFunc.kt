...
public open class VisualShaderNodeIntFunc : VisualShaderNode() {
  ...
  public var function: Long
    get() {
      ...
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_VISUALSHADERNODEINTFUNC_GET_FUNCTION,
          LONG.ordinal)
      return TransferContext.readReturnValue(LONG, false) as Long
    }
    set(`value`) {
      TransferContext.writeArguments(LONG to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_VISUALSHADERNODEINTFUNC_SET_FUNCTION,
          NIL.ordinal)
    }
