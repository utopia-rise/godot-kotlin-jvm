...
public open class BaseMaterial3D internal constructor() : Material() {
  ...
  /**
   * The texture to use for multiplying the intensity of the subsurface scattering transmitteance
  ...
  public enum class TextureFilter(
    ...
    /**
     * The texture filter blends between the nearest 4 pixels. Use this when you want to avoid a
     * pixelated style, but do not want mipmaps.
     */
    TEXTURE_FILTER_LINEAR(1),
    /**
     * The texture filter reads from the nearest pixel in the nearest mipmap. The fastest way to
     * read from textures with mipmaps.
     */
    TEXTURE_FILTER_NEAREST_WITH_MIPMAPS(2),
    /**
     * The texture filter blends between the nearest 4 pixels and between the nearest 2 mipmaps. Use
     * this for most cases as mipmaps are important to smooth out pixels that are far from the camera.
     */
