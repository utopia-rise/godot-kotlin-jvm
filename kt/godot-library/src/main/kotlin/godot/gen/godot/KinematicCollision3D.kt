...
public open class KinematicCollision3D : RefCounted() {
   ...
   */
  public open fun getPosition(collisionIndex: Long = 0): Vector3 {
   ...
   */
  public open fun getNormal(collisionIndex: Long = 0): Vector3 {
    TransferContext.writeArguments(LONG to collisionIndex)
   ...
   */
  public open fun getLocalShape(collisionIndex: Long = 0): Object? {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.callMethod(rawPtr,
   ...
   */
  public open fun getColliderShape(collisionIndex: Long = 0): Object? {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.callMethod(rawPtr,
   ...
   */
  public open fun getColliderShapeIndex(collisionIndex: Long = 0): Long {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.callMethod(rawPtr,
