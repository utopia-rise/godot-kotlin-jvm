...
public open class RemoteTransform3D : Node3D() {
  ...
  public open var remotePath: NodePath
    get() {
      ...
      TransferContext.callMethod(rawPtr, ENGINEMETHOD_ENGINECLASS_REMOTETRANSFORM3D_GET_REMOTE_PATH,
          NODE_PATH)
      return TransferContext.readReturnValue(NODE_PATH, false) as NodePath
    }
    set(`value`) {
      TransferContext.writeArguments(NODE_PATH to value)
      TransferContext.callMethod(rawPtr, ENGINEMETHOD_ENGINECLASS_REMOTETRANSFORM3D_SET_REMOTE_PATH,
          NIL)
    }
