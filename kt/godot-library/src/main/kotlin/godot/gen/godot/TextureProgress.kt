 ...
 */
@GodotBaseType
public open class TextureProgress : Range() {
  /**
   ...
   */
  public open var textureOver: Texture?
    get() {
      TransferContext.writeArguments()
   ...
   */
  public open var textureProgress: Texture?
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
  ...
  @CoreTypeHelper
  public open fun radialCenterOffset(schedule: Vector2.() -> Unit): Vector2 =
  ...
  @CoreTypeHelper
  public open fun tintOver(schedule: Color.() -> Unit): Color = tintOver.apply{
      schedule(this)
      tintOver = this
  }
  ...
  @CoreTypeHelper
  public open fun tintProgress(schedule: Color.() -> Unit): Color = tintProgress.apply{
      schedule(this)
      tintProgress = this
  }
  ...
  @CoreTypeHelper
  public open fun tintUnder(schedule: Color.() -> Unit): Color = tintUnder.apply{
      schedule(this)
      tintUnder = this
  }
  ...
  public companion object {
     ...
     * The [textureProgress] fills from the center, expanding both towards the left and the right.
     */
    public final const val FILL_BILINEAR_LEFT_AND_RIGHT: Long = 6

    /**
     * The [textureProgress] fills from the center, expanding both towards the top and the bottom.
     */
    public final const val FILL_BILINEAR_TOP_AND_BOTTOM: Long = 7

    /**
     * The [textureProgress] fills from bottom to top.
     */
    public final const val FILL_BOTTOM_TO_TOP: Long = 3

    /**
     * Turns the node into a radial bar. The [textureProgress] fills clockwise. See [radialCenterOffset], [radialInitialAngle] and [radialFillDegrees] to control the way the bar fills up.
     */
    public final const val FILL_CLOCKWISE: Long = 4

    /**
     * Turns the node into a radial bar. The [textureProgress] fills radially from the center, expanding both clockwise and counterclockwise. See [radialCenterOffset], [radialInitialAngle] and [radialFillDegrees] to control the way the bar fills up.
     */
    public final const val FILL_CLOCKWISE_AND_COUNTER_CLOCKWISE: Long = 8

    /**
     * Turns the node into a radial bar. The [textureProgress] fills counterclockwise. See [radialCenterOffset], [radialInitialAngle] and [radialFillDegrees] to control the way the bar fills up.
     */
    public final const val FILL_COUNTER_CLOCKWISE: Long = 5

    /**
     * The [textureProgress] fills from left to right.
     */
    public final const val FILL_LEFT_TO_RIGHT: Long = 0

    /**
     * The [textureProgress] fills from right to left.
     */
    public final const val FILL_RIGHT_TO_LEFT: Long = 1

    /**
     * The [textureProgress] fills from top to bottom.
     */
    public final const val FILL_TOP_TO_BOTTOM: Long = 2
  }
}
