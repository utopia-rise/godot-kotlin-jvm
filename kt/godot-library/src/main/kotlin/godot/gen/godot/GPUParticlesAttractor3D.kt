...
public open class GPUParticlesAttractor3D internal constructor() : VisualInstance3D() {
  ...
  public var strength: Double
    get() {
      ...
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_GPUPARTICLESATTRACTOR3D_GET_STRENGTH,
          DOUBLE.ordinal)
      return TransferContext.readReturnValue(DOUBLE, false) as Double
    }
    set(`value`) {
      TransferContext.writeArguments(DOUBLE to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_GPUPARTICLESATTRACTOR3D_SET_STRENGTH,
          NIL.ordinal)
    }
  ...
  public var attenuation: Double
    get() {
      ...
      TransferContext.icall(rawPtr,
          ENGINEMETHOD_ENGINECLASS_GPUPARTICLESATTRACTOR3D_GET_ATTENUATION, DOUBLE.ordinal)
      return TransferContext.readReturnValue(DOUBLE, false) as Double
    }
    set(`value`) {
      TransferContext.writeArguments(DOUBLE to value)
      TransferContext.icall(rawPtr,
          ENGINEMETHOD_ENGINECLASS_GPUPARTICLESATTRACTOR3D_SET_ATTENUATION, NIL.ordinal)
    }
  ...
  public var directionality: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.icall(rawPtr,
          ENGINEMETHOD_ENGINECLASS_GPUPARTICLESATTRACTOR3D_GET_DIRECTIONALITY, DOUBLE.ordinal)
      return TransferContext.readReturnValue(DOUBLE, false) as Double
    }
    set(`value`) {
      TransferContext.writeArguments(DOUBLE to value)
      TransferContext.icall(rawPtr,
          ENGINEMETHOD_ENGINECLASS_GPUPARTICLESATTRACTOR3D_SET_DIRECTIONALITY, NIL.ordinal)
    }
   ...
   *
   * Particle attraction can also be disabled on a per-process material basis by setting [godot.ParticlesMaterial.attractorInteractionEnabled] on the [godot.GPUParticles3D] node.
   */
  public var cullMask: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_GPUPARTICLESATTRACTOR3D_GET_CULL_MASK,
          LONG.ordinal)
      return TransferContext.readReturnValue(LONG, false) as Long
    }
    set(`value`) {
      TransferContext.writeArguments(LONG to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_GPUPARTICLESATTRACTOR3D_SET_CULL_MASK,
          NIL.ordinal)
    }
