...
public open class XRPositionalTracker : XRTracker() {
  ...
  public fun getTrackerHand(): TrackerHand {
    TransferContext.writeArguments()
  ...
  public fun setTrackerHand(hand: TrackerHand): Unit {
