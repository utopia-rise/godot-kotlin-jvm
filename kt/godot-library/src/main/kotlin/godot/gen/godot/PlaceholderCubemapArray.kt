...
/**
 * A [godot.CubemapArray] without image data.
 *
 * This class replaces a [godot.CubemapArray] or a [godot.CubemapArray]-derived class in 2 conditions:
 *
 ...
 *
 * - When the [godot.CubemapArray]-derived class is missing, for example when using a different engine version.
 *
