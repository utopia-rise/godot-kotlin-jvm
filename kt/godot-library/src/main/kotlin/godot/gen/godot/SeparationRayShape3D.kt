...
public open class SeparationRayShape3D : Shape3D() {
  ...
  public var length: Double
    get() {
      ...
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_SEPARATIONRAYSHAPE3D_GET_LENGTH,
          DOUBLE.ordinal)
      return TransferContext.readReturnValue(DOUBLE, false) as Double
    }
    set(`value`) {
      TransferContext.writeArguments(DOUBLE to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_SEPARATIONRAYSHAPE3D_SET_LENGTH,
          NIL.ordinal)
    }
  ...
  public var slideOnSlope: Boolean
    get() {
      ...
      TransferContext.icall(rawPtr,
          ENGINEMETHOD_ENGINECLASS_SEPARATIONRAYSHAPE3D_GET_SLIDE_ON_SLOPE, BOOL.ordinal)
      return TransferContext.readReturnValue(BOOL, false) as Boolean
    }
    set(`value`) {
      TransferContext.writeArguments(BOOL to value)
      TransferContext.icall(rawPtr,
          ENGINEMETHOD_ENGINECLASS_SEPARATIONRAYSHAPE3D_SET_SLIDE_ON_SLOPE, NIL.ordinal)
    }
