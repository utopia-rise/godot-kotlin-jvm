 ...
 */
@GodotBaseType
public open class StreamPeer : Reference() {
  /**
   ...
   */
  public open fun putData(`data`: PoolByteArray): GodotError {
   ...
   */
  public open fun putPartialData(`data`: PoolByteArray): VariantArray<Any?> {
    TransferContext.writeArguments(POOL_BYTE_ARRAY to data)
