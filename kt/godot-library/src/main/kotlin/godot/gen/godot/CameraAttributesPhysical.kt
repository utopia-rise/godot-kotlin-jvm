...
public open class CameraAttributesPhysical : CameraAttributes() {
  ...
  /**
   * Time for shutter to open and close, measured in seconds. A higher value will let in more light
   * leading to a brighter image, while a lower amount will let in less light leading to a darker
   * image.
   * Only available when [ProjectSettings.rendering/lightsAndShadows/usePhysicalLightUnits] is
   * enabled.
   */
