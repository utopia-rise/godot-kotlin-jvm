...
public open class RDUniform : RefCounted() {
   ...
   *
   */
  public open var uniformType: Long
    get() {
   ...
   *
   */
  public open fun addId(id: RID): Unit {
   ...
   *
   */
  public open fun getIds(): VariantArray<Any?> {
    TransferContext.writeArguments()
