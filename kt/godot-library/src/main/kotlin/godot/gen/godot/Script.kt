 ...
 *
 * Tutorials:
 * [https://docs.godotengine.org/en/3.4/getting_started/step_by_step/scripting.html](https://docs.godotengine.org/en/3.4/getting_started/step_by_step/scripting.html)
 *
 ...
 */
@GodotBaseType
public open class Script : Resource() {
  /**
   * The script source code or an empty string if source code is not available. When set, does not reload the class implementation automatically.
   */
  public open var sourceCode: String
    get() {
   ...
   */
  public open fun getBaseScript(): Script? {
    TransferContext.writeArguments()
   ...
   */
  public open fun getScriptSignalList(): VariantArray<Any?> {
    TransferContext.writeArguments()
   ...
   */
  public open fun isTool(): Boolean {
    TransferContext.writeArguments()
