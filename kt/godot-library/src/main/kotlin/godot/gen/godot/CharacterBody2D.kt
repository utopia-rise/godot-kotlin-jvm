...
public open class CharacterBody2D : PhysicsBody2D() {
   ...
   */
  public open var motionVelocity: Vector2
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_GET_MOTION_VELOCITY, VECTOR2)
      return TransferContext.readReturnValue(VECTOR2, false) as Vector2
    }
    set(`value`) {
      TransferContext.writeArguments(VECTOR2 to value)
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_SET_MOTION_VELOCITY, NIL)
    }
  ...
  public open var slideOnCeiling: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_GET_SLIDE_ON_CEILING, BOOL)
      return TransferContext.readReturnValue(BOOL, false) as Boolean
    }
    set(`value`) {
      TransferContext.writeArguments(BOOL to value)
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_SET_SLIDE_ON_CEILING, NIL)
    }
  ...
  public open var floorStopOnSlope: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_GET_FLOOR_STOP_ON_SLOPE, BOOL)
      return TransferContext.readReturnValue(BOOL, false) as Boolean
    }
    set(`value`) {
      TransferContext.writeArguments(BOOL to value)
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_SET_FLOOR_STOP_ON_SLOPE, NIL)
    }
  ...
  public open var floorConstantSpeed: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_GET_FLOOR_CONSTANT_SPEED, BOOL)
      return TransferContext.readReturnValue(BOOL, false) as Boolean
    }
    set(`value`) {
      TransferContext.writeArguments(BOOL to value)
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_SET_FLOOR_CONSTANT_SPEED, NIL)
    }
  ...
  public open var floorBlockOnWall: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_GET_FLOOR_BLOCK_ON_WALL, BOOL)
      return TransferContext.readReturnValue(BOOL, false) as Boolean
    }
    set(`value`) {
      TransferContext.writeArguments(BOOL to value)
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_SET_FLOOR_BLOCK_ON_WALL, NIL)
    }
  ...
  public open var collision_safeMargin: Double
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_GET_COLLISION_SAFE_MARGIN, DOUBLE)
      return TransferContext.readReturnValue(DOUBLE, false) as Double
    }
    set(`value`) {
      TransferContext.writeArguments(DOUBLE to value)
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_CHARACTERBODY2D_SET_COLLISION_SAFE_MARGIN, NIL)
    }
  ...
  /**
   * Moves the body based on [motionVelocity]. If the body collides with another, it will slide along the other body (by default only on floor) rather than stop immediately. If the other body is a [godot.CharacterBody2D] or [godot.RigidDynamicBody2D], it will also be affected by the motion of the other body. You can use this to make moving and rotating platforms, or to make nodes push other nodes.
   *
   ...
   *
   * Modifies [motionVelocity] if a slide collision occurred. To get the latest collision call [getLastSlideCollision], for detailed information about collisions that occurred, use [getSlideCollision].
   *
   ...
   */
  public open fun getFloorAngle(upDirection: Vector2 = Vector2Vector2(0.0, -1.0)): Double {
