...
public open class PhysicsDirectBodyState2DExtension : PhysicsDirectBodyState2D() {
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.totalGravity] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.totalLinearDamp] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.totalAngularDamp] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.centerOfMass] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.centerOfMassLocal] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.inverseMass] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.inverseInertia] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.linearVelocity] and its respective setter.
   */
  public open fun _setLinearVelocity(velocity: Vector2): Unit {
  }

  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.linearVelocity] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.angularVelocity] and its respective setter.
   */
  public open fun _setAngularVelocity(velocity: Float): Unit {
  }

  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.angularVelocity] and its respective getter.
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.transform] and its respective setter.
   */
  public open fun _setTransform(transform: Transform2D): Unit {
  }

  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.transform] and its respective getter.
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getVelocityAtLocalPosition].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.applyCentralImpulse].
   */
  public open fun _applyCentralImpulse(impulse: Vector2): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.applyImpulse].
   */
  public open fun _applyImpulse(impulse: Vector2, position: Vector2): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.applyTorqueImpulse].
   */
  public open fun _applyTorqueImpulse(impulse: Float): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.applyCentralForce].
   */
  public open fun _applyCentralForce(force: Vector2): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.applyForce].
   */
  public open fun _applyForce(force: Vector2, position: Vector2): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.applyTorque].
   */
  public open fun _applyTorque(torque: Float): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.addConstantCentralForce].
   */
  public open fun _addConstantCentralForce(force: Vector2): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.addConstantForce].
   */
  public open fun _addConstantForce(force: Vector2, position: Vector2): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.addConstantTorque].
   */
  public open fun _addConstantTorque(torque: Float): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.setConstantForce].
   */
  public open fun _setConstantForce(force: Vector2): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getConstantForce].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.setConstantTorque].
   */
  public open fun _setConstantTorque(torque: Float): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getConstantTorque].
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.sleeping] and its respective setter.
   */
  public open fun _setSleepState(enabled: Boolean): Unit {
  }

  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.sleeping] and its respective getter.
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactCount].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactLocalPosition].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactLocalNormal].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactLocalShape].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactLocalVelocityAtPosition].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactCollider].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactColliderPosition].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactColliderId].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactColliderObject].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactColliderShape].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactColliderVelocityAtPosition].
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getContactImpulse].
   */
  ...
  /**
   * Implement to override the behavior of [godot.PhysicsDirectBodyState2D.step] and its respective getter.
   */
  ...
  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.integrateForces].
   */
  public open fun _integrateForces(): Unit {
  }

  /**
   * Overridable version of [godot.PhysicsDirectBodyState2D.getSpaceState].
   */
