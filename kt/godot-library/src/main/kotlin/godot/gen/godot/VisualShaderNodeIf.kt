 ...
 * `a` and `b` that will be compared. Port 3 is the tolerance, which allows similar floating point
 * number to be considered equal. Ports 4 to 6 are the possible outputs, returned if `a == b`, `a > b`,
 * or `a < b` respectively.
 */
@GodotBaseType
