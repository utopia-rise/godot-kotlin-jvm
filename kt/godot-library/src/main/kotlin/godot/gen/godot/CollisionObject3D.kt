...
public open class CollisionObject3D internal constructor() : Node3D() {
  ...
  public var disableMode: Long
    get() {
      ...
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_GET_DISABLE_MODE,
          LONG.ordinal)
      return TransferContext.readReturnValue(LONG, false) as Long
    }
    set(`value`) {
      TransferContext.writeArguments(LONG to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SET_DISABLE_MODE,
          NIL.ordinal)
    }
  ...
  public var collisionLayer: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_GET_COLLISION_LAYER,
          LONG.ordinal)
      return TransferContext.readReturnValue(LONG, false) as Long
    }
    set(`value`) {
      TransferContext.writeArguments(LONG to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SET_COLLISION_LAYER,
          NIL.ordinal)
    }
  ...
  public var collisionMask: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_GET_COLLISION_MASK,
          LONG.ordinal)
      return TransferContext.readReturnValue(LONG, false) as Long
    }
    set(`value`) {
      TransferContext.writeArguments(LONG to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SET_COLLISION_MASK,
          NIL.ordinal)
    }
  ...
  public var inputRayPickable: Boolean
    get() {
      TransferContext.writeArguments()
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_IS_RAY_PICKABLE,
          BOOL.ordinal)
      return TransferContext.readReturnValue(BOOL, false) as Boolean
    }
    set(`value`) {
      TransferContext.writeArguments(BOOL to value)
      TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SET_RAY_PICKABLE,
          NIL.ordinal)
    }
  ...
  public var inputCaptureOnDrag: Boolean
    get() {
      ...
      TransferContext.icall(rawPtr,
          ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_GET_CAPTURE_INPUT_ON_DRAG, BOOL.ordinal)
      return TransferContext.readReturnValue(BOOL, false) as Boolean
    }
    set(`value`) {
      TransferContext.writeArguments(BOOL to value)
      TransferContext.icall(rawPtr,
          ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SET_CAPTURE_INPUT_ON_DRAG, NIL.ordinal)
    }
  ...
  public fun setCollisionLayerValue(layerNumber: Long, `value`: Boolean): Unit {
    ...
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SET_COLLISION_LAYER_VALUE, NIL.ordinal)
  }
  ...
  public fun getCollisionLayerValue(layerNumber: Long): Boolean {
    ...
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_GET_COLLISION_LAYER_VALUE, BOOL.ordinal)
    return TransferContext.readReturnValue(BOOL, false) as Boolean
  }
  ...
  public fun setCollisionMaskValue(layerNumber: Long, `value`: Boolean): Unit {
    TransferContext.writeArguments(LONG to layerNumber, BOOL to value)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SET_COLLISION_MASK_VALUE, NIL.ordinal)
  }
  ...
  public fun getCollisionMaskValue(layerNumber: Long): Boolean {
    TransferContext.writeArguments(LONG to layerNumber)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_GET_COLLISION_MASK_VALUE, BOOL.ordinal)
    return TransferContext.readReturnValue(BOOL, false) as Boolean
  }
  ...
  public fun getRid(): RID {
    TransferContext.writeArguments()
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_GET_RID, _RID.ordinal)
  ...
  public fun createShapeOwner(owner: Object): Long {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_CREATE_SHAPE_OWNER,
        LONG.ordinal)
    return TransferContext.readReturnValue(LONG, false) as Long
  }
  ...
  public fun removeShapeOwner(ownerId: Long): Unit {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_REMOVE_SHAPE_OWNER,
        NIL.ordinal)
  }
  ...
  public fun getShapeOwners(): VariantArray<Any?> {
    TransferContext.writeArguments()
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_GET_SHAPE_OWNERS,
        ARRAY.ordinal)
  ...
  public fun shapeOwnerSetTransform(ownerId: Long, transform: Transform3D): Unit {
    ...
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_SET_TRANSFORM, NIL.ordinal)
  }
  ...
  public fun shapeOwnerGetTransform(ownerId: Long): Transform3D {
    TransferContext.writeArguments(LONG to ownerId)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_GET_TRANSFORM, TRANSFORM3D.ordinal)
  ...
  public fun shapeOwnerGetOwner(ownerId: Long): Object? {
    TransferContext.writeArguments(LONG to ownerId)
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_GET_OWNER,
        OBJECT.ordinal)
  ...
  public fun shapeOwnerSetDisabled(ownerId: Long, disabled: Boolean): Unit {
    ...
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_SET_DISABLED, NIL.ordinal)
  }
  ...
  public fun isShapeOwnerDisabled(ownerId: Long): Boolean {
    TransferContext.writeArguments(LONG to ownerId)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_IS_SHAPE_OWNER_DISABLED, BOOL.ordinal)
    return TransferContext.readReturnValue(BOOL, false) as Boolean
  }
  ...
  public fun shapeOwnerAddShape(ownerId: Long, shape: Shape3D): Unit {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_ADD_SHAPE,
        NIL.ordinal)
  }
  ...
  public fun shapeOwnerGetShapeCount(ownerId: Long): Long {
    TransferContext.writeArguments(LONG to ownerId)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_GET_SHAPE_COUNT, LONG.ordinal)
    return TransferContext.readReturnValue(LONG, false) as Long
  }
  ...
  public fun shapeOwnerGetShape(ownerId: Long, shapeId: Long): Shape3D? {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_GET_SHAPE,
        OBJECT.ordinal)
  ...
  public fun shapeOwnerGetShapeIndex(ownerId: Long, shapeId: Long): Long {
    TransferContext.writeArguments(LONG to ownerId, LONG to shapeId)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_GET_SHAPE_INDEX, LONG.ordinal)
    return TransferContext.readReturnValue(LONG, false) as Long
  }
  ...
  public fun shapeOwnerRemoveShape(ownerId: Long, shapeId: Long): Unit {
    TransferContext.writeArguments(LONG to ownerId, LONG to shapeId)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_REMOVE_SHAPE, NIL.ordinal)
  }
  ...
  public fun shapeOwnerClearShapes(ownerId: Long): Unit {
    TransferContext.writeArguments(LONG to ownerId)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_OWNER_CLEAR_SHAPES, NIL.ordinal)
  }
  ...
  public fun shapeFindOwner(shapeIndex: Long): Long {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_COLLISIONOBJECT3D_SHAPE_FIND_OWNER,
        LONG.ordinal)
    return TransferContext.readReturnValue(LONG, false) as Long
  }
