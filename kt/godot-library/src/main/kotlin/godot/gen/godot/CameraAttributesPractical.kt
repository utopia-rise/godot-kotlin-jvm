...
public open class CameraAttributesPractical : CameraAttributes() {
   ...
   * a multiplier. High values lead to an increased amount of bluriness, but can be much more expensive
   * to calculate. It is best to keep this as low as possible for a given art style.
   */
