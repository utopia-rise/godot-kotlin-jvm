...
public open class AnimationNode : Resource() {
  ...
  /**
   * When inheriting from [AnimationRootNode], implement this virtual method to return all children
  ...
  /**
   * Blend another animation node (in case this animation node contains children animation nodes).
   * This function is only useful if you inherit from [AnimationRootNode] instead, else editors will
