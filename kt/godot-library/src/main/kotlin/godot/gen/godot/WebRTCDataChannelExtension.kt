...
public open class WebRTCDataChannelExtension : WebRTCDataChannel() {
  ...
  public open fun _getMaxPacketSize(): Long {
    throw
        NotImplementedError("_get_max_packet_size is not implemented for WebRTCDataChannelExtension")
  }
  ...
  public open fun _wasStringPacket(): Boolean {
    throw
        NotImplementedError("_was_string_packet is not implemented for WebRTCDataChannelExtension")
  }
  ...
  public open fun _getMaxPacketLifeTime(): Long {
    throw
        NotImplementedError("_get_max_packet_life_time is not implemented for WebRTCDataChannelExtension")
  }

  public open fun _getMaxRetransmits(): Long {
    throw
        NotImplementedError("_get_max_retransmits is not implemented for WebRTCDataChannelExtension")
  }
  ...
  public open fun _getBufferedAmount(): Long {
    throw
        NotImplementedError("_get_buffered_amount is not implemented for WebRTCDataChannelExtension")
  }
