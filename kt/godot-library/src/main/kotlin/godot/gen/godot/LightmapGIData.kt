...
public open class LightmapGIData : Resource() {
  ...
  public fun setLightmapTextures(lightTextures: VariantArray<TextureLayered>): Unit {
  ...
  public fun getLightmapTextures(): VariantArray<TextureLayered> {
   ...
   * lightmapper.
   */
  public fun setUsesSphericalHarmonics(usesSphericalHarmonics: Boolean): Unit {
   ...
   */
  public fun isUsingSphericalHarmonics(): Boolean {
    TransferContext.writeArguments()
  ...
  public fun setLightTexture(lightTexture: TextureLayered?): Unit {
  ...
  public fun getLightTexture(): TextureLayered? {
    TransferContext.writeArguments()
