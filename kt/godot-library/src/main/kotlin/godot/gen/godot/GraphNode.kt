...
public open class GraphNode : Container() {
   ...
   */
  public val offsetChanged: Signal0 by signal()
   ...
   */
  public val resizeRequest: Signal1<Vector2> by signal("new_minsize")
  ...
  public companion object {
     ...
     * Show overlay set in the `breakpoint` theme property.
     */
    public final const val OVERLAY_BREAKPOINT: Long = 1

    /**
     * No overlay is shown.
     */
    public final const val OVERLAY_DISABLED: Long = 0

    /**
     * Show overlay set in the `position` theme property.
     */
    public final const val OVERLAY_POSITION: Long = 2
  }
}
