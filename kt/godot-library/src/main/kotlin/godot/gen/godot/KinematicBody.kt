...
public open class KinematicBody : PhysicsBody() {
  ...
  public open var movingPlatformApplyVelocityOnLeave: Long
    get() {
      TransferContext.writeArguments()
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_KINEMATICBODY_GET_MOVING_PLATFORM_APPLY_VELOCITY_ON_LEAVE, LONG)
      return TransferContext.readReturnValue(LONG, false) as Long
    }
    set(`value`) {
      TransferContext.writeArguments(LONG to value)
      TransferContext.callMethod(rawPtr,
          ENGINEMETHOD_ENGINECLASS_KINEMATICBODY_SET_MOVING_PLATFORM_APPLY_VELOCITY_ON_LEAVE, NIL)
    }
