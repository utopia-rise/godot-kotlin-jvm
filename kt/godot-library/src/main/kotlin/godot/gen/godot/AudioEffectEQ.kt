...
public open class AudioEffectEQ : AudioEffect() {
  ...
  public fun setBandGainDb(bandIdx: Long, volumeDb: Double): Unit {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_AUDIOEFFECTEQ_SET_BAND_GAIN_DB,
        NIL.ordinal)
  }
  ...
  public fun getBandGainDb(bandIdx: Long): Double {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_AUDIOEFFECTEQ_GET_BAND_GAIN_DB,
        DOUBLE.ordinal)
  ...
  public fun getBandCount(): Long {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_AUDIOEFFECTEQ_GET_BAND_COUNT,
        LONG.ordinal)
