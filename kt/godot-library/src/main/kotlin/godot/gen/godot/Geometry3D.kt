...
public object Geometry3D : Object() {
   ...
   */
  public open fun buildBoxPlanes(extents: Vector3): VariantArray<Any?> {
   ...
   */
  public open fun buildCylinderPlanes(
    radius: Double,
    height: Double,
    sides: Long,
   ...
   */
  public open fun buildCapsulePlanes(
    radius: Double,
    height: Double,
    sides: Long,
    lats: Long,
   ...
   */
  public open fun rayIntersectsTriangle(
    from: Vector3,
    dir: Vector3,
    a: Vector3,
    b: Vector3,
   ...
   */
  public open fun segmentIntersectsTriangle(
    from: Vector3,
    to: Vector3,
    a: Vector3,
    b: Vector3,
  ...
  /**
   * Checks if the segment (`from`, `to`) intersects the sphere that is located at `sphere_position` and has radius `sphere_radius`. If no, returns an empty [godot.PackedVector3Array]. If yes, returns a [godot.PackedVector3Array] containing the point of intersection and the sphere's normal at the point of intersection.
   */
  public open fun segmentIntersectsSphere(
    from: Vector3,
    to: Vector3,
   ...
   */
  public open fun segmentIntersectsCylinder(
    from: Vector3,
    to: Vector3,
    height: Double,
    radius: Double
   ...
   */
  public open fun segmentIntersectsConvex(
    from: Vector3,
    to: Vector3,
   ...
   */
  public open fun clipPolygon(points: PackedVector3Array, plane: Plane): PackedVector3Array {
