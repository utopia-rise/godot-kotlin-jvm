 ...
 *     # Verifying
 *     var verified = crypto.verify(HashingContext.HASH_SHA256, data.sha256_buffer(), signature,
 * key)
 *     # Checks
 *     assert(verified)
 ...
 *         // Generate new self-signed certificate with the given key.
 *         _cert = _crypto.GenerateSelfSignedCertificate(_key, "CN=mydomain.com,O=My Game
 * Company,C=IT");
 *         // Save key and certificate in the user folder.
 ...
 *         // Signing
 *         byte[] signature = _crypto.Sign(HashingContext.HashType.Sha256, Data.Sha256Buffer(),
 * _key);
 *         // Verifying
 *         bool verified = _crypto.Verify(HashingContext.HashType.Sha256, Data.Sha256Buffer(),
 * signature, _key);
 *         // Checks
