 ...
 * when it's in [constant CollisionPolygon2D.BUILD_SOLIDS] mode.
 ...
 * [constant CollisionPolygon2D.BUILD_SOLIDS] mode. To generate a collision polygon from a sprite,
 * select the [Sprite2D] node, go to the **Sprite2D** menu that appears above the viewport, and choose
