...
public open class PhysicsTestMotionResult3D : RefCounted() {
  ...
  public fun getTravel(): Vector3 {
    ...
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_TRAVEL,
        VECTOR3.ordinal)
  ...
  public fun getRemainder(): Vector3 {
    TransferContext.writeArguments()
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_REMAINDER,
        VECTOR3.ordinal)
    return TransferContext.readReturnValue(VECTOR3, false) as Vector3
  }
  ...
  public fun getCollisionSafeFraction(): Double {
    ...
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLISION_SAFE_FRACTION,
        DOUBLE.ordinal)
  ...
  public fun getCollisionUnsafeFraction(): Double {
    TransferContext.writeArguments()
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLISION_UNSAFE_FRACTION,
        DOUBLE.ordinal)
    return TransferContext.readReturnValue(DOUBLE, false) as Double
  }
  ...
  public fun getCollisionCount(): Long {
    TransferContext.writeArguments()
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLISION_COUNT, LONG.ordinal)
  ...
  public fun getCollisionPoint(collisionIndex: Long = 0): Vector3 {
    ...
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLISION_POINT, VECTOR3.ordinal)
    return TransferContext.readReturnValue(VECTOR3, false) as Vector3
  }
  ...
  public fun getCollisionNormal(collisionIndex: Long = 0): Vector3 {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLISION_NORMAL, VECTOR3.ordinal)
    return TransferContext.readReturnValue(VECTOR3, false) as Vector3
  }
  ...
  public fun getColliderVelocity(collisionIndex: Long = 0): Vector3 {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLIDER_VELOCITY, VECTOR3.ordinal)
    return TransferContext.readReturnValue(VECTOR3, false) as Vector3
  }
  ...
  public fun getColliderId(collisionIndex: Long = 0): Long {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLIDER_ID, LONG.ordinal)
    return TransferContext.readReturnValue(LONG, false) as Long
  }
  ...
  public fun getColliderRid(collisionIndex: Long = 0): RID {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLIDER_RID, _RID.ordinal)
  ...
  public fun getCollider(collisionIndex: Long = 0): Object? {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.icall(rawPtr, ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLIDER,
        OBJECT.ordinal)
  ...
  public fun getColliderShape(collisionIndex: Long = 0): Long {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLIDER_SHAPE, LONG.ordinal)
    return TransferContext.readReturnValue(LONG, false) as Long
  }
  ...
  public fun getCollisionLocalShape(collisionIndex: Long = 0): Long {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLISION_LOCAL_SHAPE, LONG.ordinal)
    return TransferContext.readReturnValue(LONG, false) as Long
  }
  ...
  public fun getCollisionDepth(collisionIndex: Long = 0): Double {
    TransferContext.writeArguments(LONG to collisionIndex)
    TransferContext.icall(rawPtr,
        ENGINEMETHOD_ENGINECLASS_PHYSICSTESTMOTIONRESULT3D_GET_COLLISION_DEPTH, DOUBLE.ordinal)
    return TransferContext.readReturnValue(DOUBLE, false) as Double
  }
