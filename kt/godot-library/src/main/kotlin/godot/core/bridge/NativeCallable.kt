...
class NativeCallable : NativeCoreType, Callable {
    ...
    internal constructor(lambdaCallable: LambdaCallable<*>) {
        ...
        ptr = Bridge.engine_call_constructor_kt_custom_callable(lambdaCallable, lambdaCallable.variantConverter.id, lambdaCallable.hashCode(), lambdaCallable.onDestroyCall != null)
        MemoryManager.registerNativeCoreType(this, VariantParser.CALLABLE)
    }
    ...
    object Bridge {
        ...
        external fun engine_call_constructor_kt_custom_callable(callable: LambdaCallable<*>, variantTypeOrdinal: Int, hashCode: Int, hasOnDestroy: Boolean): VoidPtr
