...
class PackedInt64Array : NativeCoreType, Iterable<Long> {
     ...
     */
    fun bsearch(value: Long, before: Boolean = true): Int {
        TransferContext.writeArguments(VariantType.LONG to value, VariantType.BOOL to before)
     ...
     */
    fun count(value: Long): Int {
        TransferContext.writeArguments(VariantType.LONG to value)
     ...
     */
    fun duplicate(): PackedInt64Array {
     ...
     */
    fun rfind(value: Long, from: Int = -1): Int {
        TransferContext.writeArguments(VariantType.LONG to value, VariantType.JVM_INT to from)
     ...
     */
    fun slice(begin: Int, end: Int = Int.MAX_VALUE): PackedInt64Array {
