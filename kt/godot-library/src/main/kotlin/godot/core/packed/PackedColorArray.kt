...
class PackedColorArray : NativeCoreType, Iterable<Color> {
    ...
    constructor(from: PackedColorArray) {
        ...
        _handle = Bridge.engine_call_constructor_packed_color_array()
        GarbageCollector.registerNativeCoreType(this, VariantType.PACKED_COLOR_ARRAY)
    }
     ...
     */
    fun bsearch(value: Color, before: Boolean = true): Int {
        TransferContext.writeArguments(VariantType.COLOR to value, VariantType.BOOL to before)
    ...
    fun count(value: Color): Int {
        TransferContext.writeArguments(VariantType.COLOR to value)
     ...
     */
    fun duplicate(): PackedColorArray {
        Bridge.engine_call_duplicate(_handle)
        return TransferContext.readReturnValue(VariantType.PACKED_COLOR_ARRAY) as PackedColorArray
    }
    ...
    operator fun get(idx: Int): Color {
        ...
        return TransferContext.readReturnValue(VariantType.COLOR) as Color
    }

    /**
     * Returns `true` if the array contains [value].
     */
    fun has(value: Color): Boolean {
        TransferContext.writeArguments(VariantType.COLOR to value)
    ...
    fun insert(idx: Int, data: Color) {
        TransferContext.writeArguments(VariantType.JVM_INT to idx, VariantType.COLOR to data)
    ...
    fun pushBack(data: Color) {
        TransferContext.writeArguments(VariantType.COLOR to data)
     ...
     */
    fun rfind(value: Color, from: Int = -1): Int {
        TransferContext.writeArguments(VariantType.COLOR to value, VariantType.JVM_INT to from)
     ...
     */
    fun slice(begin: Int, end: Int = Int.MAX_VALUE): PackedColorArray {
    ...
    private object Bridge {
        ...
        external fun engine_call_constructor_packed_color_array(): VoidPtr
