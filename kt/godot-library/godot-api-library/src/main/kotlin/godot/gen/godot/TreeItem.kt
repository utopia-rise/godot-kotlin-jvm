...
public open class TreeItem internal constructor() : Object() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    Internals.callConstructor(this, ENGINE_CLASS_TREEITEM_INDEX, scriptIndex)
  }
  ...
  public final fun setCellMode(column: Int, mode: TreeCellMode): Unit {
    Internals.writeArguments(LONG to column.toLong(), LONG to mode.id)
    Internals.callMethod(rawPtr, MethodBindings.setCellModePtr, NIL)
  }
  ...
  public final fun getCellMode(column: Int): TreeCellMode {
    ...
    Internals.callMethod(rawPtr, MethodBindings.getCellModePtr, LONG)
    return TreeItem.TreeCellMode.from(Internals.readReturnValue(LONG) as Long)
  }
  ...
  public final fun setEditMultiline(column: Int, multiline: Boolean): Unit {
    Internals.writeArguments(LONG to column.toLong(), BOOL to multiline)
    Internals.callMethod(rawPtr, MethodBindings.setEditMultilinePtr, NIL)
  }
  ...
  public final fun isEditMultiline(column: Int): Boolean {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.isEditMultilinePtr, BOOL)
  ...
  public final fun setChecked(column: Int, checked: Boolean): Unit {
    Internals.writeArguments(LONG to column.toLong(), BOOL to checked)
    Internals.callMethod(rawPtr, MethodBindings.setCheckedPtr, NIL)
  }
  ...
  public final fun setIndeterminate(column: Int, indeterminate: Boolean): Unit {
    Internals.writeArguments(LONG to column.toLong(), BOOL to indeterminate)
  ...
  public final fun isChecked(column: Int): Boolean {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.isCheckedPtr, BOOL)
    return (Internals.readReturnValue(BOOL) as Boolean)
  }
  ...
  public final fun propagateCheck(column: Int, emitSignal: Boolean = true): Unit {
    Internals.writeArguments(LONG to column.toLong(), BOOL to emitSignal)
    Internals.callMethod(rawPtr, MethodBindings.propagateCheckPtr, NIL)
  }
  ...
  public final fun setText(column: Int, text: String): Unit {
    Internals.writeArguments(LONG to column.toLong(), STRING to text)
  ...
  public final fun setAutowrapMode(column: Int, autowrapMode: TextServer.AutowrapMode): Unit {
    Internals.writeArguments(LONG to column.toLong(), LONG to autowrapMode.id)
  ...
  public final fun setTextOverrunBehavior(column: Int, overrunBehavior: TextServer.OverrunBehavior):
      Unit {
    Internals.writeArguments(LONG to column.toLong(), LONG to overrunBehavior.id)
  ...
  public final fun setStructuredTextBidiOverride(column: Int,
    ...
    Internals.writeArguments(LONG to column.toLong(), LONG to parser.id)
  ...
  public final fun setStructuredTextBidiOverrideOptions(column: Int, args: VariantArray<Any?>):
      Unit {
    Internals.writeArguments(LONG to column.toLong(), ARRAY to args)
  ...
  public final fun setIcon(column: Int, texture: Texture2D?): Unit {
    Internals.writeArguments(LONG to column.toLong(), OBJECT to texture)
  ...
  public final fun setIconRegion(column: Int, region: Rect2): Unit {
    Internals.writeArguments(LONG to column.toLong(), RECT2 to region)
    Internals.callMethod(rawPtr, MethodBindings.setIconRegionPtr, NIL)
  }
  ...
  public final fun getIconRegion(column: Int): Rect2 {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getIconRegionPtr, RECT2)
  ...
  public final fun setIconMaxWidth(column: Int, width: Int): Unit {
    Internals.writeArguments(LONG to column.toLong(), LONG to width.toLong())
    Internals.callMethod(rawPtr, MethodBindings.setIconMaxWidthPtr, NIL)
  }
  ...
  public final fun getIconMaxWidth(column: Int): Int {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getIconMaxWidthPtr, LONG)
  ...
  public final fun setIconModulate(column: Int, modulate: Color): Unit {
    Internals.writeArguments(LONG to column.toLong(), COLOR to modulate)
    Internals.callMethod(rawPtr, MethodBindings.setIconModulatePtr, NIL)
  }
  ...
  public final fun getIconModulate(column: Int): Color {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getIconModulatePtr, COLOR)
  ...
  public final fun setRange(column: Int, `value`: Double): Unit {
    Internals.writeArguments(LONG to column.toLong(), DOUBLE to value)
  ...
  public final fun setRangeConfig(
    ...
    Internals.writeArguments(LONG to column.toLong(), DOUBLE to min, DOUBLE to max, DOUBLE to step, BOOL to expr)
    Internals.callMethod(rawPtr, MethodBindings.setRangeConfigPtr, NIL)
  }
  ...
  public final fun getRangeConfig(column: Int): Dictionary<Any?, Any?> {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getRangeConfigPtr, DICTIONARY)
  ...
  public final fun setMetadata(column: Int, meta: Any?): Unit {
    Internals.writeArguments(LONG to column.toLong(), ANY to meta)
    Internals.callMethod(rawPtr, MethodBindings.setMetadataPtr, NIL)
  }
  ...
  public final fun getMetadata(column: Int): Any? {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getMetadataPtr, ANY)
  ...
  public final fun setCustomDraw(
    ...
    Internals.writeArguments(LONG to column.toLong(), OBJECT to `object`, STRING_NAME to callback)
    Internals.callMethod(rawPtr, MethodBindings.setCustomDrawPtr, NIL)
  }
  ...
  public final fun setCustomDrawCallback(column: Int, callback: Callable): Unit {
    Internals.writeArguments(LONG to column.toLong(), CALLABLE to callback)
    Internals.callMethod(rawPtr, MethodBindings.setCustomDrawCallbackPtr, NIL)
  }
  ...
  public final fun getCustomDrawCallback(column: Int): Callable {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getCustomDrawCallbackPtr, CALLABLE)
  ...
  public final fun setCollapsedRecursive(enable: Boolean): Unit {
    Internals.writeArguments(BOOL to enable)
    Internals.callMethod(rawPtr, MethodBindings.setCollapsedRecursivePtr, NIL)
  }
  ...
  public final fun isAnyCollapsed(onlyVisible: Boolean = false): Boolean {
    Internals.writeArguments(BOOL to onlyVisible)
    Internals.callMethod(rawPtr, MethodBindings.isAnyCollapsedPtr, BOOL)
    return (Internals.readReturnValue(BOOL) as Boolean)
  }
  ...
  public final fun uncollapseTree(): Unit {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.uncollapseTreePtr, NIL)
  }

  public final fun setCustomMinimumHeight(height: Int): Unit {
    Internals.writeArguments(LONG to height.toLong())
    Internals.callMethod(rawPtr, MethodBindings.setCustomMinimumHeightPtr, NIL)
  }

  public final fun getCustomMinimumHeight(): Int {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getCustomMinimumHeightPtr, LONG)
    return (Internals.readReturnValue(LONG) as Long).toInt()
  }
  ...
  public final fun setSelectable(column: Int, selectable: Boolean): Unit {
    Internals.writeArguments(LONG to column.toLong(), BOOL to selectable)
  ...
  public final fun setEditable(column: Int, enabled: Boolean): Unit {
    Internals.writeArguments(LONG to column.toLong(), BOOL to enabled)
  ...
  public final fun setCustomColor(column: Int, color: Color): Unit {
    Internals.writeArguments(LONG to column.toLong(), COLOR to color)
    Internals.callMethod(rawPtr, MethodBindings.setCustomColorPtr, NIL)
  }
  ...
  public final fun getCustomColor(column: Int): Color {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getCustomColorPtr, COLOR)
    return (Internals.readReturnValue(COLOR) as Color)
  }
  ...
  public final fun clearCustomColor(column: Int): Unit {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.clearCustomColorPtr, NIL)
  }
  ...
  public final fun setCustomFont(column: Int, font: Font?): Unit {
    Internals.writeArguments(LONG to column.toLong(), OBJECT to font)
    Internals.callMethod(rawPtr, MethodBindings.setCustomFontPtr, NIL)
  }
  ...
  public final fun getCustomFont(column: Int): Font? {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getCustomFontPtr, OBJECT)
  ...
  public final fun setCustomFontSize(column: Int, fontSize: Int): Unit {
    Internals.writeArguments(LONG to column.toLong(), LONG to fontSize.toLong())
    Internals.callMethod(rawPtr, MethodBindings.setCustomFontSizePtr, NIL)
  }
  ...
  public final fun getCustomFontSize(column: Int): Int {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getCustomFontSizePtr, LONG)
    return (Internals.readReturnValue(LONG) as Long).toInt()
  }
  ...
  public final fun setCustomBgColor(
    ...
    Internals.writeArguments(LONG to column.toLong(), COLOR to color, BOOL to justOutline)
    Internals.callMethod(rawPtr, MethodBindings.setCustomBgColorPtr, NIL)
  }
  ...
  public final fun clearCustomBgColor(column: Int): Unit {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.clearCustomBgColorPtr, NIL)
  }
  ...
  public final fun getCustomBgColor(column: Int): Color {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getCustomBgColorPtr, COLOR)
    return (Internals.readReturnValue(COLOR) as Color)
  }
  ...
  public final fun setCustomAsButton(column: Int, enable: Boolean): Unit {
    ...
    Internals.callMethod(rawPtr, MethodBindings.setCustomAsButtonPtr, NIL)
  }
  ...
  public final fun isCustomSetAsButton(column: Int): Boolean {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.isCustomSetAsButtonPtr, BOOL)
    return (Internals.readReturnValue(BOOL) as Boolean)
  }
  ...
  public final fun addButton(
    ...
    Internals.writeArguments(LONG to column.toLong(), OBJECT to button, LONG to id.toLong(), BOOL to disabled, STRING to tooltipText)
    Internals.callMethod(rawPtr, MethodBindings.addButtonPtr, NIL)
  }
  ...
  public final fun getButtonCount(column: Int): Int {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getButtonCountPtr, LONG)
    return (Internals.readReturnValue(LONG) as Long).toInt()
  }
  ...
  public final fun getButtonTooltipText(column: Int, buttonIndex: Int): String {
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getButtonTooltipTextPtr, STRING)
    return (Internals.readReturnValue(STRING) as String)
  }
  ...
  public final fun getButtonId(column: Int, buttonIndex: Int): Int {
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getButtonIdPtr, LONG)
    return (Internals.readReturnValue(LONG) as Long).toInt()
  }
  ...
  public final fun getButtonById(column: Int, id: Int): Int {
    Internals.writeArguments(LONG to column.toLong(), LONG to id.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getButtonByIdPtr, LONG)
    return (Internals.readReturnValue(LONG) as Long).toInt()
  }
  ...
  public final fun getButtonColor(column: Int, id: Int): Color {
    Internals.writeArguments(LONG to column.toLong(), LONG to id.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getButtonColorPtr, COLOR)
    return (Internals.readReturnValue(COLOR) as Color)
  }
  ...
  public final fun getButton(column: Int, buttonIndex: Int): Texture2D? {
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getButtonPtr, OBJECT)
    return (Internals.readReturnValue(OBJECT) as Texture2D?)
  }
  ...
  public final fun setButtonTooltipText(
    ...
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong(), STRING to tooltip)
    Internals.callMethod(rawPtr, MethodBindings.setButtonTooltipTextPtr, NIL)
  }
  ...
  public final fun setButton(
    ...
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong(), OBJECT to button)
    Internals.callMethod(rawPtr, MethodBindings.setButtonPtr, NIL)
  }
  ...
  public final fun eraseButton(column: Int, buttonIndex: Int): Unit {
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong())
    Internals.callMethod(rawPtr, MethodBindings.eraseButtonPtr, NIL)
  }
  ...
  public final fun setButtonDisabled(
    ...
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong(), BOOL to disabled)
    Internals.callMethod(rawPtr, MethodBindings.setButtonDisabledPtr, NIL)
  }
  ...
  public final fun setButtonColor(
    ...
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong(), COLOR to color)
    Internals.callMethod(rawPtr, MethodBindings.setButtonColorPtr, NIL)
  }
  ...
  public final fun isButtonDisabled(column: Int, buttonIndex: Int): Boolean {
    Internals.writeArguments(LONG to column.toLong(), LONG to buttonIndex.toLong())
    Internals.callMethod(rawPtr, MethodBindings.isButtonDisabledPtr, BOOL)
    return (Internals.readReturnValue(BOOL) as Boolean)
  }
  ...
  public final fun setTooltipText(column: Int, tooltip: String): Unit {
    Internals.writeArguments(LONG to column.toLong(), STRING to tooltip)
  ...
  public final fun setTextAlignment(column: Int, textAlignment: HorizontalAlignment): Unit {
    Internals.writeArguments(LONG to column.toLong(), LONG to textAlignment.id)
  ...
  public final fun setExpandRight(column: Int, enable: Boolean): Unit {
    Internals.writeArguments(LONG to column.toLong(), BOOL to enable)
    Internals.callMethod(rawPtr, MethodBindings.setExpandRightPtr, NIL)
  }
  ...
  public final fun getExpandRight(column: Int): Boolean {
    Internals.writeArguments(LONG to column.toLong())
    Internals.callMethod(rawPtr, MethodBindings.getExpandRightPtr, BOOL)
    return (Internals.readReturnValue(BOOL) as Boolean)
  }

  public final fun setDisableFolding(disable: Boolean): Unit {
    Internals.writeArguments(BOOL to disable)
    Internals.callMethod(rawPtr, MethodBindings.setDisableFoldingPtr, NIL)
  }

  public final fun isFoldingDisabled(): Boolean {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.isFoldingDisabledPtr, BOOL)
    return (Internals.readReturnValue(BOOL) as Boolean)
  }
  ...
  public final fun createChild(index: Int = -1): TreeItem? {
    ...
    Internals.callMethod(rawPtr, MethodBindings.createChildPtr, OBJECT)
  ...
  public final fun addChild(child: TreeItem?): Unit {
    Internals.writeArguments(OBJECT to child)
  ...
  public final fun getTree(): Tree? {
    ...
    return (Internals.readReturnValue(OBJECT) as Tree?)
  }
  ...
  public final fun getNext(): TreeItem? {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getNextPtr, OBJECT)
    return (Internals.readReturnValue(OBJECT) as TreeItem?)
  }
  ...
  public final fun getPrev(): TreeItem? {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getPrevPtr, OBJECT)
    return (Internals.readReturnValue(OBJECT) as TreeItem?)
  }
  ...
  public final fun getFirstChild(): TreeItem? {
    Internals.writeArguments()
    Internals.callMethod(rawPtr, MethodBindings.getFirstChildPtr, OBJECT)
    return (Internals.readReturnValue(OBJECT) as TreeItem?)
  }
  ...
  public final fun getNextInTree(wrap: Boolean = false): TreeItem? {
    Internals.writeArguments(BOOL to wrap)
    Internals.callMethod(rawPtr, MethodBindings.getNextInTreePtr, OBJECT)
    return (Internals.readReturnValue(OBJECT) as TreeItem?)
  }
  ...
  public final fun getPrevInTree(wrap: Boolean = false): TreeItem? {
    Internals.writeArguments(BOOL to wrap)
    Internals.callMethod(rawPtr, MethodBindings.getPrevInTreePtr, OBJECT)
    return (Internals.readReturnValue(OBJECT) as TreeItem?)
  }
  ...
  public final fun getNextVisible(wrap: Boolean = false): TreeItem? {
    Internals.writeArguments(BOOL to wrap)
    Internals.callMethod(rawPtr, MethodBindings.getNextVisiblePtr, OBJECT)
    return (Internals.readReturnValue(OBJECT) as TreeItem?)
  }
  ...
  public final fun getPrevVisible(wrap: Boolean = false): TreeItem? {
    Internals.writeArguments(BOOL to wrap)
    Internals.callMethod(rawPtr, MethodBindings.getPrevVisiblePtr, OBJECT)
    return (Internals.readReturnValue(OBJECT) as TreeItem?)
  }
  ...
  public final fun getChildren(): VariantArray<TreeItem> {
    ...
    return (Internals.readReturnValue(ARRAY) as VariantArray<TreeItem>)
  }
  ...
  public final fun moveBefore(item: TreeItem?): Unit {
    Internals.writeArguments(OBJECT to item)
    Internals.callMethod(rawPtr, MethodBindings.moveBeforePtr, NIL)
  }
  ...
  public final fun moveAfter(item: TreeItem?): Unit {
    Internals.writeArguments(OBJECT to item)
    Internals.callMethod(rawPtr, MethodBindings.moveAfterPtr, NIL)
  }
  ...
  public final fun callRecursive(method: StringName, vararg __var_args: Any?): Unit {
    ...
    Internals.callMethod(rawPtr, MethodBindings.callRecursivePtr, NIL)
  }
