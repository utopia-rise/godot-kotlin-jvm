...
public open class VisualShaderNodeVectorFunc : VisualShaderNodeVectorBase() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    Internals.callConstructor(this, ENGINE_CLASS_VISUALSHADERNODEVECTORFUNC_INDEX, scriptIndex)
  }
  ...
  public final fun getFunction(): Function {
    ...
    return VisualShaderNodeVectorFunc.Function.from(Internals.readReturnValue(LONG) as Long)
  }
  ...
  public object MethodBindings {
    internal val setFunctionPtr: VoidPtr =
        Internals.getMethodBindPtr("VisualShaderNodeVectorFunc", "set_function", 629964457)

    internal val getFunctionPtr: VoidPtr =
        Internals.getMethodBindPtr("VisualShaderNodeVectorFunc", "get_function", 4047776843)
  }
}
