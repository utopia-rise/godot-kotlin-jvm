...
public open class VisualShaderNodeVectorOp : VisualShaderNodeVectorBase() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    Internals.callConstructor(this, ENGINE_CLASS_VISUALSHADERNODEVECTOROP_INDEX, scriptIndex)
  }
  ...
  public final fun getOperator(): Operator {
    ...
    return VisualShaderNodeVectorOp.Operator.from(Internals.readReturnValue(LONG) as Long)
  }
  ...
  public object MethodBindings {
    internal val setOperatorPtr: VoidPtr =
        Internals.getMethodBindPtr("VisualShaderNodeVectorOp", "set_operator", 3371507302)

    internal val getOperatorPtr: VoidPtr =
        Internals.getMethodBindPtr("VisualShaderNodeVectorOp", "get_operator", 11793929)
  }
}
