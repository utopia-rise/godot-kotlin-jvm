...
public open class PhysicsRayQueryParameters3D : RefCounted() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    Internals.callConstructor(this, ENGINE_CLASS_PHYSICSRAYQUERYPARAMETERS3D_INDEX, scriptIndex)
  }
  ...
  public companion object {
    ...
    public final fun create(
      ...
      Internals.writeArguments(VECTOR3 to from, VECTOR3 to to, LONG to collisionMask, ARRAY to exclude)
      Internals.callMethod(0, MethodBindings.createPtr, OBJECT)
      return (Internals.readReturnValue(OBJECT) as PhysicsRayQueryParameters3D?)
    }
  }

  public object MethodBindings {
    internal val createPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "create", 3110599579)

    internal val setFromPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "set_from", 3460891852)

    internal val getFromPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "get_from", 3360562783)

    internal val setToPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "set_to", 3460891852)

    internal val getToPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "get_to", 3360562783)

    internal val setCollisionMaskPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "set_collision_mask", 1286410249)

    internal val getCollisionMaskPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "get_collision_mask", 3905245786)

    internal val setExcludePtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "set_exclude", 381264803)

    internal val getExcludePtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "get_exclude", 3995934104)

    internal val setCollideWithBodiesPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "set_collide_with_bodies", 2586408642)

    internal val isCollideWithBodiesEnabledPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "is_collide_with_bodies_enabled", 36873697)

    internal val setCollideWithAreasPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "set_collide_with_areas", 2586408642)

    internal val isCollideWithAreasEnabledPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "is_collide_with_areas_enabled", 36873697)

    internal val setHitFromInsidePtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "set_hit_from_inside", 2586408642)

    internal val isHitFromInsideEnabledPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "is_hit_from_inside_enabled", 36873697)

    internal val setHitBackFacesPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "set_hit_back_faces", 2586408642)

    internal val isHitBackFacesEnabledPtr: VoidPtr =
        Internals.getMethodBindPtr("PhysicsRayQueryParameters3D", "is_hit_back_faces_enabled", 36873697)
  }
}
