...
public open class Semaphore : RefCounted() {
   ...
   */
  @JvmOverloads
  public final fun post(count: Int = 1) {
  ...
  public object MethodBindings {
    internal val waitPtr: VoidPtr = TypeManager.getMethodBindPtr("Semaphore", "wait", 3_218_959_716)

    internal val tryWaitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Semaphore", "try_wait", 2_240_911_060)

    internal val postPtr: VoidPtr = TypeManager.getMethodBindPtr("Semaphore", "post", 1_667_783_136)
  }
}
