...
import godot.ensureCurrentIsVisiblePtr
import godot.forceUpdateListSizePtr
import godot.getAllowReselectPtr
import godot.getAllowRmbSelectPtr
import godot.getAllowSearchPtr
import godot.getFixedColumnWidthPtr
import godot.getFixedIconSizePtr
import godot.getIconModePtr
import godot.getIconScalePtr
import godot.getItemAtPositionPtr
import godot.getItemCountPtr
import godot.getItemCustomBgColorPtr
import godot.getItemCustomFgColorPtr
import godot.getItemIconModulatePtr
import godot.getItemIconPtr
import godot.getItemIconRegionPtr
import godot.getItemLanguagePtr
import godot.getItemMetadataPtr
import godot.getItemRectPtr
import godot.getItemTextDirectionPtr
import godot.getItemTextPtr
import godot.getItemTooltipPtr
import godot.getMaxColumnsPtr
import godot.getMaxTextLinesPtr
import godot.getSelectModePtr
import godot.getSelectedItemsPtr
import godot.getTextOverrunBehaviorPtr
import godot.getVScrollBarPtr
import godot.hasAutoHeightPtr
import godot.isAnythingSelectedPtr
import godot.isItemDisabledPtr
import godot.isItemIconTransposedPtr
import godot.isItemSelectablePtr
import godot.isItemTooltipEnabledPtr
import godot.isSameColumnWidthPtr
import godot.isSelectedPtr
import godot.moveItemPtr
...
import godot.setAutoHeightPtr
import godot.setFixedColumnWidthPtr
import godot.setFixedIconSizePtr
import godot.setIconModePtr
import godot.setIconScalePtr
import godot.setItemCountPtr
import godot.setItemCustomBgColorPtr
import godot.setItemCustomFgColorPtr
import godot.setItemDisabledPtr
import godot.setItemIconModulatePtr
import godot.setItemIconPtr
import godot.setItemIconRegionPtr
import godot.setItemIconTransposedPtr
import godot.setItemLanguagePtr
import godot.setItemMetadataPtr
import godot.setItemSelectablePtr
import godot.setItemTextDirectionPtr
import godot.setItemTextPtr
import godot.setItemTooltipEnabledPtr
import godot.setItemTooltipPtr
import godot.setMaxColumnsPtr
import godot.setMaxTextLinesPtr
import godot.setSameColumnWidthPtr
import godot.setSelectModePtr
import godot.setTextOverrunBehaviorPtr
import godot.sortItemsByTextPtr
import kotlin.Any
