...
import godot.getCellularDistanceFunctionPtr
import godot.getCellularJitterPtr
import godot.getCellularReturnTypePtr
import godot.getDomainWarpAmplitudePtr
import godot.getDomainWarpFractalGainPtr
import godot.getDomainWarpFractalLacunarityPtr
import godot.getDomainWarpFractalOctavesPtr
import godot.getDomainWarpFractalTypePtr
import godot.getDomainWarpFrequencyPtr
import godot.getDomainWarpTypePtr
import godot.getFractalGainPtr
import godot.getFractalLacunarityPtr
import godot.getFractalOctavesPtr
import godot.getFractalPingPongStrengthPtr
import godot.getFractalTypePtr
import godot.getFractalWeightedStrengthPtr
import godot.getFrequencyPtr
import godot.getNoiseTypePtr
import godot.getOffsetPtr
import godot.getSeedPtr
import godot.isDomainWarpEnabledPtr
import godot.setCellularDistanceFunctionPtr
import godot.setCellularJitterPtr
import godot.setCellularReturnTypePtr
import godot.setDomainWarpAmplitudePtr
import godot.setDomainWarpEnabledPtr
import godot.setDomainWarpFractalGainPtr
import godot.setDomainWarpFractalLacunarityPtr
import godot.setDomainWarpFractalOctavesPtr
import godot.setDomainWarpFractalTypePtr
import godot.setDomainWarpFrequencyPtr
import godot.setDomainWarpTypePtr
import godot.setFractalGainPtr
import godot.setFractalLacunarityPtr
import godot.setFractalOctavesPtr
import godot.setFractalPingPongStrengthPtr
import godot.setFractalTypePtr
import godot.setFractalWeightedStrengthPtr
import godot.setFrequencyPtr
import godot.setNoiseTypePtr
...
private const val ENGINECLASS_FASTNOISELITE: Int = 238
...
public open class FastNoiseLite : Noise() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_FASTNOISELITE, scriptIndex)
  }
