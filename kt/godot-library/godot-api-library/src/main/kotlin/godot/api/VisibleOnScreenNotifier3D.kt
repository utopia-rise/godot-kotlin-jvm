...
public open class VisibleOnScreenNotifier3D : VisualInstance3D() {
   ...
   */
  @CoreTypeLocalCopy
  public final inline var aabb: CoreAABB
   ...
   */
  @CoreTypeHelper
  public final fun aabbMutate(block: CoreAABB.() -> Unit): CoreAABB = aabb.apply {
     block(this)
     aabb = this
  }

  public final fun setAabb(rect: CoreAABB) {
    TransferContext.writeArguments(VariantParserAABB to rect)
  ...
  public object MethodBindings {
    internal val setAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisibleOnScreenNotifier3D", "set_aabb", 259_215_842)

    internal val isOnScreenPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisibleOnScreenNotifier3D", "is_on_screen", 36_873_697)
  }
}
