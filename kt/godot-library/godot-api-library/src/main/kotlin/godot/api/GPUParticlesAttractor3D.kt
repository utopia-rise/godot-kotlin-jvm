...
public open class GPUParticlesAttractor3D internal constructor() : VisualInstance3D() {
  ...
  public final fun setAttenuation(attenuation: Float) {
  ...
  public final fun setDirectionality(amount: Float) {
  ...
  public object MethodBindings {
    internal val setCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticlesAttractor3D", "set_cull_mask", 1_286_410_249)

    internal val getCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticlesAttractor3D", "get_cull_mask", 3_905_245_786)

    internal val setStrengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticlesAttractor3D", "set_strength", 373_806_689)

    internal val getStrengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticlesAttractor3D", "get_strength", 1_740_695_150)

    internal val setAttenuationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticlesAttractor3D", "set_attenuation", 373_806_689)

    internal val getAttenuationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticlesAttractor3D", "get_attenuation", 1_740_695_150)

    internal val setDirectionalityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticlesAttractor3D", "set_directionality", 373_806_689)

    internal val getDirectionalityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticlesAttractor3D", "get_directionality", 1_740_695_150)
  }
}
