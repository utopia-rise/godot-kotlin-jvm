...
public open class GLTFCamera : Resource() {
  ...
  public final fun setPerspective(perspective: Boolean) {
  ...
  public final fun setSizeMag(sizeMag: Float) {
  ...
  public final fun setDepthFar(zdepthFar: Float) {
  ...
  public final fun setDepthNear(zdepthNear: Float) {
  ...
  public object MethodBindings {
    internal val fromNodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "from_node", 237_784)

    internal val toNodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "to_node", 2_285_090_890)

    internal val fromDictionaryPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "from_dictionary", 2_495_512_509)

    internal val toDictionaryPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "to_dictionary", 3_102_165_223)

    internal val getPerspectivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "get_perspective", 36_873_697)

    internal val setPerspectivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "set_perspective", 2_586_408_642)

    internal val getFovPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "get_fov", 1_740_695_150)

    internal val setFovPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "set_fov", 373_806_689)

    internal val getSizeMagPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "get_size_mag", 1_740_695_150)

    internal val setSizeMagPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "set_size_mag", 373_806_689)

    internal val getDepthFarPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "get_depth_far", 1_740_695_150)

    internal val setDepthFarPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "set_depth_far", 373_806_689)

    internal val getDepthNearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "get_depth_near", 1_740_695_150)

    internal val setDepthNearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GLTFCamera", "set_depth_near", 373_806_689)
  }
}
