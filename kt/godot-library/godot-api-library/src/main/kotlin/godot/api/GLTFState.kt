...
import godot.addUsedExtensionPtr
import godot.appendDataToBuffersPtr
...
import godot.getAccessorsPtr
import godot.getAdditionalDataPtr
import godot.getAnimationPlayerPtr
import godot.getAnimationPlayersCountPtr
import godot.getAnimationsPtr
import godot.getBakeFpsPtr
import godot.getBasePathPtr
import godot.getBufferViewsPtr
import godot.getBuffersPtr
import godot.getCamerasPtr
import godot.getCopyrightPtr
import godot.getCreateAnimationsPtr
import godot.getFilenamePtr
import godot.getGlbDataPtr
import godot.getHandleBinaryImagePtr
import godot.getImagesPtr
import godot.getImportAsSkeletonBonesPtr
import godot.getJsonPtr
import godot.getLightsPtr
import godot.getMajorVersionPtr
import godot.getMaterialsPtr
import godot.getMeshesPtr
import godot.getMinorVersionPtr
import godot.getNodeIndexPtr
import godot.getNodesPtr
import godot.getRootNodesPtr
import godot.getSceneNamePtr
import godot.getSceneNodePtr
import godot.getSkeletonsPtr
import godot.getSkinsPtr
import godot.getTextureSamplersPtr
import godot.getTexturesPtr
import godot.getUniqueAnimationNamesPtr
import godot.getUniqueNamesPtr
import godot.getUseNamedSkinBindsPtr
import godot.setAccessorsPtr
import godot.setAdditionalDataPtr
import godot.setAnimationsPtr
import godot.setBakeFpsPtr
import godot.setBasePathPtr
import godot.setBufferViewsPtr
import godot.setBuffersPtr
import godot.setCamerasPtr
import godot.setCopyrightPtr
import godot.setCreateAnimationsPtr
import godot.setFilenamePtr
import godot.setGlbDataPtr
import godot.setHandleBinaryImagePtr
import godot.setImagesPtr
import godot.setImportAsSkeletonBonesPtr
import godot.setJsonPtr
import godot.setLightsPtr
import godot.setMajorVersionPtr
import godot.setMaterialsPtr
import godot.setMeshesPtr
import godot.setMinorVersionPtr
import godot.setNodesPtr
import godot.setRootNodesPtr
import godot.setSceneNamePtr
import godot.setSkeletonsPtr
import godot.setSkinsPtr
import godot.setTextureSamplersPtr
import godot.setTexturesPtr
import godot.setUniqueAnimationNamesPtr
import godot.setUniqueNamesPtr
import godot.setUseNamedSkinBindsPtr
import kotlin.Any
