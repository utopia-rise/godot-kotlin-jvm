...
public open class GPUParticles3D : GeometryInstance3D() {
  ...
  /**
   * The base diameter for particle collision in meters. If particles appear to sink into the ground when colliding, increase this value. If particles appear to float when colliding, decrease this value. Only effective if [ParticleProcessMaterial.collisionMode] is [ParticleProcessMaterial.COLLISION_RIGID] or [ParticleProcessMaterial.COLLISION_HIDE_ON_CONTACT].
   *
  ...
  public final fun setInterpolate(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
    TransferContext.callMethod(ptr, MethodBindings.setInterpolatePtr, NIL)
  }

  public final fun setProcessMaterial(material: Material?) {
  ...
  public final fun setCollisionBaseSize(size: Float) {
    TransferContext.writeArguments(DOUBLE to size.toDouble())
    TransferContext.callMethod(ptr, MethodBindings.setCollisionBaseSizePtr, NIL)
  }

  public final fun setInterpToEnd(interp: Float) {
  ...
  public final fun setDrawPasses(passes: Int) {
   ...
   */
  public final fun setDrawPassMesh(pass: Int, mesh: Mesh?) {
  ...
  public final fun setSubEmitter(path: NodePath) {
  ...
  public final fun setTrailEnabled(enabled: Boolean) {
    TransferContext.writeArguments(BOOL to enabled)
    TransferContext.callMethod(ptr, MethodBindings.setTrailEnabledPtr, NIL)
  }

  public final fun setTrailLifetime(secs: Double) {
    TransferContext.writeArguments(DOUBLE to secs)
  ...
  public final fun setTransformAlign(align: TransformAlign) {
  ...
  public final fun setAmountRatio(ratio: Float) {
    TransferContext.writeArguments(DOUBLE to ratio.toDouble())
  ...
  public object MethodBindings {
    internal val setEmittingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_emitting", 2_586_408_642)

    internal val setAmountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_amount", 1_286_410_249)

    internal val setLifetimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_lifetime", 373_806_689)

    internal val setOneShotPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_one_shot", 2_586_408_642)

    internal val setPreProcessTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_pre_process_time", 373_806_689)

    internal val setExplosivenessRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_explosiveness_ratio", 373_806_689)

    internal val setRandomnessRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_randomness_ratio", 373_806_689)

    internal val setVisibilityAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_visibility_aabb", 259_215_842)

    internal val setUseLocalCoordinatesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_use_local_coordinates", 2_586_408_642)

    internal val setFixedFpsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_fixed_fps", 1_286_410_249)

    internal val setFractionalDeltaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_fractional_delta", 2_586_408_642)

    internal val setInterpolatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_interpolate", 2_586_408_642)

    internal val setProcessMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_process_material", 2_757_459_619)

    internal val setSpeedScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_speed_scale", 373_806_689)

    internal val setCollisionBaseSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_collision_base_size", 373_806_689)

    internal val setInterpToEndPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_interp_to_end", 373_806_689)

    internal val isEmittingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "is_emitting", 36_873_697)

    internal val getAmountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_amount", 3_905_245_786)

    internal val getLifetimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_lifetime", 1_740_695_150)

    internal val getOneShotPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_one_shot", 36_873_697)

    internal val getPreProcessTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_pre_process_time", 1_740_695_150)

    internal val getExplosivenessRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_explosiveness_ratio", 1_740_695_150)

    internal val getRandomnessRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_randomness_ratio", 1_740_695_150)

    internal val getVisibilityAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_visibility_aabb", 1_068_685_055)

    internal val getUseLocalCoordinatesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_use_local_coordinates", 36_873_697)

    internal val getFixedFpsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_fixed_fps", 3_905_245_786)

    internal val getFractionalDeltaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_fractional_delta", 36_873_697)

    internal val getInterpolatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_interpolate", 36_873_697)

    internal val getProcessMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_process_material", 5_934_680)

    internal val getSpeedScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_speed_scale", 1_740_695_150)

    internal val getCollisionBaseSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_collision_base_size", 1_740_695_150)

    internal val getInterpToEndPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_interp_to_end", 1_740_695_150)

    internal val setUseFixedSeedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_use_fixed_seed", 2_586_408_642)

    internal val getUseFixedSeedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_use_fixed_seed", 36_873_697)

    internal val setSeedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_seed", 1_286_410_249)

    internal val getSeedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_seed", 3_905_245_786)

    internal val setDrawOrderPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_draw_order", 1_208_074_815)

    internal val getDrawOrderPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_draw_order", 3_770_381_780)

    internal val setDrawPassesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_draw_passes", 1_286_410_249)

    internal val setDrawPassMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_draw_pass_mesh", 969_122_797)

    internal val getDrawPassesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_draw_passes", 3_905_245_786)

    internal val getDrawPassMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_draw_pass_mesh", 1_576_363_275)

    internal val setSkinPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_skin", 3_971_435_618)

    internal val getSkinPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_skin", 2_074_563_878)

    internal val restartPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "restart", 107_499_316)

    internal val captureAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "capture_aabb", 1_068_685_055)

    internal val setSubEmitterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_sub_emitter", 1_348_162_250)

    internal val getSubEmitterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_sub_emitter", 4_075_236_667)

    internal val emitParticlePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "emit_particle", 992_173_727)

    internal val setTrailEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_trail_enabled", 2_586_408_642)

    internal val setTrailLifetimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_trail_lifetime", 373_806_689)

    internal val isTrailEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "is_trail_enabled", 36_873_697)

    internal val getTrailLifetimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_trail_lifetime", 1_740_695_150)

    internal val setTransformAlignPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_transform_align", 3_892_425_954)

    internal val getTransformAlignPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_transform_align", 2_100_992_166)

    internal val convertFromParticlesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "convert_from_particles", 1_078_189_570)

    internal val setAmountRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "set_amount_ratio", 373_806_689)

    internal val getAmountRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "get_amount_ratio", 1_740_695_150)

    internal val requestParticlesProcessPtr: VoidPtr =
        TypeManager.getMethodBindPtr("GPUParticles3D", "request_particles_process", 373_806_689)
  }
}
