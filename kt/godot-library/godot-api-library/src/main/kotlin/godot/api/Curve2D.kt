...
public open class Curve2D : Resource() {
   ...
   */
  public final fun setPointPosition(idx: Int, position: Vector2) {
   ...
   */
  public final fun setPointIn(idx: Int, position: Vector2) {
    TransferContext.writeArguments(LONG to idx.toLong(), VECTOR2 to position)
   ...
   */
  public final fun setPointOut(idx: Int, position: Vector2) {
    TransferContext.writeArguments(LONG to idx.toLong(), VECTOR2 to position)
  ...
  /**
   * Similar to [sampleBaked], but returns [Transform2D] that includes a rotation along the curve, with [Transform2D.origin] as the point position and the [Transform2D.x] vector pointing in the direction of the path at that point. Returns an empty transform if the length of the curve is `0`.
   *
   * ```
   ...
   */
  @JvmOverloads
  public final fun sampleBakedWithRotation(offset: Float = 0.0f, cubic: Boolean = false): Transform2D {
    TransferContext.writeArguments(DOUBLE to offset.toDouble(), BOOL to cubic)
   ...
   */
  @JvmOverloads
  public final fun tessellate(maxStages: Int = 5, toleranceDegrees: Float = 4.0f): PackedVector2Array {
   ...
   */
  @JvmOverloads
  public final fun tessellateEvenLength(maxStages: Int = 5, toleranceLength: Float = 20.0f): PackedVector2Array {
  ...
  public object MethodBindings {
    internal val getPointCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_point_count", 3_905_245_786)

    internal val setPointCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "set_point_count", 1_286_410_249)

    internal val addPointPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "add_point", 4_175_465_202)

    internal val setPointPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "set_point_position", 163_021_252)

    internal val getPointPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_point_position", 2_299_179_447)

    internal val setPointInPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "set_point_in", 163_021_252)

    internal val getPointInPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_point_in", 2_299_179_447)

    internal val setPointOutPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "set_point_out", 163_021_252)

    internal val getPointOutPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_point_out", 2_299_179_447)

    internal val removePointPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "remove_point", 1_286_410_249)

    internal val clearPointsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "clear_points", 3_218_959_716)

    internal val samplePtr: VoidPtr = TypeManager.getMethodBindPtr("Curve2D", "sample", 26_514_310)

    internal val samplefPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "samplef", 3_588_506_812)

    internal val setBakeIntervalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "set_bake_interval", 373_806_689)

    internal val getBakeIntervalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_bake_interval", 1_740_695_150)

    internal val getBakedLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_baked_length", 1_740_695_150)

    internal val sampleBakedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "sample_baked", 3_464_257_706)

    internal val sampleBakedWithRotationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "sample_baked_with_rotation", 3_296_056_341)

    internal val getBakedPointsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_baked_points", 2_961_356_807)

    internal val getClosestPointPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_closest_point", 2_656_412_154)

    internal val getClosestOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "get_closest_offset", 2_276_447_920)

    internal val tessellatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "tessellate", 958_145_977)

    internal val tessellateEvenLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Curve2D", "tessellate_even_length", 2_319_761_637)
  }
}
