...
import godot.agentCreatePtr
import godot.agentGetAvoidanceEnabledPtr
import godot.agentGetAvoidanceLayersPtr
import godot.agentGetAvoidanceMaskPtr
import godot.agentGetAvoidancePriorityPtr
import godot.agentGetHeightPtr
import godot.agentGetMapPtr
import godot.agentGetMaxNeighborsPtr
import godot.agentGetMaxSpeedPtr
import godot.agentGetNeighborDistancePtr
import godot.agentGetPausedPtr
import godot.agentGetPositionPtr
import godot.agentGetRadiusPtr
import godot.agentGetTimeHorizonAgentsPtr
import godot.agentGetTimeHorizonObstaclesPtr
import godot.agentGetUse3dAvoidancePtr
import godot.agentGetVelocityPtr
import godot.agentHasAvoidanceCallbackPtr
import godot.agentIsMapChangedPtr
import godot.agentSetAvoidanceCallbackPtr
import godot.agentSetAvoidanceEnabledPtr
import godot.agentSetAvoidanceLayersPtr
import godot.agentSetAvoidanceMaskPtr
import godot.agentSetAvoidancePriorityPtr
import godot.agentSetHeightPtr
import godot.agentSetMapPtr
import godot.agentSetMaxNeighborsPtr
import godot.agentSetMaxSpeedPtr
import godot.agentSetNeighborDistancePtr
import godot.agentSetPausedPtr
import godot.agentSetPositionPtr
import godot.agentSetRadiusPtr
import godot.agentSetTimeHorizonAgentsPtr
import godot.agentSetTimeHorizonObstaclesPtr
import godot.agentSetUse3dAvoidancePtr
import godot.agentSetVelocityForcedPtr
import godot.agentSetVelocityPtr
import godot.bakeFromSourceGeometryDataAsyncPtr
...
import godot.getDebugEnabledPtr
import godot.getMapsPtr
import godot.getProcessInfoPtr
import godot.isBakingNavigationMeshPtr
import godot.linkCreatePtr
import godot.linkGetEnabledPtr
import godot.linkGetEndPositionPtr
import godot.linkGetEnterCostPtr
import godot.linkGetMapPtr
import godot.linkGetNavigationLayersPtr
import godot.linkGetOwnerIdPtr
import godot.linkGetStartPositionPtr
import godot.linkGetTravelCostPtr
import godot.linkIsBidirectionalPtr
import godot.linkSetBidirectionalPtr
import godot.linkSetEnabledPtr
import godot.linkSetEndPositionPtr
import godot.linkSetEnterCostPtr
import godot.linkSetMapPtr
import godot.linkSetNavigationLayersPtr
import godot.linkSetOwnerIdPtr
import godot.linkSetStartPositionPtr
import godot.linkSetTravelCostPtr
import godot.mapCreatePtr
import godot.mapForceUpdatePtr
import godot.mapGetAgentsPtr
import godot.mapGetCellHeightPtr
import godot.mapGetCellSizePtr
import godot.mapGetClosestPointNormalPtr
import godot.mapGetClosestPointOwnerPtr
import godot.mapGetClosestPointPtr
import godot.mapGetClosestPointToSegmentPtr
import godot.mapGetEdgeConnectionMarginPtr
import godot.mapGetIterationIdPtr
import godot.mapGetLinkConnectionRadiusPtr
import godot.mapGetLinksPtr
import godot.mapGetMergeRasterizerCellScalePtr
import godot.mapGetObstaclesPtr
import godot.mapGetPathPtr
import godot.mapGetRandomPointPtr
import godot.mapGetRegionsPtr
import godot.mapGetUpPtr
import godot.mapGetUseEdgeConnectionsPtr
import godot.mapIsActivePtr
import godot.mapSetActivePtr
import godot.mapSetCellHeightPtr
import godot.mapSetCellSizePtr
import godot.mapSetEdgeConnectionMarginPtr
import godot.mapSetLinkConnectionRadiusPtr
import godot.mapSetMergeRasterizerCellScalePtr
import godot.mapSetUpPtr
import godot.mapSetUseEdgeConnectionsPtr
import godot.obstacleCreatePtr
import godot.obstacleGetAvoidanceEnabledPtr
import godot.obstacleGetAvoidanceLayersPtr
import godot.obstacleGetHeightPtr
import godot.obstacleGetMapPtr
import godot.obstacleGetPausedPtr
import godot.obstacleGetPositionPtr
import godot.obstacleGetRadiusPtr
import godot.obstacleGetUse3dAvoidancePtr
import godot.obstacleGetVelocityPtr
import godot.obstacleGetVerticesPtr
import godot.obstacleSetAvoidanceEnabledPtr
import godot.obstacleSetAvoidanceLayersPtr
import godot.obstacleSetHeightPtr
import godot.obstacleSetMapPtr
import godot.obstacleSetPausedPtr
import godot.obstacleSetPositionPtr
import godot.obstacleSetRadiusPtr
import godot.obstacleSetUse3dAvoidancePtr
import godot.obstacleSetVelocityPtr
import godot.obstacleSetVerticesPtr
import godot.parseSourceGeometryDataPtr
import godot.queryPathPtr
import godot.regionBakeNavigationMeshPtr
import godot.regionCreatePtr
import godot.regionGetConnectionPathwayEndPtr
import godot.regionGetConnectionPathwayStartPtr
import godot.regionGetConnectionsCountPtr
import godot.regionGetEnabledPtr
import godot.regionGetEnterCostPtr
import godot.regionGetMapPtr
import godot.regionGetNavigationLayersPtr
import godot.regionGetOwnerIdPtr
import godot.regionGetRandomPointPtr
import godot.regionGetTransformPtr
import godot.regionGetTravelCostPtr
import godot.regionGetUseEdgeConnectionsPtr
import godot.regionOwnsPointPtr
import godot.regionSetEnabledPtr
import godot.regionSetEnterCostPtr
import godot.regionSetMapPtr
import godot.regionSetNavigationLayersPtr
import godot.regionSetNavigationMeshPtr
import godot.regionSetOwnerIdPtr
import godot.regionSetTransformPtr
import godot.regionSetTravelCostPtr
import godot.regionSetUseEdgeConnectionsPtr
import godot.setActivePtr
import godot.setDebugEnabledPtr
import godot.simplifyPathPtr
import godot.sourceGeometryParserCreatePtr
import godot.sourceGeometryParserSetCallbackPtr
...
public object NavigationServer3D : Object() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    getSingleton(this, ENGINECLASS_NAVIGATIONSERVER3D)
  }
