...
import godot.getAdjustmentBrightnessPtr
import godot.getAdjustmentColorCorrectionPtr
import godot.getAdjustmentContrastPtr
import godot.getAdjustmentSaturationPtr
import godot.getAmbientLightColorPtr
import godot.getAmbientLightEnergyPtr
import godot.getAmbientLightSkyContributionPtr
import godot.getAmbientSourcePtr
import godot.getBackgroundPtr
import godot.getBgColorPtr
import godot.getBgEnergyMultiplierPtr
import godot.getBgIntensityPtr
import godot.getCameraFeedIdPtr
import godot.getCanvasMaxLayerPtr
import godot.getFogAerialPerspectivePtr
import godot.getFogDensityPtr
import godot.getFogDepthBeginPtr
import godot.getFogDepthCurvePtr
import godot.getFogDepthEndPtr
import godot.getFogHeightDensityPtr
import godot.getFogHeightPtr
import godot.getFogLightColorPtr
import godot.getFogLightEnergyPtr
import godot.getFogModePtr
import godot.getFogSkyAffectPtr
import godot.getFogSunScatterPtr
import godot.getGlowBlendModePtr
import godot.getGlowBloomPtr
import godot.getGlowHdrBleedScalePtr
import godot.getGlowHdrBleedThresholdPtr
import godot.getGlowHdrLuminanceCapPtr
import godot.getGlowIntensityPtr
import godot.getGlowLevelPtr
import godot.getGlowMapPtr
import godot.getGlowMapStrengthPtr
import godot.getGlowMixPtr
import godot.getGlowStrengthPtr
import godot.getReflectionSourcePtr
import godot.getSdfgiBounceFeedbackPtr
import godot.getSdfgiCascade0DistancePtr
import godot.getSdfgiCascadesPtr
import godot.getSdfgiEnergyPtr
import godot.getSdfgiMaxDistancePtr
import godot.getSdfgiMinCellSizePtr
import godot.getSdfgiNormalBiasPtr
import godot.getSdfgiProbeBiasPtr
import godot.getSdfgiYScalePtr
import godot.getSkyCustomFovPtr
import godot.getSkyPtr
import godot.getSkyRotationPtr
import godot.getSsaoAoChannelAffectPtr
import godot.getSsaoDetailPtr
import godot.getSsaoDirectLightAffectPtr
import godot.getSsaoHorizonPtr
import godot.getSsaoIntensityPtr
import godot.getSsaoPowerPtr
import godot.getSsaoRadiusPtr
import godot.getSsaoSharpnessPtr
import godot.getSsilIntensityPtr
import godot.getSsilNormalRejectionPtr
import godot.getSsilRadiusPtr
import godot.getSsilSharpnessPtr
import godot.getSsrDepthTolerancePtr
import godot.getSsrFadeInPtr
import godot.getSsrFadeOutPtr
import godot.getSsrMaxStepsPtr
import godot.getTonemapExposurePtr
import godot.getTonemapWhitePtr
import godot.getTonemapperPtr
import godot.getVolumetricFogAlbedoPtr
import godot.getVolumetricFogAmbientInjectPtr
import godot.getVolumetricFogAnisotropyPtr
import godot.getVolumetricFogDensityPtr
import godot.getVolumetricFogDetailSpreadPtr
import godot.getVolumetricFogEmissionEnergyPtr
import godot.getVolumetricFogEmissionPtr
import godot.getVolumetricFogGiInjectPtr
import godot.getVolumetricFogLengthPtr
import godot.getVolumetricFogSkyAffectPtr
import godot.getVolumetricFogTemporalReprojectionAmountPtr
import godot.isAdjustmentEnabledPtr
import godot.isFogEnabledPtr
import godot.isGlowEnabledPtr
import godot.isGlowNormalizedPtr
import godot.isSdfgiEnabledPtr
import godot.isSdfgiReadingSkyLightPtr
import godot.isSdfgiUsingOcclusionPtr
import godot.isSsaoEnabledPtr
import godot.isSsilEnabledPtr
import godot.isSsrEnabledPtr
import godot.isVolumetricFogEnabledPtr
import godot.isVolumetricFogTemporalReprojectionEnabledPtr
import godot.setAdjustmentBrightnessPtr
import godot.setAdjustmentColorCorrectionPtr
import godot.setAdjustmentContrastPtr
import godot.setAdjustmentEnabledPtr
import godot.setAdjustmentSaturationPtr
import godot.setAmbientLightColorPtr
import godot.setAmbientLightEnergyPtr
import godot.setAmbientLightSkyContributionPtr
import godot.setAmbientSourcePtr
import godot.setBackgroundPtr
import godot.setBgColorPtr
import godot.setBgEnergyMultiplierPtr
import godot.setBgIntensityPtr
import godot.setCameraFeedIdPtr
import godot.setCanvasMaxLayerPtr
import godot.setFogAerialPerspectivePtr
import godot.setFogDensityPtr
import godot.setFogDepthBeginPtr
import godot.setFogDepthCurvePtr
import godot.setFogDepthEndPtr
import godot.setFogEnabledPtr
import godot.setFogHeightDensityPtr
import godot.setFogHeightPtr
import godot.setFogLightColorPtr
import godot.setFogLightEnergyPtr
import godot.setFogModePtr
import godot.setFogSkyAffectPtr
import godot.setFogSunScatterPtr
import godot.setGlowBlendModePtr
import godot.setGlowBloomPtr
import godot.setGlowEnabledPtr
import godot.setGlowHdrBleedScalePtr
import godot.setGlowHdrBleedThresholdPtr
import godot.setGlowHdrLuminanceCapPtr
import godot.setGlowIntensityPtr
import godot.setGlowLevelPtr
import godot.setGlowMapPtr
import godot.setGlowMapStrengthPtr
import godot.setGlowMixPtr
import godot.setGlowNormalizedPtr
import godot.setGlowStrengthPtr
import godot.setReflectionSourcePtr
import godot.setSdfgiBounceFeedbackPtr
import godot.setSdfgiCascade0DistancePtr
import godot.setSdfgiCascadesPtr
import godot.setSdfgiEnabledPtr
import godot.setSdfgiEnergyPtr
import godot.setSdfgiMaxDistancePtr
import godot.setSdfgiMinCellSizePtr
import godot.setSdfgiNormalBiasPtr
import godot.setSdfgiProbeBiasPtr
import godot.setSdfgiReadSkyLightPtr
import godot.setSdfgiUseOcclusionPtr
import godot.setSdfgiYScalePtr
import godot.setSkyCustomFovPtr
import godot.setSkyPtr
import godot.setSkyRotationPtr
import godot.setSsaoAoChannelAffectPtr
import godot.setSsaoDetailPtr
import godot.setSsaoDirectLightAffectPtr
import godot.setSsaoEnabledPtr
import godot.setSsaoHorizonPtr
import godot.setSsaoIntensityPtr
import godot.setSsaoPowerPtr
import godot.setSsaoRadiusPtr
import godot.setSsaoSharpnessPtr
import godot.setSsilEnabledPtr
import godot.setSsilIntensityPtr
import godot.setSsilNormalRejectionPtr
import godot.setSsilRadiusPtr
import godot.setSsilSharpnessPtr
import godot.setSsrDepthTolerancePtr
import godot.setSsrEnabledPtr
import godot.setSsrFadeInPtr
import godot.setSsrFadeOutPtr
import godot.setSsrMaxStepsPtr
import godot.setTonemapExposurePtr
import godot.setTonemapWhitePtr
import godot.setTonemapperPtr
import godot.setVolumetricFogAlbedoPtr
import godot.setVolumetricFogAmbientInjectPtr
import godot.setVolumetricFogAnisotropyPtr
import godot.setVolumetricFogDensityPtr
import godot.setVolumetricFogDetailSpreadPtr
import godot.setVolumetricFogEmissionEnergyPtr
import godot.setVolumetricFogEmissionPtr
import godot.setVolumetricFogEnabledPtr
import godot.setVolumetricFogGiInjectPtr
import godot.setVolumetricFogLengthPtr
import godot.setVolumetricFogSkyAffectPtr
import godot.setVolumetricFogTemporalReprojectionAmountPtr
import godot.setVolumetricFogTemporalReprojectionEnabledPtr
...
private const val ENGINECLASS_ENVIRONMENT: Int = 234
...
public open class Environment : Resource() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_ENVIRONMENT, scriptIndex)
  }
