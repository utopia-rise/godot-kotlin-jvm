...
public open class AudioStreamPlaybackPolyphonic internal constructor() : AudioStreamPlayback() {
   ...
   */
  public final fun setStreamVolume(stream: Long, volumeDb: Float) {
   ...
   */
  public final fun setStreamPitchScale(stream: Long, pitchScale: Float) {
   ...
   */
  public final fun stopStream(stream: Long) {
    TransferContext.writeArguments(LONG to stream)
  ...
  public final fun playStream(
    ...
    playbackType: AudioServer.PlaybackType = AudioServer.PlaybackType.DEFAULT,
    bus: String,
  ): Long = playStream(stream, fromOffset, volumeDb, pitchScale, playbackType, bus.asCachedStringName())
  ...
  public object MethodBindings {
    internal val playStreamPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioStreamPlaybackPolyphonic", "play_stream", 1_846_744_803)

    internal val setStreamVolumePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioStreamPlaybackPolyphonic", "set_stream_volume", 1_602_489_585)

    internal val setStreamPitchScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioStreamPlaybackPolyphonic", "set_stream_pitch_scale", 1_602_489_585)

    internal val isStreamPlayingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioStreamPlaybackPolyphonic", "is_stream_playing", 1_116_898_809)

    internal val stopStreamPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioStreamPlaybackPolyphonic", "stop_stream", 1_286_410_249)
  }
}
