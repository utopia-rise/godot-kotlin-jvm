...
public open class Shape2D internal constructor() : Resource() {
   ...
   */
  public final fun draw(canvasItem: RID, color: Color) {
  ...
  public object MethodBindings {
    internal val setCustomSolverBiasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Shape2D", "set_custom_solver_bias", 373_806_689)

    internal val getCustomSolverBiasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Shape2D", "get_custom_solver_bias", 1_740_695_150)

    internal val collidePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Shape2D", "collide", 3_709_843_132)

    internal val collideWithMotionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Shape2D", "collide_with_motion", 2_869_556_801)

    internal val collideAndGetContactsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Shape2D", "collide_and_get_contacts", 3_056_932_662)

    internal val collideWithMotionAndGetContactsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Shape2D", "collide_with_motion_and_get_contacts", 3_620_351_573)

    internal val drawPtr: VoidPtr = TypeManager.getMethodBindPtr("Shape2D", "draw", 2_948_539_648)

    internal val getRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Shape2D", "get_rect", 1_639_390_495)
  }
}
