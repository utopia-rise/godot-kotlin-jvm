...
public object NavigationMeshGenerator : Object() {
   ...
   */
  @JvmStatic
  public final fun bake(navigationMesh: NavigationMesh?, rootNode: Node?) {
   ...
   */
  @JvmStatic
  public final fun clear(navigationMesh: NavigationMesh?) {
  ...
  public object MethodBindings {
    internal val bakePtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationMeshGenerator", "bake", 1_401_173_477)

    internal val clearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationMeshGenerator", "clear", 2_923_361_153)

    internal val parseSourceGeometryDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationMeshGenerator", "parse_source_geometry_data", 3_172_802_542)

    internal val bakeFromSourceGeometryDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationMeshGenerator", "bake_from_source_geometry_data", 1_286_748_856)
  }
}
