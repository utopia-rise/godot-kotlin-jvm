...
public open class Theme : Resource() {
   ...
   */
  public final fun clearIcon(name: StringName, themeType: StringName) {
    TransferContext.writeArguments(STRING_NAME to name, STRING_NAME to themeType)
  ...
  /**
   * Creates or changes the value of the [StyleBox] property defined by [name] and [themeType]. Use [clearStylebox] to remove the property.
   */
   ...
   */
  public final fun clearStylebox(name: StringName, themeType: StringName) {
    TransferContext.writeArguments(STRING_NAME to name, STRING_NAME to themeType)
  ...
  /**
   * Creates or changes the value of the [Font] property defined by [name] and [themeType]. Use [clearFont] to remove the property.
   */
   ...
   */
  public final fun clearFont(name: StringName, themeType: StringName) {
    TransferContext.writeArguments(STRING_NAME to name, STRING_NAME to themeType)
   ...
   */
  public final fun clearFontSize(name: StringName, themeType: StringName) {
    TransferContext.writeArguments(STRING_NAME to name, STRING_NAME to themeType)
  ...
  /**
   * Creates or changes the value of the [Color] property defined by [name] and [themeType]. Use [clearColor] to remove the property.
   */
   ...
   */
  public final fun clearColor(name: StringName, themeType: StringName) {
    TransferContext.writeArguments(STRING_NAME to name, STRING_NAME to themeType)
   ...
   */
  public final fun clearConstant(name: StringName, themeType: StringName) {
    TransferContext.writeArguments(STRING_NAME to name, STRING_NAME to themeType)
  ...
  public final fun setDefaultBaseScale(baseScale: Float) {
  ...
  public final fun setDefaultFont(font: Font?) {
  ...
  public final fun setDefaultFontSize(fontSize: Int) {
   ...
   */
  public final fun setTypeVariation(themeType: StringName, baseType: StringName) {
   ...
   */
  public final fun clearTypeVariation(themeType: StringName) {
   ...
   */
  public final fun addType(themeType: StringName) {
    TransferContext.writeArguments(STRING_NAME to themeType)
   ...
   */
  public final fun removeType(themeType: StringName) {
    TransferContext.writeArguments(STRING_NAME to themeType)
   ...
   */
  public final fun mergeWith(other: Theme?) {
   ...
   * Returns the engine fallback icon value if the property doesn't exist (see [ThemeDB.fallbackIcon]). Use [hasIcon] to check for existence.
   */
  public final fun getIcon(name: String, themeType: String): Texture2D? = getIcon(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns `false` if it doesn't exist. Use [setIcon] to define it.
   */
  public final fun hasIcon(name: String, themeType: String): Boolean = hasIcon(name.asCachedStringName(), themeType.asCachedStringName())
  ...
  public final fun renameIcon(
    ...
    name: String,
    themeType: String,
  ): Unit = renameIcon(oldName.asCachedStringName(), name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Fails if it doesn't exist. Use [hasIcon] to check for existence.
   */
  public final fun clearIcon(name: String, themeType: String): Unit = clearIcon(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns the engine fallback stylebox value if the property doesn't exist (see [ThemeDB.fallbackStylebox]). Use [hasStylebox] to check for existence.
   */
  public final fun getStylebox(name: String, themeType: String): StyleBox? = getStylebox(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns `false` if it doesn't exist. Use [setStylebox] to define it.
   */
  public final fun hasStylebox(name: String, themeType: String): Boolean = hasStylebox(name.asCachedStringName(), themeType.asCachedStringName())
  ...
  public final fun renameStylebox(
    ...
    name: String,
    themeType: String,
  ): Unit = renameStylebox(oldName.asCachedStringName(), name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Fails if it doesn't exist. Use [hasStylebox] to check for existence.
   */
  public final fun clearStylebox(name: String, themeType: String): Unit = clearStylebox(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns the engine fallback font value, if neither exist (see [ThemeDB.fallbackFont]).
   */
  public final fun getFont(name: String, themeType: String): Font? = getFont(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns `false` if neither exist. Use [setFont] to define the property.
   */
  public final fun hasFont(name: String, themeType: String): Boolean = hasFont(name.asCachedStringName(), themeType.asCachedStringName())
  ...
  public final fun renameFont(
    ...
    name: String,
    themeType: String,
  ): Unit = renameFont(oldName.asCachedStringName(), name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Fails if it doesn't exist. Use [hasFont] to check for existence.
   */
  public final fun clearFont(name: String, themeType: String): Unit = clearFont(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns the engine fallback font size value, if neither exist (see [ThemeDB.fallbackFontSize]).
   */
  public final fun getFontSize(name: String, themeType: String): Int = getFontSize(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns `false` if neither exist. Use [setFontSize] to define the property.
   */
  public final fun hasFontSize(name: String, themeType: String): Boolean = hasFontSize(name.asCachedStringName(), themeType.asCachedStringName())
  ...
  public final fun renameFontSize(
    ...
    name: String,
    themeType: String,
  ): Unit = renameFontSize(oldName.asCachedStringName(), name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Fails if it doesn't exist. Use [hasFontSize] to check for existence.
   */
  public final fun clearFontSize(name: String, themeType: String): Unit = clearFontSize(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns the default color value if the property doesn't exist. Use [hasColor] to check for existence.
   */
  public final fun getColor(name: String, themeType: String): Color = getColor(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns `false` if it doesn't exist. Use [setColor] to define it.
   */
  public final fun hasColor(name: String, themeType: String): Boolean = hasColor(name.asCachedStringName(), themeType.asCachedStringName())
  ...
  public final fun renameColor(
    ...
    name: String,
    themeType: String,
  ): Unit = renameColor(oldName.asCachedStringName(), name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Fails if it doesn't exist. Use [hasColor] to check for existence.
   */
  public final fun clearColor(name: String, themeType: String): Unit = clearColor(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns `0` if the property doesn't exist. Use [hasConstant] to check for existence.
   */
  public final fun getConstant(name: String, themeType: String): Int = getConstant(name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Returns `false` if it doesn't exist. Use [setConstant] to define it.
   */
  public final fun hasConstant(name: String, themeType: String): Boolean = hasConstant(name.asCachedStringName(), themeType.asCachedStringName())
  ...
  public final fun renameConstant(
    ...
    name: String,
    themeType: String,
  ): Unit = renameConstant(oldName.asCachedStringName(), name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * Fails if it doesn't exist. Use [hasConstant] to check for existence.
   */
  public final fun clearConstant(name: String, themeType: String): Unit = clearConstant(name.asCachedStringName(), themeType.asCachedStringName())
  ...
  public final fun renameThemeItem(
    ...
    name: String,
    themeType: String,
  ): Unit = renameThemeItem(dataType, oldName.asCachedStringName(), name.asCachedStringName(), themeType.asCachedStringName())
   ...
   * **Note:** Suggestions only show up if this theme resource is set as the project default theme. See [ProjectSettings.gui/theme/custom].
   */
  public final fun setTypeVariation(themeType: String, baseType: String): Unit = setTypeVariation(themeType.asCachedStringName(), baseType.asCachedStringName())

  /**
   * Returns `true` if [themeType] is marked as a variation of [baseType].
   */
  public final fun isTypeVariation(themeType: String, baseType: String): Boolean = isTypeVariation(themeType.asCachedStringName(), baseType.asCachedStringName())

  /**
   * Unmarks [themeType] as being a variation of another theme type. See [setTypeVariation].
   */
  public final fun clearTypeVariation(themeType: String): Unit = clearTypeVariation(themeType.asCachedStringName())

  /**
   * Returns the name of the base theme type if [themeType] is a valid variation type. Returns an empty string otherwise.
   */
  public final fun getTypeVariationBase(themeType: String): StringName = getTypeVariationBase(themeType.asCachedStringName())

  /**
   * Returns a list of all type variations for the given [baseType].
   */
  public final fun getTypeVariationList(baseType: String): PackedStringArray = getTypeVariationList(baseType.asCachedStringName())
  ...
  public object MethodBindings {
    internal val setIconPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_icon", 2_188_371_082)

    internal val getIconPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_icon", 934_555_193)

    internal val hasIconPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_icon", 471_820_014)

    internal val renameIconPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "rename_icon", 642_128_662)

    internal val clearIconPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "clear_icon", 3_740_211_285)

    internal val getIconListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_icon_list", 4_291_131_558)

    internal val getIconTypeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_icon_type_list", 1_139_954_409)

    internal val setStyleboxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_stylebox", 2_075_907_568)

    internal val getStyleboxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_stylebox", 3_405_608_165)

    internal val hasStyleboxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_stylebox", 471_820_014)

    internal val renameStyleboxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "rename_stylebox", 642_128_662)

    internal val clearStyleboxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "clear_stylebox", 3_740_211_285)

    internal val getStyleboxListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_stylebox_list", 4_291_131_558)

    internal val getStyleboxTypeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_stylebox_type_list", 1_139_954_409)

    internal val setFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_font", 177_292_320)

    internal val getFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_font", 3_445_063_586)

    internal val hasFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_font", 471_820_014)

    internal val renameFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "rename_font", 642_128_662)

    internal val clearFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "clear_font", 3_740_211_285)

    internal val getFontListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_font_list", 4_291_131_558)

    internal val getFontTypeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_font_type_list", 1_139_954_409)

    internal val setFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_font_size", 281_601_298)

    internal val getFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_font_size", 2_419_549_490)

    internal val hasFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_font_size", 471_820_014)

    internal val renameFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "rename_font_size", 642_128_662)

    internal val clearFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "clear_font_size", 3_740_211_285)

    internal val getFontSizeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_font_size_list", 4_291_131_558)

    internal val getFontSizeTypeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_font_size_type_list", 1_139_954_409)

    internal val setColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_color", 4_111_215_154)

    internal val getColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_color", 2_015_923_404)

    internal val hasColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_color", 471_820_014)

    internal val renameColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "rename_color", 642_128_662)

    internal val clearColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "clear_color", 3_740_211_285)

    internal val getColorListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_color_list", 4_291_131_558)

    internal val getColorTypeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_color_type_list", 1_139_954_409)

    internal val setConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_constant", 281_601_298)

    internal val getConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_constant", 2_419_549_490)

    internal val hasConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_constant", 471_820_014)

    internal val renameConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "rename_constant", 642_128_662)

    internal val clearConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "clear_constant", 3_740_211_285)

    internal val getConstantListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_constant_list", 4_291_131_558)

    internal val getConstantTypeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_constant_type_list", 1_139_954_409)

    internal val setDefaultBaseScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_default_base_scale", 373_806_689)

    internal val getDefaultBaseScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_default_base_scale", 1_740_695_150)

    internal val hasDefaultBaseScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_default_base_scale", 36_873_697)

    internal val setDefaultFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_default_font", 1_262_170_328)

    internal val getDefaultFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_default_font", 3_229_501_585)

    internal val hasDefaultFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_default_font", 36_873_697)

    internal val setDefaultFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_default_font_size", 1_286_410_249)

    internal val getDefaultFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_default_font_size", 3_905_245_786)

    internal val hasDefaultFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_default_font_size", 36_873_697)

    internal val setThemeItemPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_theme_item", 2_492_983_623)

    internal val getThemeItemPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_theme_item", 2_191_024_021)

    internal val hasThemeItemPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "has_theme_item", 1_739_311_056)

    internal val renameThemeItemPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "rename_theme_item", 3_900_867_553)

    internal val clearThemeItemPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "clear_theme_item", 2_965_505_587)

    internal val getThemeItemListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_theme_item_list", 3_726_716_710)

    internal val getThemeItemTypeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_theme_item_type_list", 1_316_004_935)

    internal val setTypeVariationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "set_type_variation", 3_740_211_285)

    internal val isTypeVariationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "is_type_variation", 471_820_014)

    internal val clearTypeVariationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "clear_type_variation", 3_304_788_590)

    internal val getTypeVariationBasePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_type_variation_base", 1_965_194_235)

    internal val getTypeVariationListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_type_variation_list", 1_761_182_771)

    internal val addTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "add_type", 3_304_788_590)

    internal val removeTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "remove_type", 3_304_788_590)

    internal val getTypeListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "get_type_list", 1_139_954_409)

    internal val mergeWithPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Theme", "merge_with", 2_326_690_814)

    internal val clearPtr: VoidPtr = TypeManager.getMethodBindPtr("Theme", "clear", 3_218_959_716)
  }
}
