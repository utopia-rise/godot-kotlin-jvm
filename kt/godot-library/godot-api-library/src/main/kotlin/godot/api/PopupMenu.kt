...
import godot.activateItemByEventPtr
import godot.addCheckItemPtr
import godot.addCheckShortcutPtr
import godot.addIconCheckItemPtr
import godot.addIconCheckShortcutPtr
import godot.addIconItemPtr
import godot.addIconRadioCheckItemPtr
import godot.addIconRadioCheckShortcutPtr
import godot.addIconShortcutPtr
import godot.addItemPtr
import godot.addMultistateItemPtr
import godot.addRadioCheckItemPtr
import godot.addRadioCheckShortcutPtr
import godot.addSeparatorPtr
import godot.addShortcutPtr
import godot.addSubmenuItemPtr
import godot.addSubmenuNodeItemPtr
...
import godot.getAllowSearchPtr
import godot.getFocusedItemPtr
import godot.getItemAcceleratorPtr
import godot.getItemCountPtr
import godot.getItemIconMaxWidthPtr
import godot.getItemIconModulatePtr
import godot.getItemIconPtr
import godot.getItemIdPtr
import godot.getItemIndentPtr
import godot.getItemIndexPtr
import godot.getItemLanguagePtr
import godot.getItemMetadataPtr
import godot.getItemMultistateMaxPtr
import godot.getItemMultistatePtr
import godot.getItemShortcutPtr
import godot.getItemSubmenuNodePtr
import godot.getItemSubmenuPtr
import godot.getItemTextDirectionPtr
import godot.getItemTextPtr
import godot.getItemTooltipPtr
import godot.getSubmenuPopupDelayPtr
import godot.getSystemMenuPtr
import godot.isHideOnCheckableItemSelectionPtr
import godot.isHideOnItemSelectionPtr
import godot.isHideOnStateItemSelectionPtr
...
import godot.isItemSeparatorPtr
import godot.isItemShortcutDisabledPtr
import godot.isNativeMenuPtr
import godot.isPreferNativeMenuPtr
import godot.isSystemMenuPtr
import godot.removeItemPtr
import godot.scrollToItemPtr
import godot.setAllowSearchPtr
import godot.setFocusedItemPtr
import godot.setHideOnCheckableItemSelectionPtr
import godot.setHideOnItemSelectionPtr
import godot.setHideOnStateItemSelectionPtr
import godot.setItemAcceleratorPtr
import godot.setItemAsCheckablePtr
import godot.setItemAsRadioCheckablePtr
import godot.setItemAsSeparatorPtr
import godot.setItemCheckedPtr
import godot.setItemCountPtr
import godot.setItemDisabledPtr
import godot.setItemIconMaxWidthPtr
import godot.setItemIconModulatePtr
import godot.setItemIconPtr
import godot.setItemIdPtr
import godot.setItemIndentPtr
import godot.setItemLanguagePtr
import godot.setItemMetadataPtr
import godot.setItemMultistateMaxPtr
import godot.setItemMultistatePtr
import godot.setItemShortcutDisabledPtr
import godot.setItemShortcutPtr
import godot.setItemSubmenuNodePtr
import godot.setItemSubmenuPtr
import godot.setItemTextDirectionPtr
import godot.setItemTextPtr
import godot.setItemTooltipPtr
import godot.setPreferNativeMenuPtr
import godot.setSubmenuPopupDelayPtr
import godot.setSystemMenuPtr
import godot.toggleItemCheckedPtr
import godot.toggleItemMultistatePtr
import kotlin.Any
...
private const val ENGINECLASS_POPUPMENU: Int = 499
...
public open class PopupMenu : Popup() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_POPUPMENU, scriptIndex)
  }
