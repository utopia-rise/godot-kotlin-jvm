...
import godot.addButtonPtr
import godot.addChildPtr
import godot.callRecursivePtr
import godot.clearCustomBgColorPtr
import godot.clearCustomColorPtr
...
import godot.createChildPtr
import godot.deselectPtr
import godot.eraseButtonPtr
import godot.getAutowrapModePtr
import godot.getButtonByIdPtr
import godot.getButtonColorPtr
import godot.getButtonCountPtr
import godot.getButtonIdPtr
import godot.getButtonPtr
import godot.getButtonTooltipTextPtr
import godot.getCellModePtr
import godot.getChildCountPtr
import godot.getChildPtr
import godot.getChildrenPtr
import godot.getCustomBgColorPtr
import godot.getCustomColorPtr
import godot.getCustomDrawCallbackPtr
import godot.getCustomFontPtr
import godot.getCustomFontSizePtr
import godot.getCustomMinimumHeightPtr
import godot.getExpandRightPtr
import godot.getFirstChildPtr
import godot.getIconMaxWidthPtr
import godot.getIconModulatePtr
import godot.getIconPtr
import godot.getIconRegionPtr
import godot.getIndexPtr
import godot.getLanguagePtr
import godot.getMetadataPtr
import godot.getNextInTreePtr
import godot.getNextPtr
import godot.getNextVisiblePtr
import godot.getParentPtr
import godot.getPrevInTreePtr
import godot.getPrevPtr
import godot.getPrevVisiblePtr
import godot.getRangeConfigPtr
import godot.getRangePtr
import godot.getStructuredTextBidiOverrideOptionsPtr
import godot.getStructuredTextBidiOverridePtr
import godot.getSuffixPtr
import godot.getTextAlignmentPtr
import godot.getTextDirectionPtr
import godot.getTextOverrunBehaviorPtr
import godot.getTextPtr
import godot.getTooltipTextPtr
import godot.getTreePtr
import godot.isAnyCollapsedPtr
import godot.isButtonDisabledPtr
import godot.isCheckedPtr
import godot.isCollapsedPtr
import godot.isCustomSetAsButtonPtr
import godot.isEditMultilinePtr
import godot.isEditablePtr
import godot.isFoldingDisabledPtr
import godot.isIndeterminatePtr
import godot.isSelectablePtr
import godot.isSelectedPtr
import godot.isVisibleInTreePtr
import godot.isVisiblePtr
import godot.moveAfterPtr
import godot.moveBeforePtr
import godot.propagateCheckPtr
import godot.removeChildPtr
import godot.selectPtr
import godot.setAutowrapModePtr
import godot.setButtonColorPtr
import godot.setButtonDisabledPtr
import godot.setButtonPtr
import godot.setButtonTooltipTextPtr
import godot.setCellModePtr
import godot.setCheckedPtr
import godot.setCollapsedPtr
import godot.setCollapsedRecursivePtr
import godot.setCustomAsButtonPtr
import godot.setCustomBgColorPtr
import godot.setCustomColorPtr
import godot.setCustomDrawCallbackPtr
import godot.setCustomDrawPtr
import godot.setCustomFontPtr
import godot.setCustomFontSizePtr
import godot.setCustomMinimumHeightPtr
import godot.setDisableFoldingPtr
import godot.setEditMultilinePtr
import godot.setEditablePtr
import godot.setExpandRightPtr
import godot.setIconMaxWidthPtr
import godot.setIconModulatePtr
import godot.setIconPtr
import godot.setIconRegionPtr
import godot.setIndeterminatePtr
import godot.setLanguagePtr
import godot.setMetadataPtr
import godot.setRangeConfigPtr
import godot.setRangePtr
...
import godot.setSuffixPtr
import godot.setTextAlignmentPtr
import godot.setTextDirectionPtr
import godot.setTextOverrunBehaviorPtr
import godot.setTextPtr
import godot.setTooltipTextPtr
import godot.setVisiblePtr
import godot.uncollapseTreePtr
import kotlin.Any
...
public open class TreeItem internal constructor() : Object() {
  ...
  public object MethodBindings {
    ...
    internal val setTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("TreeItem", "set_text", 501894301)
    ...
    internal val setIconPtr: VoidPtr =
        TypeManager.getMethodBindPtr("TreeItem", "set_icon", 666127730)
