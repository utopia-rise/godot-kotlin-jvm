...
import godot.addCaretAtCaretsPtr
import godot.addCaretPtr
import godot.addGutterPtr
import godot.addSelectionForNextOccurrencePtr
import godot.adjustCaretsAfterEditPtr
import godot.adjustViewportToCaretPtr
import godot.applyImePtr
import godot.backspacePtr
import godot.beginComplexOperationPtr
import godot.beginMulticaretEditPtr
import godot.cancelImePtr
import godot.centerViewportToCaretPtr
import godot.clearPtr
import godot.clearUndoHistoryPtr
import godot.collapseCaretsPtr
...
import godot.cutPtr
import godot.deleteSelectionPtr
import godot.deselectPtr
import godot.endActionPtr
import godot.endComplexOperationPtr
import godot.endMulticaretEditPtr
import godot.getAutowrapModePtr
import godot.getCaretBlinkIntervalPtr
import godot.getCaretColumnPtr
import godot.getCaretCountPtr
import godot.getCaretDrawPosPtr
import godot.getCaretIndexEditOrderPtr
import godot.getCaretLinePtr
import godot.getCaretTypePtr
import godot.getCaretWrapIndexPtr
import godot.getCustomWordSeparatorsPtr
import godot.getDrawControlCharsPtr
import godot.getFirstNonWhitespaceColumnPtr
import godot.getFirstVisibleLinePtr
import godot.getGutterCountPtr
import godot.getGutterNamePtr
import godot.getGutterTypePtr
import godot.getGutterWidthPtr
import godot.getHScrollBarPtr
import godot.getHScrollPtr
import godot.getIndentLevelPtr
import godot.getLanguagePtr
import godot.getLastFullVisibleLinePtr
import godot.getLastFullVisibleLineWrapIndexPtr
import godot.getLastUnhiddenLinePtr
import godot.getLineBackgroundColorPtr
import godot.getLineColumnAtPosPtr
import godot.getLineCountPtr
import godot.getLineGutterIconPtr
import godot.getLineGutterItemColorPtr
import godot.getLineGutterMetadataPtr
import godot.getLineGutterTextPtr
import godot.getLineHeightPtr
import godot.getLinePtr
import godot.getLineRangesFromCaretsPtr
import godot.getLineWidthPtr
import godot.getLineWrapCountPtr
import godot.getLineWrapIndexAtColumnPtr
import godot.getLineWrappedTextPtr
import godot.getLineWrappingModePtr
import godot.getLocalMousePosPtr
import godot.getMenuPtr
import godot.getMinimapLineAtPosPtr
import godot.getMinimapVisibleLinesPtr
import godot.getMinimapWidthPtr
import godot.getNextVisibleLineIndexOffsetFromPtr
import godot.getNextVisibleLineOffsetFromPtr
import godot.getPlaceholderPtr
import godot.getPosAtLineColumnPtr
import godot.getRectAtLineColumnPtr
import godot.getSavedVersionPtr
import godot.getScrollPosForLinePtr
import godot.getSelectedTextPtr
import godot.getSelectionAtLineColumnPtr
import godot.getSelectionColumnPtr
import godot.getSelectionFromColumnPtr
import godot.getSelectionFromLinePtr
import godot.getSelectionLinePtr
import godot.getSelectionModePtr
import godot.getSelectionOriginColumnPtr
import godot.getSelectionOriginLinePtr
import godot.getSelectionToColumnPtr
import godot.getSelectionToLinePtr
import godot.getSortedCaretsPtr
import godot.getStructuredTextBidiOverrideOptionsPtr
import godot.getStructuredTextBidiOverridePtr
import godot.getSyntaxHighlighterPtr
import godot.getTabSizePtr
import godot.getTextDirectionPtr
import godot.getTextPtr
import godot.getTotalGutterWidthPtr
import godot.getTotalVisibleLineCountPtr
import godot.getVScrollBarPtr
import godot.getVScrollPtr
import godot.getVScrollSpeedPtr
import godot.getVersionPtr
import godot.getVisibleLineCountInRangePtr
import godot.getVisibleLineCountPtr
import godot.getWordAtPosPtr
import godot.getWordUnderCaretPtr
import godot.hasImeTextPtr
import godot.hasRedoPtr
import godot.hasSelectionPtr
import godot.hasUndoPtr
import godot.insertLineAtPtr
import godot.insertTextAtCaretPtr
import godot.insertTextPtr
import godot.isCaretAfterSelectionOriginPtr
import godot.isCaretBlinkEnabledPtr
import godot.isCaretMidGraphemeEnabledPtr
import godot.isCaretVisiblePtr
import godot.isContextMenuEnabledPtr
import godot.isCustomWordSeparatorsEnabledPtr
import godot.isDefaultWordSeparatorsEnabledPtr
import godot.isDeselectOnFocusLossEnabledPtr
import godot.isDragAndDropSelectionEnabledPtr
import godot.isDraggingCursorPtr
import godot.isDrawingCaretWhenEditableDisabledPtr
import godot.isDrawingMinimapPtr
import godot.isDrawingSpacesPtr
import godot.isDrawingTabsPtr
import godot.isEditablePtr
import godot.isFitContentHeightEnabledPtr
import godot.isGutterClickablePtr
import godot.isGutterDrawnPtr
import godot.isGutterOverwritablePtr
import godot.isHighlightAllOccurrencesEnabledPtr
import godot.isHighlightCurrentLineEnabledPtr
import godot.isInMulitcaretEditPtr
import godot.isIndentWrappedLinesPtr
import godot.isLineGutterClickablePtr
import godot.isLineWrappedPtr
import godot.isMenuVisiblePtr
import godot.isMiddleMousePasteEnabledPtr
import godot.isMouseOverSelectionPtr
import godot.isMoveCaretOnRightClickEnabledPtr
import godot.isMultipleCaretsEnabledPtr
import godot.isOvertypeModeEnabledPtr
import godot.isScrollPastEndOfFileEnabledPtr
import godot.isSelectingEnabledPtr
import godot.isShortcutKeysEnabledPtr
import godot.isSmoothScrollEnabledPtr
import godot.isVirtualKeyboardEnabledPtr
import godot.menuOptionPtr
import godot.mergeGuttersPtr
import godot.mergeOverlappingCaretsPtr
import godot.multicaretEditIgnoreCaretPtr
import godot.pastePrimaryClipboardPtr
import godot.pastePtr
import godot.redoPtr
import godot.removeCaretPtr
import godot.removeGutterPtr
import godot.removeLineAtPtr
import godot.removeSecondaryCaretsPtr
import godot.removeTextPtr
import godot.searchPtr
import godot.selectAllPtr
import godot.selectPtr
import godot.selectWordUnderCaretPtr
import godot.setAutowrapModePtr
import godot.setCaretBlinkEnabledPtr
import godot.setCaretBlinkIntervalPtr
import godot.setCaretColumnPtr
import godot.setCaretLinePtr
import godot.setCaretMidGraphemeEnabledPtr
import godot.setCaretTypePtr
import godot.setContextMenuEnabledPtr
import godot.setCustomWordSeparatorsPtr
import godot.setDeselectOnFocusLossEnabledPtr
import godot.setDragAndDropSelectionEnabledPtr
import godot.setDrawCaretWhenEditableDisabledPtr
import godot.setDrawControlCharsPtr
import godot.setDrawMinimapPtr
import godot.setDrawSpacesPtr
import godot.setDrawTabsPtr
import godot.setEditablePtr
import godot.setFitContentHeightEnabledPtr
import godot.setGutterClickablePtr
import godot.setGutterCustomDrawPtr
import godot.setGutterDrawPtr
import godot.setGutterNamePtr
import godot.setGutterOverwritablePtr
import godot.setGutterTypePtr
import godot.setGutterWidthPtr
import godot.setHScrollPtr
import godot.setHighlightAllOccurrencesPtr
import godot.setHighlightCurrentLinePtr
import godot.setIndentWrappedLinesPtr
import godot.setLanguagePtr
import godot.setLineAsCenterVisiblePtr
import godot.setLineAsFirstVisiblePtr
import godot.setLineAsLastVisiblePtr
import godot.setLineBackgroundColorPtr
import godot.setLineGutterClickablePtr
import godot.setLineGutterIconPtr
import godot.setLineGutterItemColorPtr
import godot.setLineGutterMetadataPtr
import godot.setLineGutterTextPtr
import godot.setLinePtr
import godot.setLineWrappingModePtr
import godot.setMiddleMousePasteEnabledPtr
import godot.setMinimapWidthPtr
import godot.setMoveCaretOnRightClickEnabledPtr
import godot.setMultipleCaretsEnabledPtr
import godot.setOvertypeModeEnabledPtr
import godot.setPlaceholderPtr
import godot.setScrollPastEndOfFileEnabledPtr
import godot.setSearchFlagsPtr
import godot.setSearchTextPtr
import godot.setSelectingEnabledPtr
import godot.setSelectionModePtr
import godot.setSelectionOriginColumnPtr
import godot.setSelectionOriginLinePtr
import godot.setShortcutKeysEnabledPtr
import godot.setSmoothScrollEnabledPtr
import godot.setStructuredTextBidiOverrideOptionsPtr
import godot.setStructuredTextBidiOverridePtr
import godot.setSyntaxHighlighterPtr
import godot.setTabSizePtr
import godot.setTextDirectionPtr
import godot.setTextPtr
import godot.setTooltipRequestFuncPtr
import godot.setUseCustomWordSeparatorsPtr
import godot.setUseDefaultWordSeparatorsPtr
import godot.setVScrollPtr
import godot.setVScrollSpeedPtr
import godot.setVirtualKeyboardEnabledPtr
import godot.skipSelectionForNextOccurrencePtr
import godot.startActionPtr
import godot.swapLinesPtr
import godot.tagSavedVersionPtr
import godot.undoPtr
import kotlin.Any
