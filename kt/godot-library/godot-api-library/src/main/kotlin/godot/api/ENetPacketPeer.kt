...
public open class ENetPacketPeer internal constructor() : PacketPeer() {
   ...
   */
  @JvmOverloads
  public final fun peerDisconnect(`data`: Int = 0) {
   ...
   */
  @JvmOverloads
  public final fun peerDisconnectLater(`data`: Int = 0) {
    TransferContext.writeArguments(LONG to data.toLong())
   ...
   */
  @JvmOverloads
  public final fun peerDisconnectNow(`data`: Int = 0) {
    TransferContext.writeArguments(LONG to data.toLong())
   ...
   */
  public final fun pingInterval(pingInterval: Int) {
  ...
  public companion object {
    ...
    /**
     * The reference value for throttle configuration. The default value is `32`. See [throttleConfigure].
     */
  ...
  public object MethodBindings {
    internal val peerDisconnectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "peer_disconnect", 1_995_695_955)

    internal val peerDisconnectLaterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "peer_disconnect_later", 1_995_695_955)

    internal val peerDisconnectNowPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "peer_disconnect_now", 1_995_695_955)

    internal val pingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "ping", 3_218_959_716)

    internal val pingIntervalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "ping_interval", 1_286_410_249)

    internal val resetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "reset", 3_218_959_716)

    internal val sendPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "send", 120_522_849)

    internal val throttleConfigurePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "throttle_configure", 1_649_997_291)

    internal val setTimeoutPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "set_timeout", 1_649_997_291)

    internal val getPacketFlagsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "get_packet_flags", 3_905_245_786)

    internal val getRemoteAddressPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "get_remote_address", 201_670_096)

    internal val getRemotePortPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "get_remote_port", 3_905_245_786)

    internal val getStatisticPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "get_statistic", 1_642_578_323)

    internal val getStatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "get_state", 711_068_532)

    internal val getChannelsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "get_channels", 3_905_245_786)

    internal val isActivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ENetPacketPeer", "is_active", 36_873_697)
  }
}
