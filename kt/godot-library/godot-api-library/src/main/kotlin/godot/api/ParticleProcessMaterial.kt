...
import godot.getAlphaCurvePtr
import godot.getCollisionBouncePtr
import godot.getCollisionFrictionPtr
import godot.getCollisionModePtr
import godot.getColorInitialRampPtr
import godot.getColorPtr
import godot.getColorRampPtr
import godot.getDirectionPtr
import godot.getEmissionBoxExtentsPtr
import godot.getEmissionColorTexturePtr
import godot.getEmissionCurvePtr
import godot.getEmissionNormalTexturePtr
import godot.getEmissionPointCountPtr
import godot.getEmissionPointTexturePtr
import godot.getEmissionRingAxisPtr
import godot.getEmissionRingHeightPtr
import godot.getEmissionRingInnerRadiusPtr
import godot.getEmissionRingRadiusPtr
import godot.getEmissionShapeOffsetPtr
import godot.getEmissionShapePtr
import godot.getEmissionShapeScalePtr
import godot.getEmissionSphereRadiusPtr
import godot.getFlatnessPtr
import godot.getGravityPtr
import godot.getInheritVelocityRatioPtr
import godot.getLifetimeRandomnessPtr
import godot.getParamMaxPtr
import godot.getParamMinPtr
import godot.getParamPtr
import godot.getParamTexturePtr
import godot.getParticleFlagPtr
import godot.getSpreadPtr
import godot.getSubEmitterAmountAtCollisionPtr
import godot.getSubEmitterAmountAtEndPtr
import godot.getSubEmitterFrequencyPtr
import godot.getSubEmitterKeepVelocityPtr
import godot.getSubEmitterModePtr
import godot.getTurbulenceEnabledPtr
import godot.getTurbulenceNoiseScalePtr
import godot.getTurbulenceNoiseSpeedPtr
import godot.getTurbulenceNoiseSpeedRandomPtr
import godot.getTurbulenceNoiseStrengthPtr
import godot.getVelocityLimitCurvePtr
import godot.getVelocityPivotPtr
import godot.isAttractorInteractionEnabledPtr
import godot.isCollisionUsingScalePtr
import godot.setAlphaCurvePtr
import godot.setAttractorInteractionEnabledPtr
import godot.setCollisionBouncePtr
import godot.setCollisionFrictionPtr
import godot.setCollisionModePtr
import godot.setCollisionUseScalePtr
import godot.setColorInitialRampPtr
import godot.setColorPtr
import godot.setColorRampPtr
import godot.setDirectionPtr
import godot.setEmissionBoxExtentsPtr
import godot.setEmissionColorTexturePtr
import godot.setEmissionCurvePtr
import godot.setEmissionNormalTexturePtr
import godot.setEmissionPointCountPtr
import godot.setEmissionPointTexturePtr
import godot.setEmissionRingAxisPtr
import godot.setEmissionRingHeightPtr
import godot.setEmissionRingInnerRadiusPtr
import godot.setEmissionRingRadiusPtr
import godot.setEmissionShapeOffsetPtr
import godot.setEmissionShapePtr
import godot.setEmissionShapeScalePtr
import godot.setEmissionSphereRadiusPtr
import godot.setFlatnessPtr
import godot.setGravityPtr
import godot.setInheritVelocityRatioPtr
import godot.setLifetimeRandomnessPtr
import godot.setParamMaxPtr
import godot.setParamMinPtr
import godot.setParamPtr
import godot.setParamTexturePtr
import godot.setParticleFlagPtr
import godot.setSpreadPtr
import godot.setSubEmitterAmountAtCollisionPtr
import godot.setSubEmitterAmountAtEndPtr
import godot.setSubEmitterFrequencyPtr
import godot.setSubEmitterKeepVelocityPtr
import godot.setSubEmitterModePtr
import godot.setTurbulenceEnabledPtr
import godot.setTurbulenceNoiseScalePtr
import godot.setTurbulenceNoiseSpeedPtr
import godot.setTurbulenceNoiseSpeedRandomPtr
import godot.setTurbulenceNoiseStrengthPtr
import godot.setVelocityLimitCurvePtr
import godot.setVelocityPivotPtr
