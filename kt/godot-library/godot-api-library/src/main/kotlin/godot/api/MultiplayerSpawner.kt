...
public open class MultiplayerSpawner : Node() {
   ...
   */
  public final fun addSpawnableScene(path: String) {
   ...
   */
  public final fun clearSpawnableScenes() {
    TransferContext.writeArguments()
  ...
  public final fun setSpawnPath(path: NodePath) {
  ...
  public final fun setSpawnLimit(limit: Long) {
  ...
  public final fun setSpawnFunction(spawnFunction: Callable) {
  ...
  public object MethodBindings {
    internal val addSpawnableScenePtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "add_spawnable_scene", 83_702_148)

    internal val getSpawnableSceneCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "get_spawnable_scene_count", 3_905_245_786)

    internal val getSpawnableScenePtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "get_spawnable_scene", 844_755_477)

    internal val clearSpawnableScenesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "clear_spawnable_scenes", 3_218_959_716)

    internal val spawnPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "spawn", 1_991_184_589)

    internal val getSpawnPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "get_spawn_path", 4_075_236_667)

    internal val setSpawnPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "set_spawn_path", 1_348_162_250)

    internal val getSpawnLimitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "get_spawn_limit", 3_905_245_786)

    internal val setSpawnLimitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "set_spawn_limit", 1_286_410_249)

    internal val getSpawnFunctionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "get_spawn_function", 1_307_783_378)

    internal val setSpawnFunctionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerSpawner", "set_spawn_function", 1_611_583_062)
  }
}
