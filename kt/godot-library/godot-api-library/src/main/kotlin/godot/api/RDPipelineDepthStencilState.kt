...
public open class RDPipelineDepthStencilState : RefCounted() {
  ...
  public final fun setEnableDepthTest(pMember: Boolean) {
  ...
  public final fun setEnableDepthWrite(pMember: Boolean) {
    TransferContext.writeArguments(BOOL to pMember)
  ...
  public final fun setDepthCompareOperator(pMember: RenderingDevice.CompareOperator) {
  ...
  public final fun setEnableDepthRange(pMember: Boolean) {
    TransferContext.writeArguments(BOOL to pMember)
  ...
  public final fun setDepthRangeMin(pMember: Float) {
  ...
  public final fun setDepthRangeMax(pMember: Float) {
    TransferContext.writeArguments(DOUBLE to pMember.toDouble())
  ...
  public final fun setEnableStencil(pMember: Boolean) {
    TransferContext.writeArguments(BOOL to pMember)
  ...
  public final fun setFrontOpFail(pMember: RenderingDevice.StencilOperation) {
    TransferContext.writeArguments(LONG to pMember.id)
  ...
  public final fun setFrontOpPass(pMember: RenderingDevice.StencilOperation) {
    TransferContext.writeArguments(LONG to pMember.id)
  ...
  public final fun setFrontOpDepthFail(pMember: RenderingDevice.StencilOperation) {
    TransferContext.writeArguments(LONG to pMember.id)
  ...
  public final fun setFrontOpCompare(pMember: RenderingDevice.CompareOperator) {
    TransferContext.writeArguments(LONG to pMember.id)
  ...
  public final fun setFrontOpCompareMask(pMember: Long) {
  ...
  public final fun setFrontOpWriteMask(pMember: Long) {
    TransferContext.writeArguments(LONG to pMember)
  ...
  public final fun setFrontOpReference(pMember: Long) {
    TransferContext.writeArguments(LONG to pMember)
  ...
  public final fun setBackOpFail(pMember: RenderingDevice.StencilOperation) {
    TransferContext.writeArguments(LONG to pMember.id)
  ...
  public final fun setBackOpPass(pMember: RenderingDevice.StencilOperation) {
    TransferContext.writeArguments(LONG to pMember.id)
  ...
  public final fun setBackOpDepthFail(pMember: RenderingDevice.StencilOperation) {
    TransferContext.writeArguments(LONG to pMember.id)
  ...
  public final fun setBackOpCompare(pMember: RenderingDevice.CompareOperator) {
    TransferContext.writeArguments(LONG to pMember.id)
  ...
  public final fun setBackOpCompareMask(pMember: Long) {
    TransferContext.writeArguments(LONG to pMember)
  ...
  public final fun setBackOpWriteMask(pMember: Long) {
    TransferContext.writeArguments(LONG to pMember)
  ...
  public final fun setBackOpReference(pMember: Long) {
    TransferContext.writeArguments(LONG to pMember)
  ...
  public object MethodBindings {
    internal val setEnableDepthTestPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_enable_depth_test", 2_586_408_642)

    internal val getEnableDepthTestPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_enable_depth_test", 36_873_697)

    internal val setEnableDepthWritePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_enable_depth_write", 2_586_408_642)

    internal val getEnableDepthWritePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_enable_depth_write", 36_873_697)

    internal val setDepthCompareOperatorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_depth_compare_operator", 2_573_711_505)

    internal val getDepthCompareOperatorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_depth_compare_operator", 269_730_778)

    internal val setEnableDepthRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_enable_depth_range", 2_586_408_642)

    internal val getEnableDepthRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_enable_depth_range", 36_873_697)

    internal val setDepthRangeMinPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_depth_range_min", 373_806_689)

    internal val getDepthRangeMinPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_depth_range_min", 1_740_695_150)

    internal val setDepthRangeMaxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_depth_range_max", 373_806_689)

    internal val getDepthRangeMaxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_depth_range_max", 1_740_695_150)

    internal val setEnableStencilPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_enable_stencil", 2_586_408_642)

    internal val getEnableStencilPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_enable_stencil", 36_873_697)

    internal val setFrontOpFailPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_front_op_fail", 2_092_799_566)

    internal val getFrontOpFailPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_front_op_fail", 1_714_732_389)

    internal val setFrontOpPassPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_front_op_pass", 2_092_799_566)

    internal val getFrontOpPassPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_front_op_pass", 1_714_732_389)

    internal val setFrontOpDepthFailPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_front_op_depth_fail", 2_092_799_566)

    internal val getFrontOpDepthFailPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_front_op_depth_fail", 1_714_732_389)

    internal val setFrontOpComparePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_front_op_compare", 2_573_711_505)

    internal val getFrontOpComparePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_front_op_compare", 269_730_778)

    internal val setFrontOpCompareMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_front_op_compare_mask", 1_286_410_249)

    internal val getFrontOpCompareMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_front_op_compare_mask", 3_905_245_786)

    internal val setFrontOpWriteMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_front_op_write_mask", 1_286_410_249)

    internal val getFrontOpWriteMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_front_op_write_mask", 3_905_245_786)

    internal val setFrontOpReferencePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_front_op_reference", 1_286_410_249)

    internal val getFrontOpReferencePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_front_op_reference", 3_905_245_786)

    internal val setBackOpFailPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_back_op_fail", 2_092_799_566)

    internal val getBackOpFailPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_back_op_fail", 1_714_732_389)

    internal val setBackOpPassPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_back_op_pass", 2_092_799_566)

    internal val getBackOpPassPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_back_op_pass", 1_714_732_389)

    internal val setBackOpDepthFailPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_back_op_depth_fail", 2_092_799_566)

    internal val getBackOpDepthFailPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_back_op_depth_fail", 1_714_732_389)

    internal val setBackOpComparePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_back_op_compare", 2_573_711_505)

    internal val getBackOpComparePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_back_op_compare", 269_730_778)

    internal val setBackOpCompareMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_back_op_compare_mask", 1_286_410_249)

    internal val getBackOpCompareMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_back_op_compare_mask", 3_905_245_786)

    internal val setBackOpWriteMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_back_op_write_mask", 1_286_410_249)

    internal val getBackOpWriteMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_back_op_write_mask", 3_905_245_786)

    internal val setBackOpReferencePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "set_back_op_reference", 1_286_410_249)

    internal val getBackOpReferencePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RDPipelineDepthStencilState", "get_back_op_reference", 3_905_245_786)
  }
}
