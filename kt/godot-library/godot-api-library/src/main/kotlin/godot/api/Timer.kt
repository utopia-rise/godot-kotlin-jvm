...
import godot.getTimerProcessCallbackPtr
import godot.getWaitTimePtr
import godot.hasAutostartPtr
import godot.isOneShotPtr
import godot.isPausedPtr
import godot.isStoppedPtr
import godot.setAutostartPtr
import godot.setOneShotPtr
import godot.setPausedPtr
import godot.setTimerProcessCallbackPtr
import godot.setWaitTimePtr
...
private const val ENGINECLASS_TIMER: Int = 671
...
public open class Timer : Node() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_TIMER, scriptIndex)
  }
