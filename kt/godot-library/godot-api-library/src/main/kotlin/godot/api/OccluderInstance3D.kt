...
public open class OccluderInstance3D : VisualInstance3D() {
  ...
  public final fun setBakeSimplificationDistance(simplificationDistance: Float) {
  ...
  public final fun setOccluder(occluder: Occluder3D?) {
  ...
  public object MethodBindings {
    internal val setBakeMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OccluderInstance3D", "set_bake_mask", 1_286_410_249)

    internal val getBakeMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OccluderInstance3D", "get_bake_mask", 3_905_245_786)

    internal val setBakeMaskValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OccluderInstance3D", "set_bake_mask_value", 300_928_843)

    internal val getBakeMaskValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OccluderInstance3D", "get_bake_mask_value", 1_116_898_809)

    internal val setBakeSimplificationDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OccluderInstance3D", "set_bake_simplification_distance", 373_806_689)

    internal val getBakeSimplificationDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OccluderInstance3D", "get_bake_simplification_distance", 1_740_695_150)

    internal val setOccluderPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OccluderInstance3D", "set_occluder", 1_664_878_165)

    internal val getOccluderPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OccluderInstance3D", "get_occluder", 1_696_836_198)
  }
}
