...
public open class UPNP : RefCounted() {
   ...
   */
  public final fun addDevice(device: UPNPDevice?) {
   ...
   */
  public final fun setDevice(index: Int, device: UPNPDevice?) {
   ...
   */
  public final fun removeDevice(index: Int) {
    TransferContext.writeArguments(LONG to index.toLong())
  ...
  public final fun setDiscoverMulticastIf(mIf: String) {
  ...
  public final fun setDiscoverLocalPort(port: Int) {
  ...
  public final fun setDiscoverIpv6(ipv6: Boolean) {
  ...
  public object MethodBindings {
    internal val getDeviceCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "get_device_count", 3_905_245_786)

    internal val getDevicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "get_device", 2_193_290_270)

    internal val addDevicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "add_device", 986_715_920)

    internal val setDevicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "set_device", 3_015_133_723)

    internal val removeDevicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "remove_device", 1_286_410_249)

    internal val clearDevicesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "clear_devices", 3_218_959_716)

    internal val getGatewayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "get_gateway", 2_276_800_779)

    internal val discoverPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "discover", 1_575_334_765)

    internal val queryExternalAddressPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "query_external_address", 201_670_096)

    internal val addPortMappingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "add_port_mapping", 818_314_583)

    internal val deletePortMappingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "delete_port_mapping", 3_444_187_325)

    internal val setDiscoverMulticastIfPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "set_discover_multicast_if", 83_702_148)

    internal val getDiscoverMulticastIfPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "get_discover_multicast_if", 201_670_096)

    internal val setDiscoverLocalPortPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "set_discover_local_port", 1_286_410_249)

    internal val getDiscoverLocalPortPtr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "get_discover_local_port", 3_905_245_786)

    internal val setDiscoverIpv6Ptr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "set_discover_ipv6", 2_586_408_642)

    internal val isDiscoverIpv6Ptr: VoidPtr =
        TypeManager.getMethodBindPtr("UPNP", "is_discover_ipv6", 36_873_697)
  }
}
