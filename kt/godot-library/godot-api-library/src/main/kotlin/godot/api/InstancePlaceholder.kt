...
public open class InstancePlaceholder internal constructor() : Node() {
  ...
  public object MethodBindings {
    internal val getStoredValuesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InstancePlaceholder", "get_stored_values", 2_230_153_369)

    internal val createInstancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("InstancePlaceholder", "create_instance", 3_794_612_210)

    internal val getInstancePathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InstancePlaceholder", "get_instance_path", 201_670_096)
  }
}
