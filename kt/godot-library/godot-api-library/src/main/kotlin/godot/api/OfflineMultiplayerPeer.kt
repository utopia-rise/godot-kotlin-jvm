 ...
 *
 * This means that the [SceneTree] will act as the multiplayer authority by default. Calls to [MultiplayerAPI.isServer] will return `true`, and calls to [MultiplayerAPI.getUniqueId] will return [MultiplayerPeer.TARGET_PEER_SERVER].
 */
@GodotBaseType
