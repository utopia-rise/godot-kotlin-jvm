...
public open class OpenXRInterface : XRInterface() {
  ...
  public final fun setRenderTargetSizeMultiplier(multiplier: Double) {
  ...
  public final fun setFoveationLevel(foveationLevel: Int) {
  ...
  public final fun setFoveationDynamic(foveationDynamic: Boolean) {
   ...
   */
  public final fun setActionSetActive(name: String, active: Boolean) {
   ...
   */
  public final fun setMotionRange(hand: Hand, motionRange: HandMotionRange) {
  ...
  public object MethodBindings {
    internal val getDisplayRefreshRatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_display_refresh_rate", 1_740_695_150)

    internal val setDisplayRefreshRatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "set_display_refresh_rate", 373_806_689)

    internal val getRenderTargetSizeMultiplierPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_render_target_size_multiplier", 1_740_695_150)

    internal val setRenderTargetSizeMultiplierPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "set_render_target_size_multiplier", 373_806_689)

    internal val isFoveationSupportedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "is_foveation_supported", 36_873_697)

    internal val getFoveationLevelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_foveation_level", 3_905_245_786)

    internal val setFoveationLevelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "set_foveation_level", 1_286_410_249)

    internal val getFoveationDynamicPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_foveation_dynamic", 36_873_697)

    internal val setFoveationDynamicPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "set_foveation_dynamic", 2_586_408_642)

    internal val isActionSetActivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "is_action_set_active", 3_927_539_163)

    internal val setActionSetActivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "set_action_set_active", 2_678_287_736)

    internal val getActionSetsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_action_sets", 3_995_934_104)

    internal val getAvailableDisplayRefreshRatesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_available_display_refresh_rates", 3_995_934_104)

    internal val setMotionRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "set_motion_range", 855_158_159)

    internal val getMotionRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_motion_range", 3_955_838_114)

    internal val getHandTrackingSourcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_hand_tracking_source", 4_092_421_202)

    internal val getHandJointFlagsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_hand_joint_flags", 720_567_706)

    internal val getHandJointRotationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_hand_joint_rotation", 1_974_618_321)

    internal val getHandJointPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_hand_joint_position", 3_529_194_242)

    internal val getHandJointRadiusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_hand_joint_radius", 901_522_724)

    internal val getHandJointLinearVelocityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_hand_joint_linear_velocity", 3_529_194_242)

    internal val getHandJointAngularVelocityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_hand_joint_angular_velocity", 3_529_194_242)

    internal val isHandTrackingSupportedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "is_hand_tracking_supported", 2_240_911_060)

    internal val isHandInteractionSupportedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "is_hand_interaction_supported", 36_873_697)

    internal val isEyeGazeInteractionSupportedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "is_eye_gaze_interaction_supported", 2_240_911_060)

    internal val getVrsMinRadiusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_vrs_min_radius", 1_740_695_150)

    internal val setVrsMinRadiusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "set_vrs_min_radius", 373_806_689)

    internal val getVrsStrengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "get_vrs_strength", 1_740_695_150)

    internal val setVrsStrengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRInterface", "set_vrs_strength", 373_806_689)
  }
}
