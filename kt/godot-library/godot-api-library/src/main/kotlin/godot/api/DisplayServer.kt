...
import godot.clipboardGetImagePtr
import godot.clipboardGetPrimaryPtr
import godot.clipboardGetPtr
import godot.clipboardHasImagePtr
import godot.clipboardHasPtr
import godot.clipboardSetPrimaryPtr
import godot.clipboardSetPtr
...
import godot.createStatusIndicatorPtr
import godot.cursorGetShapePtr
import godot.cursorSetCustomImagePtr
import godot.cursorSetShapePtr
import godot.deleteStatusIndicatorPtr
import godot.dialogInputTextPtr
import godot.dialogShowPtr
import godot.enableForStealingFocusPtr
import godot.fileDialogShowPtr
import godot.fileDialogWithOptionsShowPtr
import godot.forceProcessAndDropEventsPtr
import godot.getAccentColorPtr
import godot.getBaseColorPtr
import godot.getDisplayCutoutsPtr
import godot.getDisplaySafeAreaPtr
import godot.getKeyboardFocusScreenPtr
import godot.getNamePtr
import godot.getPrimaryScreenPtr
import godot.getScreenCountPtr
import godot.getScreenFromRectPtr
import godot.getSwapCancelOkPtr
import godot.getWindowAtScreenPositionPtr
import godot.getWindowListPtr
import godot.globalMenuAddCheckItemPtr
import godot.globalMenuAddIconCheckItemPtr
import godot.globalMenuAddIconItemPtr
import godot.globalMenuAddIconRadioCheckItemPtr
import godot.globalMenuAddItemPtr
import godot.globalMenuAddMultistateItemPtr
import godot.globalMenuAddRadioCheckItemPtr
import godot.globalMenuAddSeparatorPtr
import godot.globalMenuAddSubmenuItemPtr
import godot.globalMenuClearPtr
import godot.globalMenuGetItemAcceleratorPtr
import godot.globalMenuGetItemCallbackPtr
import godot.globalMenuGetItemCountPtr
import godot.globalMenuGetItemIconPtr
import godot.globalMenuGetItemIndentationLevelPtr
import godot.globalMenuGetItemIndexFromTagPtr
import godot.globalMenuGetItemIndexFromTextPtr
import godot.globalMenuGetItemKeyCallbackPtr
import godot.globalMenuGetItemMaxStatesPtr
import godot.globalMenuGetItemStatePtr
import godot.globalMenuGetItemSubmenuPtr
import godot.globalMenuGetItemTagPtr
import godot.globalMenuGetItemTextPtr
import godot.globalMenuGetItemTooltipPtr
import godot.globalMenuGetSystemMenuRootsPtr
import godot.globalMenuIsItemCheckablePtr
import godot.globalMenuIsItemCheckedPtr
import godot.globalMenuIsItemDisabledPtr
import godot.globalMenuIsItemHiddenPtr
import godot.globalMenuIsItemRadioCheckablePtr
import godot.globalMenuRemoveItemPtr
import godot.globalMenuSetItemAcceleratorPtr
import godot.globalMenuSetItemCallbackPtr
import godot.globalMenuSetItemCheckablePtr
import godot.globalMenuSetItemCheckedPtr
import godot.globalMenuSetItemDisabledPtr
import godot.globalMenuSetItemHiddenPtr
import godot.globalMenuSetItemHoverCallbacksPtr
import godot.globalMenuSetItemIconPtr
import godot.globalMenuSetItemIndentationLevelPtr
import godot.globalMenuSetItemKeyCallbackPtr
import godot.globalMenuSetItemMaxStatesPtr
import godot.globalMenuSetItemRadioCheckablePtr
import godot.globalMenuSetItemStatePtr
import godot.globalMenuSetItemSubmenuPtr
import godot.globalMenuSetItemTagPtr
import godot.globalMenuSetItemTextPtr
import godot.globalMenuSetItemTooltipPtr
import godot.globalMenuSetPopupCallbacksPtr
import godot.hasAdditionalOutputsPtr
import godot.hasFeaturePtr
import godot.helpSetSearchCallbacksPtr
import godot.imeGetSelectionPtr
import godot.imeGetTextPtr
import godot.isDarkModePtr
import godot.isDarkModeSupportedPtr
import godot.isTouchscreenAvailablePtr
import godot.isWindowTransparencyAvailablePtr
import godot.keyboardGetCurrentLayoutPtr
import godot.keyboardGetKeycodeFromPhysicalPtr
import godot.keyboardGetLabelFromPhysicalPtr
import godot.keyboardGetLayoutCountPtr
import godot.keyboardGetLayoutLanguagePtr
import godot.keyboardGetLayoutNamePtr
import godot.keyboardSetCurrentLayoutPtr
import godot.mouseGetButtonStatePtr
import godot.mouseGetModePtr
import godot.mouseGetPositionPtr
import godot.mouseSetModePtr
import godot.processEventsPtr
import godot.registerAdditionalOutputPtr
import godot.screenGetDpiPtr
import godot.screenGetImagePtr
import godot.screenGetMaxScalePtr
import godot.screenGetOrientationPtr
import godot.screenGetPixelPtr
import godot.screenGetPositionPtr
import godot.screenGetRefreshRatePtr
import godot.screenGetScalePtr
import godot.screenGetSizePtr
import godot.screenGetUsableRectPtr
import godot.screenIsKeptOnPtr
import godot.screenSetKeepOnPtr
import godot.screenSetOrientationPtr
import godot.setIconPtr
import godot.setNativeIconPtr
import godot.setSystemThemeChangeCallbackPtr
import godot.statusIndicatorGetRectPtr
import godot.statusIndicatorSetCallbackPtr
import godot.statusIndicatorSetIconPtr
import godot.statusIndicatorSetMenuPtr
import godot.statusIndicatorSetTooltipPtr
import godot.tabletGetCurrentDriverPtr
import godot.tabletGetDriverCountPtr
import godot.tabletGetDriverNamePtr
import godot.tabletSetCurrentDriverPtr
import godot.ttsGetVoicesForLanguagePtr
import godot.ttsGetVoicesPtr
import godot.ttsIsPausedPtr
import godot.ttsIsSpeakingPtr
import godot.ttsPausePtr
import godot.ttsResumePtr
import godot.ttsSetUtteranceCallbackPtr
import godot.ttsSpeakPtr
import godot.ttsStopPtr
import godot.unregisterAdditionalOutputPtr
import godot.virtualKeyboardGetHeightPtr
import godot.virtualKeyboardHidePtr
import godot.virtualKeyboardShowPtr
import godot.warpMousePtr
import godot.windowCanDrawPtr
import godot.windowGetActivePopupPtr
import godot.windowGetAttachedInstanceIdPtr
import godot.windowGetCurrentScreenPtr
import godot.windowGetFlagPtr
import godot.windowGetMaxSizePtr
import godot.windowGetMinSizePtr
import godot.windowGetModePtr
import godot.windowGetNativeHandlePtr
import godot.windowGetPopupSafeRectPtr
import godot.windowGetPositionPtr
import godot.windowGetPositionWithDecorationsPtr
import godot.windowGetSafeTitleMarginsPtr
import godot.windowGetSizePtr
import godot.windowGetSizeWithDecorationsPtr
import godot.windowGetTitleSizePtr
import godot.windowGetVsyncModePtr
import godot.windowIsFocusedPtr
import godot.windowIsMaximizeAllowedPtr
import godot.windowMaximizeOnTitleDblClickPtr
import godot.windowMinimizeOnTitleDblClickPtr
import godot.windowMoveToForegroundPtr
import godot.windowRequestAttentionPtr
import godot.windowSetCurrentScreenPtr
import godot.windowSetDropFilesCallbackPtr
import godot.windowSetExclusivePtr
import godot.windowSetFlagPtr
import godot.windowSetImeActivePtr
import godot.windowSetImePositionPtr
import godot.windowSetInputEventCallbackPtr
import godot.windowSetInputTextCallbackPtr
import godot.windowSetMaxSizePtr
import godot.windowSetMinSizePtr
import godot.windowSetModePtr
import godot.windowSetMousePassthroughPtr
import godot.windowSetPopupSafeRectPtr
import godot.windowSetPositionPtr
import godot.windowSetRectChangedCallbackPtr
import godot.windowSetSizePtr
import godot.windowSetTitlePtr
import godot.windowSetTransientPtr
import godot.windowSetVsyncModePtr
import godot.windowSetWindowButtonsOffsetPtr
import godot.windowSetWindowEventCallbackPtr
import kotlin.Any
...
public object DisplayServer : Object() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    getSingleton(this, ENGINECLASS_DISPLAYSERVER)
  }
