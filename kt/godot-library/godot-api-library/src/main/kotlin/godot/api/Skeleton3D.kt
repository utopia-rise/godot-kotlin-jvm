...
import godot.addBonePtr
import godot.clearBonesGlobalPoseOverridePtr
import godot.clearBonesPtr
...
import godot.createSkinFromRestTransformsPtr
import godot.findBonePtr
import godot.forceUpdateAllBoneTransformsPtr
import godot.forceUpdateBoneChildTransformPtr
import godot.getAnimatePhysicalBonesPtr
import godot.getBoneChildrenPtr
import godot.getBoneCountPtr
import godot.getBoneGlobalPoseNoOverridePtr
import godot.getBoneGlobalPoseOverridePtr
import godot.getBoneGlobalPosePtr
import godot.getBoneGlobalRestPtr
import godot.getBoneNamePtr
import godot.getBoneParentPtr
import godot.getBonePosePositionPtr
import godot.getBonePosePtr
import godot.getBonePoseRotationPtr
import godot.getBonePoseScalePtr
import godot.getBoneRestPtr
import godot.getConcatenatedBoneNamesPtr
import godot.getModifierCallbackModeProcessPtr
import godot.getMotionScalePtr
import godot.getParentlessBonesPtr
import godot.getVersionPtr
import godot.isBoneEnabledPtr
import godot.isShowRestOnlyPtr
import godot.localizeRestsPtr
...
import godot.registerSkinPtr
import godot.resetBonePosePtr
import godot.resetBonePosesPtr
import godot.setAnimatePhysicalBonesPtr
import godot.setBoneEnabledPtr
import godot.setBoneGlobalPoseOverridePtr
import godot.setBoneGlobalPosePtr
import godot.setBoneNamePtr
import godot.setBoneParentPtr
import godot.setBonePosePositionPtr
import godot.setBonePosePtr
import godot.setBonePoseRotationPtr
import godot.setBonePoseScalePtr
import godot.setBoneRestPtr
import godot.setModifierCallbackModeProcessPtr
import godot.setMotionScalePtr
import godot.setShowRestOnlyPtr
import godot.unparentBoneAndRestPtr
