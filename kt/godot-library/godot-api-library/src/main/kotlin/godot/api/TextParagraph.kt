...
import godot.drawDropcapOutlinePtr
import godot.drawDropcapPtr
import godot.drawLineOutlinePtr
import godot.drawLinePtr
import godot.drawOutlinePtr
import godot.drawPtr
import godot.getAlignmentPtr
import godot.getBreakFlagsPtr
import godot.getCustomPunctuationPtr
import godot.getDirectionPtr
import godot.getDropcapLinesPtr
import godot.getDropcapRidPtr
import godot.getDropcapSizePtr
import godot.getEllipsisCharPtr
import godot.getJustificationFlagsPtr
import godot.getLineAscentPtr
import godot.getLineCountPtr
import godot.getLineDescentPtr
import godot.getLineObjectRectPtr
import godot.getLineObjectsPtr
import godot.getLineRangePtr
import godot.getLineRidPtr
import godot.getLineSizePtr
import godot.getLineUnderlinePositionPtr
import godot.getLineUnderlineThicknessPtr
import godot.getLineWidthPtr
import godot.getMaxLinesVisiblePtr
import godot.getNonWrappedSizePtr
import godot.getOrientationPtr
import godot.getPreserveControlPtr
import godot.getPreserveInvalidPtr
import godot.getRidPtr
import godot.getSizePtr
import godot.getTextOverrunBehaviorPtr
import godot.getWidthPtr
import godot.hitTestPtr
import godot.resizeObjectPtr
import godot.setAlignmentPtr
import godot.setBidiOverridePtr
import godot.setBreakFlagsPtr
import godot.setCustomPunctuationPtr
import godot.setDirectionPtr
import godot.setDropcapPtr
import godot.setEllipsisCharPtr
import godot.setJustificationFlagsPtr
import godot.setMaxLinesVisiblePtr
import godot.setOrientationPtr
import godot.setPreserveControlPtr
import godot.setPreserveInvalidPtr
import godot.setTextOverrunBehaviorPtr
import godot.setWidthPtr
import godot.tabAlignPtr
import kotlin.Any
...
public open class TextParagraph : RefCounted() {
  ...
  public final fun setDropcap(
    ...
    TransferContext.callMethod(ptr, MethodBindings.setDropcapPtr, BOOL)
    return (TransferContext.readReturnValue(BOOL) as Boolean)
  }
  ...
  public final fun getLineObjects(line: Int): VariantArray<Any?> {
    TransferContext.writeArguments(LONG to line.toLong())
    TransferContext.callMethod(ptr, MethodBindings.getLineObjectsPtr, ARRAY)
  ...
  public final fun getLineObjectRect(line: Int, key: Any?): Rect2 {
    ...
    TransferContext.callMethod(ptr, MethodBindings.getLineObjectRectPtr, RECT2)
  ...
  public final fun getLineSize(line: Int): Vector2 {
    TransferContext.writeArguments(LONG to line.toLong())
    TransferContext.callMethod(ptr, MethodBindings.getLineSizePtr, VECTOR2)
    return (TransferContext.readReturnValue(VECTOR2) as Vector2)
  }
