...
public object Engine : Object() {
   ...
   *
   * If [ProjectSettings.display/window/vsync/vsyncMode] is **Enabled**, on monitors with variable refresh rate enabled (G-Sync/FreeSync), using an FPS limit a few frames lower than the monitor's refresh rate will [url=https://blurbusters.com/howto-low-lag-vsync-on/]reduce input lag while avoiding tearing[/url].
   *
  ...
  @JvmStatic
  public final fun setPhysicsTicksPerSecond(physicsTicksPerSecond: Int) {
  ...
  @JvmStatic
  public final fun setMaxPhysicsStepsPerFrame(maxPhysicsSteps: Int) {
  ...
  @JvmStatic
  public final fun setPhysicsJitterFix(physicsJitterFix: Double) {
  ...
  @JvmStatic
  public final fun setMaxFps(maxFps: Int) {
  ...
  @JvmStatic
  public final fun setTimeScale(timeScale: Double) {
   ...
   *
   * To detect whether the current build is 64-bit, or the type of architecture, don't use the architecture name. Instead, use [OS.hasFeature] to check for the `"64"` feature tag, or tags such as `"x86"` or `"arm"`. See the [url=$DOCS_URL/tutorials/export/feature_tags.html]Feature Tags[/url] documentation for more details.
   *
   ...
   */
  @JvmStatic
  public final fun registerSingleton(name: StringName, instance: Object?) {
   ...
   */
  @JvmStatic
  public final fun unregisterSingleton(name: StringName) {
    TransferContext.writeArguments(STRING_NAME to name)
  ...
  @JvmStatic
  public final fun setPrintToStdout(enabled: Boolean) {
  ...
  @JvmStatic
  public final fun setPrintErrorMessages(enabled: Boolean) {
    TransferContext.writeArguments(BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun registerSingleton(name: String, instance: Object?): Unit = registerSingleton(name.asCachedStringName(), instance)

  /**
   * Removes the singleton registered under [name]. The singleton object is *not* freed. Only works with user-defined singletons registered with [registerSingleton].
   */
  @JvmStatic
  public final fun unregisterSingleton(name: String): Unit = unregisterSingleton(name.asCachedStringName())

  public object MethodBindings {
    internal val setPhysicsTicksPerSecondPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "set_physics_ticks_per_second", 1_286_410_249)

    internal val getPhysicsTicksPerSecondPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_physics_ticks_per_second", 3_905_245_786)

    internal val setMaxPhysicsStepsPerFramePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "set_max_physics_steps_per_frame", 1_286_410_249)

    internal val getMaxPhysicsStepsPerFramePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_max_physics_steps_per_frame", 3_905_245_786)

    internal val setPhysicsJitterFixPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "set_physics_jitter_fix", 373_806_689)

    internal val getPhysicsJitterFixPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_physics_jitter_fix", 1_740_695_150)

    internal val getPhysicsInterpolationFractionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_physics_interpolation_fraction", 1_740_695_150)

    internal val setMaxFpsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "set_max_fps", 1_286_410_249)

    internal val getMaxFpsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_max_fps", 3_905_245_786)

    internal val setTimeScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "set_time_scale", 373_806_689)

    internal val getTimeScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_time_scale", 191_475_506)

    internal val getFramesDrawnPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_frames_drawn", 2_455_072_627)

    internal val getFramesPerSecondPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_frames_per_second", 1_740_695_150)

    internal val getPhysicsFramesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_physics_frames", 3_905_245_786)

    internal val getProcessFramesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_process_frames", 3_905_245_786)

    internal val getMainLoopPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_main_loop", 1_016_888_095)

    internal val getVersionInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_version_info", 3_102_165_223)

    internal val getAuthorInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_author_info", 3_102_165_223)

    internal val getCopyrightInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_copyright_info", 3_995_934_104)

    internal val getDonorInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_donor_info", 3_102_165_223)

    internal val getLicenseInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_license_info", 3_102_165_223)

    internal val getLicenseTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_license_text", 201_670_096)

    internal val getArchitectureNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_architecture_name", 201_670_096)

    internal val isInPhysicsFramePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "is_in_physics_frame", 36_873_697)

    internal val hasSingletonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "has_singleton", 2_619_796_661)

    internal val getSingletonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_singleton", 1_371_597_918)

    internal val registerSingletonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "register_singleton", 965_313_290)

    internal val unregisterSingletonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "unregister_singleton", 3_304_788_590)

    internal val getSingletonListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_singleton_list", 1_139_954_409)

    internal val registerScriptLanguagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "register_script_language", 1_850_254_898)

    internal val unregisterScriptLanguagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "unregister_script_language", 1_850_254_898)

    internal val getScriptLanguageCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_script_language_count", 2_455_072_627)

    internal val getScriptLanguagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_script_language", 2_151_255_799)

    internal val isEditorHintPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "is_editor_hint", 36_873_697)

    internal val isEmbeddedInEditorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "is_embedded_in_editor", 36_873_697)

    internal val getWriteMoviePathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "get_write_movie_path", 201_670_096)

    internal val setPrintToStdoutPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "set_print_to_stdout", 2_586_408_642)

    internal val isPrintingToStdoutPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "is_printing_to_stdout", 36_873_697)

    internal val setPrintErrorMessagesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "set_print_error_messages", 2_586_408_642)

    internal val isPrintingErrorMessagesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Engine", "is_printing_error_messages", 36_873_697)
  }
}
