 ...
 *
 * The [ReflectionProbe] is used to create high-quality reflections at a low performance cost (when [updateMode] is [UPDATE_ONCE]). [ReflectionProbe]s can be blended together and with the rest of the scene smoothly. [ReflectionProbe]s can also be combined with [VoxelGI], SDFGI ([Environment.sdfgiEnabled]) and screen-space reflections ([Environment.ssrEnabled]) to get more accurate reflections in specific areas. [ReflectionProbe]s render all objects within their [cullMask], so updating them can be quite expensive. It is best to update them once with the important static objects and then leave them as-is.
 *
...
public open class ReflectionProbe : VisualInstance3D() {
  ...
  /**
   * The maximum distance away from the [ReflectionProbe] an object can be before it is culled. Decrease this to improve performance, especially when using the [UPDATE_ALWAYS] [updateMode].
   *
  ...
  /**
   * The custom ambient color to use within the [ReflectionProbe]'s box defined by its [size]. Only effective if [ambientMode] is [AMBIENT_COLOR].
   *
   * **Warning:**
   * Be careful when trying to modify a local [copy](https://godot-kotl.in/en/stable/user-guide/api-differences/#core-types) obtained from this getter.
   * Mutating it alone won't have any effect on the actual property, it has to be reassigned again afterward.
  ...
  /**
   * The custom ambient color energy to use within the [ReflectionProbe]'s box defined by its [size]. Only effective if [ambientMode] is [AMBIENT_COLOR].
   */
  ...
  public final fun setBlendDistance(blendDistance: Float) {
  ...
  public final fun setAmbientMode(ambient: AmbientMode) {
  ...
  public final fun setAmbientColor(ambient: Color) {
  ...
  public final fun setAmbientColorEnergy(ambientEnergy: Float) {
  ...
  public final fun setMaxDistance(maxDistance: Float) {
  ...
  public final fun setMeshLodThreshold(ratio: Float) {
  ...
  public final fun setOriginOffset(originOffset: Vector3) {
  ...
  public final fun setAsInterior(enable: Boolean) {
  ...
  public final fun setEnableBoxProjection(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
  ...
  public final fun setEnableShadows(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
  ...
  public final fun setCullMask(layers: Long) {
  ...
  public final fun setReflectionMask(layers: Long) {
    TransferContext.writeArguments(LONG to layers)
  ...
  public object MethodBindings {
    internal val setIntensityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_intensity", 373_806_689)

    internal val getIntensityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_intensity", 1_740_695_150)

    internal val setBlendDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_blend_distance", 373_806_689)

    internal val getBlendDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_blend_distance", 1_740_695_150)

    internal val setAmbientModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_ambient_mode", 1_748_981_278)

    internal val getAmbientModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_ambient_mode", 1_014_607_621)

    internal val setAmbientColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_ambient_color", 2_920_490_490)

    internal val getAmbientColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_ambient_color", 3_444_240_500)

    internal val setAmbientColorEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_ambient_color_energy", 373_806_689)

    internal val getAmbientColorEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_ambient_color_energy", 1_740_695_150)

    internal val setMaxDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_max_distance", 373_806_689)

    internal val getMaxDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_max_distance", 1_740_695_150)

    internal val setMeshLodThresholdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_mesh_lod_threshold", 373_806_689)

    internal val getMeshLodThresholdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_mesh_lod_threshold", 1_740_695_150)

    internal val setSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_size", 3_460_891_852)

    internal val getSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_size", 3_360_562_783)

    internal val setOriginOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_origin_offset", 3_460_891_852)

    internal val getOriginOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_origin_offset", 3_360_562_783)

    internal val setAsInteriorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_as_interior", 2_586_408_642)

    internal val isSetAsInteriorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "is_set_as_interior", 36_873_697)

    internal val setEnableBoxProjectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_enable_box_projection", 2_586_408_642)

    internal val isBoxProjectionEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "is_box_projection_enabled", 36_873_697)

    internal val setEnableShadowsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_enable_shadows", 2_586_408_642)

    internal val areShadowsEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "are_shadows_enabled", 36_873_697)

    internal val setCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_cull_mask", 1_286_410_249)

    internal val getCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_cull_mask", 3_905_245_786)

    internal val setReflectionMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_reflection_mask", 1_286_410_249)

    internal val getReflectionMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_reflection_mask", 3_905_245_786)

    internal val setUpdateModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "set_update_mode", 4_090_221_187)

    internal val getUpdateModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("ReflectionProbe", "get_update_mode", 2_367_550_552)
  }
}
