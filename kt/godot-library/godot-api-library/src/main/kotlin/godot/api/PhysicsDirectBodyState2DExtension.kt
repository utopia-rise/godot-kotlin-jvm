...
public open class PhysicsDirectBodyState2DExtension : PhysicsDirectBodyState2D() {
   ...
   */
  public open fun _setLinearVelocity(velocity: Vector2) {
   ...
   */
  public open fun _setAngularVelocity(velocity: Float) {
   ...
   */
  public open fun _setTransform(transform: Transform2D) {
   ...
   */
  public open fun _applyCentralImpulse(impulse: Vector2) {
   ...
   */
  public open fun _applyImpulse(impulse: Vector2, position: Vector2) {
   ...
   */
  public open fun _applyTorqueImpulse(impulse: Float) {
   ...
   */
  public open fun _applyCentralForce(force: Vector2) {
   ...
   */
  public open fun _applyForce(force: Vector2, position: Vector2) {
   ...
   */
  public open fun _applyTorque(torque: Float) {
   ...
   */
  public open fun _addConstantCentralForce(force: Vector2) {
   ...
   */
  public open fun _addConstantForce(force: Vector2, position: Vector2) {
   ...
   */
  public open fun _addConstantTorque(torque: Float) {
   ...
   */
  public open fun _setConstantForce(force: Vector2) {
   ...
   */
  public open fun _setConstantTorque(torque: Float) {
