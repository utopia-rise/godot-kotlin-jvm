...
import godot.addTrackPtr
import godot.animationTrackGetKeyAnimationPtr
import godot.animationTrackInsertKeyPtr
import godot.animationTrackSetKeyAnimationPtr
import godot.audioTrackGetKeyEndOffsetPtr
import godot.audioTrackGetKeyStartOffsetPtr
import godot.audioTrackGetKeyStreamPtr
import godot.audioTrackInsertKeyPtr
import godot.audioTrackIsUseBlendPtr
import godot.audioTrackSetKeyEndOffsetPtr
import godot.audioTrackSetKeyStartOffsetPtr
import godot.audioTrackSetKeyStreamPtr
import godot.audioTrackSetUseBlendPtr
import godot.bezierTrackGetKeyInHandlePtr
import godot.bezierTrackGetKeyOutHandlePtr
import godot.bezierTrackGetKeyValuePtr
import godot.bezierTrackInsertKeyPtr
import godot.bezierTrackInterpolatePtr
import godot.bezierTrackSetKeyInHandlePtr
import godot.bezierTrackSetKeyOutHandlePtr
import godot.bezierTrackSetKeyValuePtr
import godot.blendShapeTrackInsertKeyPtr
import godot.blendShapeTrackInterpolatePtr
import godot.clearPtr
import godot.common.interop.VoidPtr
import godot.compressPtr
import godot.copyTrackPtr
...
import godot.findTrackPtr
import godot.getLengthPtr
import godot.getLoopModePtr
import godot.getStepPtr
import godot.getTrackCountPtr
import godot.isCaptureIncludedPtr
import godot.methodTrackGetNamePtr
import godot.methodTrackGetParamsPtr
import godot.positionTrackInsertKeyPtr
import godot.positionTrackInterpolatePtr
import godot.removeTrackPtr
import godot.rotationTrackInsertKeyPtr
import godot.rotationTrackInterpolatePtr
import godot.scaleTrackInsertKeyPtr
import godot.scaleTrackInterpolatePtr
import godot.setLengthPtr
import godot.setLoopModePtr
import godot.setStepPtr
import godot.trackFindKeyPtr
import godot.trackGetInterpolationLoopWrapPtr
import godot.trackGetInterpolationTypePtr
import godot.trackGetKeyCountPtr
import godot.trackGetKeyTimePtr
import godot.trackGetKeyTransitionPtr
import godot.trackGetKeyValuePtr
import godot.trackGetPathPtr
import godot.trackGetTypePtr
import godot.trackInsertKeyPtr
import godot.trackIsCompressedPtr
import godot.trackIsEnabledPtr
import godot.trackIsImportedPtr
import godot.trackMoveDownPtr
import godot.trackMoveToPtr
import godot.trackMoveUpPtr
import godot.trackRemoveKeyAtTimePtr
import godot.trackRemoveKeyPtr
import godot.trackSetEnabledPtr
import godot.trackSetImportedPtr
import godot.trackSetInterpolationLoopWrapPtr
import godot.trackSetInterpolationTypePtr
import godot.trackSetKeyTimePtr
import godot.trackSetKeyTransitionPtr
import godot.trackSetKeyValuePtr
import godot.trackSetPathPtr
import godot.trackSwapPtr
import godot.valueTrackGetUpdateModePtr
import godot.valueTrackInterpolatePtr
import godot.valueTrackSetUpdateModePtr
import kotlin.Any
