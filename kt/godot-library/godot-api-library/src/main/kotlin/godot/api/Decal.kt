...
public open class Decal : VisualInstance3D() {
   ...
   * ```
   */
  public final fun setTexture(type: DecalTexture, texture: Texture2D?) {
  ...
  public final fun setEmissionEnergy(energy: Float) {
  ...
  public final fun setAlbedoMix(energy: Float) {
    TransferContext.writeArguments(DOUBLE to energy.toDouble())
  ...
  public final fun setUpperFade(fade: Float) {
  ...
  public final fun setLowerFade(fade: Float) {
    TransferContext.writeArguments(DOUBLE to fade.toDouble())
  ...
  public final fun setNormalFade(fade: Float) {
    TransferContext.writeArguments(DOUBLE to fade.toDouble())
  ...
  public object MethodBindings {
    internal val setSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_size", 3_460_891_852)

    internal val getSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_size", 3_360_562_783)

    internal val setTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_texture", 2_086_764_391)

    internal val getTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_texture", 3_244_119_503)

    internal val setEmissionEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_emission_energy", 373_806_689)

    internal val getEmissionEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_emission_energy", 1_740_695_150)

    internal val setAlbedoMixPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_albedo_mix", 373_806_689)

    internal val getAlbedoMixPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_albedo_mix", 1_740_695_150)

    internal val setModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_modulate", 2_920_490_490)

    internal val getModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_modulate", 3_444_240_500)

    internal val setUpperFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_upper_fade", 373_806_689)

    internal val getUpperFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_upper_fade", 1_740_695_150)

    internal val setLowerFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_lower_fade", 373_806_689)

    internal val getLowerFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_lower_fade", 1_740_695_150)

    internal val setNormalFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_normal_fade", 373_806_689)

    internal val getNormalFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_normal_fade", 1_740_695_150)

    internal val setEnableDistanceFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_enable_distance_fade", 2_586_408_642)

    internal val isDistanceFadeEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "is_distance_fade_enabled", 36_873_697)

    internal val setDistanceFadeBeginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_distance_fade_begin", 373_806_689)

    internal val getDistanceFadeBeginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_distance_fade_begin", 1_740_695_150)

    internal val setDistanceFadeLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_distance_fade_length", 373_806_689)

    internal val getDistanceFadeLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_distance_fade_length", 1_740_695_150)

    internal val setCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "set_cull_mask", 1_286_410_249)

    internal val getCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Decal", "get_cull_mask", 3_905_245_786)
  }
}
