...
public open class TextServerExtension : TextServer() {
   ...
   */
  public open fun _freeRid(rid: RID) {
   ...
   */
  public open fun _fontSetFixedSize(fontRid: RID, fixedSize: Long) {
   ...
   */
  public open fun _fontSetFixedSizeScaleMode(fontRid: RID, fixedSizeScaleMode: TextServer.FixedSizeScaleMode) {
   ...
   */
  public open fun _fontClearSizeCache(fontRid: RID) {
   ...
   */
  public open fun _fontRemoveSizeCache(fontRid: RID, size: Vector2i) {
   ...
   */
  public open fun _fontClearTextures(fontRid: RID, size: Vector2i) {
   ...
   */
  public open fun _fontClearGlyphs(fontRid: RID, size: Vector2i) {
   ...
   */
  public open fun _createShapedText(direction: TextServer.Direction, orientation: TextServer.Orientation): RID {
   ...
   */
  public open fun _shapedTextClear(shaped: RID) {
