...
public open class SeparationRayShape3D : Shape3D() {
  ...
  public object MethodBindings {
    internal val setLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SeparationRayShape3D", "set_length", 373_806_689)

    internal val getLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SeparationRayShape3D", "get_length", 1_740_695_150)

    internal val setSlideOnSlopePtr: VoidPtr =
        TypeManager.getMethodBindPtr("SeparationRayShape3D", "set_slide_on_slope", 2_586_408_642)

    internal val getSlideOnSlopePtr: VoidPtr =
        TypeManager.getMethodBindPtr("SeparationRayShape3D", "get_slide_on_slope", 36_873_697)
  }
}
