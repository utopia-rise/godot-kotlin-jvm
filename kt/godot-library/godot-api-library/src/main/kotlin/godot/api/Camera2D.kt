...
import godot.forceUpdateScrollPtr
import godot.getAnchorModePtr
import godot.getCustomViewportPtr
import godot.getDragHorizontalOffsetPtr
import godot.getDragMarginPtr
import godot.getDragVerticalOffsetPtr
import godot.getLimitPtr
import godot.getOffsetPtr
import godot.getPositionSmoothingSpeedPtr
import godot.getProcessCallbackPtr
import godot.getRotationSmoothingSpeedPtr
import godot.getScreenCenterPositionPtr
import godot.getTargetPositionPtr
import godot.getZoomPtr
import godot.isCurrentPtr
import godot.isDragHorizontalEnabledPtr
import godot.isDragVerticalEnabledPtr
import godot.isEnabledPtr
import godot.isIgnoringRotationPtr
import godot.isLimitDrawingEnabledPtr
import godot.isLimitSmoothingEnabledPtr
import godot.isMarginDrawingEnabledPtr
import godot.isPositionSmoothingEnabledPtr
import godot.isRotationSmoothingEnabledPtr
import godot.isScreenDrawingEnabledPtr
import godot.makeCurrentPtr
import godot.resetSmoothingPtr
import godot.setAnchorModePtr
import godot.setCustomViewportPtr
import godot.setDragHorizontalEnabledPtr
import godot.setDragHorizontalOffsetPtr
import godot.setDragMarginPtr
import godot.setDragVerticalEnabledPtr
import godot.setDragVerticalOffsetPtr
import godot.setEnabledPtr
import godot.setIgnoreRotationPtr
import godot.setLimitDrawingEnabledPtr
import godot.setLimitPtr
import godot.setLimitSmoothingEnabledPtr
import godot.setMarginDrawingEnabledPtr
import godot.setOffsetPtr
import godot.setPositionSmoothingEnabledPtr
import godot.setPositionSmoothingSpeedPtr
import godot.setProcessCallbackPtr
import godot.setRotationSmoothingEnabledPtr
import godot.setRotationSmoothingSpeedPtr
import godot.setScreenDrawingEnabledPtr
...
private const val ENGINECLASS_CAMERA2D: Int = 161
