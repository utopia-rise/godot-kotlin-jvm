...
public open class RootMotionView : VisualInstance3D() {
  ...
  public final fun setAnimationPath(path: NodePath) {
  ...
  public final fun setCellSize(size: Float) {
  ...
  public final fun setRadius(size: Float) {
    TransferContext.writeArguments(DOUBLE to size.toDouble())
  ...
  public final fun setZeroY(enable: Boolean) {
  ...
  public object MethodBindings {
    internal val setAnimationPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "set_animation_path", 1_348_162_250)

    internal val getAnimationPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "get_animation_path", 4_075_236_667)

    internal val setColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "set_color", 2_920_490_490)

    internal val getColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "get_color", 3_444_240_500)

    internal val setCellSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "set_cell_size", 373_806_689)

    internal val getCellSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "get_cell_size", 1_740_695_150)

    internal val setRadiusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "set_radius", 373_806_689)

    internal val getRadiusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "get_radius", 1_740_695_150)

    internal val setZeroYPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "set_zero_y", 2_586_408_642)

    internal val getZeroYPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RootMotionView", "get_zero_y", 36_873_697)
  }
}
