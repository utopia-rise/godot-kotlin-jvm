...
import godot.getBasePtr
import godot.getInstancePtr
import godot.getLayerMaskPtr
import godot.getLayerMaskValuePtr
import godot.getSortingOffsetPtr
import godot.isSortingUseAabbCenterPtr
import godot.setBasePtr
import godot.setLayerMaskPtr
import godot.setLayerMaskValuePtr
import godot.setSortingOffsetPtr
import godot.setSortingUseAabbCenterPtr
...
private const val ENGINECLASS_VISUALINSTANCE3D: Int = 704
...
public open class VisualInstance3D : Node3D() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_VISUALINSTANCE3D, scriptIndex)
  }
