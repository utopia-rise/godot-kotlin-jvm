...
import godot.createFontLinkedVariationPtr
import godot.createFontPtr
import godot.createShapedTextPtr
import godot.drawHexCodeBoxPtr
import godot.fontClearGlyphsPtr
import godot.fontClearKerningMapPtr
import godot.fontClearSizeCachePtr
import godot.fontClearTexturesPtr
import godot.fontDrawGlyphOutlinePtr
import godot.fontDrawGlyphPtr
import godot.fontGetAntialiasingPtr
import godot.fontGetAscentPtr
import godot.fontGetBaselineOffsetPtr
import godot.fontGetCharFromGlyphIndexPtr
import godot.fontGetDescentPtr
import godot.fontGetDisableEmbeddedBitmapsPtr
import godot.fontGetEmboldenPtr
import godot.fontGetFaceCountPtr
import godot.fontGetFaceIndexPtr
import godot.fontGetFixedSizePtr
import godot.fontGetFixedSizeScaleModePtr
import godot.fontGetGenerateMipmapsPtr
import godot.fontGetGlobalOversamplingPtr
import godot.fontGetGlyphAdvancePtr
import godot.fontGetGlyphContoursPtr
import godot.fontGetGlyphIndexPtr
import godot.fontGetGlyphListPtr
import godot.fontGetGlyphOffsetPtr
import godot.fontGetGlyphSizePtr
import godot.fontGetGlyphTextureIdxPtr
import godot.fontGetGlyphTextureRidPtr
import godot.fontGetGlyphTextureSizePtr
import godot.fontGetGlyphUvRectPtr
import godot.fontGetHintingPtr
import godot.fontGetKerningListPtr
import godot.fontGetKerningPtr
import godot.fontGetLanguageSupportOverridePtr
import godot.fontGetLanguageSupportOverridesPtr
import godot.fontGetMsdfPixelRangePtr
import godot.fontGetMsdfSizePtr
import godot.fontGetNamePtr
import godot.fontGetOpentypeFeatureOverridesPtr
import godot.fontGetOtNameStringsPtr
import godot.fontGetOversamplingPtr
import godot.fontGetScalePtr
import godot.fontGetScriptSupportOverridePtr
import godot.fontGetScriptSupportOverridesPtr
import godot.fontGetSizeCacheListPtr
import godot.fontGetSpacingPtr
import godot.fontGetStretchPtr
import godot.fontGetStyleNamePtr
import godot.fontGetStylePtr
import godot.fontGetSubpixelPositioningPtr
import godot.fontGetSupportedCharsPtr
import godot.fontGetTextureCountPtr
import godot.fontGetTextureImagePtr
import godot.fontGetTextureOffsetsPtr
import godot.fontGetTransformPtr
import godot.fontGetUnderlinePositionPtr
import godot.fontGetUnderlineThicknessPtr
import godot.fontGetVariationCoordinatesPtr
import godot.fontGetWeightPtr
import godot.fontHasCharPtr
import godot.fontIsAllowSystemFallbackPtr
import godot.fontIsForceAutohinterPtr
import godot.fontIsLanguageSupportedPtr
import godot.fontIsMultichannelSignedDistanceFieldPtr
import godot.fontIsScriptSupportedPtr
import godot.fontRemoveGlyphPtr
import godot.fontRemoveKerningPtr
import godot.fontRemoveLanguageSupportOverridePtr
import godot.fontRemoveScriptSupportOverridePtr
import godot.fontRemoveSizeCachePtr
import godot.fontRemoveTexturePtr
import godot.fontRenderGlyphPtr
import godot.fontRenderRangePtr
import godot.fontSetAllowSystemFallbackPtr
import godot.fontSetAntialiasingPtr
import godot.fontSetAscentPtr
import godot.fontSetBaselineOffsetPtr
import godot.fontSetDataPtr
import godot.fontSetDescentPtr
import godot.fontSetDisableEmbeddedBitmapsPtr
import godot.fontSetEmboldenPtr
import godot.fontSetFaceIndexPtr
import godot.fontSetFixedSizePtr
import godot.fontSetFixedSizeScaleModePtr
import godot.fontSetForceAutohinterPtr
import godot.fontSetGenerateMipmapsPtr
import godot.fontSetGlobalOversamplingPtr
import godot.fontSetGlyphAdvancePtr
import godot.fontSetGlyphOffsetPtr
import godot.fontSetGlyphSizePtr
import godot.fontSetGlyphTextureIdxPtr
import godot.fontSetGlyphUvRectPtr
import godot.fontSetHintingPtr
import godot.fontSetKerningPtr
import godot.fontSetLanguageSupportOverridePtr
import godot.fontSetMsdfPixelRangePtr
import godot.fontSetMsdfSizePtr
import godot.fontSetMultichannelSignedDistanceFieldPtr
import godot.fontSetNamePtr
import godot.fontSetOpentypeFeatureOverridesPtr
import godot.fontSetOversamplingPtr
import godot.fontSetScalePtr
import godot.fontSetScriptSupportOverridePtr
import godot.fontSetSpacingPtr
import godot.fontSetStretchPtr
import godot.fontSetStyleNamePtr
import godot.fontSetStylePtr
import godot.fontSetSubpixelPositioningPtr
import godot.fontSetTextureImagePtr
import godot.fontSetTextureOffsetsPtr
import godot.fontSetTransformPtr
import godot.fontSetUnderlinePositionPtr
import godot.fontSetUnderlineThicknessPtr
import godot.fontSetVariationCoordinatesPtr
import godot.fontSetWeightPtr
import godot.fontSupportedFeatureListPtr
import godot.fontSupportedVariationListPtr
import godot.formatNumberPtr
import godot.freeRidPtr
import godot.getFeaturesPtr
import godot.getHexCodeBoxSizePtr
import godot.getNamePtr
import godot.getSupportDataFilenamePtr
import godot.getSupportDataInfoPtr
import godot.hasFeaturePtr
import godot.hasPtr
import godot.isConfusablePtr
import godot.isLocaleRightToLeftPtr
import godot.isValidIdentifierPtr
import godot.isValidLetterPtr
import godot.loadSupportDataPtr
import godot.nameToTagPtr
import godot.parseNumberPtr
import godot.parseStructuredTextPtr
import godot.percentSignPtr
import godot.saveSupportDataPtr
import godot.shapedGetSpanCountPtr
import godot.shapedGetSpanMetaPtr
import godot.shapedSetSpanUpdateFontPtr
import godot.shapedTextAddObjectPtr
import godot.shapedTextAddStringPtr
import godot.shapedTextClearPtr
import godot.shapedTextClosestCharacterPosPtr
import godot.shapedTextDrawOutlinePtr
import godot.shapedTextDrawPtr
import godot.shapedTextFitToWidthPtr
import godot.shapedTextGetAscentPtr
import godot.shapedTextGetCaretsPtr
import godot.shapedTextGetCharacterBreaksPtr
import godot.shapedTextGetCustomEllipsisPtr
import godot.shapedTextGetCustomPunctuationPtr
import godot.shapedTextGetDescentPtr
import godot.shapedTextGetDirectionPtr
import godot.shapedTextGetDominantDirectionInRangePtr
import godot.shapedTextGetEllipsisGlyphCountPtr
import godot.shapedTextGetEllipsisGlyphsPtr
import godot.shapedTextGetEllipsisPosPtr
import godot.shapedTextGetGlyphCountPtr
import godot.shapedTextGetGlyphsPtr
import godot.shapedTextGetGraphemeBoundsPtr
import godot.shapedTextGetInferredDirectionPtr
import godot.shapedTextGetLineBreaksAdvPtr
import godot.shapedTextGetLineBreaksPtr
import godot.shapedTextGetObjectGlyphPtr
import godot.shapedTextGetObjectRangePtr
import godot.shapedTextGetObjectRectPtr
import godot.shapedTextGetObjectsPtr
import godot.shapedTextGetOrientationPtr
import godot.shapedTextGetParentPtr
import godot.shapedTextGetPreserveControlPtr
import godot.shapedTextGetPreserveInvalidPtr
import godot.shapedTextGetRangePtr
import godot.shapedTextGetSelectionPtr
import godot.shapedTextGetSizePtr
import godot.shapedTextGetSpacingPtr
import godot.shapedTextGetTrimPosPtr
import godot.shapedTextGetUnderlinePositionPtr
import godot.shapedTextGetUnderlineThicknessPtr
import godot.shapedTextGetWidthPtr
import godot.shapedTextGetWordBreaksPtr
import godot.shapedTextHasVisibleCharsPtr
import godot.shapedTextHitTestGraphemePtr
import godot.shapedTextHitTestPositionPtr
import godot.shapedTextIsReadyPtr
import godot.shapedTextNextCharacterPosPtr
import godot.shapedTextNextGraphemePosPtr
import godot.shapedTextOverrunTrimToWidthPtr
import godot.shapedTextPrevCharacterPosPtr
import godot.shapedTextPrevGraphemePosPtr
import godot.shapedTextResizeObjectPtr
import godot.shapedTextSetBidiOverridePtr
import godot.shapedTextSetCustomEllipsisPtr
import godot.shapedTextSetCustomPunctuationPtr
import godot.shapedTextSetDirectionPtr
import godot.shapedTextSetOrientationPtr
import godot.shapedTextSetPreserveControlPtr
import godot.shapedTextSetPreserveInvalidPtr
import godot.shapedTextSetSpacingPtr
import godot.shapedTextShapePtr
import godot.shapedTextSortLogicalPtr
import godot.shapedTextSubstrPtr
import godot.shapedTextTabAlignPtr
import godot.spoofCheckPtr
import godot.stringGetCharacterBreaksPtr
import godot.stringGetWordBreaksPtr
import godot.stringToLowerPtr
import godot.stringToTitlePtr
import godot.stringToUpperPtr
import godot.stripDiacriticsPtr
import godot.tagToNamePtr
import kotlin.Any
