...
public open class Image : Resource() {
   ...
   */
  public final fun convert(format: Format) {
   ...
   */
  @JvmOverloads
  public final fun resizeToPo2(square: Boolean = false, interpolation: Interpolation = Image.Interpolation.INTERPOLATE_BILINEAR) {
   ...
   */
  public final fun crop(width: Int, height: Int) {
   ...
   */
  @JvmOverloads
  public final fun detectUsedChannels(source: CompressSource = Image.CompressSource.GENERIC): UsedChannels {
   ...
   */
  public final fun rotate90(direction: ClockDirection) {
   ...
   */
  public final fun fixAlphaEdges() {
    TransferContext.writeArguments()
   ...
   */
  public final fun premultiplyAlpha() {
    TransferContext.writeArguments()
   ...
   */
  public final fun normalMapToXy() {
    TransferContext.writeArguments()
   ...
   */
  @JvmOverloads
  public final fun bumpMapToNormalMap(bumpScale: Float = 1.0f) {
   ...
   */
  public final fun computeImageMetrics(comparedImage: Image?, useLuma: Boolean): Dictionary<Any?, Any?> {
   ...
   */
  public final fun fill(color: Color) {
   ...
   */
  public final fun fillRect(rect: Rect2i, color: Color) {
   ...
   */
  public final fun copyFrom(src: Image?) {
   ...
   *
   * This is the same as [getPixel], but with a [Vector2i] argument instead of two integer arguments.
   */
   ...
   *
   * This is the same as [getPixelv], but with two integer arguments instead of a [Vector2i] argument.
   */
   ...
   * ```
   *
   * This is the same as [setPixel], but with a [Vector2i] argument instead of two integer arguments.
   */
  public final fun setPixelv(point: Vector2i, color: Color) {
   ...
   * ```
   *
   * This is the same as [setPixelv], but with a two integer arguments instead of a [Vector2i] argument.
   */
  ...
  public enum class Format(
    ...
    ETC2_RGB8A1(32),
    /**
     * [url=https://en.wikipedia.org/wiki/Ericsson_Texture_Compression#ETC2_and_EAC]Ericsson Texture Compression format 2[/url] (`RGBA8` variant), which compresses RA data and interprets it as two channels (red and green). See also [FORMAT_ETC2_RGBA8].
     */
    ETC2_RA_AS_RG(33),
    /**
     * The [url=https://en.wikipedia.org/wiki/S3_Texture_Compression]S3TC[/url] texture format also known as Block Compression 3 or BC3, which compresses RA data and interprets it as two channels (red and green). See also [FORMAT_DXT5].
     */
    DXT5_RA_AS_RG(34),
    /**
  ...
  public companion object {
    ...
    /**
     * Creates an empty image of given size and format. See [Format] constants. If [useMipmaps] is `true`, then generate mipmaps for this image. See the [generateMipmaps].
     */
    @JvmStatic
    ...
    /**
     * Creates a new image of given size and format. See [Format] constants. Fills the image with the given raw data. If [useMipmaps] is `true` then loads mipmaps for this image from [data]. See [generateMipmaps].
     */
    @JvmStatic
  ...
  public object MethodBindings {
    internal val getWidthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_width", 3_905_245_786)

    internal val getHeightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_height", 3_905_245_786)

    internal val getSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_size", 3_690_982_128)

    internal val hasMipmapsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "has_mipmaps", 36_873_697)

    internal val getFormatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_format", 3_847_873_762)

    internal val getDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_data", 2_362_200_018)

    internal val getDataSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_data_size", 3_905_245_786)

    internal val convertPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "convert", 2_120_693_146)

    internal val getMipmapCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_mipmap_count", 3_905_245_786)

    internal val getMipmapOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_mipmap_offset", 923_996_154)

    internal val resizeToPo2Ptr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "resize_to_po2", 4_189_212_329)

    internal val resizePtr: VoidPtr = TypeManager.getMethodBindPtr("Image", "resize", 994_498_151)

    internal val shrinkX2Ptr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "shrink_x2", 3_218_959_716)

    internal val cropPtr: VoidPtr = TypeManager.getMethodBindPtr("Image", "crop", 3_937_882_851)

    internal val flipXPtr: VoidPtr = TypeManager.getMethodBindPtr("Image", "flip_x", 3_218_959_716)

    internal val flipYPtr: VoidPtr = TypeManager.getMethodBindPtr("Image", "flip_y", 3_218_959_716)

    internal val generateMipmapsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "generate_mipmaps", 1_633_102_583)

    internal val clearMipmapsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "clear_mipmaps", 3_218_959_716)

    internal val createPtr: VoidPtr = TypeManager.getMethodBindPtr("Image", "create", 986_942_177)

    internal val createEmptyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "create_empty", 986_942_177)

    internal val createFromDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "create_from_data", 299_398_494)

    internal val setDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "set_data", 2_740_482_212)

    internal val isEmptyPtr: VoidPtr = TypeManager.getMethodBindPtr("Image", "is_empty", 36_873_697)

    internal val loadPtr: VoidPtr = TypeManager.getMethodBindPtr("Image", "load", 166_001_499)

    internal val loadFromFilePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_from_file", 736_337_515)

    internal val savePngPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "save_png", 2_113_323_047)

    internal val savePngToBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "save_png_to_buffer", 2_362_200_018)

    internal val saveJpgPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "save_jpg", 2_800_019_068)

    internal val saveJpgToBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "save_jpg_to_buffer", 592_235_273)

    internal val saveExrPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "save_exr", 3_108_122_999)

    internal val saveExrToBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "save_exr_to_buffer", 3_178_917_920)

    internal val saveWebpPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "save_webp", 2_781_156_876)

    internal val saveWebpToBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "save_webp_to_buffer", 1_214_628_238)

    internal val detectAlphaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "detect_alpha", 2_030_116_505)

    internal val isInvisiblePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "is_invisible", 36_873_697)

    internal val detectUsedChannelsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "detect_used_channels", 2_703_139_984)

    internal val compressPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "compress", 2_975_424_957)

    internal val compressFromChannelsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "compress_from_channels", 4_212_890_953)

    internal val decompressPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "decompress", 166_280_745)

    internal val isCompressedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "is_compressed", 36_873_697)

    internal val rotate90Ptr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "rotate_90", 1_901_204_267)

    internal val rotate180Ptr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "rotate_180", 3_218_959_716)

    internal val fixAlphaEdgesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "fix_alpha_edges", 3_218_959_716)

    internal val premultiplyAlphaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "premultiply_alpha", 3_218_959_716)

    internal val srgbToLinearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "srgb_to_linear", 3_218_959_716)

    internal val linearToSrgbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "linear_to_srgb", 3_218_959_716)

    internal val normalMapToXyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "normal_map_to_xy", 3_218_959_716)

    internal val rgbeToSrgbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "rgbe_to_srgb", 564_927_088)

    internal val bumpMapToNormalMapPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "bump_map_to_normal_map", 3_423_495_036)

    internal val computeImageMetricsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "compute_image_metrics", 3_080_961_247)

    internal val blitRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "blit_rect", 2_903_928_755)

    internal val blitRectMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "blit_rect_mask", 3_383_581_145)

    internal val blendRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "blend_rect", 2_903_928_755)

    internal val blendRectMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "blend_rect_mask", 3_383_581_145)

    internal val fillPtr: VoidPtr = TypeManager.getMethodBindPtr("Image", "fill", 2_920_490_490)

    internal val fillRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "fill_rect", 514_693_913)

    internal val getUsedRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_used_rect", 410_525_958)

    internal val getRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_region", 2_601_441_065)

    internal val copyFromPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "copy_from", 532_598_488)

    internal val getPixelvPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_pixelv", 1_532_707_496)

    internal val getPixelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "get_pixel", 2_165_839_948)

    internal val setPixelvPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "set_pixelv", 287_851_464)

    internal val setPixelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "set_pixel", 3_733_378_741)

    internal val adjustBcsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "adjust_bcs", 2_385_087_082)

    internal val loadPngFromBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_png_from_buffer", 680_677_267)

    internal val loadJpgFromBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_jpg_from_buffer", 680_677_267)

    internal val loadWebpFromBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_webp_from_buffer", 680_677_267)

    internal val loadTgaFromBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_tga_from_buffer", 680_677_267)

    internal val loadBmpFromBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_bmp_from_buffer", 680_677_267)

    internal val loadKtxFromBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_ktx_from_buffer", 680_677_267)

    internal val loadSvgFromBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_svg_from_buffer", 311_853_421)

    internal val loadSvgFromStringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Image", "load_svg_from_string", 3_254_053_600)
  }
}
