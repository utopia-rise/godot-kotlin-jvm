...
public open class ConvexPolygonShape2D : Shape2D() {
   ...
   */
  public final fun setPointCloud(pointCloud: PackedVector2Array) {
  ...
  public object MethodBindings {
    internal val setPointCloudPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ConvexPolygonShape2D", "set_point_cloud", 1_509_147_220)

    internal val setPointsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ConvexPolygonShape2D", "set_points", 1_509_147_220)

    internal val getPointsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ConvexPolygonShape2D", "get_points", 2_961_356_807)
  }
}
