...
public object RenderingServer : Object() {
   ...
   */
  @JvmStatic
  public final fun texture2dLayeredCreate(layers: VariantArray<Image>, layeredType: TextureLayeredType): RID {
   ...
   */
  @JvmStatic
  public final fun texture3dUpdate(texture: RID, `data`: VariantArray<Image>) {
   ...
   */
  @JvmStatic
  public final fun textureProxyUpdate(texture: RID, proxyTo: RID) {
   ...
   */
  @JvmStatic
  public final fun textureReplace(texture: RID, byTexture: RID) {
  ...
  @JvmStatic
  public final fun textureSetPath(texture: RID, path: String) {
  ...
  @JvmStatic
  public final fun textureSetForceRedrawIfVisible(texture: RID, enable: Boolean) {
  ...
  @JvmOverloads
  @JvmStatic
  public final fun textureRdCreate(rdTexture: RID, layerType: TextureLayeredType = RenderingServer.TextureLayeredType.TEXTURE_LAYERED_2D_ARRAY): RID {
   ...
   */
  @JvmStatic
  public final fun shaderSetCode(shader: RID, code: String) {
   ...
   */
  @JvmStatic
  public final fun shaderSetPathHint(shader: RID, path: String) {
   ...
   */
  @JvmStatic
  public final fun materialSetShader(shaderMaterial: RID, shader: RID) {
   ...
   */
  @JvmStatic
  public final fun materialSetRenderPriority(material: RID, priority: Int) {
   ...
   */
  @JvmStatic
  public final fun materialSetNextPass(material: RID, nextMaterial: RID) {
  ...
  @JvmOverloads
  @JvmStatic
  public final fun meshCreateFromSurfaces(surfaces: VariantArray<Dictionary<Any?, Any?>>, blendShapeCount: Int = 0): RID {
   ...
   */
  @JvmStatic
  public final fun meshSurfaceGetFormatNormalTangentStride(format: ArrayFormat, vertexCount: Int): Long {
    TransferContext.writeArguments(LONG to format.flag, LONG to vertexCount.toLong())
  ...
  @JvmStatic
  public final fun meshAddSurface(mesh: RID, surface: Dictionary<Any?, Any?>) {
   ...
   */
  @JvmStatic
  public final fun meshSetBlendShapeMode(mesh: RID, mode: BlendShapeMode) {
   ...
   */
  @JvmStatic
  public final fun meshSurfaceGetBlendShapeArrays(mesh: RID, surface: Int): VariantArray<VariantArray<Any?>> {
    TransferContext.writeArguments(_RID to mesh, LONG to surface.toLong())
   ...
   */
  @JvmStatic
  public final fun meshSetCustomAabb(mesh: RID, aabb: CoreAABB) {
    TransferContext.writeArguments(_RID to mesh, VariantParserAABB to aabb)
   ...
   */
  @JvmStatic
  public final fun meshGetCustomAabb(mesh: RID): CoreAABB {
    TransferContext.writeArguments(_RID to mesh)
    TransferContext.callMethod(ptr, MethodBindings.meshGetCustomAabbPtr, VariantParserAABB)
   ...
   */
  @JvmStatic
  public final fun meshSurfaceRemove(mesh: RID, surface: Int) {
    TransferContext.writeArguments(_RID to mesh, LONG to surface.toLong())
   ...
   */
  @JvmStatic
  public final fun meshClear(mesh: RID) {
    TransferContext.writeArguments(_RID to mesh)
  ...
  @JvmStatic
  public final fun meshSetShadowMesh(mesh: RID, shadowMesh: RID) {
   ...
   */
  @JvmStatic
  public final fun multimeshSetMesh(multimesh: RID, mesh: RID) {
   ...
   */
  @JvmStatic
  public final fun multimeshGetAabb(multimesh: RID): CoreAABB {
    TransferContext.writeArguments(_RID to multimesh)
    TransferContext.callMethod(ptr, MethodBindings.multimeshGetAabbPtr, VariantParserAABB)
    return (TransferContext.readReturnValue(VariantParserAABB) as CoreAABB)
  }
   ...
   */
  @JvmStatic
  public final fun multimeshSetCustomAabb(multimesh: RID, aabb: CoreAABB) {
    TransferContext.writeArguments(_RID to multimesh, VariantParserAABB to aabb)
   ...
   */
  @JvmStatic
  public final fun multimeshGetCustomAabb(multimesh: RID): CoreAABB {
    TransferContext.writeArguments(_RID to multimesh)
    TransferContext.callMethod(ptr, MethodBindings.multimeshGetCustomAabbPtr, VariantParserAABB)
    return (TransferContext.readReturnValue(VariantParserAABB) as CoreAABB)
  }
   ...
   */
  @JvmStatic
  public final fun multimeshSetVisibleInstances(multimesh: RID, visible: Int) {
   ...
   */
  @JvmStatic
  public final fun multimeshSetBuffer(multimesh: RID, buffer: PackedFloat32Array) {
  ...
  /**
   * Returns the [RenderingDevice] [RID] handle of the [MultiMesh] command buffer. This [RID] is only valid if `use_indirect` is set to `true` when allocating data through [multimeshAllocateData]. It can be used to directly modify the instance count via buffer.
   *
   ...
   */
  @JvmStatic
  public final fun multimeshSetPhysicsInterpolated(multimesh: RID, interpolated: Boolean) {
   ...
   */
  @JvmStatic
  public final fun multimeshSetPhysicsInterpolationQuality(multimesh: RID, quality: MultimeshPhysicsInterpolationQuality) {
   ...
   */
  @JvmStatic
  public final fun multimeshInstanceResetPhysicsInterpolation(multimesh: RID, index: Int) {
    TransferContext.writeArguments(_RID to multimesh, LONG to index.toLong())
  ...
  @JvmStatic
  public final fun skeletonSetBaseTransform2d(skeleton: RID, baseTransform: Transform2D) {
   ...
   */
  @JvmStatic
  public final fun lightSetColor(light: RID, color: Color) {
  ...
  /**
   * Sets the specified 3D light parameter. See [LightParam] for options. Equivalent to [Light3D.setParam].
   */
  @JvmStatic
   ...
   */
  @JvmStatic
  public final fun lightSetShadow(light: RID, enabled: Boolean) {
   ...
   */
  @JvmStatic
  public final fun lightSetProjector(light: RID, texture: RID) {
   ...
   */
  @JvmStatic
  public final fun lightSetNegative(light: RID, enable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun lightSetCullMask(light: RID, mask: Long) {
   ...
   */
  @JvmStatic
  public final fun lightSetReverseCullFaceMode(light: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to light, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun lightSetShadowCasterMask(light: RID, mask: Long) {
    TransferContext.writeArguments(_RID to light, LONG to mask)
   ...
   */
  @JvmStatic
  public final fun lightSetBakeMode(light: RID, bakeMode: LightBakeMode) {
   ...
   */
  @JvmStatic
  public final fun lightSetMaxSdfgiCascade(light: RID, cascade: Long) {
   ...
   */
  @JvmStatic
  public final fun lightOmniSetShadowMode(light: RID, mode: LightOmniShadowMode) {
  ...
  /**
   * Sets the shadow mode for this directional light. Equivalent to [DirectionalLight3D.directionalShadowMode]. See [LightDirectionalShadowMode] for options.
   */
  @JvmStatic
   ...
   */
  @JvmStatic
  public final fun lightDirectionalSetBlendSplits(light: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to light, BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun lightDirectionalSetSkyMode(light: RID, mode: LightDirectionalSkyMode) {
    TransferContext.writeArguments(_RID to light, LONG to mode.id)
   ...
   */
  @JvmStatic
  public final fun lightProjectorsSetFilter(filter: LightProjectorFilter) {
   ...
   */
  @JvmStatic
  public final fun lightmapsSetBicubicFilter(enable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun positionalSoftShadowFilterSetQuality(quality: ShadowQuality) {
   ...
   */
  @JvmStatic
  public final fun directionalSoftShadowFilterSetQuality(quality: ShadowQuality) {
    TransferContext.writeArguments(LONG to quality.id)
   ...
   */
  @JvmStatic
  public final fun directionalShadowAtlasSetSize(size: Int, is16bits: Boolean) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetUpdateMode(probe: RID, mode: ReflectionProbeUpdateMode) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetIntensity(probe: RID, intensity: Float) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetBlendDistance(probe: RID, blendDistance: Float) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetAmbientColor(probe: RID, color: Color) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetAmbientEnergy(probe: RID, energy: Float) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetMaxDistance(probe: RID, distance: Float) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetSize(probe: RID, size: Vector3) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetOriginOffset(probe: RID, offset: Vector3) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetAsInterior(probe: RID, enable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetEnableBoxProjection(probe: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to probe, BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetEnableShadows(probe: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to probe, BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetCullMask(probe: RID, layers: Long) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetReflectionMask(probe: RID, layers: Long) {
    TransferContext.writeArguments(_RID to probe, LONG to layers)
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetResolution(probe: RID, resolution: Int) {
   ...
   */
  @JvmStatic
  public final fun reflectionProbeSetMeshLodThreshold(probe: RID, pixels: Float) {
   ...
   */
  @JvmStatic
  public final fun decalSetSize(decal: RID, size: Vector3) {
   ...
   */
  @JvmStatic
  public final fun decalSetEmissionEnergy(decal: RID, energy: Float) {
   ...
   */
  @JvmStatic
  public final fun decalSetAlbedoMix(decal: RID, albedoMix: Float) {
   ...
   */
  @JvmStatic
  public final fun decalSetModulate(decal: RID, color: Color) {
   ...
   */
  @JvmStatic
  public final fun decalSetCullMask(decal: RID, mask: Long) {
   ...
   */
  @JvmStatic
  public final fun decalSetNormalFade(decal: RID, fade: Float) {
   ...
   */
  @JvmStatic
  public final fun decalsSetFilter(filter: DecalFilter) {
    TransferContext.writeArguments(LONG to filter.id)
   ...
   */
  @JvmStatic
  public final fun giSetUseHalfResolution(halfResolution: Boolean) {
  ...
  public final fun voxelGiAllocateData(
    ...
    TransferContext.writeArguments(_RID to voxelGi, TRANSFORM3D to toCellXform, VariantParserAABB to aabb, VECTOR3I to octreeSize, PACKED_BYTE_ARRAY to octreeCells, PACKED_BYTE_ARRAY to dataCells, PACKED_BYTE_ARRAY to distanceField, PACKED_INT_32_ARRAY to levelCounts)
   ...
   */
  @JvmStatic
  public final fun voxelGiSetDynamicRange(voxelGi: RID, range: Float) {
   ...
   */
  @JvmStatic
  public final fun voxelGiSetPropagation(voxelGi: RID, amount: Float) {
   ...
   */
  @JvmStatic
  public final fun voxelGiSetEnergy(voxelGi: RID, energy: Float) {
   ...
   */
  @JvmStatic
  public final fun voxelGiSetBakedExposureNormalization(voxelGi: RID, bakedExposure: Float) {
   ...
   */
  @JvmStatic
  public final fun voxelGiSetBias(voxelGi: RID, bias: Float) {
   ...
   */
  @JvmStatic
  public final fun voxelGiSetNormalBias(voxelGi: RID, bias: Float) {
    TransferContext.writeArguments(_RID to voxelGi, DOUBLE to bias.toDouble())
   ...
   */
  @JvmStatic
  public final fun voxelGiSetInterior(voxelGi: RID, enable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun voxelGiSetUseTwoBounces(voxelGi: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to voxelGi, BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun voxelGiSetQuality(quality: VoxelGIQuality) {
    TransferContext.writeArguments(LONG to quality.id)
  ...
  @JvmStatic
  public final fun lightmapSetProbeBounds(lightmap: RID, bounds: CoreAABB) {
    TransferContext.writeArguments(_RID to lightmap, VariantParserAABB to bounds)
    TransferContext.callMethod(ptr, MethodBindings.lightmapSetProbeBoundsPtr, NIL)
  }

  @JvmStatic
  public final fun lightmapSetProbeInterior(lightmap: RID, interior: Boolean) {
  ...
  @JvmStatic
  public final fun lightmapSetProbeCaptureUpdateSpeed(speed: Float) {
   ...
   */
  @JvmStatic
  public final fun particlesSetMode(particles: RID, mode: ParticlesMode) {
   ...
   */
  @JvmStatic
  public final fun particlesSetEmitting(particles: RID, emitting: Boolean) {
   ...
   */
  @JvmStatic
  public final fun particlesSetAmount(particles: RID, amount: Int) {
   ...
   */
  @JvmStatic
  public final fun particlesSetAmountRatio(particles: RID, ratio: Float) {
   ...
   */
  @JvmStatic
  public final fun particlesSetLifetime(particles: RID, lifetime: Double) {
   ...
   */
  @JvmStatic
  public final fun particlesSetOneShot(particles: RID, oneShot: Boolean) {
   ...
   */
  @JvmStatic
  public final fun particlesSetPreProcessTime(particles: RID, time: Double) {
   ...
   */
  @JvmStatic
  public final fun particlesRequestProcessTime(particles: RID, time: Float) {
   ...
   */
  @JvmStatic
  public final fun particlesSetExplosivenessRatio(particles: RID, ratio: Float) {
    TransferContext.writeArguments(_RID to particles, DOUBLE to ratio.toDouble())
   ...
   */
  @JvmStatic
  public final fun particlesSetRandomnessRatio(particles: RID, ratio: Float) {
    TransferContext.writeArguments(_RID to particles, DOUBLE to ratio.toDouble())
   ...
   */
  @JvmStatic
  public final fun particlesSetInterpToEnd(particles: RID, factor: Float) {
   ...
   */
  @JvmStatic
  public final fun particlesSetEmitterVelocity(particles: RID, velocity: Vector3) {
   ...
   */
  @JvmStatic
  public final fun particlesSetCustomAabb(particles: RID, aabb: CoreAABB) {
    TransferContext.writeArguments(_RID to particles, VariantParserAABB to aabb)
   ...
   */
  @JvmStatic
  public final fun particlesSetSpeedScale(particles: RID, scale: Double) {
   ...
   */
  @JvmStatic
  public final fun particlesSetUseLocalCoordinates(particles: RID, enable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun particlesSetProcessMaterial(particles: RID, material: RID) {
   ...
   */
  @JvmStatic
  public final fun particlesSetFixedFps(particles: RID, fps: Int) {
  ...
  @JvmStatic
  public final fun particlesSetInterpolate(particles: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to particles, BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun particlesSetFractionalDelta(particles: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to particles, BOOL to enable)
    TransferContext.callMethod(ptr, MethodBindings.particlesSetFractionalDeltaPtr, NIL)
  }

  @JvmStatic
  public final fun particlesSetCollisionBaseSize(particles: RID, size: Float) {
   ...
   */
  @JvmStatic
  public final fun particlesRequestProcess(particles: RID) {
    TransferContext.writeArguments(_RID to particles)
   ...
   */
  @JvmStatic
  public final fun particlesRestart(particles: RID) {
    TransferContext.writeArguments(_RID to particles)
    TransferContext.callMethod(ptr, MethodBindings.particlesRestartPtr, NIL)
  }

  @JvmStatic
  public final fun particlesSetSubemitter(particles: RID, subemitterParticles: RID) {
  ...
  /**
   * Sets the draw order of the particles to one of the named enums from [ParticlesDrawOrder]. See [ParticlesDrawOrder] for options. Equivalent to [GPUParticles3D.drawOrder].
   */
  @JvmStatic
  public final fun particlesSetDrawOrder(particles: RID, order: ParticlesDrawOrder) {
   ...
   */
  @JvmStatic
  public final fun particlesSetDrawPasses(particles: RID, count: Int) {
   ...
   */
  @JvmStatic
  public final fun particlesGetCurrentAabb(particles: RID): CoreAABB {
    TransferContext.writeArguments(_RID to particles)
    TransferContext.callMethod(ptr, MethodBindings.particlesGetCurrentAabbPtr, VariantParserAABB)
    return (TransferContext.readReturnValue(VariantParserAABB) as CoreAABB)
  }
   ...
   */
  @JvmStatic
  public final fun particlesSetEmissionTransform(particles: RID, transform: Transform3D) {
   ...
   */
  @JvmStatic
  public final fun particlesCollisionSetCollisionType(particlesCollision: RID, type: ParticlesCollisionType) {
   ...
   */
  @JvmStatic
  public final fun particlesCollisionSetCullMask(particlesCollision: RID, mask: Long) {
   ...
   */
  @JvmStatic
  public final fun particlesCollisionSetSphereRadius(particlesCollision: RID, radius: Float) {
   ...
   */
  @JvmStatic
  public final fun particlesCollisionSetAttractorDirectionality(particlesCollision: RID, amount: Float) {
   ...
   */
  @JvmStatic
  public final fun particlesCollisionSetFieldTexture(particlesCollision: RID, texture: RID) {
   ...
   */
  @JvmStatic
  public final fun particlesCollisionHeightFieldUpdate(particlesCollision: RID) {
   ...
   */
  @JvmStatic
  public final fun particlesCollisionSetHeightFieldResolution(particlesCollision: RID, resolution: ParticlesCollisionHeightfieldResolution) {
   ...
   */
  @JvmStatic
  public final fun particlesCollisionSetHeightFieldMask(particlesCollision: RID, mask: Long) {
    TransferContext.writeArguments(_RID to particlesCollision, LONG to mask)
   ...
   */
  @JvmStatic
  public final fun fogVolumeSetShape(fogVolume: RID, shape: FogVolumeShape) {
   ...
   */
  @JvmStatic
  public final fun fogVolumeSetSize(fogVolume: RID, size: Vector3) {
   ...
   */
  @JvmStatic
  public final fun fogVolumeSetMaterial(fogVolume: RID, material: RID) {
  ...
  @JvmStatic
  public final fun visibilityNotifierSetAabb(notifier: RID, aabb: CoreAABB) {
    TransferContext.writeArguments(_RID to notifier, VariantParserAABB to aabb)
   ...
   */
  @JvmStatic
  public final fun cameraSetTransform(camera: RID, transform: Transform3D) {
   ...
   */
  @JvmStatic
  public final fun cameraSetCullMask(camera: RID, layers: Long) {
   ...
   */
  @JvmStatic
  public final fun cameraSetEnvironment(camera: RID, env: RID) {
   ...
   */
  @JvmStatic
  public final fun cameraSetCameraAttributes(camera: RID, effects: RID) {
   ...
   */
  @JvmStatic
  public final fun cameraSetCompositor(camera: RID, compositor: RID) {
   ...
   */
  @JvmStatic
  public final fun cameraSetUseVerticalAspect(camera: RID, enable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun viewportSetUseXr(viewport: RID, useXr: Boolean) {
   ...
   */
  @JvmStatic
  public final fun viewportSetActive(viewport: RID, active: Boolean) {
   ...
   */
  @JvmStatic
  public final fun viewportSetParentViewport(viewport: RID, parentViewport: RID) {
   ...
   */
  @JvmStatic
  public final fun viewportSetRenderDirectToScreen(viewport: RID, enabled: Boolean) {
   ...
   */
  @JvmStatic
  public final fun viewportSetCanvasCullMask(viewport: RID, canvasCullMask: Long) {
   ...
   */
  @JvmStatic
  public final fun viewportSetScaling3dScale(viewport: RID, scale: Float) {
   ...
   */
  @JvmStatic
  public final fun viewportSetFsrSharpness(viewport: RID, sharpness: Float) {
   ...
   */
  @JvmStatic
  public final fun viewportSetTextureMipmapBias(viewport: RID, mipmapBias: Float) {
   ...
   */
  @JvmStatic
  public final fun viewportSetAnisotropicFilteringLevel(viewport: RID, anisotropicFilteringLevel: ViewportAnisotropicFiltering) {
   ...
   */
  @JvmStatic
  public final fun viewportSetUpdateMode(viewport: RID, updateMode: ViewportUpdateMode) {
   ...
   */
  @JvmStatic
  public final fun viewportSetClearMode(viewport: RID, clearMode: ViewportClearMode) {
   ...
   */
  @JvmStatic
  public final fun viewportSetDisable3d(viewport: RID, disable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun viewportSetDisable2d(viewport: RID, disable: Boolean) {
    TransferContext.writeArguments(_RID to viewport, BOOL to disable)
   ...
   */
  @JvmStatic
  public final fun viewportSetEnvironmentMode(viewport: RID, mode: ViewportEnvironmentMode) {
   ...
   */
  @JvmStatic
  public final fun viewportAttachCamera(viewport: RID, camera: RID) {
   ...
   */
  @JvmStatic
  public final fun viewportSetScenario(viewport: RID, scenario: RID) {
   ...
   */
  @JvmStatic
  public final fun viewportAttachCanvas(viewport: RID, canvas: RID) {
   ...
   */
  @JvmStatic
  public final fun viewportRemoveCanvas(viewport: RID, canvas: RID) {
    TransferContext.writeArguments(_RID to viewport, _RID to canvas)
   ...
   */
  @JvmStatic
  public final fun viewportSetSnap2dTransformsToPixel(viewport: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to viewport, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun viewportSetSnap2dVerticesToPixel(viewport: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to viewport, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun viewportSetDefaultCanvasItemTextureFilter(viewport: RID, filter: CanvasItemTextureFilter) {
   ...
   */
  @JvmStatic
  public final fun viewportSetDefaultCanvasItemTextureRepeat(viewport: RID, repeat: CanvasItemTextureRepeat) {
   ...
   */
  @JvmStatic
  public final fun viewportSetTransparentBackground(viewport: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to viewport, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun viewportSetGlobalCanvasTransform(viewport: RID, transform: Transform2D) {
  ...
  /**
   * Sets the multisample antialiasing mode for 3D on the specified [viewport] RID. See [ViewportMSAA] for options. Equivalent to [ProjectSettings.rendering/antiAliasing/quality/msaa3d] or [Viewport.msaa3d].
   */
  @JvmStatic
  public final fun viewportSetMsaa3d(viewport: RID, msaa: ViewportMSAA) {
  ...
  /**
   * Sets the multisample antialiasing mode for 2D/Canvas on the specified [viewport] RID. See [ViewportMSAA] for options. Equivalent to [ProjectSettings.rendering/antiAliasing/quality/msaa2d] or [Viewport.msaa2d].
   */
  @JvmStatic
  public final fun viewportSetMsaa2d(viewport: RID, msaa: ViewportMSAA) {
    TransferContext.writeArguments(_RID to viewport, LONG to msaa.id)
   ...
   */
  @JvmStatic
  public final fun viewportSetUseHdr2d(viewport: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to viewport, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun viewportSetScreenSpaceAa(viewport: RID, mode: ViewportScreenSpaceAA) {
    TransferContext.writeArguments(_RID to viewport, LONG to mode.id)
   ...
   */
  @JvmStatic
  public final fun viewportSetUseTaa(viewport: RID, enable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun viewportSetUseDebanding(viewport: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to viewport, BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun viewportSetUseOcclusionCulling(viewport: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to viewport, BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun viewportSetOcclusionRaysPerThread(raysPerThread: Int) {
   ...
   */
  @JvmStatic
  public final fun viewportSetOcclusionCullingBuildQuality(quality: ViewportOcclusionCullingBuildQuality) {
    TransferContext.writeArguments(LONG to quality.id)
   ...
   */
  @JvmStatic
  public final fun viewportSetDebugDraw(viewport: RID, draw: ViewportDebugDraw) {
   ...
   */
  @JvmStatic
  public final fun viewportSetMeasureRenderTime(viewport: RID, enable: Boolean) {
    TransferContext.writeArguments(_RID to viewport, BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun viewportSetVrsMode(viewport: RID, mode: ViewportVRSMode) {
    TransferContext.writeArguments(_RID to viewport, LONG to mode.id)
   ...
   */
  @JvmStatic
  public final fun viewportSetVrsUpdateMode(viewport: RID, mode: ViewportVRSUpdateMode) {
    TransferContext.writeArguments(_RID to viewport, LONG to mode.id)
   ...
   */
  @JvmStatic
  public final fun viewportSetVrsTexture(viewport: RID, texture: RID) {
   ...
   */
  @JvmStatic
  public final fun skySetRadianceSize(sky: RID, radianceSize: Int) {
   ...
   */
  @JvmStatic
  public final fun skySetMode(sky: RID, mode: SkyMode) {
   ...
   */
  @JvmStatic
  public final fun skySetMaterial(sky: RID, material: RID) {
   ...
   */
  @JvmStatic
  public final fun compositorEffectSetEnabled(effect: RID, enabled: Boolean) {
   ...
   */
  @JvmStatic
  public final fun environmentSetBackground(env: RID, bg: EnvironmentBG) {
   ...
   */
  @JvmStatic
  public final fun environmentSetCameraId(env: RID, id: Int) {
   ...
   */
  @JvmStatic
  public final fun environmentSetSky(env: RID, sky: RID) {
   ...
   */
  @JvmStatic
  public final fun environmentSetSkyCustomFov(env: RID, scale: Float) {
   ...
   */
  @JvmStatic
  public final fun environmentSetSkyOrientation(env: RID, orientation: Basis) {
   ...
   */
  @JvmStatic
  public final fun environmentSetBgColor(env: RID, color: Color) {
   ...
   */
  @JvmStatic
  public final fun environmentSetCanvasMaxLayer(env: RID, maxLayer: Int) {
   ...
   */
  @JvmStatic
  public final fun environmentGlowSetUseBicubicUpscale(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
   ...
   */
  @JvmStatic
  public final fun environmentSetSdfgiRayCount(rayCount: EnvironmentSDFGIRayCount) {
   ...
   */
  @JvmStatic
  public final fun environmentSetSdfgiFramesToUpdateLight(frames: EnvironmentSDFGIFramesToUpdateLight) {
    TransferContext.writeArguments(LONG to frames.id)
   ...
   */
  @JvmStatic
  public final fun environmentSetVolumetricFogVolumeSize(size: Int, depth: Int) {
   ...
   */
  @JvmStatic
  public final fun environmentSetVolumetricFogFilterActive(active: Boolean) {
   ...
   */
  @JvmStatic
  public final fun subSurfaceScatteringSetQuality(quality: SubSurfaceScatteringQuality) {
    TransferContext.writeArguments(LONG to quality.id)
   ...
   */
  @JvmStatic
  public final fun subSurfaceScatteringSetScale(scale: Float, depthScale: Float) {
  ...
  /**
   * Sets the quality level of the DOF blur effect to one of the options in [DOFBlurQuality]. [useJitter] can be used to jitter samples taken during the blur pass to hide artifacts at the cost of looking more fuzzy.
   */
  @JvmStatic
   ...
   */
  @JvmStatic
  public final fun cameraAttributesSetDofBlurBokehShape(shape: DOFBokehShape) {
   ...
   */
  @JvmStatic
  public final fun scenarioSetEnvironment(scenario: RID, environment: RID) {
   ...
   */
  @JvmStatic
  public final fun scenarioSetFallbackEnvironment(scenario: RID, environment: RID) {
    TransferContext.writeArguments(_RID to scenario, _RID to environment)
   ...
   */
  @JvmStatic
  public final fun scenarioSetCameraAttributes(scenario: RID, effects: RID) {
   ...
   */
  @JvmStatic
  public final fun scenarioSetCompositor(scenario: RID, compositor: RID) {
   ...
   */
  @JvmStatic
  public final fun instanceSetBase(instance: RID, base: RID) {
   ...
   */
  @JvmStatic
  public final fun instanceSetScenario(instance: RID, scenario: RID) {
   ...
   */
  @JvmStatic
  public final fun instanceSetLayerMask(instance: RID, mask: Long) {
   ...
   */
  @JvmStatic
  public final fun instanceSetTransform(instance: RID, transform: Transform3D) {
   ...
   */
  @JvmStatic
  public final fun instanceSetInterpolated(instance: RID, interpolated: Boolean) {
   ...
   */
  @JvmStatic
  public final fun instanceResetPhysicsInterpolation(instance: RID) {
   ...
   */
  @JvmStatic
  public final fun instanceAttachObjectInstanceId(instance: RID, id: Long) {
   ...
   */
  @JvmStatic
  public final fun instanceSetVisible(instance: RID, visible: Boolean) {
   ...
   */
  @JvmStatic
  public final fun instanceGeometrySetTransparency(instance: RID, transparency: Float) {
   ...
   */
  @JvmStatic
  public final fun instanceSetCustomAabb(instance: RID, aabb: CoreAABB) {
    TransferContext.writeArguments(_RID to instance, VariantParserAABB to aabb)
   ...
   */
  @JvmStatic
  public final fun instanceAttachSkeleton(instance: RID, skeleton: RID) {
   ...
   */
  @JvmStatic
  public final fun instanceSetExtraVisibilityMargin(instance: RID, margin: Float) {
   ...
   */
  @JvmStatic
  public final fun instanceSetVisibilityParent(instance: RID, parent: RID) {
   ...
   */
  @JvmStatic
  public final fun instanceSetIgnoreCulling(instance: RID, enabled: Boolean) {
  ...
  /**
   * Sets the shadow casting setting to one of [ShadowCastingSetting]. Equivalent to [GeometryInstance3D.castShadow].
   */
  @JvmStatic
  public final fun instanceGeometrySetCastShadowsSetting(instance: RID, shadowCastingSetting: ShadowCastingSetting) {
   ...
   */
  @JvmStatic
  public final fun instanceGeometrySetMaterialOverride(instance: RID, material: RID) {
   ...
   */
  @JvmStatic
  public final fun instanceGeometrySetMaterialOverlay(instance: RID, material: RID) {
    TransferContext.writeArguments(_RID to instance, _RID to material)
   ...
   */
  @JvmStatic
  public final fun instanceGeometrySetLodBias(instance: RID, lodBias: Float) {
   ...
   */
  @JvmStatic
  public final fun instanceGeometryGetShaderParameterDefaultValue(instance: RID, parameter: StringName): Any? {
    TransferContext.writeArguments(_RID to instance, STRING_NAME to parameter)
   ...
   */
  @JvmStatic
  public final fun instanceGeometryGetShaderParameterList(instance: RID): VariantArray<Dictionary<Any?, Any?>> {
    TransferContext.writeArguments(_RID to instance)
  ...
  @JvmOverloads
  @JvmStatic
  public final fun instancesCullAabb(aabb: CoreAABB, scenario: RID = RID()): PackedInt64Array {
    TransferContext.writeArguments(VariantParserAABB to aabb, _RID to scenario)
  ...
  @JvmOverloads
  @JvmStatic
  public final fun instancesCullConvex(convex: VariantArray<Plane>, scenario: RID = RID()): PackedInt64Array {
  ...
  /**
   * Bakes the material data of the Mesh passed in the [base] parameter with optional [materialOverrides] to a set of [Image]s of size [imageSize]. Returns an array of [Image]s containing material properties as specified in [BakeChannels].
   */
  @JvmStatic
   ...
   */
  @JvmStatic
  public final fun canvasSetModulate(canvas: RID, color: Color) {
  ...
  @JvmStatic
  public final fun canvasSetDisableScale(disable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasTextureSetTextureFilter(canvasTexture: RID, filter: CanvasItemTextureFilter) {
   ...
   */
  @JvmStatic
  public final fun canvasTextureSetTextureRepeat(canvasTexture: RID, repeat: CanvasItemTextureRepeat) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetParent(item: RID, parent: RID) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetVisible(item: RID, visible: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetLightMask(item: RID, mask: Int) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetVisibilityLayer(item: RID, visibilityLayer: Long) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetTransform(item: RID, transform: Transform2D) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetClip(item: RID, clip: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetDistanceFieldMode(item: RID, enabled: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetModulate(item: RID, color: Color) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetSelfModulate(item: RID, color: Color) {
    TransferContext.writeArguments(_RID to item, COLOR to color)
   ...
   */
  @JvmStatic
  public final fun canvasItemSetDrawBehindParent(item: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to item, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun canvasItemSetInterpolated(item: RID, interpolated: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasItemResetPhysicsInterpolation(item: RID) {
  ...
  /**
   * Draws a line on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawLine].
   */
  @JvmOverloads
  @JvmStatic
  ...
  /**
   * Draws a 2D polyline on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawPolyline] and [CanvasItem.drawPolylineColors].
   */
  @JvmOverloads
  @JvmStatic
  ...
  /**
   * Draws a 2D multiline on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawMultiline] and [CanvasItem.drawMultilineColors].
   */
  @JvmOverloads
  @JvmStatic
  ...
  /**
   * Draws a rectangle on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawRect].
   */
  @JvmOverloads
  @JvmStatic
  ...
  /**
   * Draws a circle on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawCircle].
   */
  @JvmOverloads
  @JvmStatic
  ...
  /**
   * Draws a 2D textured rectangle on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawTextureRect] and [Texture2D.drawRect].
   */
  @JvmOverloads
  @JvmStatic
  ...
  /**
   * Draws the specified region of a 2D textured rectangle on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawTextureRectRegion] and [Texture2D.drawRectRegion].
   */
  @JvmOverloads
  @JvmStatic
  ...
  /**
   * Draws a 2D primitive on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawPrimitive].
   */
  @JvmStatic
  ...
  /**
   * Draws a 2D polygon on the [CanvasItem] pointed to by the [item] [RID]. If you need more flexibility (such as being able to use bones), use [canvasItemAddTriangleArray] instead. See also [CanvasItem.drawPolygon].
   *
  ...
  /**
   * Draws a triangle array on the [CanvasItem] pointed to by the [item] [RID]. This is internally used by [Line2D] and [StyleBoxFlat] for rendering. [canvasItemAddTriangleArray] is highly flexible, but more complex to use than [canvasItemAddPolygon].
   *
  ...
  /**
   * Draws a 2D [MultiMesh] on the [CanvasItem] pointed to by the [item] [RID]. See also [CanvasItem.drawMultimesh].
   */
  @JvmOverloads
  @JvmStatic
   ...
   */
  @JvmStatic
  public final fun canvasItemAddSetTransform(item: RID, transform: Transform2D) {
    TransferContext.writeArguments(_RID to item, TRANSFORM2D to transform)
   ...
   */
  @JvmStatic
  public final fun canvasItemAddClipIgnore(item: RID, ignore: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetSortChildrenByY(item: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to item, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun canvasItemSetZIndex(item: RID, zIndex: Int) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetZAsRelativeToParent(item: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to item, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun canvasItemAttachSkeleton(item: RID, skeleton: RID) {
   ...
   */
  @JvmStatic
  public final fun canvasItemClear(item: RID) {
    TransferContext.writeArguments(_RID to item)
   ...
   */
  @JvmStatic
  public final fun canvasItemSetDrawIndex(item: RID, index: Int) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetMaterial(item: RID, material: RID) {
   ...
   */
  @JvmStatic
  public final fun canvasItemSetUseParentMaterial(item: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to item, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun canvasItemGetInstanceShaderParameterDefaultValue(instance: RID, parameter: StringName): Any? {
    TransferContext.writeArguments(_RID to instance, STRING_NAME to parameter)
   ...
   */
  @JvmStatic
  public final fun canvasItemGetInstanceShaderParameterList(instance: RID): VariantArray<Dictionary<Any?, Any?>> {
    TransferContext.writeArguments(_RID to instance)
   ...
   */
  @JvmStatic
  public final fun canvasLightAttachToCanvas(light: RID, canvas: RID) {
   ...
   */
  @JvmStatic
  public final fun canvasLightSetEnabled(light: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to light, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun canvasLightSetTextureScale(light: RID, scale: Float) {
   ...
   */
  @JvmStatic
  public final fun canvasLightSetTransform(light: RID, transform: Transform2D) {
   ...
   */
  @JvmStatic
  public final fun canvasLightSetTexture(light: RID, texture: RID) {
    TransferContext.writeArguments(_RID to light, _RID to texture)
   ...
   */
  @JvmStatic
  public final fun canvasLightSetTextureOffset(light: RID, offset: Vector2) {
   ...
   */
  @JvmStatic
  public final fun canvasLightSetColor(light: RID, color: Color) {
    TransferContext.writeArguments(_RID to light, COLOR to color)
   ...
   */
  @JvmStatic
  public final fun canvasLightSetHeight(light: RID, height: Float) {
   ...
   */
  @JvmStatic
  public final fun canvasLightSetEnergy(light: RID, energy: Float) {
   ...
   */
  @JvmStatic
  public final fun canvasLightSetItemCullMask(light: RID, mask: Int) {
   ...
   */
  @JvmStatic
  public final fun canvasLightSetItemShadowCullMask(light: RID, mask: Int) {
    TransferContext.writeArguments(_RID to light, LONG to mask.toLong())
   ...
   */
  @JvmStatic
  public final fun canvasLightSetMode(light: RID, mode: CanvasLightMode) {
    TransferContext.writeArguments(_RID to light, LONG to mode.id)
   ...
   */
  @JvmStatic
  public final fun canvasLightSetShadowEnabled(light: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to light, BOOL to enabled)
   ...
   */
  @JvmStatic
  public final fun canvasLightSetShadowFilter(light: RID, filter: CanvasLightShadowFilter) {
   ...
   */
  @JvmStatic
  public final fun canvasLightSetShadowColor(light: RID, color: Color) {
    TransferContext.writeArguments(_RID to light, COLOR to color)
   ...
   */
  @JvmStatic
  public final fun canvasLightSetShadowSmooth(light: RID, smooth: Float) {
  ...
  /**
   * Sets the blend mode for the given canvas light. See [CanvasLightBlendMode] for options. Equivalent to [Light2D.blendMode].
   */
  @JvmStatic
  public final fun canvasLightSetBlendMode(light: RID, mode: CanvasLightBlendMode) {
    TransferContext.writeArguments(_RID to light, LONG to mode.id)
   ...
   */
  @JvmStatic
  public final fun canvasLightSetInterpolated(light: RID, interpolated: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasLightResetPhysicsInterpolation(light: RID) {
   ...
   */
  @JvmStatic
  public final fun canvasLightOccluderAttachToCanvas(occluder: RID, canvas: RID) {
   ...
   */
  @JvmStatic
  public final fun canvasLightOccluderSetEnabled(occluder: RID, enabled: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasLightOccluderSetPolygon(occluder: RID, polygon: RID) {
  ...
  @JvmStatic
  public final fun canvasLightOccluderSetAsSdfCollision(occluder: RID, enable: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasLightOccluderSetTransform(occluder: RID, transform: Transform2D) {
   ...
   */
  @JvmStatic
  public final fun canvasLightOccluderSetLightMask(occluder: RID, mask: Int) {
   ...
   */
  @JvmStatic
  public final fun canvasLightOccluderSetInterpolated(occluder: RID, interpolated: Boolean) {
   ...
   */
  @JvmStatic
  public final fun canvasLightOccluderResetPhysicsInterpolation(occluder: RID) {
   ...
   */
  @JvmStatic
  public final fun canvasLightOccluderTransformPhysicsInterpolation(occluder: RID, transform: Transform2D) {
    TransferContext.writeArguments(_RID to occluder, TRANSFORM2D to transform)
   ...
   */
  @JvmStatic
  public final fun canvasOccluderPolygonSetCullMode(occluderPolygon: RID, mode: CanvasOccluderPolygonCullMode) {
   ...
   */
  @JvmStatic
  public final fun canvasSetShadowTextureSize(size: Int) {
   ...
   */
  @JvmStatic
  public final fun globalShaderParameterRemove(name: StringName) {
   ...
   */
  @JvmStatic
  public final fun globalShaderParameterSet(name: StringName, `value`: Any?) {
   ...
   */
  @JvmStatic
  public final fun globalShaderParameterSetOverride(name: StringName, `value`: Any?) {
    TransferContext.writeArguments(STRING_NAME to name, ANY to value)
   ...
   */
  @JvmStatic
  public final fun requestFrameDrawnCallback(callable: Callable) {
  ...
  /**
   * Returns a statistic about the rendering engine which can be used for performance profiling. See [RenderingServer.RenderingInfo] for a list of values that can be queried. See also [viewportGetRenderInfo], which returns information specific to a viewport.
   *
  ...
  /**
   * Returns the RID of a 256×256 texture with a testing pattern on it (in [Image.FORMAT_RGB8] format). This texture will be created and returned on the first call to [getTestTexture], then it will be cached for subsequent calls. See also [getWhiteTexture].
   *
  ...
  /**
   * Returns the ID of a 4×4 white texture (in [Image.FORMAT_RGB8] format). This texture will be created and returned on the first call to [getWhiteTexture], then it will be cached for subsequent calls. See also [getTestTexture].
   *
   ...
   */
  @JvmStatic
  public final fun setDefaultClearColor(color: Color) {
   ...
   */
  @JvmStatic
  public final fun setDebugGenerateWireframes(generate: Boolean) {
  ...
  @JvmStatic
  public final fun setRenderLoopEnabled(enabled: Boolean) {
  ...
  @JvmOverloads
  @JvmStatic
  public final fun forceDraw(swapBuffers: Boolean = true, frameStep: Double = 0.0) {
   ...
   */
  @JvmStatic
  public final fun callOnRenderThread(callable: Callable) {
    TransferContext.writeArguments(CALLABLE to callable)
   ...
   */
  @JvmStatic
  public final fun shaderGetParameterDefault(shader: RID, name: String): Any? = shaderGetParameterDefault(shader, name.asCachedStringName())
   ...
   */
  @JvmStatic
  public final fun materialGetParam(material: RID, parameter: String): Any? = materialGetParam(material, parameter.asCachedStringName())
   ...
   */
  @JvmStatic
  public final fun instanceGeometryGetShaderParameter(instance: RID, parameter: String): Any? = instanceGeometryGetShaderParameter(instance, parameter.asCachedStringName())

  /**
   * Returns the default value of the per-instance shader uniform from the specified 3D geometry instance. Equivalent to [GeometryInstance3D.getInstanceShaderParameter].
   */
  @JvmStatic
  public final fun instanceGeometryGetShaderParameterDefaultValue(instance: RID, parameter: String): Any? = instanceGeometryGetShaderParameterDefaultValue(instance, parameter.asCachedStringName())
   ...
   */
  @JvmStatic
  public final fun canvasItemGetInstanceShaderParameter(instance: RID, parameter: String): Any? = canvasItemGetInstanceShaderParameter(instance, parameter.asCachedStringName())

  /**
   * Returns the default value of the per-instance shader uniform from the specified canvas item instance. Equivalent to [CanvasItem.getInstanceShaderParameter].
   */
  @JvmStatic
  public final fun canvasItemGetInstanceShaderParameterDefaultValue(instance: RID, parameter: String): Any? = canvasItemGetInstanceShaderParameterDefaultValue(instance, parameter.asCachedStringName())
   ...
   */
  @JvmStatic
  public final fun globalShaderParameterRemove(name: String): Unit = globalShaderParameterRemove(name.asCachedStringName())

  /**
   * Sets the global shader uniform [name] to [value].
   */
  @JvmStatic
  public final fun globalShaderParameterSet(name: String, `value`: Any?): Unit = globalShaderParameterSet(name.asCachedStringName(), value)

  /**
   * Overrides the global shader uniform [name] with [value]. Equivalent to the [ShaderGlobalsOverride] node.
   */
  @JvmStatic
  public final fun globalShaderParameterSetOverride(name: String, `value`: Any?): Unit = globalShaderParameterSetOverride(name.asCachedStringName(), value)
   ...
   */
  @JvmStatic
  public final fun globalShaderParameterGet(name: String): Any? = globalShaderParameterGet(name.asCachedStringName())
   ...
   */
  @JvmStatic
  public final fun globalShaderParameterGetType(name: String): GlobalShaderParameterType = globalShaderParameterGetType(name.asCachedStringName())
  ...
  public class ArrayFormat(
    ...
    public companion object {
       ...
       */
      @JvmField
      public val FLAG_FORMAT_VERSION_2: ArrayFormat = ArrayFormat(34_359_738_368)
       ...
       */
      @JvmField
      public val FLAG_FORMAT_CURRENT_VERSION: ArrayFormat = ArrayFormat(34_359_738_368)
  ...
  public enum class MultimeshPhysicsInterpolationQuality(
    ...
    public companion object {
      public fun from(`value`: Long): MultimeshPhysicsInterpolationQuality = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class LightBakeMode(
    ...
    STATIC(1),
    /**
     * Light is taken into account in dynamic baking ([VoxelGI] and SDFGI ([Environment.sdfgiEnabled]) only). The light can be moved around or modified with global illumination updating in real-time. The light's global illumination appearance will be slightly different compared to [LIGHT_BAKE_STATIC]. This has a greater performance cost compared to [LIGHT_BAKE_STATIC]. When using SDFGI, the update speed of dynamic lights is affected by [ProjectSettings.rendering/globalIllumination/sdfgi/framesToUpdateLights].
     */
    DYNAMIC(2),
    ;
  ...
  public enum class LightDirectionalShadowMode(
    ...
    public companion object {
      public fun from(`value`: Long): LightDirectionalShadowMode = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class ReflectionProbeUpdateMode(
    ...
    public companion object {
      public fun from(`value`: Long): ReflectionProbeUpdateMode = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class ReflectionProbeAmbientMode(
    ...
    public companion object {
      public fun from(`value`: Long): ReflectionProbeAmbientMode = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class ParticlesCollisionHeightfieldResolution(
    ...
    public companion object {
      public fun from(`value`: Long): ParticlesCollisionHeightfieldResolution = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class ViewportAnisotropicFiltering(
    ...
    public companion object {
      public fun from(`value`: Long): ViewportAnisotropicFiltering = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class ViewportOcclusionCullingBuildQuality(
    ...
    public companion object {
      public fun from(`value`: Long): ViewportOcclusionCullingBuildQuality = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class CompositorEffectCallbackType(
    ...
    public companion object {
      public fun from(`value`: Long): CompositorEffectCallbackType = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class EnvironmentReflectionSource(
    ...
    public companion object {
      public fun from(`value`: Long): EnvironmentReflectionSource = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class EnvironmentToneMapper(
     ...
     *
     * **Note:** When [Environment.tonemapWhite] is left at the default value of `1.0`, [ENV_TONE_MAPPER_REINHARD] produces an identical image to [ENV_TONE_MAPPER_LINEAR].
     */
    REINHARD(1),
    /**
     ...
     *
     * **Note:** [Environment.tonemapWhite] is fixed at a value of `16.29`, which makes [ENV_TONE_MAPPER_AGX] unsuitable for use with the Mobile rendering method.
     */
    AGX(4),
    ;
  ...
  public enum class EnvironmentSSRRoughnessQuality(
    ...
    public companion object {
      public fun from(`value`: Long): EnvironmentSSRRoughnessQuality = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class EnvironmentSDFGIFramesToConverge(
    ...
    public companion object {
      public fun from(`value`: Long): EnvironmentSDFGIFramesToConverge = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class EnvironmentSDFGIFramesToUpdateLight(
    ...
    public companion object {
      public fun from(`value`: Long): EnvironmentSDFGIFramesToUpdateLight = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class SubSurfaceScatteringQuality(
    ...
    public companion object {
      public fun from(`value`: Long): SubSurfaceScatteringQuality = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class BakeChannels(
    ...
    /**
     * Index of [Image] in array of [Image]s returned by [bakeRenderUv2]. Image uses [Image.FORMAT_RGBA8] and contains albedo color in the `.rgb` channels and alpha in the `.a` channel.
     */
    ALBEDO_ALPHA(0),
    /**
     * Index of [Image] in array of [Image]s returned by [bakeRenderUv2]. Image uses [Image.FORMAT_RGBA8] and contains the per-pixel normal of the object in the `.rgb` channels and nothing in the `.a` channel. The per-pixel normal is encoded as `normal * 0.5 + 0.5`.
     */
    NORMAL(1),
    /**
     * Index of [Image] in array of [Image]s returned by [bakeRenderUv2]. Image uses [Image.FORMAT_RGBA8] and contains ambient occlusion (from material and decals only) in the `.r` channel, roughness in the `.g` channel, metallic in the `.b` channel and sub surface scattering amount in the `.a` channel.
     */
    ORM(2),
    /**
     * Index of [Image] in array of [Image]s returned by [bakeRenderUv2]. Image uses [Image.FORMAT_RGBAH] and contains emission color in the `.rgb` channels and nothing in the `.a` channel.
     */
    EMISSION(3),
    ;
  ...
  public enum class CanvasOccluderPolygonCullMode(
    ...
    public companion object {
      public fun from(`value`: Long): CanvasOccluderPolygonCullMode = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class GlobalShaderParameterType(
    ...
    public companion object {
      public fun from(`value`: Long): GlobalShaderParameterType = entries.single { it.id == `value` }
    }
  }
  ...
  public object MethodBindings {
    internal val texture2dCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_2d_create", 2_010_018_390)

    internal val texture2dLayeredCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_2d_layered_create", 913_689_023)

    internal val texture3dCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_3d_create", 4_036_838_706)

    internal val textureProxyCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_proxy_create", 41_030_802)

    internal val textureCreateFromNativeHandlePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_create_from_native_handle", 1_682_977_582)

    internal val texture2dUpdatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_2d_update", 999_539_803)

    internal val texture3dUpdatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_3d_update", 684_822_712)

    internal val textureProxyUpdatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_proxy_update", 395_945_892)

    internal val texture2dPlaceholderCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_2d_placeholder_create", 529_393_457)

    internal val texture2dLayeredPlaceholderCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_2d_layered_placeholder_create", 1_394_585_590)

    internal val texture3dPlaceholderCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_3d_placeholder_create", 529_393_457)

    internal val texture2dGetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_2d_get", 4_206_205_781)

    internal val texture2dLayerGetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_2d_layer_get", 2_705_440_895)

    internal val texture3dGetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_3d_get", 2_684_255_073)

    internal val textureReplacePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_replace", 395_945_892)

    internal val textureSetSizeOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_set_size_override", 4_288_446_313)

    internal val textureSetPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_set_path", 2_726_140_452)

    internal val textureGetPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_get_path", 642_473_191)

    internal val textureGetFormatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_get_format", 1_932_918_979)

    internal val textureSetForceRedrawIfVisiblePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_set_force_redraw_if_visible", 1_265_174_801)

    internal val textureRdCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_rd_create", 1_434_128_712)

    internal val textureGetRdTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_get_rd_texture", 2_790_148_051)

    internal val textureGetNativeHandlePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "texture_get_native_handle", 1_834_114_100)

    internal val shaderCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "shader_create", 529_393_457)

    internal val shaderSetCodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "shader_set_code", 2_726_140_452)

    internal val shaderSetPathHintPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "shader_set_path_hint", 2_726_140_452)

    internal val shaderGetCodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "shader_get_code", 642_473_191)

    internal val getShaderParameterListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_shader_parameter_list", 2_684_255_073)

    internal val shaderGetParameterDefaultPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "shader_get_parameter_default", 2_621_281_810)

    internal val shaderSetDefaultTextureParameterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "shader_set_default_texture_parameter", 4_094_001_817)

    internal val shaderGetDefaultTextureParameterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "shader_get_default_texture_parameter", 1_464_608_890)

    internal val materialCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "material_create", 529_393_457)

    internal val materialSetShaderPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "material_set_shader", 395_945_892)

    internal val materialSetParamPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "material_set_param", 3_477_296_213)

    internal val materialGetParamPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "material_get_param", 2_621_281_810)

    internal val materialSetRenderPriorityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "material_set_render_priority", 3_411_492_887)

    internal val materialSetNextPassPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "material_set_next_pass", 395_945_892)

    internal val meshCreateFromSurfacesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_create_from_surfaces", 4_291_747_531)

    internal val meshCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_create", 529_393_457)

    internal val meshSurfaceGetFormatOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_get_format_offset", 2_981_368_685)

    internal val meshSurfaceGetFormatVertexStridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_get_format_vertex_stride", 3_188_363_337)

    internal val meshSurfaceGetFormatNormalTangentStridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_get_format_normal_tangent_stride", 3_188_363_337)

    internal val meshSurfaceGetFormatAttributeStridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_get_format_attribute_stride", 3_188_363_337)

    internal val meshSurfaceGetFormatSkinStridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_get_format_skin_stride", 3_188_363_337)

    internal val meshAddSurfacePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_add_surface", 1_217_542_888)

    internal val meshAddSurfaceFromArraysPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_add_surface_from_arrays", 2_342_446_560)

    internal val meshGetBlendShapeCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_get_blend_shape_count", 2_198_884_583)

    internal val meshSetBlendShapeModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_set_blend_shape_mode", 1_294_662_092)

    internal val meshGetBlendShapeModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_get_blend_shape_mode", 4_282_291_819)

    internal val meshSurfaceSetMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_set_material", 2_310_537_182)

    internal val meshSurfaceGetMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_get_material", 1_066_463_050)

    internal val meshGetSurfacePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_get_surface", 186_674_697)

    internal val meshSurfaceGetArraysPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_get_arrays", 1_778_388_067)

    internal val meshSurfaceGetBlendShapeArraysPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_get_blend_shape_arrays", 1_778_388_067)

    internal val meshGetSurfaceCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_get_surface_count", 2_198_884_583)

    internal val meshSetCustomAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_set_custom_aabb", 3_696_536_120)

    internal val meshGetCustomAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_get_custom_aabb", 974_181_306)

    internal val meshSurfaceRemovePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_remove", 3_411_492_887)

    internal val meshClearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_clear", 2_722_037_293)

    internal val meshSurfaceUpdateVertexRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_update_vertex_region", 2_900_195_149)

    internal val meshSurfaceUpdateAttributeRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_update_attribute_region", 2_900_195_149)

    internal val meshSurfaceUpdateSkinRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_surface_update_skin_region", 2_900_195_149)

    internal val meshSetShadowMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "mesh_set_shadow_mesh", 395_945_892)

    internal val multimeshCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_create", 529_393_457)

    internal val multimeshAllocateDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_allocate_data", 557_240_154)

    internal val multimeshGetInstanceCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_get_instance_count", 2_198_884_583)

    internal val multimeshSetMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_set_mesh", 395_945_892)

    internal val multimeshInstanceSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_set_transform", 675_327_471)

    internal val multimeshInstanceSetTransform2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_set_transform_2d", 736_082_694)

    internal val multimeshInstanceSetColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_set_color", 176_975_443)

    internal val multimeshInstanceSetCustomDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_set_custom_data", 176_975_443)

    internal val multimeshGetMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_get_mesh", 3_814_569_979)

    internal val multimeshGetAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_get_aabb", 974_181_306)

    internal val multimeshSetCustomAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_set_custom_aabb", 3_696_536_120)

    internal val multimeshGetCustomAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_get_custom_aabb", 974_181_306)

    internal val multimeshInstanceGetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_get_transform", 1_050_775_521)

    internal val multimeshInstanceGetTransform2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_get_transform_2d", 1_324_854_622)

    internal val multimeshInstanceGetColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_get_color", 2_946_315_076)

    internal val multimeshInstanceGetCustomDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_get_custom_data", 2_946_315_076)

    internal val multimeshSetVisibleInstancesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_set_visible_instances", 3_411_492_887)

    internal val multimeshGetVisibleInstancesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_get_visible_instances", 2_198_884_583)

    internal val multimeshSetBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_set_buffer", 2_960_552_364)

    internal val multimeshGetCommandBufferRdRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_get_command_buffer_rd_rid", 3_814_569_979)

    internal val multimeshGetBufferRdRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_get_buffer_rd_rid", 3_814_569_979)

    internal val multimeshGetBufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_get_buffer", 3_964_669_176)

    internal val multimeshSetBufferInterpolatedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_set_buffer_interpolated", 659_844_711)

    internal val multimeshSetPhysicsInterpolatedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_set_physics_interpolated", 1_265_174_801)

    internal val multimeshSetPhysicsInterpolationQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_set_physics_interpolation_quality", 3_934_808_223)

    internal val multimeshInstanceResetPhysicsInterpolationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "multimesh_instance_reset_physics_interpolation", 3_411_492_887)

    internal val skeletonCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "skeleton_create", 529_393_457)

    internal val skeletonAllocateDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "skeleton_allocate_data", 1_904_426_712)

    internal val skeletonGetBoneCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "skeleton_get_bone_count", 2_198_884_583)

    internal val skeletonBoneSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "skeleton_bone_set_transform", 675_327_471)

    internal val skeletonBoneGetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "skeleton_bone_get_transform", 1_050_775_521)

    internal val skeletonBoneSetTransform2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "skeleton_bone_set_transform_2d", 736_082_694)

    internal val skeletonBoneGetTransform2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "skeleton_bone_get_transform_2d", 1_324_854_622)

    internal val skeletonSetBaseTransform2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "skeleton_set_base_transform_2d", 1_246_044_741)

    internal val directionalLightCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "directional_light_create", 529_393_457)

    internal val omniLightCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "omni_light_create", 529_393_457)

    internal val spotLightCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "spot_light_create", 529_393_457)

    internal val lightSetColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_color", 2_948_539_648)

    internal val lightSetParamPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_param", 501_936_875)

    internal val lightSetShadowPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_shadow", 1_265_174_801)

    internal val lightSetProjectorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_projector", 395_945_892)

    internal val lightSetNegativePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_negative", 1_265_174_801)

    internal val lightSetCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_cull_mask", 3_411_492_887)

    internal val lightSetDistanceFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_distance_fade", 1_622_292_572)

    internal val lightSetReverseCullFaceModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_reverse_cull_face_mode", 1_265_174_801)

    internal val lightSetShadowCasterMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_shadow_caster_mask", 3_411_492_887)

    internal val lightSetBakeModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_bake_mode", 1_048_525_260)

    internal val lightSetMaxSdfgiCascadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_set_max_sdfgi_cascade", 3_411_492_887)

    internal val lightOmniSetShadowModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_omni_set_shadow_mode", 2_552_677_200)

    internal val lightDirectionalSetShadowModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_directional_set_shadow_mode", 380_462_970)

    internal val lightDirectionalSetBlendSplitsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_directional_set_blend_splits", 1_265_174_801)

    internal val lightDirectionalSetSkyModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_directional_set_sky_mode", 2_559_740_754)

    internal val lightProjectorsSetFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "light_projectors_set_filter", 43_944_325)

    internal val lightmapsSetBicubicFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmaps_set_bicubic_filter", 2_586_408_642)

    internal val positionalSoftShadowFilterSetQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "positional_soft_shadow_filter_set_quality", 3_613_045_266)

    internal val directionalSoftShadowFilterSetQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "directional_soft_shadow_filter_set_quality", 3_613_045_266)

    internal val directionalShadowAtlasSetSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "directional_shadow_atlas_set_size", 300_928_843)

    internal val reflectionProbeCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_create", 529_393_457)

    internal val reflectionProbeSetUpdateModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_update_mode", 3_853_670_147)

    internal val reflectionProbeSetIntensityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_intensity", 1_794_382_983)

    internal val reflectionProbeSetBlendDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_blend_distance", 1_794_382_983)

    internal val reflectionProbeSetAmbientModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_ambient_mode", 184_163_074)

    internal val reflectionProbeSetAmbientColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_ambient_color", 2_948_539_648)

    internal val reflectionProbeSetAmbientEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_ambient_energy", 1_794_382_983)

    internal val reflectionProbeSetMaxDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_max_distance", 1_794_382_983)

    internal val reflectionProbeSetSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_size", 3_227_306_858)

    internal val reflectionProbeSetOriginOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_origin_offset", 3_227_306_858)

    internal val reflectionProbeSetAsInteriorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_as_interior", 1_265_174_801)

    internal val reflectionProbeSetEnableBoxProjectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_enable_box_projection", 1_265_174_801)

    internal val reflectionProbeSetEnableShadowsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_enable_shadows", 1_265_174_801)

    internal val reflectionProbeSetCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_cull_mask", 3_411_492_887)

    internal val reflectionProbeSetReflectionMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_reflection_mask", 3_411_492_887)

    internal val reflectionProbeSetResolutionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_resolution", 3_411_492_887)

    internal val reflectionProbeSetMeshLodThresholdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "reflection_probe_set_mesh_lod_threshold", 1_794_382_983)

    internal val decalCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_create", 529_393_457)

    internal val decalSetSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_size", 3_227_306_858)

    internal val decalSetTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_texture", 3_953_344_054)

    internal val decalSetEmissionEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_emission_energy", 1_794_382_983)

    internal val decalSetAlbedoMixPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_albedo_mix", 1_794_382_983)

    internal val decalSetModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_modulate", 2_948_539_648)

    internal val decalSetCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_cull_mask", 3_411_492_887)

    internal val decalSetDistanceFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_distance_fade", 2_972_769_666)

    internal val decalSetFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_fade", 2_513_314_492)

    internal val decalSetNormalFadePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decal_set_normal_fade", 1_794_382_983)

    internal val decalsSetFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "decals_set_filter", 3_519_875_702)

    internal val giSetUseHalfResolutionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "gi_set_use_half_resolution", 2_586_408_642)

    internal val voxelGiCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_create", 529_393_457)

    internal val voxelGiAllocateDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_allocate_data", 4_108_223_027)

    internal val voxelGiGetOctreeSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_get_octree_size", 2_607_699_645)

    internal val voxelGiGetOctreeCellsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_get_octree_cells", 3_348_040_486)

    internal val voxelGiGetDataCellsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_get_data_cells", 3_348_040_486)

    internal val voxelGiGetDistanceFieldPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_get_distance_field", 3_348_040_486)

    internal val voxelGiGetLevelCountsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_get_level_counts", 788_230_395)

    internal val voxelGiGetToCellXformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_get_to_cell_xform", 1_128_465_797)

    internal val voxelGiSetDynamicRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_dynamic_range", 1_794_382_983)

    internal val voxelGiSetPropagationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_propagation", 1_794_382_983)

    internal val voxelGiSetEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_energy", 1_794_382_983)

    internal val voxelGiSetBakedExposureNormalizationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_baked_exposure_normalization", 1_794_382_983)

    internal val voxelGiSetBiasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_bias", 1_794_382_983)

    internal val voxelGiSetNormalBiasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_normal_bias", 1_794_382_983)

    internal val voxelGiSetInteriorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_interior", 1_265_174_801)

    internal val voxelGiSetUseTwoBouncesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_use_two_bounces", 1_265_174_801)

    internal val voxelGiSetQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "voxel_gi_set_quality", 1_538_689_978)

    internal val lightmapCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_create", 529_393_457)

    internal val lightmapSetTexturesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_set_textures", 2_646_464_759)

    internal val lightmapSetProbeBoundsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_set_probe_bounds", 3_696_536_120)

    internal val lightmapSetProbeInteriorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_set_probe_interior", 1_265_174_801)

    internal val lightmapSetProbeCaptureDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_set_probe_capture_data", 3_217_845_880)

    internal val lightmapGetProbeCapturePointsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_get_probe_capture_points", 808_965_560)

    internal val lightmapGetProbeCaptureShPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_get_probe_capture_sh", 1_569_415_609)

    internal val lightmapGetProbeCaptureTetrahedraPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_get_probe_capture_tetrahedra", 788_230_395)

    internal val lightmapGetProbeCaptureBspTreePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_get_probe_capture_bsp_tree", 788_230_395)

    internal val lightmapSetBakedExposureNormalizationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_set_baked_exposure_normalization", 1_794_382_983)

    internal val lightmapSetProbeCaptureUpdateSpeedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "lightmap_set_probe_capture_update_speed", 373_806_689)

    internal val particlesCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_create", 529_393_457)

    internal val particlesSetModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_mode", 3_492_270_028)

    internal val particlesSetEmittingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_emitting", 1_265_174_801)

    internal val particlesGetEmittingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_get_emitting", 3_521_089_500)

    internal val particlesSetAmountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_amount", 3_411_492_887)

    internal val particlesSetAmountRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_amount_ratio", 1_794_382_983)

    internal val particlesSetLifetimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_lifetime", 1_794_382_983)

    internal val particlesSetOneShotPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_one_shot", 1_265_174_801)

    internal val particlesSetPreProcessTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_pre_process_time", 1_794_382_983)

    internal val particlesRequestProcessTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_request_process_time", 1_794_382_983)

    internal val particlesSetExplosivenessRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_explosiveness_ratio", 1_794_382_983)

    internal val particlesSetRandomnessRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_randomness_ratio", 1_794_382_983)

    internal val particlesSetInterpToEndPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_interp_to_end", 1_794_382_983)

    internal val particlesSetEmitterVelocityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_emitter_velocity", 3_227_306_858)

    internal val particlesSetCustomAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_custom_aabb", 3_696_536_120)

    internal val particlesSetSpeedScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_speed_scale", 1_794_382_983)

    internal val particlesSetUseLocalCoordinatesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_use_local_coordinates", 1_265_174_801)

    internal val particlesSetProcessMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_process_material", 395_945_892)

    internal val particlesSetFixedFpsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_fixed_fps", 3_411_492_887)

    internal val particlesSetInterpolatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_interpolate", 1_265_174_801)

    internal val particlesSetFractionalDeltaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_fractional_delta", 1_265_174_801)

    internal val particlesSetCollisionBaseSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_collision_base_size", 1_794_382_983)

    internal val particlesSetTransformAlignPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_transform_align", 3_264_971_368)

    internal val particlesSetTrailsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_trails", 2_010_054_925)

    internal val particlesSetTrailBindPosesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_trail_bind_poses", 684_822_712)

    internal val particlesIsInactivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_is_inactive", 3_521_089_500)

    internal val particlesRequestProcessPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_request_process", 2_722_037_293)

    internal val particlesRestartPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_restart", 2_722_037_293)

    internal val particlesSetSubemitterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_subemitter", 395_945_892)

    internal val particlesEmitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_emit", 4_043_136_117)

    internal val particlesSetDrawOrderPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_draw_order", 935_028_487)

    internal val particlesSetDrawPassesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_draw_passes", 3_411_492_887)

    internal val particlesSetDrawPassMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_draw_pass_mesh", 2_310_537_182)

    internal val particlesGetCurrentAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_get_current_aabb", 3_952_830_260)

    internal val particlesSetEmissionTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_set_emission_transform", 3_935_195_649)

    internal val particlesCollisionCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_create", 529_393_457)

    internal val particlesCollisionSetCollisionTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_collision_type", 1_497_044_930)

    internal val particlesCollisionSetCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_cull_mask", 3_411_492_887)

    internal val particlesCollisionSetSphereRadiusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_sphere_radius", 1_794_382_983)

    internal val particlesCollisionSetBoxExtentsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_box_extents", 3_227_306_858)

    internal val particlesCollisionSetAttractorStrengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_attractor_strength", 1_794_382_983)

    internal val particlesCollisionSetAttractorDirectionalityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_attractor_directionality", 1_794_382_983)

    internal val particlesCollisionSetAttractorAttenuationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_attractor_attenuation", 1_794_382_983)

    internal val particlesCollisionSetFieldTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_field_texture", 395_945_892)

    internal val particlesCollisionHeightFieldUpdatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_height_field_update", 2_722_037_293)

    internal val particlesCollisionSetHeightFieldResolutionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_height_field_resolution", 962_977_297)

    internal val particlesCollisionSetHeightFieldMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "particles_collision_set_height_field_mask", 3_411_492_887)

    internal val fogVolumeCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "fog_volume_create", 529_393_457)

    internal val fogVolumeSetShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "fog_volume_set_shape", 3_818_703_106)

    internal val fogVolumeSetSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "fog_volume_set_size", 3_227_306_858)

    internal val fogVolumeSetMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "fog_volume_set_material", 395_945_892)

    internal val visibilityNotifierCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "visibility_notifier_create", 529_393_457)

    internal val visibilityNotifierSetAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "visibility_notifier_set_aabb", 3_696_536_120)

    internal val visibilityNotifierSetCallbacksPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "visibility_notifier_set_callbacks", 2_689_735_388)

    internal val occluderCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "occluder_create", 529_393_457)

    internal val occluderSetMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "occluder_set_mesh", 3_854_404_263)

    internal val cameraCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_create", 529_393_457)

    internal val cameraSetPerspectivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_perspective", 157_498_339)

    internal val cameraSetOrthogonalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_orthogonal", 157_498_339)

    internal val cameraSetFrustumPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_frustum", 1_889_878_953)

    internal val cameraSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_transform", 3_935_195_649)

    internal val cameraSetCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_cull_mask", 3_411_492_887)

    internal val cameraSetEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_environment", 395_945_892)

    internal val cameraSetCameraAttributesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_camera_attributes", 395_945_892)

    internal val cameraSetCompositorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_compositor", 395_945_892)

    internal val cameraSetUseVerticalAspectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_set_use_vertical_aspect", 1_265_174_801)

    internal val viewportCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_create", 529_393_457)

    internal val viewportSetUseXrPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_use_xr", 1_265_174_801)

    internal val viewportSetSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_size", 4_288_446_313)

    internal val viewportSetActivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_active", 1_265_174_801)

    internal val viewportSetParentViewportPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_parent_viewport", 395_945_892)

    internal val viewportAttachToScreenPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_attach_to_screen", 1_062_245_816)

    internal val viewportSetRenderDirectToScreenPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_render_direct_to_screen", 1_265_174_801)

    internal val viewportSetCanvasCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_canvas_cull_mask", 3_411_492_887)

    internal val viewportSetScaling3dModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_scaling_3d_mode", 2_386_524_376)

    internal val viewportSetScaling3dScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_scaling_3d_scale", 1_794_382_983)

    internal val viewportSetFsrSharpnessPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_fsr_sharpness", 1_794_382_983)

    internal val viewportSetTextureMipmapBiasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_texture_mipmap_bias", 1_794_382_983)

    internal val viewportSetAnisotropicFilteringLevelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_anisotropic_filtering_level", 3_953_214_029)

    internal val viewportSetUpdateModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_update_mode", 3_161_116_010)

    internal val viewportGetUpdateModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_get_update_mode", 3_803_901_472)

    internal val viewportSetClearModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_clear_mode", 3_628_367_896)

    internal val viewportGetRenderTargetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_get_render_target", 3_814_569_979)

    internal val viewportGetTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_get_texture", 3_814_569_979)

    internal val viewportSetDisable3dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_disable_3d", 1_265_174_801)

    internal val viewportSetDisable2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_disable_2d", 1_265_174_801)

    internal val viewportSetEnvironmentModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_environment_mode", 2_196_892_182)

    internal val viewportAttachCameraPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_attach_camera", 395_945_892)

    internal val viewportSetScenarioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_scenario", 395_945_892)

    internal val viewportAttachCanvasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_attach_canvas", 395_945_892)

    internal val viewportRemoveCanvasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_remove_canvas", 395_945_892)

    internal val viewportSetSnap2dTransformsToPixelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_snap_2d_transforms_to_pixel", 1_265_174_801)

    internal val viewportSetSnap2dVerticesToPixelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_snap_2d_vertices_to_pixel", 1_265_174_801)

    internal val viewportSetDefaultCanvasItemTextureFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_default_canvas_item_texture_filter", 1_155_129_294)

    internal val viewportSetDefaultCanvasItemTextureRepeatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_default_canvas_item_texture_repeat", 1_652_956_681)

    internal val viewportSetCanvasTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_canvas_transform", 3_608_606_053)

    internal val viewportSetCanvasStackingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_canvas_stacking", 3_713_930_247)

    internal val viewportSetTransparentBackgroundPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_transparent_background", 1_265_174_801)

    internal val viewportSetGlobalCanvasTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_global_canvas_transform", 1_246_044_741)

    internal val viewportSetSdfOversizeAndScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_sdf_oversize_and_scale", 1_329_198_632)

    internal val viewportSetPositionalShadowAtlasSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_positional_shadow_atlas_size", 1_904_426_712)

    internal val viewportSetPositionalShadowAtlasQuadrantSubdivisionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_positional_shadow_atlas_quadrant_subdivision", 4_288_446_313)

    internal val viewportSetMsaa3dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_msaa_3d", 3_764_433_340)

    internal val viewportSetMsaa2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_msaa_2d", 3_764_433_340)

    internal val viewportSetUseHdr2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_use_hdr_2d", 1_265_174_801)

    internal val viewportSetScreenSpaceAaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_screen_space_aa", 1_447_279_591)

    internal val viewportSetUseTaaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_use_taa", 1_265_174_801)

    internal val viewportSetUseDebandingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_use_debanding", 1_265_174_801)

    internal val viewportSetUseOcclusionCullingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_use_occlusion_culling", 1_265_174_801)

    internal val viewportSetOcclusionRaysPerThreadPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_occlusion_rays_per_thread", 1_286_410_249)

    internal val viewportSetOcclusionCullingBuildQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_occlusion_culling_build_quality", 2_069_725_696)

    internal val viewportGetRenderInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_get_render_info", 2_041_262_392)

    internal val viewportSetDebugDrawPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_debug_draw", 2_089_420_930)

    internal val viewportSetMeasureRenderTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_measure_render_time", 1_265_174_801)

    internal val viewportGetMeasuredRenderTimeCpuPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_get_measured_render_time_cpu", 866_169_185)

    internal val viewportGetMeasuredRenderTimeGpuPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_get_measured_render_time_gpu", 866_169_185)

    internal val viewportSetVrsModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_vrs_mode", 398_809_874)

    internal val viewportSetVrsUpdateModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_vrs_update_mode", 2_696_154_815)

    internal val viewportSetVrsTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "viewport_set_vrs_texture", 395_945_892)

    internal val skyCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "sky_create", 529_393_457)

    internal val skySetRadianceSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "sky_set_radiance_size", 3_411_492_887)

    internal val skySetModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "sky_set_mode", 3_279_019_937)

    internal val skySetMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "sky_set_material", 395_945_892)

    internal val skyBakePanoramaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "sky_bake_panorama", 3_875_285_818)

    internal val compositorEffectCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "compositor_effect_create", 529_393_457)

    internal val compositorEffectSetEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "compositor_effect_set_enabled", 1_265_174_801)

    internal val compositorEffectSetCallbackPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "compositor_effect_set_callback", 487_412_485)

    internal val compositorEffectSetFlagPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "compositor_effect_set_flag", 3_659_527_075)

    internal val compositorCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "compositor_create", 529_393_457)

    internal val compositorSetCompositorEffectsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "compositor_set_compositor_effects", 684_822_712)

    internal val environmentCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_create", 529_393_457)

    internal val environmentSetBackgroundPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_background", 3_937_328_877)

    internal val environmentSetCameraIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_camera_id", 3_411_492_887)

    internal val environmentSetSkyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_sky", 395_945_892)

    internal val environmentSetSkyCustomFovPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_sky_custom_fov", 1_794_382_983)

    internal val environmentSetSkyOrientationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_sky_orientation", 1_735_850_857)

    internal val environmentSetBgColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_bg_color", 2_948_539_648)

    internal val environmentSetBgEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_bg_energy", 2_513_314_492)

    internal val environmentSetCanvasMaxLayerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_canvas_max_layer", 3_411_492_887)

    internal val environmentSetAmbientLightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_ambient_light", 1_214_961_493)

    internal val environmentSetGlowPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_glow", 2_421_724_940)

    internal val environmentSetTonemapPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_tonemap", 2_914_312_638)

    internal val environmentSetAdjustmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_adjustment", 876_799_838)

    internal val environmentSetSsrPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_ssr", 3_607_294_374)

    internal val environmentSetSsaoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_ssao", 3_994_732_740)

    internal val environmentSetFogPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_fog", 105_051_629)

    internal val environmentSetSdfgiPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_sdfgi", 3_519_144_388)

    internal val environmentSetVolumetricFogPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_volumetric_fog", 1_553_633_833)

    internal val environmentGlowSetUseBicubicUpscalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_glow_set_use_bicubic_upscale", 2_586_408_642)

    internal val environmentSetSsrRoughnessQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_ssr_roughness_quality", 1_190_026_788)

    internal val environmentSetSsaoQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_ssao_quality", 189_753_569)

    internal val environmentSetSsilQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_ssil_quality", 1_713_836_683)

    internal val environmentSetSdfgiRayCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_sdfgi_ray_count", 340_137_951)

    internal val environmentSetSdfgiFramesToConvergePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_sdfgi_frames_to_converge", 2_182_444_374)

    internal val environmentSetSdfgiFramesToUpdateLightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_sdfgi_frames_to_update_light", 1_251_144_068)

    internal val environmentSetVolumetricFogVolumeSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_volumetric_fog_volume_size", 3_937_882_851)

    internal val environmentSetVolumetricFogFilterActivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_set_volumetric_fog_filter_active", 2_586_408_642)

    internal val environmentBakePanoramaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "environment_bake_panorama", 2_452_908_646)

    internal val screenSpaceRoughnessLimiterSetActivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "screen_space_roughness_limiter_set_active", 916_716_790)

    internal val subSurfaceScatteringSetQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "sub_surface_scattering_set_quality", 64_571_803)

    internal val subSurfaceScatteringSetScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "sub_surface_scattering_set_scale", 1_017_552_074)

    internal val cameraAttributesCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_attributes_create", 529_393_457)

    internal val cameraAttributesSetDofBlurQualityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_attributes_set_dof_blur_quality", 2_220_136_795)

    internal val cameraAttributesSetDofBlurBokehShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_attributes_set_dof_blur_bokeh_shape", 1_205_058_394)

    internal val cameraAttributesSetDofBlurPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_attributes_set_dof_blur", 316_272_616)

    internal val cameraAttributesSetExposurePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_attributes_set_exposure", 2_513_314_492)

    internal val cameraAttributesSetAutoExposurePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "camera_attributes_set_auto_exposure", 4_266_986_332)

    internal val scenarioCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "scenario_create", 529_393_457)

    internal val scenarioSetEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "scenario_set_environment", 395_945_892)

    internal val scenarioSetFallbackEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "scenario_set_fallback_environment", 395_945_892)

    internal val scenarioSetCameraAttributesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "scenario_set_camera_attributes", 395_945_892)

    internal val scenarioSetCompositorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "scenario_set_compositor", 395_945_892)

    internal val instanceCreate2Ptr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_create2", 746_547_085)

    internal val instanceCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_create", 529_393_457)

    internal val instanceSetBasePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_base", 395_945_892)

    internal val instanceSetScenarioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_scenario", 395_945_892)

    internal val instanceSetLayerMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_layer_mask", 3_411_492_887)

    internal val instanceSetPivotDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_pivot_data", 1_280_615_259)

    internal val instanceSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_transform", 3_935_195_649)

    internal val instanceSetInterpolatedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_interpolated", 1_265_174_801)

    internal val instanceResetPhysicsInterpolationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_reset_physics_interpolation", 2_722_037_293)

    internal val instanceAttachObjectInstanceIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_attach_object_instance_id", 3_411_492_887)

    internal val instanceSetBlendShapeWeightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_blend_shape_weight", 1_892_459_533)

    internal val instanceSetSurfaceOverrideMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_surface_override_material", 2_310_537_182)

    internal val instanceSetVisiblePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_visible", 1_265_174_801)

    internal val instanceGeometrySetTransparencyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_transparency", 1_794_382_983)

    internal val instanceSetCustomAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_custom_aabb", 3_696_536_120)

    internal val instanceAttachSkeletonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_attach_skeleton", 395_945_892)

    internal val instanceSetExtraVisibilityMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_extra_visibility_margin", 1_794_382_983)

    internal val instanceSetVisibilityParentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_visibility_parent", 395_945_892)

    internal val instanceSetIgnoreCullingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_set_ignore_culling", 1_265_174_801)

    internal val instanceGeometrySetFlagPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_flag", 1_014_989_537)

    internal val instanceGeometrySetCastShadowsSettingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_cast_shadows_setting", 3_768_836_020)

    internal val instanceGeometrySetMaterialOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_material_override", 395_945_892)

    internal val instanceGeometrySetMaterialOverlayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_material_overlay", 395_945_892)

    internal val instanceGeometrySetVisibilityRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_visibility_range", 4_263_925_858)

    internal val instanceGeometrySetLightmapPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_lightmap", 536_974_962)

    internal val instanceGeometrySetLodBiasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_lod_bias", 1_794_382_983)

    internal val instanceGeometrySetShaderParameterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_set_shader_parameter", 3_477_296_213)

    internal val instanceGeometryGetShaderParameterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_get_shader_parameter", 2_621_281_810)

    internal val instanceGeometryGetShaderParameterDefaultValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_get_shader_parameter_default_value", 2_621_281_810)

    internal val instanceGeometryGetShaderParameterListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instance_geometry_get_shader_parameter_list", 2_684_255_073)

    internal val instancesCullAabbPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instances_cull_aabb", 2_570_105_777)

    internal val instancesCullRayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instances_cull_ray", 2_208_759_584)

    internal val instancesCullConvexPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "instances_cull_convex", 2_488_539_944)

    internal val bakeRenderUv2Ptr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "bake_render_uv2", 1_904_608_558)

    internal val canvasCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_create", 529_393_457)

    internal val canvasSetItemMirroringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_set_item_mirroring", 2_343_975_398)

    internal val canvasSetItemRepeatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_set_item_repeat", 1_739_512_717)

    internal val canvasSetModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_set_modulate", 2_948_539_648)

    internal val canvasSetDisableScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_set_disable_scale", 2_586_408_642)

    internal val canvasTextureCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_texture_create", 529_393_457)

    internal val canvasTextureSetChannelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_texture_set_channel", 3_822_119_138)

    internal val canvasTextureSetShadingParametersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_texture_set_shading_parameters", 2_124_967_469)

    internal val canvasTextureSetTextureFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_texture_set_texture_filter", 1_155_129_294)

    internal val canvasTextureSetTextureRepeatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_texture_set_texture_repeat", 1_652_956_681)

    internal val canvasItemCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_create", 529_393_457)

    internal val canvasItemSetParentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_parent", 395_945_892)

    internal val canvasItemSetDefaultTextureFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_default_texture_filter", 1_155_129_294)

    internal val canvasItemSetDefaultTextureRepeatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_default_texture_repeat", 1_652_956_681)

    internal val canvasItemSetVisiblePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_visible", 1_265_174_801)

    internal val canvasItemSetLightMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_light_mask", 3_411_492_887)

    internal val canvasItemSetVisibilityLayerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_visibility_layer", 3_411_492_887)

    internal val canvasItemSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_transform", 1_246_044_741)

    internal val canvasItemSetClipPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_clip", 1_265_174_801)

    internal val canvasItemSetDistanceFieldModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_distance_field_mode", 1_265_174_801)

    internal val canvasItemSetCustomRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_custom_rect", 1_333_997_032)

    internal val canvasItemSetModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_modulate", 2_948_539_648)

    internal val canvasItemSetSelfModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_self_modulate", 2_948_539_648)

    internal val canvasItemSetDrawBehindParentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_draw_behind_parent", 1_265_174_801)

    internal val canvasItemSetInterpolatedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_interpolated", 1_265_174_801)

    internal val canvasItemResetPhysicsInterpolationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_reset_physics_interpolation", 2_722_037_293)

    internal val canvasItemTransformPhysicsInterpolationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_transform_physics_interpolation", 1_246_044_741)

    internal val canvasItemAddLinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_line", 1_819_681_853)

    internal val canvasItemAddPolylinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_polyline", 3_098_767_073)

    internal val canvasItemAddMultilinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_multiline", 3_098_767_073)

    internal val canvasItemAddRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_rect", 3_523_446_176)

    internal val canvasItemAddCirclePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_circle", 333_077_949)

    internal val canvasItemAddTextureRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_texture_rect", 324_864_032)

    internal val canvasItemAddMsdfTextureRectRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_msdf_texture_rect_region", 97_408_773)

    internal val canvasItemAddLcdTextureRectRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_lcd_texture_rect_region", 359_793_297)

    internal val canvasItemAddTextureRectRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_texture_rect_region", 485_157_892)

    internal val canvasItemAddNinePatchPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_nine_patch", 389_957_886)

    internal val canvasItemAddPrimitivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_primitive", 3_731_601_077)

    internal val canvasItemAddPolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_polygon", 3_580_000_528)

    internal val canvasItemAddTriangleArrayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_triangle_array", 660_261_329)

    internal val canvasItemAddMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_mesh", 316_450_961)

    internal val canvasItemAddMultimeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_multimesh", 2_131_855_138)

    internal val canvasItemAddParticlesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_particles", 2_575_754_278)

    internal val canvasItemAddSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_set_transform", 1_246_044_741)

    internal val canvasItemAddClipIgnorePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_clip_ignore", 1_265_174_801)

    internal val canvasItemAddAnimationSlicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_add_animation_slice", 2_646_834_499)

    internal val canvasItemSetSortChildrenByYPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_sort_children_by_y", 1_265_174_801)

    internal val canvasItemSetZIndexPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_z_index", 3_411_492_887)

    internal val canvasItemSetZAsRelativeToParentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_z_as_relative_to_parent", 1_265_174_801)

    internal val canvasItemSetCopyToBackbufferPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_copy_to_backbuffer", 2_429_202_503)

    internal val canvasItemAttachSkeletonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_attach_skeleton", 395_945_892)

    internal val canvasItemClearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_clear", 2_722_037_293)

    internal val canvasItemSetDrawIndexPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_draw_index", 3_411_492_887)

    internal val canvasItemSetMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_material", 395_945_892)

    internal val canvasItemSetUseParentMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_use_parent_material", 1_265_174_801)

    internal val canvasItemSetInstanceShaderParameterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_instance_shader_parameter", 3_477_296_213)

    internal val canvasItemGetInstanceShaderParameterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_get_instance_shader_parameter", 2_621_281_810)

    internal val canvasItemGetInstanceShaderParameterDefaultValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_get_instance_shader_parameter_default_value", 2_621_281_810)

    internal val canvasItemGetInstanceShaderParameterListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_get_instance_shader_parameter_list", 2_684_255_073)

    internal val canvasItemSetVisibilityNotifierPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_visibility_notifier", 3_568_945_579)

    internal val canvasItemSetCanvasGroupModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_item_set_canvas_group_mode", 3_973_586_316)

    internal val debugCanvasItemGetRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "debug_canvas_item_get_rect", 624_227_424)

    internal val canvasLightCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_create", 529_393_457)

    internal val canvasLightAttachToCanvasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_attach_to_canvas", 395_945_892)

    internal val canvasLightSetEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_enabled", 1_265_174_801)

    internal val canvasLightSetTextureScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_texture_scale", 1_794_382_983)

    internal val canvasLightSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_transform", 1_246_044_741)

    internal val canvasLightSetTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_texture", 395_945_892)

    internal val canvasLightSetTextureOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_texture_offset", 3_201_125_042)

    internal val canvasLightSetColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_color", 2_948_539_648)

    internal val canvasLightSetHeightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_height", 1_794_382_983)

    internal val canvasLightSetEnergyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_energy", 1_794_382_983)

    internal val canvasLightSetZRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_z_range", 4_288_446_313)

    internal val canvasLightSetLayerRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_layer_range", 4_288_446_313)

    internal val canvasLightSetItemCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_item_cull_mask", 3_411_492_887)

    internal val canvasLightSetItemShadowCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_item_shadow_cull_mask", 3_411_492_887)

    internal val canvasLightSetModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_mode", 2_957_564_891)

    internal val canvasLightSetShadowEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_shadow_enabled", 1_265_174_801)

    internal val canvasLightSetShadowFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_shadow_filter", 393_119_659)

    internal val canvasLightSetShadowColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_shadow_color", 2_948_539_648)

    internal val canvasLightSetShadowSmoothPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_shadow_smooth", 1_794_382_983)

    internal val canvasLightSetBlendModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_blend_mode", 804_895_945)

    internal val canvasLightSetInterpolatedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_set_interpolated", 1_265_174_801)

    internal val canvasLightResetPhysicsInterpolationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_reset_physics_interpolation", 2_722_037_293)

    internal val canvasLightTransformPhysicsInterpolationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_transform_physics_interpolation", 1_246_044_741)

    internal val canvasLightOccluderCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_create", 529_393_457)

    internal val canvasLightOccluderAttachToCanvasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_attach_to_canvas", 395_945_892)

    internal val canvasLightOccluderSetEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_set_enabled", 1_265_174_801)

    internal val canvasLightOccluderSetPolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_set_polygon", 395_945_892)

    internal val canvasLightOccluderSetAsSdfCollisionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_set_as_sdf_collision", 1_265_174_801)

    internal val canvasLightOccluderSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_set_transform", 1_246_044_741)

    internal val canvasLightOccluderSetLightMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_set_light_mask", 3_411_492_887)

    internal val canvasLightOccluderSetInterpolatedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_set_interpolated", 1_265_174_801)

    internal val canvasLightOccluderResetPhysicsInterpolationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_reset_physics_interpolation", 2_722_037_293)

    internal val canvasLightOccluderTransformPhysicsInterpolationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_light_occluder_transform_physics_interpolation", 1_246_044_741)

    internal val canvasOccluderPolygonCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_occluder_polygon_create", 529_393_457)

    internal val canvasOccluderPolygonSetShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_occluder_polygon_set_shape", 2_103_882_027)

    internal val canvasOccluderPolygonSetCullModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_occluder_polygon_set_cull_mode", 1_839_404_663)

    internal val canvasSetShadowTextureSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "canvas_set_shadow_texture_size", 1_286_410_249)

    internal val globalShaderParameterAddPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "global_shader_parameter_add", 463_390_080)

    internal val globalShaderParameterRemovePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "global_shader_parameter_remove", 3_304_788_590)

    internal val globalShaderParameterGetListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "global_shader_parameter_get_list", 3_995_934_104)

    internal val globalShaderParameterSetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "global_shader_parameter_set", 3_776_071_444)

    internal val globalShaderParameterSetOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "global_shader_parameter_set_override", 3_776_071_444)

    internal val globalShaderParameterGetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "global_shader_parameter_get", 2_760_726_917)

    internal val globalShaderParameterGetTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "global_shader_parameter_get_type", 1_601_414_142)

    internal val freeRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "free_rid", 2_722_037_293)

    internal val requestFrameDrawnCallbackPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "request_frame_drawn_callback", 1_611_583_062)

    internal val hasChangedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "has_changed", 36_873_697)

    internal val getRenderingInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_rendering_info", 3_763_192_241)

    internal val getVideoAdapterNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_video_adapter_name", 201_670_096)

    internal val getVideoAdapterVendorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_video_adapter_vendor", 201_670_096)

    internal val getVideoAdapterTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_video_adapter_type", 3_099_547_011)

    internal val getVideoAdapterApiVersionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_video_adapter_api_version", 201_670_096)

    internal val getCurrentRenderingDriverNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_current_rendering_driver_name", 201_670_096)

    internal val getCurrentRenderingMethodPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_current_rendering_method", 201_670_096)

    internal val makeSphereMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "make_sphere_mesh", 2_251_015_897)

    internal val getTestCubePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_test_cube", 529_393_457)

    internal val getTestTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_test_texture", 529_393_457)

    internal val getWhiteTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_white_texture", 529_393_457)

    internal val setBootImagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "set_boot_image", 3_759_744_527)

    internal val getDefaultClearColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_default_clear_color", 3_200_896_285)

    internal val setDefaultClearColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "set_default_clear_color", 2_920_490_490)

    internal val hasOsFeaturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "has_os_feature", 3_927_539_163)

    internal val setDebugGenerateWireframesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "set_debug_generate_wireframes", 2_586_408_642)

    internal val isRenderLoopEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "is_render_loop_enabled", 36_873_697)

    internal val setRenderLoopEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "set_render_loop_enabled", 2_586_408_642)

    internal val getFrameSetupTimeCpuPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_frame_setup_time_cpu", 1_740_695_150)

    internal val forceSyncPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "force_sync", 3_218_959_716)

    internal val forceDrawPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "force_draw", 1_076_185_472)

    internal val getRenderingDevicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "get_rendering_device", 1_405_107_940)

    internal val createLocalRenderingDevicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "create_local_rendering_device", 1_405_107_940)

    internal val isOnRenderThreadPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "is_on_render_thread", 2_240_911_060)

    internal val callOnRenderThreadPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "call_on_render_thread", 1_611_583_062)

    internal val hasFeaturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingServer", "has_feature", 598_462_696)
  }
}
