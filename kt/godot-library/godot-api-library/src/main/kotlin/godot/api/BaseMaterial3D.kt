...
import godot.getAlbedoPtr
import godot.getAlphaAntialiasingEdgePtr
import godot.getAlphaAntialiasingPtr
import godot.getAlphaHashScalePtr
import godot.getAlphaScissorThresholdPtr
import godot.getAnisotropyPtr
import godot.getAoLightAffectPtr
import godot.getAoTextureChannelPtr
import godot.getBacklightPtr
import godot.getBillboardModePtr
import godot.getBlendModePtr
import godot.getClearcoatPtr
import godot.getClearcoatRoughnessPtr
import godot.getCullModePtr
import godot.getDepthDrawModePtr
import godot.getDetailBlendModePtr
import godot.getDetailUvPtr
import godot.getDiffuseModePtr
import godot.getDistanceFadeMaxDistancePtr
import godot.getDistanceFadeMinDistancePtr
import godot.getDistanceFadePtr
import godot.getEmissionEnergyMultiplierPtr
import godot.getEmissionIntensityPtr
import godot.getEmissionOperatorPtr
import godot.getEmissionPtr
import godot.getFeaturePtr
import godot.getFlagPtr
import godot.getGrowPtr
import godot.getHeightmapDeepParallaxFlipBinormalPtr
import godot.getHeightmapDeepParallaxFlipTangentPtr
import godot.getHeightmapDeepParallaxMaxLayersPtr
import godot.getHeightmapDeepParallaxMinLayersPtr
import godot.getHeightmapScalePtr
import godot.getMetallicPtr
import godot.getMetallicTextureChannelPtr
import godot.getMsdfOutlineSizePtr
import godot.getMsdfPixelRangePtr
import godot.getNormalScalePtr
import godot.getParticlesAnimHFramesPtr
import godot.getParticlesAnimLoopPtr
import godot.getParticlesAnimVFramesPtr
import godot.getPointSizePtr
import godot.getProximityFadeDistancePtr
import godot.getRefractionPtr
import godot.getRefractionTextureChannelPtr
import godot.getRimPtr
import godot.getRimTintPtr
import godot.getRoughnessPtr
import godot.getRoughnessTextureChannelPtr
import godot.getShadingModePtr
import godot.getSpecularModePtr
import godot.getSpecularPtr
import godot.getSubsurfaceScatteringStrengthPtr
import godot.getTextureFilterPtr
import godot.getTexturePtr
import godot.getTransmittanceBoostPtr
import godot.getTransmittanceColorPtr
import godot.getTransmittanceDepthPtr
import godot.getTransparencyPtr
import godot.getUv1OffsetPtr
import godot.getUv1ScalePtr
import godot.getUv1TriplanarBlendSharpnessPtr
import godot.getUv2OffsetPtr
import godot.getUv2ScalePtr
import godot.getUv2TriplanarBlendSharpnessPtr
import godot.isGrowEnabledPtr
import godot.isHeightmapDeepParallaxEnabledPtr
import godot.isProximityFadeEnabledPtr
import godot.setAlbedoPtr
import godot.setAlphaAntialiasingEdgePtr
import godot.setAlphaAntialiasingPtr
import godot.setAlphaHashScalePtr
import godot.setAlphaScissorThresholdPtr
import godot.setAnisotropyPtr
import godot.setAoLightAffectPtr
import godot.setAoTextureChannelPtr
import godot.setBacklightPtr
import godot.setBillboardModePtr
import godot.setBlendModePtr
import godot.setClearcoatPtr
import godot.setClearcoatRoughnessPtr
import godot.setCullModePtr
import godot.setDepthDrawModePtr
import godot.setDetailBlendModePtr
import godot.setDetailUvPtr
import godot.setDiffuseModePtr
import godot.setDistanceFadeMaxDistancePtr
import godot.setDistanceFadeMinDistancePtr
import godot.setDistanceFadePtr
import godot.setEmissionEnergyMultiplierPtr
import godot.setEmissionIntensityPtr
import godot.setEmissionOperatorPtr
import godot.setEmissionPtr
import godot.setFeaturePtr
import godot.setFlagPtr
import godot.setGrowEnabledPtr
import godot.setGrowPtr
import godot.setHeightmapDeepParallaxFlipBinormalPtr
import godot.setHeightmapDeepParallaxFlipTangentPtr
import godot.setHeightmapDeepParallaxMaxLayersPtr
import godot.setHeightmapDeepParallaxMinLayersPtr
import godot.setHeightmapDeepParallaxPtr
import godot.setHeightmapScalePtr
import godot.setMetallicPtr
import godot.setMetallicTextureChannelPtr
import godot.setMsdfOutlineSizePtr
import godot.setMsdfPixelRangePtr
import godot.setNormalScalePtr
import godot.setParticlesAnimHFramesPtr
import godot.setParticlesAnimLoopPtr
import godot.setParticlesAnimVFramesPtr
import godot.setPointSizePtr
import godot.setProximityFadeDistancePtr
import godot.setProximityFadeEnabledPtr
import godot.setRefractionPtr
import godot.setRefractionTextureChannelPtr
import godot.setRimPtr
import godot.setRimTintPtr
import godot.setRoughnessPtr
import godot.setRoughnessTextureChannelPtr
import godot.setShadingModePtr
import godot.setSpecularModePtr
import godot.setSpecularPtr
import godot.setSubsurfaceScatteringStrengthPtr
import godot.setTextureFilterPtr
import godot.setTexturePtr
import godot.setTransmittanceBoostPtr
import godot.setTransmittanceColorPtr
import godot.setTransmittanceDepthPtr
import godot.setTransparencyPtr
import godot.setUv1OffsetPtr
import godot.setUv1ScalePtr
import godot.setUv1TriplanarBlendSharpnessPtr
import godot.setUv2OffsetPtr
import godot.setUv2ScalePtr
import godot.setUv2TriplanarBlendSharpnessPtr
