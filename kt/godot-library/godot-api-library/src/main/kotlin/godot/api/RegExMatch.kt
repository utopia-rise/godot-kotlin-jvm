...
public open class RegExMatch : RefCounted() {
  ...
  public object MethodBindings {
    internal val getSubjectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegExMatch", "get_subject", 201_670_096)

    internal val getGroupCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegExMatch", "get_group_count", 3_905_245_786)

    internal val getNamesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegExMatch", "get_names", 3_102_165_223)

    internal val getStringsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegExMatch", "get_strings", 1_139_954_409)

    internal val getStringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegExMatch", "get_string", 687_115_856)

    internal val getStartPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegExMatch", "get_start", 490_464_691)

    internal val getEndPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegExMatch", "get_end", 490_464_691)
  }
}
