...
public object InputMap : Object() {
  ...
  @JvmOverloads
  @JvmStatic
  public final fun addAction(action: StringName, deadzone: Float = 0.2f) {
   ...
   */
  @JvmStatic
  public final fun eraseAction(action: StringName) {
    TransferContext.writeArguments(STRING_NAME to action)
   ...
   */
  @JvmStatic
  public final fun actionSetDeadzone(action: StringName, deadzone: Float) {
    TransferContext.writeArguments(STRING_NAME to action, DOUBLE to deadzone.toDouble())
   ...
   */
  @JvmStatic
  public final fun actionAddEvent(action: StringName, event: InputEvent?) {
   ...
   */
  @JvmStatic
  public final fun actionEraseEvent(action: StringName, event: InputEvent?) {
    TransferContext.writeArguments(STRING_NAME to action, OBJECT to event)
   ...
   */
  @JvmStatic
  public final fun actionEraseEvents(action: StringName) {
    TransferContext.writeArguments(STRING_NAME to action)
   ...
   */
  @JvmStatic
  public final fun loadFromProjectSettings() {
    TransferContext.writeArguments()
  ...
  @JvmOverloads
  @JvmStatic
  public final fun addAction(action: String, deadzone: Float = 0.2f): Unit = addAction(action.asCachedStringName(), deadzone)
   ...
   */
  @JvmStatic
  public final fun actionSetDeadzone(action: String, deadzone: Float): Unit = actionSetDeadzone(action.asCachedStringName(), deadzone)

  /**
   * Returns a deadzone value for the action.
   */
  @JvmStatic
  public final fun actionGetDeadzone(action: String): Float = actionGetDeadzone(action.asCachedStringName())

  /**
   * Adds an [InputEvent] to an action. This [InputEvent] will trigger the action.
   */
  @JvmStatic
  public final fun actionAddEvent(action: String, event: InputEvent?): Unit = actionAddEvent(action.asCachedStringName(), event)

  /**
   * Returns `true` if the action has the given [InputEvent] associated with it.
   */
  @JvmStatic
  public final fun actionHasEvent(action: String, event: InputEvent?): Boolean = actionHasEvent(action.asCachedStringName(), event)

  /**
   * Removes an [InputEvent] from an action.
   */
  @JvmStatic
  public final fun actionEraseEvent(action: String, event: InputEvent?): Unit = actionEraseEvent(action.asCachedStringName(), event)

  /**
   * Removes all events from an action.
   */
  @JvmStatic
  public final fun actionEraseEvents(action: String): Unit = actionEraseEvents(action.asCachedStringName())
   ...
   */
  @JvmStatic
  public final fun actionGetEvents(action: String): VariantArray<InputEvent> = actionGetEvents(action.asCachedStringName())
  ...
  public object MethodBindings {
    internal val hasActionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "has_action", 2_619_796_661)

    internal val getActionsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "get_actions", 2_915_620_761)

    internal val addActionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "add_action", 1_195_233_573)

    internal val eraseActionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "erase_action", 3_304_788_590)

    internal val actionSetDeadzonePtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "action_set_deadzone", 4_135_858_297)

    internal val actionGetDeadzonePtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "action_get_deadzone", 1_391_627_649)

    internal val actionAddEventPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "action_add_event", 518_302_593)

    internal val actionHasEventPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "action_has_event", 1_185_871_985)

    internal val actionEraseEventPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "action_erase_event", 518_302_593)

    internal val actionEraseEventsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "action_erase_events", 3_304_788_590)

    internal val actionGetEventsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "action_get_events", 689_397_652)

    internal val eventIsActionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "event_is_action", 3_193_353_650)

    internal val loadFromProjectSettingsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("InputMap", "load_from_project_settings", 3_218_959_716)
  }
}
