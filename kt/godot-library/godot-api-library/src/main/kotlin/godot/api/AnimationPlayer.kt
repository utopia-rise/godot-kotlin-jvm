...
public open class AnimationPlayer : AnimationMixer() {
   ...
   */
  public final fun animationSetNext(animationFrom: StringName, animationTo: StringName) {
  ...
  public final fun setDefaultBlendTime(sec: Double) {
  ...
  public final fun setAutoCapture(autoCapture: Boolean) {
  ...
  public final fun setAutoCaptureDuration(autoCaptureDuration: Double) {
  ...
  public final fun setAutoCaptureEaseType(autoCaptureEaseType: Tween.EaseType) {
  ...
  /**
   * Plays the animation with key [name] and the section starting from [startTime] and ending on [endTime]. See also [play].
   *
   ...
   */
  @JvmOverloads
  public final fun stop(keepState: Boolean = false) {
   ...
   */
  public final fun queue(name: StringName) {
   ...
   */
  public final fun clearQueue() {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.clearQueuePtr, NIL)
  }

  public final fun setSpeedScale(speed: Float) {
  ...
  public final fun setMovieQuitOnFinishEnabled(enabled: Boolean) {
   ...
   */
  public final fun setSectionWithMarkers(startMarker: StringName = StringName(""), endMarker: StringName = StringName("")) {
   ...
   */
  @JvmOverloads
  public final fun setSection(startTime: Double = -1.0, endTime: Double = -1.0) {
   ...
   */
  public final fun setMethodCallMode(mode: AnimationMethodCallMode) {
    TransferContext.writeArguments(LONG to mode.id)
   ...
   */
  public final fun setRoot(path: NodePath) {
   ...
   * Returns the key of the animation which is queued to play after the [animationFrom] animation.
   */
  public final fun animationGetNext(animationFrom: String): StringName = animationGetNext(animationFrom.asCachedStringName())
  ...
  public final fun playSectionWithMarkers(
    ...
    customSpeed: Float = 1.0f,
    fromEnd: Boolean = false,
  ): Unit = playSectionWithMarkers(name.asCachedStringName(), startMarker.asCachedStringName(), endMarker.asCachedStringName(), customBlend, customSpeed, fromEnd)
  ...
  public final fun playSection(
    ...
    customSpeed: Float = 1.0f,
    fromEnd: Boolean = false,
  ): Unit = playSection(name.asCachedStringName(), startTime, endTime, customBlend, customSpeed, fromEnd)
   ...
   */
  @JvmOverloads
  public final fun playBackwards(name: String, customBlend: Double = -1.0): Unit = playBackwards(name.asCachedStringName(), customBlend)
  ...
  public final fun playSectionWithMarkersBackwards(
    ...
    endMarker: String,
    customBlend: Double = -1.0,
  ): Unit = playSectionWithMarkersBackwards(name.asCachedStringName(), startMarker.asCachedStringName(), endMarker.asCachedStringName(), customBlend)
  ...
  public final fun playWithCapture(
    ...
    transType: Tween.TransitionType = Tween.TransitionType.LINEAR,
    easeType: Tween.EaseType = Tween.EaseType.IN,
  ): Unit = playWithCapture(name.asCachedStringName(), duration, customBlend, customSpeed, fromEnd, transType, easeType)
   ...
   * If the argument is empty, the section uses the beginning or end of the animation. If both are empty, it means that the section is not set.
   */
  public final fun setSectionWithMarkers(startMarker: String, endMarker: String): Unit = setSectionWithMarkers(startMarker.asCachedStringName(), endMarker.asCachedStringName())
  ...
  public object MethodBindings {
    internal val animationSetNextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "animation_set_next", 3_740_211_285)

    internal val animationGetNextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "animation_get_next", 1_965_194_235)

    internal val setBlendTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_blend_time", 3_231_131_886)

    internal val getBlendTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_blend_time", 1_958_752_504)

    internal val setDefaultBlendTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_default_blend_time", 373_806_689)

    internal val getDefaultBlendTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_default_blend_time", 1_740_695_150)

    internal val setAutoCapturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_auto_capture", 2_586_408_642)

    internal val isAutoCapturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "is_auto_capture", 36_873_697)

    internal val setAutoCaptureDurationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_auto_capture_duration", 373_806_689)

    internal val getAutoCaptureDurationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_auto_capture_duration", 1_740_695_150)

    internal val setAutoCaptureTransitionTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_auto_capture_transition_type", 1_058_637_742)

    internal val getAutoCaptureTransitionTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_auto_capture_transition_type", 3_842_314_528)

    internal val setAutoCaptureEaseTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_auto_capture_ease_type", 1_208_105_857)

    internal val getAutoCaptureEaseTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_auto_capture_ease_type", 631_880_200)

    internal val playPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "play", 3_118_260_607)

    internal val playSectionWithMarkersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "play_section_with_markers", 1_421_431_412)

    internal val playSectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "play_section", 284_774_635)

    internal val playBackwardsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "play_backwards", 2_787_282_401)

    internal val playSectionWithMarkersBackwardsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "play_section_with_markers_backwards", 910_195_100)

    internal val playSectionBackwardsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "play_section_backwards", 831_955_981)

    internal val playWithCapturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "play_with_capture", 1_572_969_103)

    internal val pausePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "pause", 3_218_959_716)

    internal val stopPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "stop", 107_499_316)

    internal val isPlayingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "is_playing", 36_873_697)

    internal val setCurrentAnimationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_current_animation", 83_702_148)

    internal val getCurrentAnimationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_current_animation", 201_670_096)

    internal val setAssignedAnimationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_assigned_animation", 83_702_148)

    internal val getAssignedAnimationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_assigned_animation", 201_670_096)

    internal val queuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "queue", 3_304_788_590)

    internal val getQueuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_queue", 2_981_934_095)

    internal val clearQueuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "clear_queue", 3_218_959_716)

    internal val setSpeedScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_speed_scale", 373_806_689)

    internal val getSpeedScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_speed_scale", 1_740_695_150)

    internal val getPlayingSpeedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_playing_speed", 1_740_695_150)

    internal val setAutoplayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_autoplay", 83_702_148)

    internal val getAutoplayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_autoplay", 201_670_096)

    internal val setMovieQuitOnFinishEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_movie_quit_on_finish_enabled", 2_586_408_642)

    internal val isMovieQuitOnFinishEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "is_movie_quit_on_finish_enabled", 36_873_697)

    internal val getCurrentAnimationPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_current_animation_position", 1_740_695_150)

    internal val getCurrentAnimationLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_current_animation_length", 1_740_695_150)

    internal val setSectionWithMarkersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_section_with_markers", 794_792_241)

    internal val setSectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_section", 3_749_779_719)

    internal val resetSectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "reset_section", 3_218_959_716)

    internal val getSectionStartTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_section_start_time", 1_740_695_150)

    internal val getSectionEndTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_section_end_time", 1_740_695_150)

    internal val hasSectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "has_section", 36_873_697)

    internal val seekPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "seek", 1_807_872_683)

    internal val setProcessCallbackPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_process_callback", 1_663_839_457)

    internal val getProcessCallbackPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_process_callback", 4_207_496_604)

    internal val setMethodCallModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_method_call_mode", 3_413_514_846)

    internal val getMethodCallModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_method_call_mode", 3_583_380_054)

    internal val setRootPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "set_root", 1_348_162_250)

    internal val getRootPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationPlayer", "get_root", 4_075_236_667)
  }
}
