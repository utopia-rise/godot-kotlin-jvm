...
import godot.getGizmoExtentsPtr
import godot.setGizmoExtentsPtr
...
private const val ENGINECLASS_MARKER2D: Int = 361
...
public open class Marker2D : Node2D() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_MARKER2D, scriptIndex)
  }
