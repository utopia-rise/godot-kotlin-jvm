...
public open class NavigationRegion3D : Node3D() {
  ...
  /**
   * Returns the [RID] of this region on the [NavigationServer3D]. Combined with [NavigationServer3D.mapGetClosestPointOwner] can be used to identify the [NavigationRegion3D] closest to a point on the merged navigation map.
   */
  ...
  public final fun setNavigationMesh(navigationMesh: NavigationMesh?) {
   ...
   */
  @JvmOverloads
  public final fun bakeNavigationMesh(onThread: Boolean = true) {
  ...
  public object MethodBindings {
    internal val getRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_rid", 2_944_877_500)

    internal val setNavigationMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "set_navigation_mesh", 2_923_361_153)

    internal val getNavigationMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_navigation_mesh", 1_468_720_886)

    internal val setEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "set_enabled", 2_586_408_642)

    internal val isEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "is_enabled", 36_873_697)

    internal val setNavigationMapPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "set_navigation_map", 2_722_037_293)

    internal val getNavigationMapPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_navigation_map", 2_944_877_500)

    internal val setUseEdgeConnectionsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "set_use_edge_connections", 2_586_408_642)

    internal val getUseEdgeConnectionsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_use_edge_connections", 36_873_697)

    internal val setNavigationLayersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "set_navigation_layers", 1_286_410_249)

    internal val getNavigationLayersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_navigation_layers", 3_905_245_786)

    internal val setNavigationLayerValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "set_navigation_layer_value", 300_928_843)

    internal val getNavigationLayerValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_navigation_layer_value", 1_116_898_809)

    internal val getRegionRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_region_rid", 2_944_877_500)

    internal val setEnterCostPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "set_enter_cost", 373_806_689)

    internal val getEnterCostPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_enter_cost", 1_740_695_150)

    internal val setTravelCostPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "set_travel_cost", 373_806_689)

    internal val getTravelCostPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_travel_cost", 1_740_695_150)

    internal val bakeNavigationMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "bake_navigation_mesh", 3_216_645_846)

    internal val isBakingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "is_baking", 36_873_697)

    internal val getBoundsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationRegion3D", "get_bounds", 1_068_685_055)
  }
}
