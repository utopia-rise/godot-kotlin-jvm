...
import godot.getEditorDrawGizmoPtr
import godot.getEnabledPtr
import godot.getExecutionModePtr
import godot.getIsSetupPtr
import godot.getModificationStackPtr
import godot.setEditorDrawGizmoPtr
import godot.setEnabledPtr
import godot.setExecutionModePtr
import godot.setIsSetupPtr
...
private const val ENGINECLASS_SKELETONMODIFICATION2D: Int = 586
...
public open class SkeletonModification2D : Resource() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_SKELETONMODIFICATION2D, scriptIndex)
  }
