...
public open class BoxMesh : PrimitiveMesh() {
  ...
  public final fun setSubdivideHeight(divisions: Int) {
  ...
  public final fun setSubdivideDepth(divisions: Int) {
    TransferContext.writeArguments(LONG to divisions.toLong())
  ...
  public object MethodBindings {
    internal val setSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("BoxMesh", "set_size", 3_460_891_852)

    internal val getSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("BoxMesh", "get_size", 3_360_562_783)

    internal val setSubdivideWidthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("BoxMesh", "set_subdivide_width", 1_286_410_249)

    internal val getSubdivideWidthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("BoxMesh", "get_subdivide_width", 3_905_245_786)

    internal val setSubdivideHeightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("BoxMesh", "set_subdivide_height", 1_286_410_249)

    internal val getSubdivideHeightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("BoxMesh", "get_subdivide_height", 3_905_245_786)

    internal val setSubdivideDepthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("BoxMesh", "set_subdivide_depth", 1_286_410_249)

    internal val getSubdivideDepthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("BoxMesh", "get_subdivide_depth", 3_905_245_786)
  }
}
