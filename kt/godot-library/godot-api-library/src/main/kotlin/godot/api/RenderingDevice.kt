...
public infix fun Long.or(other: RenderingDevice.PipelineDynamicStateFlags): Long = this.or(other.flag)

public infix fun Long.xor(other: RenderingDevice.PipelineDynamicStateFlags): Long = this.xor(other.flag)

public infix fun Long.and(other: RenderingDevice.PipelineDynamicStateFlags): Long = this.and(other.flag)
...
public open class RenderingDevice internal constructor() : Object() {
   ...
   */
  public final fun textureIsFormatSupportedForUsage(format: DataFormat, usageFlags: TextureUsageBits): Boolean {
   ...
   */
  public final fun textureSetDiscardable(texture: RID, discardable: Boolean) {
   ...
   */
  @JvmOverloads
  public final fun framebufferFormatCreate(attachments: VariantArray<RDAttachmentFormat>, viewCount: Long = 1): Long {
   ...
   */
  @JvmOverloads
  public final fun framebufferFormatCreateEmpty(samples: TextureSamples = RenderingDevice.TextureSamples.TEXTURE_SAMPLES_1): Long {
   ...
   */
  @JvmOverloads
  public final fun framebufferFormatGetTextureSamples(format: Long, renderPass: Long = 0): TextureSamples {
   ...
   */
  public final fun samplerIsFormatSupportedForFilter(format: DataFormat, samplerFilter: SamplerFilter): Boolean {
  ...
  /**
   * Compiles a SPIR-V from the shader source code in [shaderSource] and returns the SPIR-V as a [RDShaderSPIRV]. This intermediate language shader is portable across different GPU models and driver versions, but cannot be run directly by GPUs until compiled into a binary shader using [shaderCompileBinaryFromSpirv].
   *
   ...
   */
  @JvmOverloads
  public final fun shaderCompileSpirvFromSource(shaderSource: RDShaderSource?, allowCache: Boolean = true): RDShaderSPIRV? {
   ...
   */
  @JvmOverloads
  public final fun shaderCompileBinaryFromSpirv(spirvData: RDShaderSPIRV?, name: String = ""): PackedByteArray {
   ...
   */
  @JvmOverloads
  public final fun shaderCreateFromBytecode(binaryData: PackedByteArray, placeholderRid: RID = RID()): RID {
   ...
   *
   * **Note:** You must check that the GPU supports this functionality by calling [hasFeature] with [SUPPORTS_BUFFER_DEVICE_ADDRESS] as a parameter.
   */
  ...
  public final fun renderPipelineCreate(
    ...
    specializationConstants: VariantArray<RDPipelineSpecializationConstant> = godot.core.variantArrayOf(),
  ): RID {
   ...
   */
  @JvmOverloads
  public final fun computePipelineCreate(shader: RID, specializationConstants: VariantArray<RDPipelineSpecializationConstant> = godot.core.variantArrayOf()): RID {
   ...
   *
   * **Note:** Only the main [RenderingDevice] returned by [RenderingServer.getRenderingDevice] has a width. If called on a local [RenderingDevice], this method prints an error and returns [INVALID_ID].
   */
  @JvmOverloads
   ...
   *
   * **Note:** Only the main [RenderingDevice] returned by [RenderingServer.getRenderingDevice] has a height. If called on a local [RenderingDevice], this method prints an error and returns [INVALID_ID].
   */
  @JvmOverloads
   ...
   *
   * **Note:** Only the main [RenderingDevice] returned by [RenderingServer.getRenderingDevice] has a format. If called on a local [RenderingDevice], this method prints an error and returns [INVALID_ID].
   */
  @JvmOverloads
   ...
   */
  @JvmOverloads
  public final fun drawListBeginForScreen(screen: Int = 0, clearColor: Color = Color(Color(0, 0, 0, 1))): Long {
   ...
   */
  public final fun drawListSetBlendConstants(drawList: Long, color: Color) {
   ...
   */
  public final fun drawListBindRenderPipeline(drawList: Long, renderPipeline: RID) {
   ...
   */
  public final fun drawListBindVertexArray(drawList: Long, vertexArray: RID) {
   ...
   */
  public final fun drawListBindIndexArray(drawList: Long, indexArray: RID) {
   ...
   */
  public final fun drawListDisableScissor(drawList: Long) {
   ...
   */
  public final fun computeListBindComputePipeline(computeList: Long, computePipeline: RID) {
   ...
   */
  public final fun computeListAddBarrier(computeList: Long) {
   ...
   */
  public final fun computeListEnd() {
    TransferContext.writeArguments()
   ...
   */
  public final fun captureTimestamp(name: String) {
   ...
   */
  @JvmOverloads
  public final fun barrier(from: BarrierMask = RenderingDevice.BarrierMask.ALL_BARRIERS, to: BarrierMask = RenderingDevice.BarrierMask.ALL_BARRIERS) {
   ...
   */
  public final fun setResourceName(id: RID, name: String) {
   ...
   */
  public final fun drawCommandBeginLabel(name: String, color: Color) {
   ...
   * This method does nothing.
   */
  public final fun drawCommandInsertLabel(name: String, color: Color) {
    TransferContext.writeArguments(STRING to name, COLOR to color)
   ...
   */
  public final fun drawCommandEndLabel() {
    TransferContext.writeArguments()
  ...
  public enum class DeviceType(
    ...
    VIRTUAL_GPU(3),
    /**
     * Rendering device is provided by software emulation (such as Lavapipe or [url=https://github.com/google/swiftshader]SwiftShader[/url]). This is the slowest kind of rendering device available; it's typically much slower than [DEVICE_TYPE_INTEGRATED_GPU].
     */
    CPU(4),
    /**
  ...
  public enum class DataFormat(
    ...
    ASTC_4x4_SFLOAT_BLOCK(218),
    ASTC_5x4_SFLOAT_BLOCK(219),
    ASTC_5x5_SFLOAT_BLOCK(220),
    ASTC_6x5_SFLOAT_BLOCK(221),
    ASTC_6x6_SFLOAT_BLOCK(222),
    ASTC_8x5_SFLOAT_BLOCK(223),
    ASTC_8x6_SFLOAT_BLOCK(224),
    ASTC_8x8_SFLOAT_BLOCK(225),
    ASTC_10x5_SFLOAT_BLOCK(226),
    ASTC_10x6_SFLOAT_BLOCK(227),
    ASTC_10x8_SFLOAT_BLOCK(228),
    ASTC_10x10_SFLOAT_BLOCK(229),
    ASTC_12x10_SFLOAT_BLOCK(230),
    ASTC_12x12_SFLOAT_BLOCK(231),
    /**
  ...
  public class BarrierMask(
    ...
    public companion object {
       ...
       */
      @JvmField
      public val ALL_BARRIERS: BarrierMask = BarrierMask(32_767)

      /**
       * No barrier for any type.
       */
      @JvmField
      public val NO_BARRIER: BarrierMask = BarrierMask(32_768)
    }
  }
  ...
  public class TextureUsageBits(
    ...
    public infix fun or(other: TextureUsageBits): TextureUsageBits = TextureUsageBits(flag.or(other.flag))

    public infix fun or(other: Long): TextureUsageBits = TextureUsageBits(flag.or(other))

    public infix fun xor(other: TextureUsageBits): TextureUsageBits = TextureUsageBits(flag.xor(other.flag))

    public infix fun xor(other: Long): TextureUsageBits = TextureUsageBits(flag.xor(other))

    public infix fun and(other: TextureUsageBits): TextureUsageBits = TextureUsageBits(flag.and(other.flag))
  ...
  public class StorageBufferUsage(
    ...
    public infix fun or(other: StorageBufferUsage): StorageBufferUsage = StorageBufferUsage(flag.or(other.flag))

    public infix fun or(other: Long): StorageBufferUsage = StorageBufferUsage(flag.or(other))

    public infix fun xor(other: StorageBufferUsage): StorageBufferUsage = StorageBufferUsage(flag.xor(other.flag))

    public infix fun xor(other: Long): StorageBufferUsage = StorageBufferUsage(flag.xor(other))

    public infix fun and(other: StorageBufferUsage): StorageBufferUsage = StorageBufferUsage(flag.and(other.flag))
  ...
  public class BufferCreationBits(
    ...
    public infix fun or(other: BufferCreationBits): BufferCreationBits = BufferCreationBits(flag.or(other.flag))

    public infix fun or(other: Long): BufferCreationBits = BufferCreationBits(flag.or(other))

    public infix fun xor(other: BufferCreationBits): BufferCreationBits = BufferCreationBits(flag.xor(other.flag))

    public infix fun xor(other: Long): BufferCreationBits = BufferCreationBits(flag.xor(other))

    public infix fun and(other: BufferCreationBits): BufferCreationBits = BufferCreationBits(flag.and(other.flag))
  ...
  public class PipelineDynamicStateFlags(
    ...
    public infix fun or(other: PipelineDynamicStateFlags): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.or(other.flag))

    public infix fun or(other: Long): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.or(other))

    public infix fun xor(other: PipelineDynamicStateFlags): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.xor(other.flag))

    public infix fun xor(other: Long): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.xor(other))

    public infix fun and(other: PipelineDynamicStateFlags): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.and(other.flag))

    public infix fun and(other: Long): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.and(other))

    public fun unaryPlus(): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.unaryPlus())

    public fun unaryMinus(): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.unaryMinus())

    public fun inv(): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag.inv())

    public infix fun shl(bits: Int): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag shl bits)

    public infix fun shr(bits: Int): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag shr bits)

    public infix fun ushr(bits: Int): PipelineDynamicStateFlags = PipelineDynamicStateFlags(flag ushr bits)
  ...
  public enum class PipelineSpecializationConstantType(
    ...
    public companion object {
      public fun from(`value`: Long): PipelineSpecializationConstantType = entries.single { it.id == `value` }
    }
  }
  ...
  public enum class BreadcrumbMarker(
    ...
    NONE(0),
    REFLECTION_PROBES(65_536),
    SKY_PASS(131_072),
    LIGHTMAPPER_PASS(196_608),
    SHADOW_PASS_DIRECTIONAL(262_144),
    SHADOW_PASS_CUBE(327_680),
    OPAQUE_PASS(393_216),
    ALPHA_PASS(458_752),
    TRANSPARENT_PASS(524_288),
    POST_PROCESSING_PASS(589_824),
    BLIT_PASS(655_360),
    UI_PASS(720_896),
    DEBUG_PASS(786_432),
    ;
  ...
  public class DrawFlags(
    ...
    public companion object {
       ...
       */
      @JvmField
      public val IGNORE_COLOR_2: DrawFlags = DrawFlags(1_024)

      /**
       * Ignore the previous contents of the fourth color attachment.
       */
      @JvmField
      public val IGNORE_COLOR_3: DrawFlags = DrawFlags(2_048)

      /**
       * Ignore the previous contents of the fifth color attachment.
       */
      @JvmField
      public val IGNORE_COLOR_4: DrawFlags = DrawFlags(4_096)

      /**
       * Ignore the previous contents of the sixth color attachment.
       */
      @JvmField
      public val IGNORE_COLOR_5: DrawFlags = DrawFlags(8_192)

      /**
       * Ignore the previous contents of the seventh color attachment.
       */
      @JvmField
      public val IGNORE_COLOR_6: DrawFlags = DrawFlags(16_384)

      /**
       * Ignore the previous contents of the eighth color attachment.
       */
      @JvmField
      public val IGNORE_COLOR_7: DrawFlags = DrawFlags(32_768)

      /**
       * Mask for ignoring all the previous contents of the color attachments.
       */
      @JvmField
      public val IGNORE_COLOR_MASK: DrawFlags = DrawFlags(65_280)

      /**
       * Ignore the previous contents of all color attachments.
       */
      @JvmField
      public val IGNORE_COLOR_ALL: DrawFlags = DrawFlags(65_280)

      /**
       * Clear the depth attachment.
       */
      @JvmField
      public val CLEAR_DEPTH: DrawFlags = DrawFlags(65_536)

      /**
       * Ignore the previous contents of the depth attachment.
       */
      @JvmField
      public val IGNORE_DEPTH: DrawFlags = DrawFlags(131_072)

      /**
       * Clear the stencil attachment.
       */
      @JvmField
      public val CLEAR_STENCIL: DrawFlags = DrawFlags(262_144)

      /**
       * Ignore the previous contents of the stencil attachment.
       */
      @JvmField
      public val IGNORE_STENCIL: DrawFlags = DrawFlags(524_288)

      /**
       * Clear all attachments.
       */
      @JvmField
      public val CLEAR_ALL: DrawFlags = DrawFlags(327_935)

      /**
       * Ignore the previous contents of all attachments.
       */
      @JvmField
      public val IGNORE_ALL: DrawFlags = DrawFlags(720_640)
    }
  }
  ...
  public object MethodBindings {
    internal val textureCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_create", 3_709_173_589)

    internal val textureCreateSharedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_create_shared", 3_178_156_134)

    internal val textureCreateSharedFromSlicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_create_shared_from_slice", 1_808_971_279)

    internal val textureCreateFromExtensionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_create_from_extension", 1_397_171_480)

    internal val textureUpdatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_update", 1_349_464_008)

    internal val textureGetDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_get_data", 1_859_412_099)

    internal val textureGetDataAsyncPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_get_data_async", 498_832_090)

    internal val textureIsFormatSupportedForUsagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_is_format_supported_for_usage", 2_592_520_478)

    internal val textureIsSharedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_is_shared", 3_521_089_500)

    internal val textureIsValidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_is_valid", 3_521_089_500)

    internal val textureSetDiscardablePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_set_discardable", 1_265_174_801)

    internal val textureIsDiscardablePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_is_discardable", 3_521_089_500)

    internal val textureCopyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_copy", 2_859_522_160)

    internal val textureClearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_clear", 3_477_703_247)

    internal val textureResolveMultisamplePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_resolve_multisample", 3_181_288_260)

    internal val textureGetFormatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_get_format", 1_374_471_690)

    internal val textureGetNativeHandlePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_get_native_handle", 3_917_799_429)

    internal val framebufferFormatCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_format_create", 697_032_759)

    internal val framebufferFormatCreateMultipassPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_format_create_multipass", 2_647_479_094)

    internal val framebufferFormatCreateEmptyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_format_create_empty", 555_930_169)

    internal val framebufferFormatGetTextureSamplesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_format_get_texture_samples", 4_223_391_010)

    internal val framebufferCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_create", 3_284_231_055)

    internal val framebufferCreateMultipassPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_create_multipass", 1_750_306_695)

    internal val framebufferCreateEmptyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_create_empty", 3_058_360_618)

    internal val framebufferGetFormatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_get_format", 3_917_799_429)

    internal val framebufferIsValidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "framebuffer_is_valid", 4_155_700_596)

    internal val samplerCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "sampler_create", 2_327_892_535)

    internal val samplerIsFormatSupportedForFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "sampler_is_format_supported_for_filter", 2_247_922_238)

    internal val vertexBufferCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "vertex_buffer_create", 2_089_548_973)

    internal val vertexFormatCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "vertex_format_create", 1_242_678_479)

    internal val vertexArrayCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "vertex_array_create", 3_799_816_279)

    internal val indexBufferCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "index_buffer_create", 2_368_684_885)

    internal val indexArrayCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "index_array_create", 2_256_026_069)

    internal val shaderCompileSpirvFromSourcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "shader_compile_spirv_from_source", 1_178_973_306)

    internal val shaderCompileBinaryFromSpirvPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "shader_compile_binary_from_spirv", 134_910_450)

    internal val shaderCreateFromSpirvPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "shader_create_from_spirv", 342_949_005)

    internal val shaderCreateFromBytecodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "shader_create_from_bytecode", 1_687_031_350)

    internal val shaderCreatePlaceholderPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "shader_create_placeholder", 529_393_457)

    internal val shaderGetVertexInputAttributeMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "shader_get_vertex_input_attribute_mask", 3_917_799_429)

    internal val uniformBufferCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "uniform_buffer_create", 2_089_548_973)

    internal val storageBufferCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "storage_buffer_create", 1_609_052_553)

    internal val textureBufferCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "texture_buffer_create", 1_470_338_698)

    internal val uniformSetCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "uniform_set_create", 2_280_795_797)

    internal val uniformSetIsValidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "uniform_set_is_valid", 3_521_089_500)

    internal val bufferCopyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "buffer_copy", 864_257_779)

    internal val bufferUpdatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "buffer_update", 3_454_956_949)

    internal val bufferClearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "buffer_clear", 2_452_320_800)

    internal val bufferGetDataPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "buffer_get_data", 3_101_830_688)

    internal val bufferGetDataAsyncPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "buffer_get_data_async", 2_370_287_848)

    internal val bufferGetDeviceAddressPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "buffer_get_device_address", 3_917_799_429)

    internal val renderPipelineCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "render_pipeline_create", 2_385_451_958)

    internal val renderPipelineIsValidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "render_pipeline_is_valid", 3_521_089_500)

    internal val computePipelineCreatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_pipeline_create", 1_448_838_280)

    internal val computePipelineIsValidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_pipeline_is_valid", 3_521_089_500)

    internal val screenGetWidthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "screen_get_width", 1_591_665_591)

    internal val screenGetHeightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "screen_get_height", 1_591_665_591)

    internal val screenGetFramebufferFormatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "screen_get_framebuffer_format", 1_591_665_591)

    internal val drawListBeginForScreenPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_begin_for_screen", 3_988_079_995)

    internal val drawListBeginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_begin", 1_317_926_357)

    internal val drawListBeginSplitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_begin_split", 2_406_300_660)

    internal val drawListSetBlendConstantsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_set_blend_constants", 2_878_471_219)

    internal val drawListBindRenderPipelinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_bind_render_pipeline", 4_040_184_819)

    internal val drawListBindUniformSetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_bind_uniform_set", 749_655_778)

    internal val drawListBindVertexArrayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_bind_vertex_array", 4_040_184_819)

    internal val drawListBindIndexArrayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_bind_index_array", 4_040_184_819)

    internal val drawListSetPushConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_set_push_constant", 2_772_371_345)

    internal val drawListDrawPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_draw", 4_230_067_973)

    internal val drawListDrawIndirectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_draw_indirect", 1_092_133_571)

    internal val drawListEnableScissorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_enable_scissor", 244_650_101)

    internal val drawListDisableScissorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_disable_scissor", 1_286_410_249)

    internal val drawListSwitchToNextPassPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_switch_to_next_pass", 2_455_072_627)

    internal val drawListSwitchToNextPassSplitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_switch_to_next_pass_split", 2_865_087_369)

    internal val drawListEndPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_list_end", 3_218_959_716)

    internal val computeListBeginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_list_begin", 2_455_072_627)

    internal val computeListBindComputePipelinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_list_bind_compute_pipeline", 4_040_184_819)

    internal val computeListSetPushConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_list_set_push_constant", 2_772_371_345)

    internal val computeListBindUniformSetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_list_bind_uniform_set", 749_655_778)

    internal val computeListDispatchPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_list_dispatch", 4_275_841_770)

    internal val computeListDispatchIndirectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_list_dispatch_indirect", 749_655_778)

    internal val computeListAddBarrierPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_list_add_barrier", 1_286_410_249)

    internal val computeListEndPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "compute_list_end", 3_218_959_716)

    internal val freeRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "free_rid", 2_722_037_293)

    internal val captureTimestampPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "capture_timestamp", 83_702_148)

    internal val getCapturedTimestampsCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_captured_timestamps_count", 3_905_245_786)

    internal val getCapturedTimestampsFramePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_captured_timestamps_frame", 3_905_245_786)

    internal val getCapturedTimestampGpuTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_captured_timestamp_gpu_time", 923_996_154)

    internal val getCapturedTimestampCpuTimePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_captured_timestamp_cpu_time", 923_996_154)

    internal val getCapturedTimestampNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_captured_timestamp_name", 844_755_477)

    internal val hasFeaturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "has_feature", 1_772_728_326)

    internal val limitGetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "limit_get", 1_559_202_131)

    internal val getFrameDelayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_frame_delay", 3_905_245_786)

    internal val submitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "submit", 3_218_959_716)

    internal val syncPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "sync", 3_218_959_716)

    internal val barrierPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "barrier", 3_718_155_691)

    internal val fullBarrierPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "full_barrier", 3_218_959_716)

    internal val createLocalDevicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "create_local_device", 2_846_302_423)

    internal val setResourceNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "set_resource_name", 2_726_140_452)

    internal val drawCommandBeginLabelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_command_begin_label", 1_636_512_886)

    internal val drawCommandInsertLabelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_command_insert_label", 1_636_512_886)

    internal val drawCommandEndLabelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "draw_command_end_label", 3_218_959_716)

    internal val getDeviceVendorNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_device_vendor_name", 201_670_096)

    internal val getDeviceNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_device_name", 201_670_096)

    internal val getDevicePipelineCacheUuidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_device_pipeline_cache_uuid", 201_670_096)

    internal val getMemoryUsagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_memory_usage", 251_690_689)

    internal val getDriverResourcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_driver_resource", 501_815_484)

    internal val getPerfReportPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_perf_report", 201_670_096)

    internal val getDriverAndDeviceMemoryReportPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_driver_and_device_memory_report", 201_670_096)

    internal val getTrackedObjectNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_tracked_object_name", 844_755_477)

    internal val getTrackedObjectTypeCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_tracked_object_type_count", 3_905_245_786)

    internal val getDriverTotalMemoryPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_driver_total_memory", 3_905_245_786)

    internal val getDriverAllocationCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_driver_allocation_count", 3_905_245_786)

    internal val getDriverMemoryByObjectTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_driver_memory_by_object_type", 923_996_154)

    internal val getDriverAllocsByObjectTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_driver_allocs_by_object_type", 923_996_154)

    internal val getDeviceTotalMemoryPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_device_total_memory", 3_905_245_786)

    internal val getDeviceAllocationCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_device_allocation_count", 3_905_245_786)

    internal val getDeviceMemoryByObjectTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_device_memory_by_object_type", 923_996_154)

    internal val getDeviceAllocsByObjectTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RenderingDevice", "get_device_allocs_by_object_type", 923_996_154)
  }
}
