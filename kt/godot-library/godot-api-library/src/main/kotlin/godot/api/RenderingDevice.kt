...
import godot.barrierPtr
import godot.bufferClearPtr
import godot.bufferCopyPtr
import godot.bufferGetDataPtr
import godot.bufferUpdatePtr
import godot.captureTimestampPtr
import godot.common.interop.VoidPtr
import godot.computeListAddBarrierPtr
import godot.computeListBeginPtr
import godot.computeListBindComputePipelinePtr
import godot.computeListBindUniformSetPtr
import godot.computeListDispatchIndirectPtr
import godot.computeListDispatchPtr
import godot.computeListEndPtr
import godot.computeListSetPushConstantPtr
...
import godot.createLocalDevicePtr
import godot.drawCommandBeginLabelPtr
import godot.drawCommandEndLabelPtr
import godot.drawCommandInsertLabelPtr
import godot.drawListBeginForScreenPtr
import godot.drawListBeginPtr
import godot.drawListBeginSplitPtr
import godot.drawListBindIndexArrayPtr
import godot.drawListBindRenderPipelinePtr
import godot.drawListBindUniformSetPtr
import godot.drawListBindVertexArrayPtr
import godot.drawListDisableScissorPtr
import godot.drawListDrawPtr
import godot.drawListEnableScissorPtr
import godot.drawListEndPtr
import godot.drawListSetBlendConstantsPtr
import godot.drawListSetPushConstantPtr
import godot.drawListSwitchToNextPassPtr
import godot.drawListSwitchToNextPassSplitPtr
import godot.framebufferCreateEmptyPtr
import godot.framebufferCreateMultipassPtr
import godot.framebufferCreatePtr
import godot.framebufferFormatCreateEmptyPtr
import godot.framebufferFormatCreateMultipassPtr
import godot.framebufferFormatCreatePtr
import godot.framebufferFormatGetTextureSamplesPtr
import godot.framebufferGetFormatPtr
import godot.framebufferIsValidPtr
import godot.freeRidPtr
import godot.fullBarrierPtr
import godot.getCapturedTimestampCpuTimePtr
import godot.getCapturedTimestampGpuTimePtr
import godot.getCapturedTimestampNamePtr
import godot.getCapturedTimestampsCountPtr
import godot.getCapturedTimestampsFramePtr
import godot.getDeviceNamePtr
import godot.getDevicePipelineCacheUuidPtr
import godot.getDeviceVendorNamePtr
import godot.getDriverResourcePtr
import godot.getFrameDelayPtr
import godot.getMemoryUsagePtr
import godot.indexArrayCreatePtr
import godot.indexBufferCreatePtr
import godot.limitGetPtr
import godot.renderPipelineCreatePtr
import godot.renderPipelineIsValidPtr
import godot.samplerCreatePtr
import godot.samplerIsFormatSupportedForFilterPtr
import godot.screenGetFramebufferFormatPtr
import godot.screenGetHeightPtr
import godot.screenGetWidthPtr
import godot.setResourceNamePtr
import godot.shaderCompileBinaryFromSpirvPtr
import godot.shaderCompileSpirvFromSourcePtr
import godot.shaderCreateFromBytecodePtr
import godot.shaderCreateFromSpirvPtr
import godot.shaderCreatePlaceholderPtr
import godot.shaderGetVertexInputAttributeMaskPtr
import godot.storageBufferCreatePtr
import godot.submitPtr
import godot.syncPtr
import godot.textureBufferCreatePtr
import godot.textureClearPtr
import godot.textureCopyPtr
import godot.textureCreateFromExtensionPtr
import godot.textureCreatePtr
import godot.textureCreateSharedFromSlicePtr
import godot.textureCreateSharedPtr
import godot.textureGetDataPtr
import godot.textureGetFormatPtr
import godot.textureGetNativeHandlePtr
import godot.textureIsFormatSupportedForUsagePtr
import godot.textureIsSharedPtr
import godot.textureIsValidPtr
import godot.textureResolveMultisamplePtr
import godot.textureUpdatePtr
import godot.uniformBufferCreatePtr
import godot.uniformSetCreatePtr
import godot.uniformSetIsValidPtr
import godot.vertexArrayCreatePtr
import godot.vertexBufferCreatePtr
import godot.vertexFormatCreatePtr
