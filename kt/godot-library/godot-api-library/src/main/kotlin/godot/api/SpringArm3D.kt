...
public open class SpringArm3D : Node3D() {
   ...
   */
  public final fun addExcludedObject(RID: RID) {
   ...
   */
  public final fun clearExcludedObjects() {
    TransferContext.writeArguments()
  ...
  public object MethodBindings {
    internal val getHitLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "get_hit_length", 191_475_506)

    internal val setLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "set_length", 373_806_689)

    internal val getLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "get_length", 1_740_695_150)

    internal val setShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "set_shape", 1_549_710_052)

    internal val getShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "get_shape", 3_214_262_478)

    internal val addExcludedObjectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "add_excluded_object", 2_722_037_293)

    internal val removeExcludedObjectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "remove_excluded_object", 3_521_089_500)

    internal val clearExcludedObjectsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "clear_excluded_objects", 3_218_959_716)

    internal val setCollisionMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "set_collision_mask", 1_286_410_249)

    internal val getCollisionMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "get_collision_mask", 2_455_072_627)

    internal val setMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "set_margin", 373_806_689)

    internal val getMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SpringArm3D", "get_margin", 191_475_506)
  }
}
