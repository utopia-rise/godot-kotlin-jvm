...
import godot.getBakeIntervalPtr
import godot.getBakedLengthPtr
import godot.getBakedPointsPtr
import godot.getBakedTiltsPtr
import godot.getBakedUpVectorsPtr
import godot.getClosestOffsetPtr
import godot.getClosestPointPtr
import godot.getPointCountPtr
import godot.getPointInPtr
import godot.getPointOutPtr
import godot.getPointPositionPtr
import godot.getPointTiltPtr
import godot.isUpVectorEnabledPtr
import godot.removePointPtr
import godot.sampleBakedPtr
import godot.sampleBakedUpVectorPtr
import godot.sampleBakedWithRotationPtr
import godot.samplePtr
import godot.samplefPtr
import godot.setBakeIntervalPtr
import godot.setPointCountPtr
import godot.setPointInPtr
import godot.setPointOutPtr
import godot.setPointPositionPtr
import godot.setPointTiltPtr
import godot.setUpVectorEnabledPtr
import godot.tessellateEvenLengthPtr
import godot.tessellatePtr
...
private const val ENGINECLASS_CURVE3D: Int = 218
...
public open class Curve3D : Resource() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_CURVE3D, scriptIndex)
  }
