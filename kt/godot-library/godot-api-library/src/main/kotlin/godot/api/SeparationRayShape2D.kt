...
public open class SeparationRayShape2D : Shape2D() {
  ...
  public final fun setSlideOnSlope(active: Boolean) {
  ...
  public object MethodBindings {
    internal val setLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SeparationRayShape2D", "set_length", 373_806_689)

    internal val getLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("SeparationRayShape2D", "get_length", 1_740_695_150)

    internal val setSlideOnSlopePtr: VoidPtr =
        TypeManager.getMethodBindPtr("SeparationRayShape2D", "set_slide_on_slope", 2_586_408_642)

    internal val getSlideOnSlopePtr: VoidPtr =
        TypeManager.getMethodBindPtr("SeparationRayShape2D", "get_slide_on_slope", 36_873_697)
  }
}
