...
public open class NavigationPathQueryResult2D : RefCounted() {
   ...
   */
  @CoreTypeHelper
  public final fun pathMutate(block: PackedVector2Array.() -> Unit): PackedVector2Array = path.apply {
     block(this)
     path = this
  }
   ...
   */
  @CoreTypeHelper
  public final fun pathMutateEach(block: (index: Int, `value`: Vector2) -> Unit): PackedVector2Array = path.apply {
  ...
  public final fun setPath(path: PackedVector2Array) {
  ...
  public object MethodBindings {
    internal val setPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "set_path", 1_509_147_220)

    internal val getPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "get_path", 2_961_356_807)

    internal val setPathTypesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "set_path_types", 3_614_634_198)

    internal val getPathTypesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "get_path_types", 1_930_428_628)

    internal val setPathRidsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "set_path_rids", 381_264_803)

    internal val getPathRidsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "get_path_rids", 3_995_934_104)

    internal val setPathOwnerIdsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "set_path_owner_ids", 3_709_968_205)

    internal val getPathOwnerIdsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "get_path_owner_ids", 235_988_956)

    internal val resetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "reset", 3_218_959_716)
  }
}
