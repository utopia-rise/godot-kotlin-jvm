...
public open class NavigationPathQueryResult2D : RefCounted() {
  ...
  public override fun new(scriptPtr: VoidPtr): Unit {
    createNativeObject(261, scriptPtr)
  }
  ...
  public object MethodBindings {
    ...
    internal val setPathLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "set_path_length", 373806689)

    internal val getPathLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("NavigationPathQueryResult2D", "get_path_length", 1740695150)
