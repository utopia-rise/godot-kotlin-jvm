...
public open class XROrigin3D : Node3D() {
  ...
  public final fun setWorldScale(worldScale: Float) {
  ...
  public object MethodBindings {
    internal val setWorldScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("XROrigin3D", "set_world_scale", 373_806_689)

    internal val getWorldScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("XROrigin3D", "get_world_scale", 1_740_695_150)

    internal val setCurrentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("XROrigin3D", "set_current", 2_586_408_642)

    internal val isCurrentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("XROrigin3D", "is_current", 36_873_697)
  }
}
