 ...
 */
@GodotBaseType
public open class VisualShaderNodeTextureParameter internal constructor() : VisualShaderNodeParameter() {
  /**
  ...
  public final fun setTextureType(type: TextureType) {
  ...
  public final fun setColorDefault(color: ColorDefault) {
  ...
  public final fun setTextureFilter(filter: TextureFilter) {
  ...
  public final fun setTextureRepeat(repeat: TextureRepeat) {
  ...
  public final fun setTextureSource(source: TextureSource) {
  ...
  public object MethodBindings {
    internal val setTextureTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "set_texture_type", 2_227_296_876)

    internal val getTextureTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "get_texture_type", 367_922_070)

    internal val setColorDefaultPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "set_color_default", 4_217_624_432)

    internal val getColorDefaultPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "get_color_default", 3_837_060_134)

    internal val setTextureFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "set_texture_filter", 2_147_684_752)

    internal val getTextureFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "get_texture_filter", 4_184_490_817)

    internal val setTextureRepeatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "set_texture_repeat", 2_036_143_070)

    internal val getTextureRepeatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "get_texture_repeat", 1_690_132_794)

    internal val setTextureSourcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "set_texture_source", 1_212_687_372)

    internal val getTextureSourcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeTextureParameter", "get_texture_source", 2_039_092_262)
  }
}
