...
public object OS : Object() {
   ...
   */
  @JvmStatic
  public final fun openMidiInputs() {
    TransferContext.writeArguments()
   ...
   */
  @JvmStatic
  public final fun closeMidiInputs() {
    TransferContext.writeArguments()
  ...
  @JvmOverloads
  @JvmStatic
  public final fun alert(text: String, title: String = "Alert!") {
  ...
  @JvmStatic
  public final fun setLowProcessorUsageModeSleepUsec(usec: Int) {
  ...
  @JvmStatic
  public final fun setDeltaSmoothing(deltaSmoothingEnabled: Boolean) {
   ...
   *
   * **Note:** This method is currently only implemented on Windows and macOS. On other platforms, it will fallback to [shellOpen] with a directory path of [fileOrDirPath] prefixed with `file://`.
   */
  @JvmOverloads
  @JvmStatic
   ...
   */
  @JvmStatic
  public final fun setEnvironment(variable: String, `value`: String) {
   ...
   */
  @JvmStatic
  public final fun unsetEnvironment(variable: String) {
    TransferContext.writeArguments(STRING to variable)
  ...
  /**
   * If [restart] is `true`, restarts the project automatically when it is exited with [SceneTree.quit] or [Node.NOTIFICATION_WM_CLOSE_REQUEST]. Command-line [arguments] can be supplied. To restart the project with the same command line arguments as originally used to run the project, pass [getCmdlineArgs] as the value for [arguments].
   *
  ...
  @JvmOverloads
  @JvmStatic
  public final fun setRestartOnExit(restart: Boolean, arguments: PackedStringArray = PackedStringArray()) {
   ...
   */
  @JvmStatic
  public final fun delayUsec(usec: Int) {
    TransferContext.writeArguments(LONG to usec.toLong())
   ...
   */
  @JvmStatic
  public final fun delayMsec(msec: Int) {
  ...
  /**
   * Returns `true` if the engine was executed with the `--verbose` or `-v` command line argument, or if [ProjectSettings.debug/settings/stdout/verboseStdout] is `true`. See also [@GlobalScope.printVerbose].
   */
  @JvmStatic
   ...
   *
   * On the Linux/BSD platform, this path can be overridden by setting the `XDG_CONFIG_HOME` environment variable before starting the project. See [url=$DOCS_URL/tutorials/io/data_paths.html]File paths in Godot projects[/url] in the documentation for more information. See also [getCacheDir] and [getDataDir].
   *
   ...
   *
   * On the Linux/BSD platform, this path can be overridden by setting the `XDG_DATA_HOME` environment variable before starting the project. See [url=$DOCS_URL/tutorials/io/data_paths.html]File paths in Godot projects[/url] in the documentation for more information. See also [getCacheDir] and [getConfigDir].
   *
   * Not to be confused with [getUserDataDir], which returns the *project-specific* user data path.
   */
  @JvmStatic
   ...
   *
   * On the Linux/BSD platform, this path can be overridden by setting the `XDG_CACHE_HOME` environment variable before starting the project. See [url=$DOCS_URL/tutorials/io/data_paths.html]File paths in Godot projects[/url] in the documentation for more information. See also [getConfigDir] and [getDataDir].
   *
   * Not to be confused with [getUserDataDir], which returns the *project-specific* user data path.
   */
  @JvmStatic
   ...
   */
  @JvmStatic
  public final fun setUseFileAccessSaveAndSwap(enabled: Boolean) {
   ...
   */
  @JvmStatic
  public final fun revokeGrantedPermissions() {
    TransferContext.writeArguments()
  ...
  public object MethodBindings {
    internal val getEntropyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_entropy", 47_165_747)

    internal val getSystemCaCertificatesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_system_ca_certificates", 2_841_200_299)

    internal val getConnectedMidiInputsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_connected_midi_inputs", 2_981_934_095)

    internal val openMidiInputsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "open_midi_inputs", 3_218_959_716)

    internal val closeMidiInputsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "close_midi_inputs", 3_218_959_716)

    internal val alertPtr: VoidPtr = TypeManager.getMethodBindPtr("OS", "alert", 1_783_970_740)

    internal val crashPtr: VoidPtr = TypeManager.getMethodBindPtr("OS", "crash", 83_702_148)

    internal val setLowProcessorUsageModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "set_low_processor_usage_mode", 2_586_408_642)

    internal val isInLowProcessorUsageModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_in_low_processor_usage_mode", 36_873_697)

    internal val setLowProcessorUsageModeSleepUsecPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "set_low_processor_usage_mode_sleep_usec", 1_286_410_249)

    internal val getLowProcessorUsageModeSleepUsecPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_low_processor_usage_mode_sleep_usec", 3_905_245_786)

    internal val setDeltaSmoothingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "set_delta_smoothing", 2_586_408_642)

    internal val isDeltaSmoothingEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_delta_smoothing_enabled", 36_873_697)

    internal val getProcessorCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_processor_count", 3_905_245_786)

    internal val getProcessorNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_processor_name", 201_670_096)

    internal val getSystemFontsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_system_fonts", 1_139_954_409)

    internal val getSystemFontPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_system_font_path", 626_580_860)

    internal val getSystemFontPathForTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_system_font_path_for_text", 197_317_981)

    internal val getExecutablePathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_executable_path", 201_670_096)

    internal val readStringFromStdinPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "read_string_from_stdin", 990_163_283)

    internal val readBufferFromStdinPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "read_buffer_from_stdin", 47_165_747)

    internal val getStdinTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_stdin_type", 1_704_816_237)

    internal val getStdoutTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_stdout_type", 1_704_816_237)

    internal val getStderrTypePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_stderr_type", 1_704_816_237)

    internal val executePtr: VoidPtr = TypeManager.getMethodBindPtr("OS", "execute", 1_488_299_882)

    internal val executeWithPipePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "execute_with_pipe", 2_851_312_030)

    internal val createProcessPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "create_process", 2_903_767_230)

    internal val createInstancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "create_instance", 1_080_601_263)

    internal val killPtr: VoidPtr = TypeManager.getMethodBindPtr("OS", "kill", 844_576_869)

    internal val shellOpenPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "shell_open", 166_001_499)

    internal val shellShowInFileManagerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "shell_show_in_file_manager", 3_565_188_097)

    internal val isProcessRunningPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_process_running", 1_116_898_809)

    internal val getProcessExitCodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_process_exit_code", 923_996_154)

    internal val getProcessIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_process_id", 3_905_245_786)

    internal val hasEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "has_environment", 3_927_539_163)

    internal val getEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_environment", 3_135_753_539)

    internal val setEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "set_environment", 3_605_043_004)

    internal val unsetEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "unset_environment", 3_089_850_668)

    internal val getNamePtr: VoidPtr = TypeManager.getMethodBindPtr("OS", "get_name", 201_670_096)

    internal val getDistributionNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_distribution_name", 201_670_096)

    internal val getVersionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_version", 201_670_096)

    internal val getVersionAliasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_version_alias", 201_670_096)

    internal val getCmdlineArgsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_cmdline_args", 2_981_934_095)

    internal val getCmdlineUserArgsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_cmdline_user_args", 2_981_934_095)

    internal val getVideoAdapterDriverInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_video_adapter_driver_info", 1_139_954_409)

    internal val setRestartOnExitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "set_restart_on_exit", 3_331_453_935)

    internal val isRestartOnExitSetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_restart_on_exit_set", 36_873_697)

    internal val getRestartOnExitArgumentsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_restart_on_exit_arguments", 1_139_954_409)

    internal val delayUsecPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "delay_usec", 998_575_451)

    internal val delayMsecPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "delay_msec", 998_575_451)

    internal val getLocalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_locale", 201_670_096)

    internal val getLocaleLanguagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_locale_language", 201_670_096)

    internal val getModelNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_model_name", 201_670_096)

    internal val isUserfsPersistentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_userfs_persistent", 36_873_697)

    internal val isStdoutVerbosePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_stdout_verbose", 36_873_697)

    internal val isDebugBuildPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_debug_build", 36_873_697)

    internal val getStaticMemoryUsagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_static_memory_usage", 3_905_245_786)

    internal val getStaticMemoryPeakUsagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_static_memory_peak_usage", 3_905_245_786)

    internal val getMemoryInfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_memory_info", 3_102_165_223)

    internal val moveToTrashPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "move_to_trash", 2_113_323_047)

    internal val getUserDataDirPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_user_data_dir", 201_670_096)

    internal val getSystemDirPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_system_dir", 3_073_895_123)

    internal val getConfigDirPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_config_dir", 201_670_096)

    internal val getDataDirPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_data_dir", 201_670_096)

    internal val getCacheDirPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_cache_dir", 201_670_096)

    internal val getTempDirPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_temp_dir", 201_670_096)

    internal val getUniqueIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_unique_id", 201_670_096)

    internal val getKeycodeStringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_keycode_string", 2_261_993_717)

    internal val isKeycodeUnicodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_keycode_unicode", 1_116_898_809)

    internal val findKeycodeFromStringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "find_keycode_from_string", 1_084_858_572)

    internal val setUseFileAccessSaveAndSwapPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "set_use_file_access_save_and_swap", 2_586_408_642)

    internal val setThreadNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "set_thread_name", 166_001_499)

    internal val getThreadCallerIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_thread_caller_id", 3_905_245_786)

    internal val getMainThreadIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_main_thread_id", 3_905_245_786)

    internal val hasFeaturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "has_feature", 3_927_539_163)

    internal val isSandboxedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "is_sandboxed", 36_873_697)

    internal val requestPermissionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "request_permission", 2_323_990_056)

    internal val requestPermissionsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "request_permissions", 2_240_911_060)

    internal val getGrantedPermissionsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "get_granted_permissions", 1_139_954_409)

    internal val revokeGrantedPermissionsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OS", "revoke_granted_permissions", 3_218_959_716)
  }
}
