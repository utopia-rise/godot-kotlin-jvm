 ...
 * ```
 *
 * **Note:** Since [CanvasGroup] and [CanvasItem.clipChildren] both utilize the backbuffer, children of a [CanvasGroup] who have their [CanvasItem.clipChildren] set to anything other than [CanvasItem.CLIP_CHILDREN_DISABLED] will not function correctly.
 */
@GodotBaseType
public open class CanvasGroup : Node2D() {
  ...
  public final fun setFitMargin(fitMargin: Float) {
  ...
  public final fun setClearMargin(clearMargin: Float) {
  ...
  public final fun setUseMipmaps(useMipmaps: Boolean) {
  ...
  public object MethodBindings {
    internal val setFitMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasGroup", "set_fit_margin", 373_806_689)

    internal val getFitMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasGroup", "get_fit_margin", 1_740_695_150)

    internal val setClearMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasGroup", "set_clear_margin", 373_806_689)

    internal val getClearMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasGroup", "get_clear_margin", 1_740_695_150)

    internal val setUseMipmapsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasGroup", "set_use_mipmaps", 2_586_408_642)

    internal val isUsingMipmapsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasGroup", "is_using_mipmaps", 36_873_697)
  }
}
