 ...
 *
 * Any [CanvasItem] can draw. For this, [queueRedraw] is called by the engine, then [NOTIFICATION_DRAW] will be received on idle time to request a redraw. Because of this, canvas items don't need to be redrawn on every frame, improving the performance significantly. Several functions for drawing on the [CanvasItem] are provided (see `draw_*` functions). However, they can only be used inside [_draw], its corresponding [Object.Notification] or methods connected to the [signal draw] signal.
 *
...
public open class CanvasItem internal constructor() : Node() {
   ...
   *
   * **Note:** Internal children (e.g. sliders in [ColorPicker] or tab bar in [TabContainer]) are also not affected by this property (see `include_internal` parameter of [Node.getChild] and other similar methods).
   *
   * **Warning:**
   * Be careful when trying to modify a local [copy](https://godot-kotl.in/en/stable/user-guide/api-differences/#core-types) obtained from this getter.
   * Mutating it alone won't have any effect on the actual property, it has to be reassigned again afterward.
  ...
  public final fun setLightMask(lightMask: Int) {
  ...
  public final fun setSelfModulate(selfModulate: Color) {
  ...
  public final fun setZAsRelative(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
  ...
  public final fun setYSortEnabled(enabled: Boolean) {
  ...
  public final fun setDrawBehindParent(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
  ...
  /**
   * Draws a line from a 2D point to another, with a given color and width. It can be optionally antialiased. See also [drawDashedLine], [drawMultiline], and [drawPolyline].
   *
  ...
  /**
   * Draws a dashed line from a 2D point to another, with a given color and width. See also [drawLine], [drawMultiline], and [drawPolyline].
   *
   ...
   */
  public final fun drawStyleBox(styleBox: StyleBox?, rect: Rect2) {
  ...
  /**
   * Draws a solid polygon of any number of points, convex or concave. Unlike [drawColoredPolygon], each point's color can be changed individually. See also [drawPolyline] and [drawPolylineColors]. If you need more flexibility (such as being able to use bones), use [RenderingServer.canvasItemAddTriangleArray] instead.
   *
   ...
   */
  public final fun drawMultimesh(multimesh: MultiMesh?, texture: Texture2D?) {
   ...
   */
  public final fun drawSetTransformMatrix(xform: Transform2D) {
   ...
   */
  public final fun drawEndAnimation() {
    TransferContext.writeArguments()
  ...
  public final fun setUseParentMaterial(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
  ...
  public final fun setVisibilityLayer(layer: Long) {
   ...
   */
  public final fun setVisibilityLayerBit(layer: Long, enabled: Boolean) {
  ...
  public final fun setTextureRepeat(mode: TextureRepeat) {
    TransferContext.writeArguments(LONG to mode.id)
  ...
  public final fun setClipChildrenMode(mode: ClipChildrenMode) {
    TransferContext.writeArguments(LONG to mode.id)
  ...
  public companion object {
    /**
     * The [CanvasItem]'s global transform has changed. This notification is only received if enabled by [setNotifyTransform].
     */
    public final const val NOTIFICATION_TRANSFORM_CHANGED: Long = 2000

    /**
     * The [CanvasItem]'s local transform has changed. This notification is only received if enabled by [setNotifyLocalTransform].
     */
  ...
  public object MethodBindings {
    internal val getCanvasItemPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_canvas_item", 2_944_877_500)

    internal val setVisiblePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_visible", 2_586_408_642)

    internal val isVisiblePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "is_visible", 36_873_697)

    internal val isVisibleInTreePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "is_visible_in_tree", 36_873_697)

    internal val showPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "show", 3_218_959_716)

    internal val hidePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "hide", 3_218_959_716)

    internal val queueRedrawPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "queue_redraw", 3_218_959_716)

    internal val moveToFrontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "move_to_front", 3_218_959_716)

    internal val setAsTopLevelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_as_top_level", 2_586_408_642)

    internal val isSetAsTopLevelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "is_set_as_top_level", 36_873_697)

    internal val setLightMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_light_mask", 1_286_410_249)

    internal val getLightMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_light_mask", 3_905_245_786)

    internal val setModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_modulate", 2_920_490_490)

    internal val getModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_modulate", 3_444_240_500)

    internal val setSelfModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_self_modulate", 2_920_490_490)

    internal val getSelfModulatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_self_modulate", 3_444_240_500)

    internal val setZIndexPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_z_index", 1_286_410_249)

    internal val getZIndexPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_z_index", 3_905_245_786)

    internal val setZAsRelativePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_z_as_relative", 2_586_408_642)

    internal val isZRelativePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "is_z_relative", 36_873_697)

    internal val setYSortEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_y_sort_enabled", 2_586_408_642)

    internal val isYSortEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "is_y_sort_enabled", 36_873_697)

    internal val setDrawBehindParentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_draw_behind_parent", 2_586_408_642)

    internal val isDrawBehindParentEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "is_draw_behind_parent_enabled", 36_873_697)

    internal val drawLinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_line", 1_562_330_099)

    internal val drawDashedLinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_dashed_line", 3_653_831_622)

    internal val drawPolylinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_polyline", 3_797_364_428)

    internal val drawPolylineColorsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_polyline_colors", 2_311_979_562)

    internal val drawArcPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_arc", 4_140_652_635)

    internal val drawMultilinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_multiline", 3_797_364_428)

    internal val drawMultilineColorsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_multiline_colors", 2_311_979_562)

    internal val drawRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_rect", 2_773_573_813)

    internal val drawCirclePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_circle", 3_153_026_596)

    internal val drawTexturePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_texture", 520_200_117)

    internal val drawTextureRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_texture_rect", 3_832_805_018)

    internal val drawTextureRectRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_texture_rect_region", 3_883_821_411)

    internal val drawMsdfTextureRectRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_msdf_texture_rect_region", 4_219_163_252)

    internal val drawLcdTextureRectRegionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_lcd_texture_rect_region", 3_212_350_954)

    internal val drawStyleBoxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_style_box", 388_176_283)

    internal val drawPrimitivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_primitive", 3_288_481_815)

    internal val drawPolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_polygon", 974_537_912)

    internal val drawColoredPolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_colored_polygon", 15_245_644)

    internal val drawStringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_string", 728_290_553)

    internal val drawMultilineStringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_multiline_string", 1_927_038_192)

    internal val drawStringOutlinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_string_outline", 340_562_381)

    internal val drawMultilineStringOutlinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_multiline_string_outline", 1_912_318_525)

    internal val drawCharPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_char", 3_339_793_283)

    internal val drawCharOutlinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_char_outline", 3_302_344_391)

    internal val drawMeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_mesh", 153_818_295)

    internal val drawMultimeshPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_multimesh", 937_992_368)

    internal val drawSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_set_transform", 288_975_085)

    internal val drawSetTransformMatrixPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_set_transform_matrix", 2_761_652_528)

    internal val drawAnimationSlicePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_animation_slice", 3_112_831_842)

    internal val drawEndAnimationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "draw_end_animation", 3_218_959_716)

    internal val getTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_transform", 3_814_499_831)

    internal val getGlobalTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_global_transform", 3_814_499_831)

    internal val getGlobalTransformWithCanvasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_global_transform_with_canvas", 3_814_499_831)

    internal val getViewportTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_viewport_transform", 3_814_499_831)

    internal val getViewportRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_viewport_rect", 1_639_390_495)

    internal val getCanvasTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_canvas_transform", 3_814_499_831)

    internal val getScreenTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_screen_transform", 3_814_499_831)

    internal val getLocalMousePositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_local_mouse_position", 3_341_600_327)

    internal val getGlobalMousePositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_global_mouse_position", 3_341_600_327)

    internal val getCanvasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_canvas", 2_944_877_500)

    internal val getCanvasLayerNodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_canvas_layer_node", 2_602_762_519)

    internal val getWorld2dPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_world_2d", 2_339_128_592)

    internal val setMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_material", 2_757_459_619)

    internal val getMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_material", 5_934_680)

    internal val setInstanceShaderParameterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_instance_shader_parameter", 3_776_071_444)

    internal val getInstanceShaderParameterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_instance_shader_parameter", 2_760_726_917)

    internal val setUseParentMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_use_parent_material", 2_586_408_642)

    internal val getUseParentMaterialPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_use_parent_material", 36_873_697)

    internal val setNotifyLocalTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_notify_local_transform", 2_586_408_642)

    internal val isLocalTransformNotificationEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "is_local_transform_notification_enabled", 36_873_697)

    internal val setNotifyTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_notify_transform", 2_586_408_642)

    internal val isTransformNotificationEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "is_transform_notification_enabled", 36_873_697)

    internal val forceUpdateTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "force_update_transform", 3_218_959_716)

    internal val makeCanvasPositionLocalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "make_canvas_position_local", 2_656_412_154)

    internal val makeInputLocalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "make_input_local", 811_130_057)

    internal val setVisibilityLayerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_visibility_layer", 1_286_410_249)

    internal val getVisibilityLayerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_visibility_layer", 3_905_245_786)

    internal val setVisibilityLayerBitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_visibility_layer_bit", 300_928_843)

    internal val getVisibilityLayerBitPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_visibility_layer_bit", 1_116_898_809)

    internal val setTextureFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_texture_filter", 1_037_999_706)

    internal val getTextureFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_texture_filter", 121_960_042)

    internal val setTextureRepeatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_texture_repeat", 1_716_472_974)

    internal val getTextureRepeatPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_texture_repeat", 2_667_158_319)

    internal val setClipChildrenModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "set_clip_children_mode", 1_319_393_776)

    internal val getClipChildrenModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CanvasItem", "get_clip_children_mode", 3_581_808_349)
  }
}
