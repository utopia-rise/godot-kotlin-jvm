...
import godot.drawAnimationSlicePtr
import godot.drawArcPtr
import godot.drawCharOutlinePtr
import godot.drawCharPtr
import godot.drawCirclePtr
import godot.drawColoredPolygonPtr
import godot.drawDashedLinePtr
import godot.drawEndAnimationPtr
import godot.drawLcdTextureRectRegionPtr
import godot.drawLinePtr
import godot.drawMeshPtr
import godot.drawMsdfTextureRectRegionPtr
import godot.drawMultilineColorsPtr
import godot.drawMultilinePtr
import godot.drawMultilineStringOutlinePtr
import godot.drawMultilineStringPtr
import godot.drawMultimeshPtr
import godot.drawPolygonPtr
import godot.drawPolylineColorsPtr
import godot.drawPolylinePtr
import godot.drawPrimitivePtr
import godot.drawRectPtr
import godot.drawSetTransformMatrixPtr
import godot.drawSetTransformPtr
import godot.drawStringOutlinePtr
import godot.drawStringPtr
import godot.drawStyleBoxPtr
import godot.drawTexturePtr
import godot.drawTextureRectPtr
import godot.drawTextureRectRegionPtr
import godot.forceUpdateTransformPtr
import godot.getCanvasItemPtr
import godot.getCanvasLayerNodePtr
import godot.getCanvasPtr
import godot.getCanvasTransformPtr
import godot.getClipChildrenModePtr
import godot.getGlobalMousePositionPtr
import godot.getGlobalTransformPtr
import godot.getGlobalTransformWithCanvasPtr
import godot.getLightMaskPtr
import godot.getLocalMousePositionPtr
import godot.getMaterialPtr
import godot.getModulatePtr
import godot.getScreenTransformPtr
import godot.getSelfModulatePtr
import godot.getTextureFilterPtr
import godot.getTextureRepeatPtr
import godot.getTransformPtr
import godot.getUseParentMaterialPtr
import godot.getViewportRectPtr
import godot.getViewportTransformPtr
import godot.getVisibilityLayerBitPtr
import godot.getVisibilityLayerPtr
import godot.getWorld2dPtr
import godot.getZIndexPtr
import godot.hidePtr
import godot.isDrawBehindParentEnabledPtr
import godot.isLocalTransformNotificationEnabledPtr
import godot.isSetAsTopLevelPtr
import godot.isTransformNotificationEnabledPtr
import godot.isVisibleInTreePtr
import godot.isVisiblePtr
import godot.isYSortEnabledPtr
import godot.isZRelativePtr
import godot.makeCanvasPositionLocalPtr
import godot.makeInputLocalPtr
import godot.moveToFrontPtr
import godot.queueRedrawPtr
import godot.setAsTopLevelPtr
import godot.setClipChildrenModePtr
import godot.setDrawBehindParentPtr
import godot.setLightMaskPtr
import godot.setMaterialPtr
import godot.setModulatePtr
import godot.setNotifyLocalTransformPtr
import godot.setNotifyTransformPtr
import godot.setSelfModulatePtr
import godot.setTextureFilterPtr
import godot.setTextureRepeatPtr
import godot.setUseParentMaterialPtr
import godot.setVisibilityLayerBitPtr
import godot.setVisibilityLayerPtr
import godot.setVisiblePtr
import godot.setYSortEnabledPtr
import godot.setZAsRelativePtr
import godot.setZIndexPtr
