...
public open class WebSocketPeer : PacketPeer() {
  ...
  /**
   * Connects to the given URL. TLS certificates will be verified against the hostname when connecting using the `wss://` protocol. You can pass the optional [tlsClientOptions] parameter to customize the trusted certification authorities, or disable the common name verification. See [TLSOptions.client] and [TLSOptions.clientUnsafe].
   *
  ...
  /**
   * Sends the given [message] using the desired [writeMode]. When sending a [String], prefer using [sendText].
   */
  @JvmOverloads
  public final fun send(message: PackedByteArray, writeMode: WriteMode = WebSocketPeer.WriteMode.BINARY): Error {
   ...
   */
  @JvmOverloads
  public final fun close(code: Int = 1000, reason: String = "") {
  ...
  /**
   * Returns the received WebSocket close frame status code, or `-1` when the connection was not cleanly closed. Only call this method when [getReadyState] returns [STATE_CLOSED].
   */
  ...
  /**
   * Returns the received WebSocket close frame status reason string. Only call this method when [getReadyState] returns [STATE_CLOSED].
   */
  ...
  public final fun setMaxQueuedPackets(bufferSize: Int) {
    TransferContext.writeArguments(LONG to bufferSize.toLong())
  ...
  public final fun setHeartbeatInterval(interval: Double) {
  ...
  public object MethodBindings {
    internal val connectToUrlPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "connect_to_url", 1_966_198_364)

    internal val acceptStreamPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "accept_stream", 255_125_695)

    internal val sendPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "send", 2_780_360_567)

    internal val sendTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "send_text", 166_001_499)

    internal val wasStringPacketPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "was_string_packet", 36_873_697)

    internal val pollPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "poll", 3_218_959_716)

    internal val closePtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "close", 1_047_156_615)

    internal val getConnectedHostPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_connected_host", 201_670_096)

    internal val getConnectedPortPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_connected_port", 3_905_245_786)

    internal val getSelectedProtocolPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_selected_protocol", 201_670_096)

    internal val getRequestedUrlPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_requested_url", 201_670_096)

    internal val setNoDelayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "set_no_delay", 2_586_408_642)

    internal val getCurrentOutboundBufferedAmountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_current_outbound_buffered_amount", 3_905_245_786)

    internal val getReadyStatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_ready_state", 346_482_985)

    internal val getCloseCodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_close_code", 3_905_245_786)

    internal val getCloseReasonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_close_reason", 201_670_096)

    internal val getSupportedProtocolsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_supported_protocols", 1_139_954_409)

    internal val setSupportedProtocolsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "set_supported_protocols", 4_015_028_928)

    internal val getHandshakeHeadersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_handshake_headers", 1_139_954_409)

    internal val setHandshakeHeadersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "set_handshake_headers", 4_015_028_928)

    internal val getInboundBufferSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_inbound_buffer_size", 3_905_245_786)

    internal val setInboundBufferSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "set_inbound_buffer_size", 1_286_410_249)

    internal val getOutboundBufferSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_outbound_buffer_size", 3_905_245_786)

    internal val setOutboundBufferSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "set_outbound_buffer_size", 1_286_410_249)

    internal val setMaxQueuedPacketsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "set_max_queued_packets", 1_286_410_249)

    internal val getMaxQueuedPacketsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_max_queued_packets", 3_905_245_786)

    internal val setHeartbeatIntervalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "set_heartbeat_interval", 373_806_689)

    internal val getHeartbeatIntervalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WebSocketPeer", "get_heartbeat_interval", 1_740_695_150)
  }
}
