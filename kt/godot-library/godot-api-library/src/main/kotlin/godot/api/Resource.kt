...
public open class Resource : RefCounted() {
   ...
   * ```
   */
  public open fun _setupLocalToScene() {
  ...
  /**
   * For resources that use a variable number of properties, either via [Object.ValidateProperty] or [Object.GetPropertyList], this method should be implemented to correctly clear the resource's state.
   */
  public open fun _resetState() {
   ...
   */
  public open fun _setPathCache(path: String) {
    throw NotImplementedError("Resource::_setPathCache is not implemented.")
  }

  public final fun setPath(path: String) {
   ...
   */
  public final fun takeOverPath(path: String) {
    TransferContext.writeArguments(STRING to path)
   ...
   * Sets the resource's path to [path] without involving the resource cache.
   */
  public final fun setPathCache(path: String) {
    TransferContext.writeArguments(STRING to path)
  ...
  public final fun setLocalToScene(enable: Boolean) {
  ...
  /**
   * Calls [_setupLocalToScene]. If [resourceLocalToScene] is set to `true`, this method is automatically called from [PackedScene.instantiate] by the newly duplicated resource within the scene instance.
   */
  public final fun setupLocalToScene() {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.setupLocalToScenePtr, NIL)
  }

  /**
   * For resources that use a variable number of properties, either via [Object.ValidateProperty] or [Object.GetPropertyList], override [_resetState] to correctly clear the resource's state.
   */
  public final fun resetState() {
    TransferContext.writeArguments()
   ...
   */
  public final fun setIdForPath(path: String, id: String) {
  ...
  public final fun setSceneUniqueId(id: String) {
  ...
  public object MethodBindings {
    internal val setPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "set_path", 83_702_148)

    internal val takeOverPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "take_over_path", 83_702_148)

    internal val getPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "get_path", 201_670_096)

    internal val setPathCachePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "set_path_cache", 83_702_148)

    internal val setNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "set_name", 83_702_148)

    internal val getNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "get_name", 201_670_096)

    internal val getRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "get_rid", 2_944_877_500)

    internal val setLocalToScenePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "set_local_to_scene", 2_586_408_642)

    internal val isLocalToScenePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "is_local_to_scene", 36_873_697)

    internal val getLocalScenePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "get_local_scene", 3_160_264_692)

    internal val setupLocalToScenePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "setup_local_to_scene", 3_218_959_716)

    internal val resetStatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "reset_state", 3_218_959_716)

    internal val setIdForPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "set_id_for_path", 3_186_203_200)

    internal val getIdForPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "get_id_for_path", 3_135_753_539)

    internal val isBuiltInPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "is_built_in", 36_873_697)

    internal val generateSceneUniqueIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "generate_scene_unique_id", 2_841_200_299)

    internal val setSceneUniqueIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "set_scene_unique_id", 83_702_148)

    internal val getSceneUniqueIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "get_scene_unique_id", 201_670_096)

    internal val emitChangedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "emit_changed", 3_218_959_716)

    internal val duplicatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Resource", "duplicate", 482_882_304)
  }
}
