...
public open class CameraAttributesPractical : CameraAttributes() {
  ...
  public final fun setDofBlurFarEnabled(enabled: Boolean) {
  ...
  public final fun setDofBlurFarDistance(distance: Float) {
  ...
  public final fun setDofBlurFarTransition(distance: Float) {
    TransferContext.writeArguments(DOUBLE to distance.toDouble())
  ...
  public final fun setDofBlurNearEnabled(enabled: Boolean) {
    TransferContext.writeArguments(BOOL to enabled)
  ...
  public final fun setDofBlurNearDistance(distance: Float) {
    TransferContext.writeArguments(DOUBLE to distance.toDouble())
  ...
  public final fun setDofBlurNearTransition(distance: Float) {
    TransferContext.writeArguments(DOUBLE to distance.toDouble())
  ...
  public final fun setDofBlurAmount(amount: Float) {
  ...
  public final fun setAutoExposureMaxSensitivity(maxSensitivity: Float) {
  ...
  public final fun setAutoExposureMinSensitivity(minSensitivity: Float) {
  ...
  public object MethodBindings {
    internal val setDofBlurFarEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_dof_blur_far_enabled", 2_586_408_642)

    internal val isDofBlurFarEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "is_dof_blur_far_enabled", 36_873_697)

    internal val setDofBlurFarDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_dof_blur_far_distance", 373_806_689)

    internal val getDofBlurFarDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "get_dof_blur_far_distance", 1_740_695_150)

    internal val setDofBlurFarTransitionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_dof_blur_far_transition", 373_806_689)

    internal val getDofBlurFarTransitionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "get_dof_blur_far_transition", 1_740_695_150)

    internal val setDofBlurNearEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_dof_blur_near_enabled", 2_586_408_642)

    internal val isDofBlurNearEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "is_dof_blur_near_enabled", 36_873_697)

    internal val setDofBlurNearDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_dof_blur_near_distance", 373_806_689)

    internal val getDofBlurNearDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "get_dof_blur_near_distance", 1_740_695_150)

    internal val setDofBlurNearTransitionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_dof_blur_near_transition", 373_806_689)

    internal val getDofBlurNearTransitionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "get_dof_blur_near_transition", 1_740_695_150)

    internal val setDofBlurAmountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_dof_blur_amount", 373_806_689)

    internal val getDofBlurAmountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "get_dof_blur_amount", 1_740_695_150)

    internal val setAutoExposureMaxSensitivityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_auto_exposure_max_sensitivity", 373_806_689)

    internal val getAutoExposureMaxSensitivityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "get_auto_exposure_max_sensitivity", 1_740_695_150)

    internal val setAutoExposureMinSensitivityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "set_auto_exposure_min_sensitivity", 373_806_689)

    internal val getAutoExposureMinSensitivityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CameraAttributesPractical", "get_auto_exposure_min_sensitivity", 1_740_695_150)
  }
}
