...
import godot.getAccessorTypePtr
import godot.getBufferViewPtr
import godot.getByteOffsetPtr
import godot.getComponentTypePtr
import godot.getCountPtr
import godot.getMaxPtr
import godot.getMinPtr
import godot.getNormalizedPtr
import godot.getSparseCountPtr
import godot.getSparseIndicesBufferViewPtr
import godot.getSparseIndicesByteOffsetPtr
import godot.getSparseIndicesComponentTypePtr
import godot.getSparseValuesBufferViewPtr
import godot.getSparseValuesByteOffsetPtr
import godot.getTypePtr
import godot.setAccessorTypePtr
import godot.setBufferViewPtr
import godot.setByteOffsetPtr
import godot.setComponentTypePtr
import godot.setCountPtr
import godot.setMaxPtr
import godot.setMinPtr
import godot.setNormalizedPtr
import godot.setSparseCountPtr
import godot.setSparseIndicesBufferViewPtr
import godot.setSparseIndicesByteOffsetPtr
import godot.setSparseIndicesComponentTypePtr
import godot.setSparseValuesBufferViewPtr
import godot.setSparseValuesByteOffsetPtr
import godot.setTypePtr
...
private const val ENGINECLASS_GLTFACCESSOR: Int = 250
