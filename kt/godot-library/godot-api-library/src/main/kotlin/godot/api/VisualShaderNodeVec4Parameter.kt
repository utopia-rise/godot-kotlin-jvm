...
public open class VisualShaderNodeVec4Parameter : VisualShaderNodeParameter() {
  ...
  public final fun setDefaultValue(`value`: Vector4) {
  ...
  public object MethodBindings {
    internal val setDefaultValueEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeVec4Parameter", "set_default_value_enabled", 2_586_408_642)

    internal val isDefaultValueEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeVec4Parameter", "is_default_value_enabled", 36_873_697)

    internal val setDefaultValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeVec4Parameter", "set_default_value", 643_568_085)

    internal val getDefaultValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VisualShaderNodeVec4Parameter", "get_default_value", 2_435_802_345)
  }
}
