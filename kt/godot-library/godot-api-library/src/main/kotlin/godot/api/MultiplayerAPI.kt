...
public open class MultiplayerAPI internal constructor() : RefCounted() {
  ...
  public final fun setMultiplayerPeer(peer: MultiplayerPeer?) {
  ...
  public companion object {
     ...
     */
    @JvmStatic
    public final fun setDefaultInterface(interfaceName: StringName) {
     ...
     */
    @JvmStatic
    public final fun setDefaultInterface(interfaceName: String): Unit = setDefaultInterface(interfaceName.asCachedStringName())
  }

  public object MethodBindings {
    internal val hasMultiplayerPeerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "has_multiplayer_peer", 2_240_911_060)

    internal val getMultiplayerPeerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "get_multiplayer_peer", 3_223_692_825)

    internal val setMultiplayerPeerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "set_multiplayer_peer", 3_694_835_298)

    internal val getUniqueIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "get_unique_id", 2_455_072_627)

    internal val isServerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "is_server", 2_240_911_060)

    internal val getRemoteSenderIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "get_remote_sender_id", 2_455_072_627)

    internal val pollPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "poll", 166_280_745)

    internal val rpcPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "rpc", 2_077_486_355)

    internal val objectConfigurationAddPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "object_configuration_add", 1_171_879_464)

    internal val objectConfigurationRemovePtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "object_configuration_remove", 1_171_879_464)

    internal val getPeersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "get_peers", 969_006_518)

    internal val setDefaultInterfacePtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "set_default_interface", 3_304_788_590)

    internal val getDefaultInterfacePtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "get_default_interface", 2_737_447_660)

    internal val createDefaultInterfacePtr: VoidPtr =
        TypeManager.getMethodBindPtr("MultiplayerAPI", "create_default_interface", 3_294_156_723)
  }
}
