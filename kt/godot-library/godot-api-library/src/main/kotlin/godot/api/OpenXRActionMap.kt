...
public open class OpenXRActionMap : Resource() {
  ...
  public final fun setActionSets(actionSets: VariantArray<Any?>) {
   ...
   * Add an action set.
   */
  public final fun addActionSet(actionSet: OpenXRActionSet?) {
   ...
   */
  public final fun removeActionSet(actionSet: OpenXRActionSet?) {
    TransferContext.writeArguments(OBJECT to actionSet)
    TransferContext.callMethod(ptr, MethodBindings.removeActionSetPtr, NIL)
  }

  public final fun setInteractionProfiles(interactionProfiles: VariantArray<Any?>) {
   ...
   */
  public final fun addInteractionProfile(interactionProfile: OpenXRInteractionProfile?) {
   ...
   */
  public final fun removeInteractionProfile(interactionProfile: OpenXRInteractionProfile?) {
    TransferContext.writeArguments(OBJECT to interactionProfile)
   ...
   */
  public final fun createDefaultActionSets() {
    TransferContext.writeArguments()
  ...
  public object MethodBindings {
    internal val setActionSetsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "set_action_sets", 381_264_803)

    internal val getActionSetsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "get_action_sets", 3_995_934_104)

    internal val getActionSetCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "get_action_set_count", 3_905_245_786)

    internal val findActionSetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "find_action_set", 1_888_809_267)

    internal val getActionSetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "get_action_set", 1_789_580_336)

    internal val addActionSetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "add_action_set", 2_093_310_581)

    internal val removeActionSetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "remove_action_set", 2_093_310_581)

    internal val setInteractionProfilesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "set_interaction_profiles", 381_264_803)

    internal val getInteractionProfilesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "get_interaction_profiles", 3_995_934_104)

    internal val getInteractionProfileCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "get_interaction_profile_count", 3_905_245_786)

    internal val findInteractionProfilePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "find_interaction_profile", 3_095_875_538)

    internal val getInteractionProfilePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "get_interaction_profile", 2_546_151_210)

    internal val addInteractionProfilePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "add_interaction_profile", 2_697_953_512)

    internal val removeInteractionProfilePtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "remove_interaction_profile", 2_697_953_512)

    internal val createDefaultActionSetsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRActionMap", "create_default_action_sets", 3_218_959_716)
  }
}
