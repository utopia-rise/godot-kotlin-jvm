...
public open class CollisionObject2D internal constructor() : Node2D() {
  ...
  public final fun setPickable(enabled: Boolean) {
   ...
   */
  public final fun removeShapeOwner(ownerId: Long) {
   ...
   */
  public final fun shapeOwnerSetTransform(ownerId: Long, transform: Transform2D) {
   ...
   */
  public final fun shapeOwnerSetDisabled(ownerId: Long, disabled: Boolean) {
   ...
   */
  public final fun shapeOwnerSetOneWayCollision(ownerId: Long, enable: Boolean) {
   ...
   */
  public final fun shapeOwnerSetOneWayCollisionMargin(ownerId: Long, margin: Float) {
   ...
   */
  public final fun shapeOwnerAddShape(ownerId: Long, shape: Shape2D?) {
   ...
   */
  public final fun shapeOwnerRemoveShape(ownerId: Long, shapeId: Int) {
    TransferContext.writeArguments(LONG to ownerId, LONG to shapeId.toLong())
   ...
   */
  public final fun shapeOwnerClearShapes(ownerId: Long) {
    TransferContext.writeArguments(LONG to ownerId)
  ...
  public enum class DisableMode(
    ...
    /**
     * When [Node.processMode] is set to [Node.PROCESS_MODE_DISABLED], remove from the physics simulation to stop all physics interactions with this [CollisionObject2D].
     *
     * Automatically re-added to the physics simulation when the [Node] is processed again.
     */
    REMOVE(0),
    /**
     * When [Node.processMode] is set to [Node.PROCESS_MODE_DISABLED], make the body static. Doesn't affect [Area2D]. [PhysicsBody2D] can't be affected by forces or other bodies while static.
     *
  ...
  public object MethodBindings {
    internal val getRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_rid", 2_944_877_500)

    internal val setCollisionLayerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "set_collision_layer", 1_286_410_249)

    internal val getCollisionLayerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_collision_layer", 3_905_245_786)
    ...
    internal val getCollisionMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_collision_mask", 3_905_245_786)

    internal val setCollisionLayerValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "set_collision_layer_value", 300_928_843)

    internal val getCollisionLayerValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_collision_layer_value", 1_116_898_809)

    internal val setCollisionMaskValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "set_collision_mask_value", 300_928_843)

    internal val getCollisionMaskValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_collision_mask_value", 1_116_898_809)

    internal val setCollisionPriorityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "set_collision_priority", 373_806_689)

    internal val getCollisionPriorityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_collision_priority", 1_740_695_150)

    internal val setDisableModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "set_disable_mode", 1_919_204_045)

    internal val getDisableModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_disable_mode", 3_172_846_349)

    internal val setPickablePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "set_pickable", 2_586_408_642)

    internal val isPickablePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "is_pickable", 36_873_697)

    internal val createShapeOwnerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "create_shape_owner", 3_429_307_534)

    internal val removeShapeOwnerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "remove_shape_owner", 1_286_410_249)

    internal val getShapeOwnersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_shape_owners", 969_006_518)

    internal val shapeOwnerSetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_set_transform", 30_160_968)

    internal val shapeOwnerGetTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_get_transform", 3_836_996_910)

    internal val shapeOwnerGetOwnerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_get_owner", 3_332_903_315)

    internal val shapeOwnerSetDisabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_set_disabled", 300_928_843)

    internal val isShapeOwnerDisabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "is_shape_owner_disabled", 1_116_898_809)

    internal val shapeOwnerSetOneWayCollisionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_set_one_way_collision", 300_928_843)

    internal val isShapeOwnerOneWayCollisionEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "is_shape_owner_one_way_collision_enabled", 1_116_898_809)

    internal val shapeOwnerSetOneWayCollisionMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_set_one_way_collision_margin", 1_602_489_585)

    internal val getShapeOwnerOneWayCollisionMarginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "get_shape_owner_one_way_collision_margin", 2_339_986_948)

    internal val shapeOwnerAddShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_add_shape", 2_077_425_081)

    internal val shapeOwnerGetShapeCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_get_shape_count", 923_996_154)

    internal val shapeOwnerGetShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_get_shape", 3_106_725_749)

    internal val shapeOwnerGetShapeIndexPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_get_shape_index", 3_175_239_445)

    internal val shapeOwnerRemoveShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_remove_shape", 3_937_882_851)

    internal val shapeOwnerClearShapesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_owner_clear_shapes", 1_286_410_249)

    internal val shapeFindOwnerPtr: VoidPtr =
        TypeManager.getMethodBindPtr("CollisionObject2D", "shape_find_owner", 923_996_154)
  }
}
