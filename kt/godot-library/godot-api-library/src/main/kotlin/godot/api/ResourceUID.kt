...
public object ResourceUID : Object() {
   ...
   */
  @JvmStatic
  public final fun addId(id: Long, path: String) {
   ...
   */
  @JvmStatic
  public final fun setId(id: Long, path: String) {
    TransferContext.writeArguments(LONG to id, STRING to path)
   ...
   */
  @JvmStatic
  public final fun removeId(id: Long) {
    TransferContext.writeArguments(LONG to id)
  ...
  public object MethodBindings {
    internal val idToTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ResourceUID", "id_to_text", 844_755_477)

    internal val textToIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ResourceUID", "text_to_id", 1_321_353_865)

    internal val createIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ResourceUID", "create_id", 2_455_072_627)

    internal val hasIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ResourceUID", "has_id", 1_116_898_809)

    internal val addIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ResourceUID", "add_id", 501_894_301)

    internal val setIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ResourceUID", "set_id", 501_894_301)

    internal val getIdPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ResourceUID", "get_id_path", 844_755_477)

    internal val removeIdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("ResourceUID", "remove_id", 1_286_410_249)
  }
}
