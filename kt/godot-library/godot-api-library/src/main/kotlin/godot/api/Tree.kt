...
import godot.areColumnTitlesVisiblePtr
...
import godot.createItemPtr
import godot.deselectAllPtr
import godot.editSelectedPtr
import godot.ensureCursorIsVisiblePtr
import godot.getAllowReselectPtr
import godot.getAllowRmbSelectPtr
import godot.getAllowSearchPtr
import godot.getButtonIdAtPositionPtr
import godot.getColumnAtPositionPtr
import godot.getColumnExpandRatioPtr
import godot.getColumnTitleAlignmentPtr
import godot.getColumnTitleDirectionPtr
import godot.getColumnTitleLanguagePtr
import godot.getColumnTitlePtr
import godot.getColumnWidthPtr
import godot.getColumnsPtr
import godot.getCustomPopupRectPtr
import godot.getDropModeFlagsPtr
import godot.getDropSectionAtPositionPtr
import godot.getEditedColumnPtr
import godot.getEditedPtr
import godot.getItemAreaRectPtr
import godot.getItemAtPositionPtr
import godot.getNextSelectedPtr
import godot.getPressedButtonPtr
import godot.getRootPtr
import godot.getScrollPtr
import godot.getSelectModePtr
import godot.getSelectedColumnPtr
import godot.getSelectedPtr
import godot.isColumnClippingContentPtr
import godot.isColumnExpandingPtr
import godot.isFoldingHiddenPtr
import godot.isHScrollEnabledPtr
import godot.isRecursiveFoldingEnabledPtr
import godot.isRootHiddenPtr
import godot.isVScrollEnabledPtr
import godot.scrollToItemPtr
import godot.setAllowReselectPtr
import godot.setAllowRmbSelectPtr
import godot.setAllowSearchPtr
import godot.setColumnClipContentPtr
import godot.setColumnCustomMinimumWidthPtr
import godot.setColumnExpandPtr
import godot.setColumnExpandRatioPtr
import godot.setColumnTitleAlignmentPtr
import godot.setColumnTitleDirectionPtr
import godot.setColumnTitleLanguagePtr
import godot.setColumnTitlePtr
import godot.setColumnTitlesVisiblePtr
import godot.setColumnsPtr
import godot.setDropModeFlagsPtr
import godot.setEnableRecursiveFoldingPtr
import godot.setHScrollEnabledPtr
import godot.setHideFoldingPtr
import godot.setHideRootPtr
import godot.setSelectModePtr
import godot.setSelectedPtr
import godot.setVScrollEnabledPtr
