 ...
 * [OpenXRSpatialEntityExtension.createSpatialContext] to create a spatial context with spatial anchor
 * capabilities.
 */
@GodotBaseType
public open class OpenXRSpatialCapabilityConfigurationAnchor :
  ...
  public companion object {
    ...
    public val getEnabledComponentsName:
        MethodStringName0<OpenXRSpatialCapabilityConfigurationAnchor, PackedInt64Array> =
        MethodStringName0<OpenXRSpatialCapabilityConfigurationAnchor, PackedInt64Array>("get_enabled_components")
  }

  public object MethodBindings {
    internal val getEnabledComponentsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRSpatialCapabilityConfigurationAnchor", "get_enabled_components", 235988956)
  }
}
