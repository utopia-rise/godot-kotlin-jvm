...
import godot.clearBakedMeshesPtr
...
import godot.getBakeMeshInstancePtr
import godot.getBakeMeshesPtr
import godot.getBasisWithOrthogonalIndexPtr
import godot.getCellItemBasisPtr
import godot.getCellItemOrientationPtr
import godot.getCellItemPtr
import godot.getCellScalePtr
import godot.getCellSizePtr
import godot.getCenterXPtr
import godot.getCenterYPtr
import godot.getCenterZPtr
import godot.getCollisionLayerPtr
import godot.getCollisionLayerValuePtr
import godot.getCollisionMaskPtr
import godot.getCollisionMaskValuePtr
import godot.getCollisionPriorityPtr
import godot.getMeshLibraryPtr
import godot.getMeshesPtr
import godot.getNavigationMapPtr
import godot.getOctantSizePtr
import godot.getOrthogonalIndexFromBasisPtr
import godot.getPhysicsMaterialPtr
import godot.getUsedCellsByItemPtr
import godot.getUsedCellsPtr
import godot.isBakingNavigationPtr
import godot.localToMapPtr
import godot.makeBakedMeshesPtr
import godot.mapToLocalPtr
import godot.resourceChangedPtr
import godot.setBakeNavigationPtr
import godot.setCellItemPtr
import godot.setCellScalePtr
import godot.setCellSizePtr
import godot.setCenterXPtr
import godot.setCenterYPtr
import godot.setCenterZPtr
import godot.setCollisionLayerPtr
import godot.setCollisionLayerValuePtr
import godot.setCollisionMaskPtr
import godot.setCollisionMaskValuePtr
import godot.setCollisionPriorityPtr
import godot.setMeshLibraryPtr
import godot.setNavigationMapPtr
import godot.setOctantSizePtr
import godot.setPhysicsMaterialPtr
import kotlin.Any
...
private const val ENGINECLASS_GRIDMAP: Int = 290
...
public open class GridMap : Node3D() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_GRIDMAP, scriptIndex)
  }
