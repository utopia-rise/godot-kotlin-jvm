...
public open class RichTextLabel : Control() {
  /**
   * Triggered when the user clicks on content between meta (URL) tags. If the meta is defined in BBCode, e.g. [code skip-lint][url={"key": "value"}]Text[/url][/code], then the parameter for this signal will always be a [String] type. If a particular type or an object is desired, the [pushMeta] method must be used to manually insert the data into the tag stack. Alternatively, you can convert the [String] input to the desired type based on its contents (such as calling [JSON.parse] on it).
   *
  ...
  /**
   * If `true`, the label underlines meta tags such as [code skip-lint][url]{text}[/url][/code]. These tags can call a function when clicked if [signal meta_clicked] is connected to a function.
   */
   ...
   */
  public final fun addText(text: String) {
   ...
   *
   * If [noInvalidate] is set to `true`, cache for the subsequent paragraphs is not invalidated. Use it for faster updates if deleted paragraph is fully self-contained (have no unclosed tags), or this call is part of the complex edit operation and [invalidateParagraph] will be called at the end of operation.
   */
  @JvmOverloads
   ...
   */
  @JvmOverloads
  public final fun pushFont(font: Font?, fontSize: Int = 0) {
   ...
   */
  public final fun pushFontSize(fontSize: Int) {
   ...
   */
  public final fun pushBoldItalics() {
    TransferContext.writeArguments()
   ...
   */
  public final fun pushColor(color: Color) {
   ...
   */
  public final fun pushOutlineSize(outlineSize: Int) {
   ...
   */
  public final fun pushOutlineColor(color: Color) {
    TransferContext.writeArguments(COLOR to color)
  ...
  /**
   * Adds an [code skip-lint][indent][/code] tag to the tag stack. Multiplies [level] by current [tabSize] to determine new margin length.
   */
  public final fun pushIndent(level: Int) {
    TransferContext.writeArguments(LONG to level.toLong())
    TransferContext.callMethod(ptr, MethodBindings.pushIndentPtr, NIL)
  }

  /**
   * Adds [code skip-lint][ol][/code] or [code skip-lint][ul][/code] tag to the tag stack. Multiplies [level] by current [tabSize] to determine new margin length.
   */
  @JvmOverloads
   ...
   */
  public final fun pushHint(description: String) {
   ...
   */
  public final fun pushLanguage(language: String) {
   ...
   */
  public final fun pushUnderline() {
    TransferContext.writeArguments()
   ...
   */
  public final fun pushStrikethrough() {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.pushStrikethroughPtr, NIL)
  }

  /**
   * Adds a [code skip-lint][table=columns,inline_align][/code] tag to the tag stack. Use [setTableColumnExpand] to set column expansion ratio. Use [pushCell] to add cells.
   */
  @JvmOverloads
   ...
   */
  public final fun setCellRowBackgroundColor(oddRowBg: Color, evenRowBg: Color) {
   ...
   */
  public final fun setCellBorderColor(color: Color) {
    TransferContext.writeArguments(COLOR to color)
   ...
   */
  public final fun setCellSizeOverride(minSize: Vector2, maxSize: Vector2) {
   ...
   */
  public final fun setCellPadding(padding: Rect2) {
    TransferContext.writeArguments(RECT2 to padding)
    TransferContext.callMethod(ptr, MethodBindings.setCellPaddingPtr, NIL)
  }

  /**
   * Adds a [code skip-lint][cell][/code] tag to the tag stack. Must be inside a [code skip-lint][table][/code] tag. See [pushTable] for details. Use [setTableColumnExpand] to set column expansion ratio, [setCellBorderColor] to set cell border, [setCellRowBackgroundColor] to set cell background, [setCellSizeOverride] to override cell size, and [setCellPadding] to set padding.
   */
  public final fun pushCell() {
    TransferContext.writeArguments()
   ...
   */
  public final fun pushFgcolor(fgcolor: Color) {
   ...
   */
  public final fun pushBgcolor(bgcolor: Color) {
   ...
   */
  public final fun pushCustomfx(effect: RichTextEffect?, env: Dictionary<Any?, Any?>) {
  ...
  public final fun setMetaUnderline(enable: Boolean) {
  ...
  public final fun setHintUnderline(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
  ...
  public final fun setScrollActive(active: Boolean) {
  ...
  public final fun setScrollFollow(follow: Boolean) {
   ...
   */
  public final fun scrollToLine(line: Int) {
   ...
   */
  public final fun scrollToParagraph(paragraph: Int) {
    TransferContext.writeArguments(LONG to paragraph.toLong())
   ...
   */
  public final fun scrollToSelection() {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.scrollToSelectionPtr, NIL)
  }

  public final fun setTabSize(spaces: Int) {
  ...
  public final fun setFitContent(enabled: Boolean) {
  ...
  public final fun setSelectionEnabled(enabled: Boolean) {
    TransferContext.writeArguments(BOOL to enabled)
   ...
   */
  public final fun parseBbcode(bbcode: String) {
   ...
   */
  public final fun appendText(bbcode: String) {
    TransferContext.writeArguments(STRING to bbcode)
  ...
  public final fun setThreaded(threaded: Boolean) {
  ...
  public final fun setProgressBarDelay(delayMs: Int) {
  ...
  public final fun setUseBbcode(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
   ...
   *
   * **Note:** If [visibleCharactersBehavior] is set to [TextServer.VC_CHARS_BEFORE_SHAPING] only visible wrapped lines are counted.
   *
   * **Note:** If [threaded] is enabled, this method returns a value for the loaded part of the document. Use [isFinished] or [signal finished] to determine whether document is fully loaded.
   */
  ...
  public final fun setEffects(effects: VariantArray<Any?>) {
   ...
   * ```
   */
  public final fun installEffect(effect: Any?) {
  ...
  public class ImageUpdateMask(
    ...
    public infix fun or(other: ImageUpdateMask): ImageUpdateMask = ImageUpdateMask(flag.or(other.flag))

    public infix fun or(other: Long): ImageUpdateMask = ImageUpdateMask(flag.or(other))

    public infix fun xor(other: ImageUpdateMask): ImageUpdateMask = ImageUpdateMask(flag.xor(other.flag))

    public infix fun xor(other: Long): ImageUpdateMask = ImageUpdateMask(flag.xor(other))

    public infix fun and(other: ImageUpdateMask): ImageUpdateMask = ImageUpdateMask(flag.and(other.flag))
  ...
  public object MethodBindings {
    internal val getParsedTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_parsed_text", 201_670_096)

    internal val addTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "add_text", 83_702_148)

    internal val setTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_text", 83_702_148)

    internal val addImagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "add_image", 3_017_663_154)

    internal val updateImagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "update_image", 815_048_486)

    internal val newlinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "newline", 3_218_959_716)

    internal val removeParagraphPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "remove_paragraph", 3_262_369_265)

    internal val invalidateParagraphPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "invalidate_paragraph", 3_067_735_520)

    internal val pushFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_font", 2_347_424_842)

    internal val pushFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_font_size", 1_286_410_249)

    internal val pushNormalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_normal", 3_218_959_716)

    internal val pushBoldPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_bold", 3_218_959_716)

    internal val pushBoldItalicsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_bold_italics", 3_218_959_716)

    internal val pushItalicsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_italics", 3_218_959_716)

    internal val pushMonoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_mono", 3_218_959_716)

    internal val pushColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_color", 2_920_490_490)

    internal val pushOutlineSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_outline_size", 1_286_410_249)

    internal val pushOutlineColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_outline_color", 2_920_490_490)

    internal val pushParagraphPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_paragraph", 3_089_306_873)

    internal val pushIndentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_indent", 1_286_410_249)

    internal val pushListPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_list", 3_017_143_144)

    internal val pushMetaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_meta", 3_765_356_747)

    internal val pushHintPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_hint", 83_702_148)

    internal val pushLanguagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_language", 83_702_148)

    internal val pushUnderlinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_underline", 3_218_959_716)

    internal val pushStrikethroughPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_strikethrough", 3_218_959_716)

    internal val pushTablePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_table", 2_623_499_273)

    internal val pushDropcapPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_dropcap", 4_061_635_501)

    internal val setTableColumnExpandPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_table_column_expand", 117_236_061)

    internal val setCellRowBackgroundColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_cell_row_background_color", 3_465_483_165)

    internal val setCellBorderColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_cell_border_color", 2_920_490_490)

    internal val setCellSizeOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_cell_size_override", 3_108_078_480)

    internal val setCellPaddingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_cell_padding", 2_046_264_180)

    internal val pushCellPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_cell", 3_218_959_716)

    internal val pushFgcolorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_fgcolor", 2_920_490_490)

    internal val pushBgcolorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_bgcolor", 2_920_490_490)

    internal val pushCustomfxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_customfx", 2_337_942_958)

    internal val pushContextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "push_context", 3_218_959_716)

    internal val popContextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "pop_context", 3_218_959_716)

    internal val popPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "pop", 3_218_959_716)

    internal val popAllPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "pop_all", 3_218_959_716)

    internal val clearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "clear", 3_218_959_716)

    internal val setStructuredTextBidiOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_structured_text_bidi_override", 55_961_453)

    internal val getStructuredTextBidiOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_structured_text_bidi_override", 3_385_126_229)

    internal val setStructuredTextBidiOverrideOptionsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_structured_text_bidi_override_options", 381_264_803)

    internal val getStructuredTextBidiOverrideOptionsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_structured_text_bidi_override_options", 3_995_934_104)

    internal val setTextDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_text_direction", 119_160_795)

    internal val getTextDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_text_direction", 797_257_663)

    internal val setLanguagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_language", 83_702_148)

    internal val getLanguagePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_language", 201_670_096)

    internal val setHorizontalAlignmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_horizontal_alignment", 2_312_603_777)

    internal val getHorizontalAlignmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_horizontal_alignment", 341_400_642)

    internal val setVerticalAlignmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_vertical_alignment", 1_796_458_609)

    internal val getVerticalAlignmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_vertical_alignment", 3_274_884_059)

    internal val setJustificationFlagsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_justification_flags", 2_877_345_813)

    internal val getJustificationFlagsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_justification_flags", 1_583_363_614)

    internal val setTabStopsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_tab_stops", 2_899_603_908)

    internal val getTabStopsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_tab_stops", 675_695_659)

    internal val setAutowrapModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_autowrap_mode", 3_289_138_044)

    internal val getAutowrapModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_autowrap_mode", 1_549_071_663)

    internal val setMetaUnderlinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_meta_underline", 2_586_408_642)

    internal val isMetaUnderlinedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_meta_underlined", 36_873_697)

    internal val setHintUnderlinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_hint_underline", 2_586_408_642)

    internal val isHintUnderlinedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_hint_underlined", 36_873_697)

    internal val setScrollActivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_scroll_active", 2_586_408_642)

    internal val isScrollActivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_scroll_active", 36_873_697)

    internal val setScrollFollowPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_scroll_follow", 2_586_408_642)

    internal val isScrollFollowingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_scroll_following", 36_873_697)

    internal val getVScrollBarPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_v_scroll_bar", 2_630_340_773)

    internal val scrollToLinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "scroll_to_line", 1_286_410_249)

    internal val scrollToParagraphPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "scroll_to_paragraph", 1_286_410_249)

    internal val scrollToSelectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "scroll_to_selection", 3_218_959_716)

    internal val setTabSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_tab_size", 1_286_410_249)

    internal val getTabSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_tab_size", 3_905_245_786)

    internal val setFitContentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_fit_content", 2_586_408_642)

    internal val isFitContentEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_fit_content_enabled", 36_873_697)

    internal val setSelectionEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_selection_enabled", 2_586_408_642)

    internal val isSelectionEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_selection_enabled", 36_873_697)

    internal val setContextMenuEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_context_menu_enabled", 2_586_408_642)

    internal val isContextMenuEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_context_menu_enabled", 36_873_697)

    internal val setShortcutKeysEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_shortcut_keys_enabled", 2_586_408_642)

    internal val isShortcutKeysEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_shortcut_keys_enabled", 36_873_697)

    internal val setDeselectOnFocusLossEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_deselect_on_focus_loss_enabled", 2_586_408_642)

    internal val isDeselectOnFocusLossEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_deselect_on_focus_loss_enabled", 36_873_697)

    internal val setDragAndDropSelectionEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_drag_and_drop_selection_enabled", 2_586_408_642)

    internal val isDragAndDropSelectionEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_drag_and_drop_selection_enabled", 36_873_697)

    internal val getSelectionFromPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_selection_from", 3_905_245_786)

    internal val getSelectionToPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_selection_to", 3_905_245_786)

    internal val getSelectionLineOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_selection_line_offset", 1_740_695_150)

    internal val selectAllPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "select_all", 3_218_959_716)

    internal val getSelectedTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_selected_text", 201_670_096)

    internal val deselectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "deselect", 3_218_959_716)

    internal val parseBbcodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "parse_bbcode", 83_702_148)

    internal val appendTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "append_text", 83_702_148)

    internal val getTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_text", 201_670_096)

    internal val isReadyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_ready", 36_873_697)

    internal val isFinishedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_finished", 36_873_697)

    internal val setThreadedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_threaded", 2_586_408_642)

    internal val isThreadedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_threaded", 36_873_697)

    internal val setProgressBarDelayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_progress_bar_delay", 1_286_410_249)

    internal val getProgressBarDelayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_progress_bar_delay", 3_905_245_786)

    internal val setVisibleCharactersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_visible_characters", 1_286_410_249)

    internal val getVisibleCharactersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_visible_characters", 3_905_245_786)

    internal val getVisibleCharactersBehaviorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_visible_characters_behavior", 258_789_322)

    internal val setVisibleCharactersBehaviorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_visible_characters_behavior", 3_383_839_701)

    internal val setVisibleRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_visible_ratio", 373_806_689)

    internal val getVisibleRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_visible_ratio", 1_740_695_150)

    internal val getCharacterLinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_character_line", 3_744_713_108)

    internal val getCharacterParagraphPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_character_paragraph", 3_744_713_108)

    internal val getTotalCharacterCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_total_character_count", 3_905_245_786)

    internal val setUseBbcodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_use_bbcode", 2_586_408_642)

    internal val isUsingBbcodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_using_bbcode", 36_873_697)

    internal val getLineCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_line_count", 3_905_245_786)

    internal val getLineRangePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_line_range", 3_665_014_314)

    internal val getVisibleLineCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_visible_line_count", 3_905_245_786)

    internal val getParagraphCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_paragraph_count", 3_905_245_786)

    internal val getVisibleParagraphCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_visible_paragraph_count", 3_905_245_786)

    internal val getContentHeightPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_content_height", 3_905_245_786)

    internal val getContentWidthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_content_width", 3_905_245_786)

    internal val getLineOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_line_offset", 4_025_615_559)

    internal val getParagraphOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_paragraph_offset", 4_025_615_559)

    internal val parseExpressionsForValuesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "parse_expressions_for_values", 1_522_900_837)

    internal val setEffectsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "set_effects", 381_264_803)

    internal val getEffectsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_effects", 2_915_620_761)

    internal val installEffectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "install_effect", 1_114_965_689)

    internal val getMenuPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "get_menu", 229_722_558)

    internal val isMenuVisiblePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "is_menu_visible", 36_873_697)

    internal val menuOptionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RichTextLabel", "menu_option", 1_286_410_249)
  }
}
