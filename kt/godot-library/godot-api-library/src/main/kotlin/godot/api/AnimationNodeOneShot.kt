...
import godot.getAutorestartDelayPtr
import godot.getAutorestartRandomDelayPtr
import godot.getFadeinCurvePtr
import godot.getFadeinTimePtr
import godot.getFadeoutCurvePtr
import godot.getFadeoutTimePtr
import godot.getMixModePtr
import godot.hasAutorestartPtr
import godot.isLoopBrokenAtEndPtr
import godot.setAutorestartDelayPtr
import godot.setAutorestartPtr
import godot.setAutorestartRandomDelayPtr
import godot.setBreakLoopAtEndPtr
import godot.setFadeinCurvePtr
import godot.setFadeinTimePtr
import godot.setFadeoutCurvePtr
import godot.setFadeoutTimePtr
import godot.setMixModePtr
...
private const val ENGINECLASS_ANIMATIONNODEONESHOT: Int = 60
...
public open class AnimationNodeOneShot : AnimationNodeSync() {
  ...
  public final fun getFadeinTime(): Double {
    ...
    TransferContext.callMethod(ptr, MethodBindings.getFadeinTimePtr, DOUBLE)
  ...
  public final fun getFadeoutTime(): Double {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.getFadeoutTimePtr, DOUBLE)
    return (TransferContext.readReturnValue(DOUBLE) as Double)
  }
  ...
  public final fun getAutorestartDelay(): Double {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.getAutorestartDelayPtr, DOUBLE)
    return (TransferContext.readReturnValue(DOUBLE) as Double)
  }
  ...
  public final fun getAutorestartRandomDelay(): Double {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.getAutorestartRandomDelayPtr, DOUBLE)
    return (TransferContext.readReturnValue(DOUBLE) as Double)
  }
