...
import godot.addFilterPtr
import godot.addOptionPtr
import godot.clearFiltersPtr
...
import godot.getAccessPtr
import godot.getCurrentDirPtr
import godot.getCurrentFilePtr
import godot.getCurrentPathPtr
import godot.getFileModePtr
import godot.getFiltersPtr
import godot.getLineEditPtr
import godot.getOptionCountPtr
import godot.getOptionDefaultPtr
import godot.getOptionNamePtr
import godot.getOptionValuesPtr
import godot.getRootSubfolderPtr
import godot.getSelectedOptionsPtr
import godot.getUseNativeDialogPtr
import godot.getVboxPtr
import godot.invalidatePtr
import godot.isModeOverridingTitlePtr
import godot.isShowingHiddenFilesPtr
import godot.setAccessPtr
import godot.setCurrentDirPtr
import godot.setCurrentFilePtr
import godot.setCurrentPathPtr
import godot.setFileModePtr
import godot.setFiltersPtr
import godot.setModeOverridesTitlePtr
import godot.setOptionCountPtr
import godot.setOptionDefaultPtr
import godot.setOptionNamePtr
import godot.setOptionValuesPtr
import godot.setRootSubfolderPtr
import godot.setShowHiddenFilesPtr
import godot.setUseNativeDialogPtr
import kotlin.Any
...
private const val ENGINECLASS_FILEDIALOG: Int = 240
...
public open class FileDialog : ConfirmationDialog() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_FILEDIALOG, scriptIndex)
  }
