...
import godot.clearGlyphsPtr
import godot.clearKerningMapPtr
import godot.clearSizeCachePtr
...
import godot.getAntialiasingPtr
import godot.getCacheAscentPtr
import godot.getCacheCountPtr
import godot.getCacheDescentPtr
import godot.getCacheScalePtr
import godot.getCacheUnderlinePositionPtr
import godot.getCacheUnderlineThicknessPtr
import godot.getCharFromGlyphIndexPtr
import godot.getDataPtr
import godot.getDisableEmbeddedBitmapsPtr
import godot.getEmboldenPtr
import godot.getExtraBaselineOffsetPtr
import godot.getExtraSpacingPtr
import godot.getFaceIndexPtr
import godot.getFixedSizePtr
import godot.getFixedSizeScaleModePtr
import godot.getGenerateMipmapsPtr
import godot.getGlyphAdvancePtr
import godot.getGlyphIndexPtr
import godot.getGlyphListPtr
import godot.getGlyphOffsetPtr
import godot.getGlyphSizePtr
import godot.getGlyphTextureIdxPtr
import godot.getGlyphUvRectPtr
import godot.getHintingPtr
import godot.getKerningListPtr
import godot.getKerningPtr
import godot.getLanguageSupportOverridePtr
import godot.getLanguageSupportOverridesPtr
import godot.getMsdfPixelRangePtr
import godot.getMsdfSizePtr
import godot.getOpentypeFeatureOverridesPtr
import godot.getOversamplingPtr
import godot.getScriptSupportOverridePtr
import godot.getScriptSupportOverridesPtr
import godot.getSizeCacheListPtr
import godot.getSubpixelPositioningPtr
import godot.getTextureCountPtr
import godot.getTextureImagePtr
import godot.getTextureOffsetsPtr
import godot.getTransformPtr
import godot.getVariationCoordinatesPtr
import godot.isAllowSystemFallbackPtr
import godot.isForceAutohinterPtr
import godot.isMultichannelSignedDistanceFieldPtr
import godot.loadBitmapFontPtr
import godot.loadDynamicFontPtr
import godot.removeCachePtr
import godot.removeGlyphPtr
import godot.removeKerningPtr
import godot.removeLanguageSupportOverridePtr
import godot.removeScriptSupportOverridePtr
import godot.removeSizeCachePtr
import godot.removeTexturePtr
import godot.renderGlyphPtr
import godot.renderRangePtr
import godot.setAllowSystemFallbackPtr
import godot.setAntialiasingPtr
import godot.setCacheAscentPtr
import godot.setCacheDescentPtr
import godot.setCacheScalePtr
import godot.setCacheUnderlinePositionPtr
import godot.setCacheUnderlineThicknessPtr
import godot.setDataPtr
import godot.setDisableEmbeddedBitmapsPtr
import godot.setEmboldenPtr
import godot.setExtraBaselineOffsetPtr
import godot.setExtraSpacingPtr
import godot.setFaceIndexPtr
import godot.setFixedSizePtr
import godot.setFixedSizeScaleModePtr
import godot.setFontNamePtr
import godot.setFontStretchPtr
import godot.setFontStyleNamePtr
import godot.setFontStylePtr
import godot.setFontWeightPtr
import godot.setForceAutohinterPtr
import godot.setGenerateMipmapsPtr
import godot.setGlyphAdvancePtr
import godot.setGlyphOffsetPtr
import godot.setGlyphSizePtr
import godot.setGlyphTextureIdxPtr
import godot.setGlyphUvRectPtr
import godot.setHintingPtr
import godot.setKerningPtr
import godot.setLanguageSupportOverridePtr
import godot.setMsdfPixelRangePtr
import godot.setMsdfSizePtr
import godot.setMultichannelSignedDistanceFieldPtr
import godot.setOpentypeFeatureOverridesPtr
import godot.setOversamplingPtr
import godot.setScriptSupportOverridePtr
import godot.setSubpixelPositioningPtr
import godot.setTextureImagePtr
import godot.setTextureOffsetsPtr
import godot.setTransformPtr
import godot.setVariationCoordinatesPtr
import kotlin.Any
