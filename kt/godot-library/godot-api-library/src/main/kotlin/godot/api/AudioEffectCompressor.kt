...
public open class AudioEffectCompressor : AudioEffect() {
  ...
  public final fun setGain(gain: Float) {
  ...
  public final fun setAttackUs(attackUs: Float) {
  ...
  public final fun setReleaseMs(releaseMs: Float) {
  ...
  public final fun setMix(mix: Float) {
  ...
  public final fun setSidechain(sidechain: StringName) {
  ...
  public object MethodBindings {
    internal val setThresholdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "set_threshold", 373_806_689)

    internal val getThresholdPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "get_threshold", 1_740_695_150)

    internal val setRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "set_ratio", 373_806_689)

    internal val getRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "get_ratio", 1_740_695_150)

    internal val setGainPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "set_gain", 373_806_689)

    internal val getGainPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "get_gain", 1_740_695_150)

    internal val setAttackUsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "set_attack_us", 373_806_689)

    internal val getAttackUsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "get_attack_us", 1_740_695_150)

    internal val setReleaseMsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "set_release_ms", 373_806_689)

    internal val getReleaseMsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "get_release_ms", 1_740_695_150)

    internal val setMixPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "set_mix", 373_806_689)

    internal val getMixPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "get_mix", 1_740_695_150)

    internal val setSidechainPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "set_sidechain", 3_304_788_590)

    internal val getSidechainPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AudioEffectCompressor", "get_sidechain", 2_002_593_661)
  }
}
