...
public open class VehicleWheel3D : Node3D() {
  ...
  public final fun setRadius(length: Float) {
  ...
  public final fun setSuspensionRestLength(length: Float) {
    TransferContext.writeArguments(DOUBLE to length.toDouble())
  ...
  public final fun setSuspensionTravel(length: Float) {
    TransferContext.writeArguments(DOUBLE to length.toDouble())
  ...
  public final fun setSuspensionStiffness(length: Float) {
    TransferContext.writeArguments(DOUBLE to length.toDouble())
  ...
  public final fun setSuspensionMaxForce(length: Float) {
    TransferContext.writeArguments(DOUBLE to length.toDouble())
  ...
  public final fun setDampingCompression(length: Float) {
    TransferContext.writeArguments(DOUBLE to length.toDouble())
  ...
  public final fun setDampingRelaxation(length: Float) {
    TransferContext.writeArguments(DOUBLE to length.toDouble())
  ...
  public final fun setUseAsTraction(enable: Boolean) {
  ...
  public final fun setUseAsSteering(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
  ...
  public final fun setFrictionSlip(length: Float) {
    TransferContext.writeArguments(DOUBLE to length.toDouble())
  ...
  public final fun setRollInfluence(rollInfluence: Float) {
  ...
  public final fun setEngineForce(engineForce: Float) {
  ...
  public final fun setBrake(brake: Float) {
  ...
  public final fun setSteering(steering: Float) {
  ...
  public object MethodBindings {
    internal val setRadiusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_radius", 373_806_689)

    internal val getRadiusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_radius", 1_740_695_150)

    internal val setSuspensionRestLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_suspension_rest_length", 373_806_689)

    internal val getSuspensionRestLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_suspension_rest_length", 1_740_695_150)

    internal val setSuspensionTravelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_suspension_travel", 373_806_689)

    internal val getSuspensionTravelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_suspension_travel", 1_740_695_150)

    internal val setSuspensionStiffnessPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_suspension_stiffness", 373_806_689)

    internal val getSuspensionStiffnessPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_suspension_stiffness", 1_740_695_150)

    internal val setSuspensionMaxForcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_suspension_max_force", 373_806_689)

    internal val getSuspensionMaxForcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_suspension_max_force", 1_740_695_150)

    internal val setDampingCompressionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_damping_compression", 373_806_689)

    internal val getDampingCompressionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_damping_compression", 1_740_695_150)

    internal val setDampingRelaxationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_damping_relaxation", 373_806_689)

    internal val getDampingRelaxationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_damping_relaxation", 1_740_695_150)

    internal val setUseAsTractionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_use_as_traction", 2_586_408_642)

    internal val isUsedAsTractionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "is_used_as_traction", 36_873_697)

    internal val setUseAsSteeringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_use_as_steering", 2_586_408_642)

    internal val isUsedAsSteeringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "is_used_as_steering", 36_873_697)

    internal val setFrictionSlipPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_friction_slip", 373_806_689)

    internal val getFrictionSlipPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_friction_slip", 1_740_695_150)

    internal val isInContactPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "is_in_contact", 36_873_697)

    internal val getContactBodyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_contact_body", 151_077_316)

    internal val getContactPointPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_contact_point", 3_360_562_783)

    internal val getContactNormalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_contact_normal", 3_360_562_783)

    internal val setRollInfluencePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_roll_influence", 373_806_689)

    internal val getRollInfluencePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_roll_influence", 1_740_695_150)

    internal val getSkidinfoPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_skidinfo", 1_740_695_150)

    internal val getRpmPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_rpm", 1_740_695_150)

    internal val setEngineForcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_engine_force", 373_806_689)

    internal val getEngineForcePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_engine_force", 1_740_695_150)

    internal val setBrakePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_brake", 373_806_689)

    internal val getBrakePtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_brake", 1_740_695_150)

    internal val setSteeringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "set_steering", 373_806_689)

    internal val getSteeringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("VehicleWheel3D", "get_steering", 1_740_695_150)
  }
}
