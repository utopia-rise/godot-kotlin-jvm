...
import godot.getBrakePtr
import godot.getContactBodyPtr
import godot.getDampingCompressionPtr
import godot.getDampingRelaxationPtr
import godot.getEngineForcePtr
import godot.getFrictionSlipPtr
import godot.getRadiusPtr
import godot.getRollInfluencePtr
import godot.getRpmPtr
import godot.getSkidinfoPtr
import godot.getSteeringPtr
import godot.getSuspensionMaxForcePtr
import godot.getSuspensionRestLengthPtr
import godot.getSuspensionStiffnessPtr
import godot.getSuspensionTravelPtr
import godot.isInContactPtr
import godot.isUsedAsSteeringPtr
import godot.isUsedAsTractionPtr
import godot.setBrakePtr
import godot.setDampingCompressionPtr
import godot.setDampingRelaxationPtr
import godot.setEngineForcePtr
import godot.setFrictionSlipPtr
import godot.setRadiusPtr
import godot.setRollInfluencePtr
import godot.setSteeringPtr
import godot.setSuspensionMaxForcePtr
import godot.setSuspensionRestLengthPtr
import godot.setSuspensionStiffnessPtr
import godot.setSuspensionTravelPtr
import godot.setUseAsSteeringPtr
import godot.setUseAsTractionPtr
