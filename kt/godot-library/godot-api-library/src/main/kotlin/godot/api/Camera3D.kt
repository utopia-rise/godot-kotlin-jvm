...
public open class Camera3D : Node3D() {
  ...
  public final fun setProjection(mode: ProjectionType) {
    TransferContext.writeArguments(LONG to mode.id)
    TransferContext.callMethod(ptr, MethodBindings.setProjectionPtr, NIL)
  }

  public final fun setHOffset(offset: Float) {
  ...
  public final fun setVOffset(offset: Float) {
    TransferContext.writeArguments(DOUBLE to offset.toDouble())
  ...
  public final fun setCullMask(mask: Long) {
  ...
  public final fun setAttributes(env: CameraAttributes?) {
    TransferContext.writeArguments(OBJECT to env)
  ...
  public final fun setKeepAspectMode(mode: KeepAspect) {
    TransferContext.writeArguments(LONG to mode.id)
   ...
   */
  public final fun setCullMaskValue(layerNumber: Int, `value`: Boolean) {
  ...
  public object MethodBindings {
    internal val projectRayNormalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "project_ray_normal", 1_718_073_306)

    internal val projectLocalRayNormalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "project_local_ray_normal", 1_718_073_306)

    internal val projectRayOriginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "project_ray_origin", 1_718_073_306)

    internal val unprojectPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "unproject_position", 3_758_901_831)

    internal val isPositionBehindPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "is_position_behind", 3_108_956_480)

    internal val projectPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "project_position", 2_171_975_744)

    internal val setPerspectivePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_perspective", 2_385_087_082)

    internal val setOrthogonalPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_orthogonal", 2_385_087_082)

    internal val setFrustumPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_frustum", 354_890_663)

    internal val makeCurrentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "make_current", 3_218_959_716)

    internal val clearCurrentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "clear_current", 3_216_645_846)

    internal val setCurrentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_current", 2_586_408_642)

    internal val isCurrentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "is_current", 36_873_697)

    internal val getCameraTransformPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_camera_transform", 3_229_777_777)

    internal val getCameraProjectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_camera_projection", 2_910_717_950)

    internal val getFovPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_fov", 1_740_695_150)

    internal val getFrustumOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_frustum_offset", 3_341_600_327)

    internal val getSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_size", 1_740_695_150)

    internal val getFarPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_far", 1_740_695_150)

    internal val getNearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_near", 1_740_695_150)

    internal val setFovPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_fov", 373_806_689)

    internal val setFrustumOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_frustum_offset", 743_155_724)

    internal val setSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_size", 373_806_689)

    internal val setFarPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_far", 373_806_689)

    internal val setNearPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_near", 373_806_689)

    internal val getProjectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_projection", 2_624_185_235)

    internal val setProjectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_projection", 4_218_540_108)

    internal val setHOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_h_offset", 373_806_689)

    internal val getHOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_h_offset", 1_740_695_150)

    internal val setVOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_v_offset", 373_806_689)

    internal val getVOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_v_offset", 1_740_695_150)

    internal val setCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_cull_mask", 1_286_410_249)

    internal val getCullMaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_cull_mask", 3_905_245_786)

    internal val setEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_environment", 4_143_518_816)

    internal val getEnvironmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_environment", 3_082_064_660)

    internal val setAttributesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_attributes", 2_817_810_567)

    internal val getAttributesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_attributes", 3_921_283_215)

    internal val setCompositorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_compositor", 1_586_754_307)

    internal val getCompositorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_compositor", 3_647_707_413)

    internal val setKeepAspectModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_keep_aspect_mode", 1_740_651_252)

    internal val getKeepAspectModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_keep_aspect_mode", 2_790_278_316)

    internal val setDopplerTrackingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_doppler_tracking", 3_109_431_270)

    internal val getDopplerTrackingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_doppler_tracking", 1_584_483_649)

    internal val getFrustumPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_frustum", 3_995_934_104)

    internal val isPositionInFrustumPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "is_position_in_frustum", 3_108_956_480)

    internal val getCameraRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_camera_rid", 2_944_877_500)

    internal val getPyramidShapeRidPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_pyramid_shape_rid", 529_393_457)

    internal val setCullMaskValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "set_cull_mask_value", 300_928_843)

    internal val getCullMaskValuePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Camera3D", "get_cull_mask_value", 1_116_898_809)
  }
}
