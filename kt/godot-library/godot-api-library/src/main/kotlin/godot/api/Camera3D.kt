...
import godot.getAttributesPtr
import godot.getCameraProjectionPtr
import godot.getCameraRidPtr
import godot.getCameraTransformPtr
import godot.getCompositorPtr
import godot.getCullMaskPtr
import godot.getCullMaskValuePtr
import godot.getDopplerTrackingPtr
import godot.getEnvironmentPtr
import godot.getFarPtr
import godot.getFovPtr
import godot.getFrustumOffsetPtr
import godot.getFrustumPtr
import godot.getHOffsetPtr
import godot.getKeepAspectModePtr
import godot.getNearPtr
import godot.getProjectionPtr
import godot.getPyramidShapeRidPtr
import godot.getSizePtr
import godot.getVOffsetPtr
import godot.isCurrentPtr
import godot.isPositionBehindPtr
import godot.isPositionInFrustumPtr
import godot.makeCurrentPtr
import godot.projectLocalRayNormalPtr
import godot.projectPositionPtr
import godot.projectRayNormalPtr
import godot.projectRayOriginPtr
import godot.setAttributesPtr
import godot.setCompositorPtr
import godot.setCullMaskPtr
import godot.setCullMaskValuePtr
import godot.setCurrentPtr
import godot.setDopplerTrackingPtr
import godot.setEnvironmentPtr
import godot.setFarPtr
import godot.setFovPtr
import godot.setFrustumOffsetPtr
import godot.setFrustumPtr
import godot.setHOffsetPtr
import godot.setKeepAspectModePtr
import godot.setNearPtr
import godot.setOrthogonalPtr
import godot.setPerspectivePtr
import godot.setProjectionPtr
import godot.setSizePtr
import godot.setVOffsetPtr
import godot.unprojectPositionPtr
...
private const val ENGINECLASS_CAMERA3D: Int = 162
...
public open class Camera3D : Node3D() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_CAMERA3D, scriptIndex)
  }
