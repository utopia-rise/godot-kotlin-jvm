...
import godot.applyFloorSnapPtr
...
import godot.getFloorAnglePtr
import godot.getFloorMaxAnglePtr
import godot.getFloorNormalPtr
import godot.getFloorSnapLengthPtr
import godot.getLastMotionPtr
import godot.getLastSlideCollisionPtr
import godot.getMaxSlidesPtr
import godot.getMotionModePtr
import godot.getPlatformAngularVelocityPtr
import godot.getPlatformFloorLayersPtr
import godot.getPlatformOnLeavePtr
import godot.getPlatformVelocityPtr
import godot.getPlatformWallLayersPtr
import godot.getPositionDeltaPtr
import godot.getRealVelocityPtr
import godot.getSafeMarginPtr
import godot.getSlideCollisionCountPtr
import godot.getSlideCollisionPtr
import godot.getUpDirectionPtr
import godot.getVelocityPtr
import godot.getWallMinSlideAnglePtr
import godot.getWallNormalPtr
import godot.isFloorBlockOnWallEnabledPtr
import godot.isFloorConstantSpeedEnabledPtr
import godot.isFloorStopOnSlopeEnabledPtr
import godot.isOnCeilingOnlyPtr
import godot.isOnCeilingPtr
import godot.isOnFloorOnlyPtr
import godot.isOnFloorPtr
import godot.isOnWallOnlyPtr
import godot.isOnWallPtr
import godot.isSlideOnCeilingEnabledPtr
import godot.moveAndSlidePtr
import godot.setFloorBlockOnWallEnabledPtr
import godot.setFloorConstantSpeedEnabledPtr
import godot.setFloorMaxAnglePtr
import godot.setFloorSnapLengthPtr
import godot.setFloorStopOnSlopeEnabledPtr
import godot.setMaxSlidesPtr
import godot.setMotionModePtr
import godot.setPlatformFloorLayersPtr
import godot.setPlatformOnLeavePtr
import godot.setPlatformWallLayersPtr
import godot.setSafeMarginPtr
import godot.setSlideOnCeilingEnabledPtr
import godot.setUpDirectionPtr
import godot.setVelocityPtr
import godot.setWallMinSlideAnglePtr
...
private const val ENGINECLASS_CHARACTERBODY3D: Int = 180
...
public open class CharacterBody3D : PhysicsBody3D() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_CHARACTERBODY3D, scriptIndex)
  }
