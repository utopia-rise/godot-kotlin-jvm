...
import godot.eofReachedPtr
import godot.fileExistsPtr
import godot.flushPtr
import godot.get16Ptr
import godot.get32Ptr
import godot.get64Ptr
import godot.get8Ptr
import godot.getAsTextPtr
import godot.getBufferPtr
import godot.getCsvLinePtr
import godot.getDoublePtr
import godot.getErrorPtr
import godot.getFileAsBytesPtr
import godot.getFileAsStringPtr
import godot.getFloatPtr
import godot.getHiddenAttributePtr
import godot.getLengthPtr
import godot.getLinePtr
import godot.getMd5Ptr
import godot.getModifiedTimePtr
import godot.getOpenErrorPtr
import godot.getPascalStringPtr
import godot.getPathAbsolutePtr
import godot.getPathPtr
import godot.getPositionPtr
import godot.getReadOnlyAttributePtr
import godot.getRealPtr
import godot.getSha256Ptr
import godot.getUnixPermissionsPtr
import godot.getVarPtr
import godot.isBigEndianPtr
import godot.isOpenPtr
import godot.openCompressedPtr
import godot.openEncryptedPtr
import godot.openEncryptedWithPassPtr
import godot.openPtr
import godot.resizePtr
import godot.seekEndPtr
import godot.seekPtr
import godot.setBigEndianPtr
import godot.setHiddenAttributePtr
import godot.setReadOnlyAttributePtr
import godot.setUnixPermissionsPtr
import godot.store16Ptr
import godot.store32Ptr
import godot.store64Ptr
import godot.store8Ptr
import godot.storeBufferPtr
import godot.storeCsvLinePtr
import godot.storeDoublePtr
import godot.storeFloatPtr
import godot.storeLinePtr
import godot.storePascalStringPtr
import godot.storeRealPtr
import godot.storeStringPtr
import godot.storeVarPtr
import kotlin.Any
