...
public object Geometry2D : Object() {
   ...
   */
  @JvmStatic
  public final fun decomposePolygonInConvex(polygon: PackedVector2Array): VariantArray<PackedVector2Array> {
    TransferContext.writeArguments(PACKED_VECTOR2_ARRAY to polygon)
   ...
   */
  @JvmStatic
  public final fun mergePolygons(polygonA: PackedVector2Array, polygonB: PackedVector2Array): VariantArray<PackedVector2Array> {
   ...
   */
  @JvmStatic
  public final fun clipPolygons(polygonA: PackedVector2Array, polygonB: PackedVector2Array): VariantArray<PackedVector2Array> {
    TransferContext.writeArguments(PACKED_VECTOR2_ARRAY to polygonA, PACKED_VECTOR2_ARRAY to polygonB)
   ...
   */
  @JvmStatic
  public final fun intersectPolygons(polygonA: PackedVector2Array, polygonB: PackedVector2Array): VariantArray<PackedVector2Array> {
    TransferContext.writeArguments(PACKED_VECTOR2_ARRAY to polygonA, PACKED_VECTOR2_ARRAY to polygonB)
   ...
   */
  @JvmStatic
  public final fun excludePolygons(polygonA: PackedVector2Array, polygonB: PackedVector2Array): VariantArray<PackedVector2Array> {
    TransferContext.writeArguments(PACKED_VECTOR2_ARRAY to polygonA, PACKED_VECTOR2_ARRAY to polygonB)
   ...
   */
  @JvmStatic
  public final fun clipPolylineWithPolygon(polyline: PackedVector2Array, polygon: PackedVector2Array): VariantArray<PackedVector2Array> {
   ...
   */
  @JvmStatic
  public final fun intersectPolylineWithPolygon(polyline: PackedVector2Array, polygon: PackedVector2Array): VariantArray<PackedVector2Array> {
    TransferContext.writeArguments(PACKED_VECTOR2_ARRAY to polyline, PACKED_VECTOR2_ARRAY to polygon)
  ...
  public object MethodBindings {
    internal val isPointInCirclePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "is_point_in_circle", 2_929_491_703)

    internal val segmentIntersectsCirclePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "segment_intersects_circle", 1_356_928_167)

    internal val segmentIntersectsSegmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "segment_intersects_segment", 2_058_025_344)

    internal val lineIntersectsLinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "line_intersects_line", 2_058_025_344)

    internal val getClosestPointsBetweenSegmentsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "get_closest_points_between_segments", 3_344_690_961)

    internal val getClosestPointToSegmentPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "get_closest_point_to_segment", 4_172_901_909)

    internal val getClosestPointToSegmentUncappedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "get_closest_point_to_segment_uncapped", 4_172_901_909)

    internal val pointIsInsideTrianglePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "point_is_inside_triangle", 1_025_948_137)

    internal val isPolygonClockwisePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "is_polygon_clockwise", 1_361_156_557)

    internal val isPointInPolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "is_point_in_polygon", 738_277_916)

    internal val triangulatePolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "triangulate_polygon", 1_389_921_771)

    internal val triangulateDelaunayPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "triangulate_delaunay", 1_389_921_771)

    internal val convexHullPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "convex_hull", 2_004_331_998)

    internal val decomposePolygonInConvexPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "decompose_polygon_in_convex", 3_982_393_695)

    internal val mergePolygonsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "merge_polygons", 3_637_387_053)

    internal val clipPolygonsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "clip_polygons", 3_637_387_053)

    internal val intersectPolygonsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "intersect_polygons", 3_637_387_053)

    internal val excludePolygonsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "exclude_polygons", 3_637_387_053)

    internal val clipPolylineWithPolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "clip_polyline_with_polygon", 3_637_387_053)

    internal val intersectPolylineWithPolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "intersect_polyline_with_polygon", 3_637_387_053)

    internal val offsetPolygonPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "offset_polygon", 1_275_354_010)

    internal val offsetPolylinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "offset_polyline", 2_328_231_778)

    internal val makeAtlasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "make_atlas", 1_337_682_371)

    internal val bresenhamLinePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Geometry2D", "bresenham_line", 1_989_391_000)
  }
}
