...
/**
 * Configuration header for micro QR code markers. Pass this to
 * [OpenXRSpatialEntityExtension.createSpatialContext] to create a spatial context that can detect
 * micro QR code markers.
 */
@GodotBaseType
public open class OpenXRSpatialCapabilityConfigurationQrCode :
  ...
  public companion object {
    ...
    public val getEnabledComponentsName:
        MethodStringName0<OpenXRSpatialCapabilityConfigurationQrCode, PackedInt64Array> =
        MethodStringName0<OpenXRSpatialCapabilityConfigurationQrCode, PackedInt64Array>("get_enabled_components")
  }

  public object MethodBindings {
    internal val getEnabledComponentsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("OpenXRSpatialCapabilityConfigurationQrCode", "get_enabled_components", 235988956)
  }
}
