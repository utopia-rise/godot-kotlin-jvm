...
public open class HTTPClient : RefCounted() {
   ...
   *
   * If no [port] is specified (or `-1` is used), it is automatically set to 80 for HTTP and 443 for HTTPS. You can pass the optional [tlsOptions] parameter to customize the trusted certification authorities, or the common name verification when using HTTPS. See [TLSOptions.client] and [TLSOptions.clientUnsafe].
   */
  @JvmOverloads
  ...
  public final fun setConnection(connection: StreamPeer?) {
    TransferContext.writeArguments(OBJECT to connection)
    TransferContext.callMethod(ptr, MethodBindings.setConnectionPtr, NIL)
  }
   ...
   * ```
   *
   * **Note:** The [body] parameter is ignored if [method] is [HTTPClient.METHOD_GET]. This is because GET methods can't contain request data. As a workaround, you can pass request data as a query string in the URL. See [String.uriEncode] for an example.
   */
  @JvmOverloads
  ...
  public final fun setReadChunkSize(bytes: Int) {
    TransferContext.writeArguments(LONG to bytes.toLong())
    TransferContext.callMethod(ptr, MethodBindings.setReadChunkSizePtr, NIL)
  }
  ...
  public final fun setBlockingMode(enabled: Boolean) {
    TransferContext.writeArguments(BOOL to enabled)
    TransferContext.callMethod(ptr, MethodBindings.setBlockingModePtr, NIL)
  }
  ...
  public final fun queryStringFromDict(fields: Dictionary<Any?, Any?>): String {
    ...
    TransferContext.callMethod(ptr, MethodBindings.queryStringFromDictPtr, STRING)
  ...
  public object MethodBindings {
    internal val connectToHostPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "connect_to_host", 504_540_374)

    internal val setConnectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "set_connection", 3_281_897_016)

    internal val getConnectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "get_connection", 2_741_655_269)

    internal val requestRawPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "request_raw", 540_161_961)

    internal val requestPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "request", 3_778_990_155)

    internal val closePtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "close", 3_218_959_716)

    internal val hasResponsePtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "has_response", 36_873_697)

    internal val isResponseChunkedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "is_response_chunked", 36_873_697)

    internal val getResponseCodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "get_response_code", 3_905_245_786)

    internal val getResponseHeadersPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "get_response_headers", 2_981_934_095)

    internal val getResponseHeadersAsDictionaryPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "get_response_headers_as_dictionary", 2_382_534_195)

    internal val getResponseBodyLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "get_response_body_length", 3_905_245_786)

    internal val readResponseBodyChunkPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "read_response_body_chunk", 2_115_431_945)

    internal val setReadChunkSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "set_read_chunk_size", 1_286_410_249)

    internal val getReadChunkSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "get_read_chunk_size", 3_905_245_786)

    internal val setBlockingModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "set_blocking_mode", 2_586_408_642)

    internal val isBlockingModeEnabledPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "is_blocking_mode_enabled", 36_873_697)

    internal val getStatusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "get_status", 1_426_656_811)

    internal val pollPtr: VoidPtr = TypeManager.getMethodBindPtr("HTTPClient", "poll", 166_280_745)

    internal val setHttpProxyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "set_http_proxy", 2_956_805_083)

    internal val setHttpsProxyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "set_https_proxy", 2_956_805_083)

    internal val queryStringFromDictPtr: VoidPtr =
        TypeManager.getMethodBindPtr("HTTPClient", "query_string_from_dict", 2_538_086_567)
  }
}
