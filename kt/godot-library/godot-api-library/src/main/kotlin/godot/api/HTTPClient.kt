...
import godot.getConnectionPtr
import godot.getReadChunkSizePtr
import godot.getResponseBodyLengthPtr
import godot.getResponseCodePtr
import godot.getResponseHeadersAsDictionaryPtr
import godot.getResponseHeadersPtr
import godot.getStatusPtr
import godot.hasResponsePtr
import godot.isBlockingModeEnabledPtr
import godot.isResponseChunkedPtr
import godot.pollPtr
import godot.queryStringFromDictPtr
import godot.readResponseBodyChunkPtr
import godot.requestPtr
import godot.requestRawPtr
import godot.setBlockingModePtr
import godot.setConnectionPtr
import godot.setHttpProxyPtr
import godot.setHttpsProxyPtr
import godot.setReadChunkSizePtr
import kotlin.Any
...
private const val ENGINECLASS_HTTPCLIENT: Int = 299
...
public open class HTTPClient : RefCounted() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_HTTPCLIENT, scriptIndex)
  }
  ...
  public object MethodBindings {
    ...
    internal val closePtr: VoidPtr = TypeManager.getMethodBindPtr("HTTPClient", "close", 3218959716)
    ...
    internal val pollPtr: VoidPtr = TypeManager.getMethodBindPtr("HTTPClient", "poll", 166280745)
