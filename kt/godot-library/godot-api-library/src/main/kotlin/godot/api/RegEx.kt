...
public open class RegEx : RefCounted() {
  ...
  /**
   * Compiles and assign the search pattern to use. Returns [OK] if the compilation is successful. If compilation fails, returns [FAILED] and when [showError] is `true`, details are printed to standard output.
   */
  @JvmOverloads
  ...
  public object MethodBindings {
    internal val createFromStringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegEx", "create_from_string", 4_249_111_514)

    internal val clearPtr: VoidPtr = TypeManager.getMethodBindPtr("RegEx", "clear", 3_218_959_716)

    internal val compilePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegEx", "compile", 3_565_188_097)

    internal val searchPtr: VoidPtr = TypeManager.getMethodBindPtr("RegEx", "search", 3_365_977_994)

    internal val searchAllPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegEx", "search_all", 849_021_363)

    internal val subPtr: VoidPtr = TypeManager.getMethodBindPtr("RegEx", "sub", 54_019_702)

    internal val isValidPtr: VoidPtr = TypeManager.getMethodBindPtr("RegEx", "is_valid", 36_873_697)

    internal val getPatternPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegEx", "get_pattern", 201_670_096)

    internal val getGroupCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegEx", "get_group_count", 3_905_245_786)

    internal val getNamesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RegEx", "get_names", 1_139_954_409)
  }
}
