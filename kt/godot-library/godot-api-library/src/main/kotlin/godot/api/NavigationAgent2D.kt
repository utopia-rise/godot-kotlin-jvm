...
import godot.distanceToTargetPtr
import godot.getAvoidanceEnabledPtr
import godot.getAvoidanceLayerValuePtr
import godot.getAvoidanceLayersPtr
import godot.getAvoidanceMaskPtr
import godot.getAvoidanceMaskValuePtr
import godot.getAvoidancePriorityPtr
import godot.getCurrentNavigationPathIndexPtr
import godot.getCurrentNavigationPathPtr
import godot.getCurrentNavigationResultPtr
import godot.getDebugEnabledPtr
import godot.getDebugPathCustomColorPtr
import godot.getDebugPathCustomLineWidthPtr
import godot.getDebugPathCustomPointSizePtr
import godot.getDebugUseCustomPtr
import godot.getFinalPositionPtr
import godot.getMaxNeighborsPtr
import godot.getMaxSpeedPtr
import godot.getNavigationLayerValuePtr
import godot.getNavigationLayersPtr
import godot.getNavigationMapPtr
import godot.getNeighborDistancePtr
import godot.getNextPathPositionPtr
import godot.getPathDesiredDistancePtr
import godot.getPathMaxDistancePtr
import godot.getPathMetadataFlagsPtr
import godot.getPathPostprocessingPtr
import godot.getPathfindingAlgorithmPtr
import godot.getRadiusPtr
import godot.getRidPtr
import godot.getSimplifyEpsilonPtr
import godot.getSimplifyPathPtr
import godot.getTargetDesiredDistancePtr
import godot.getTargetPositionPtr
import godot.getTimeHorizonAgentsPtr
import godot.getTimeHorizonObstaclesPtr
import godot.getVelocityPtr
import godot.isNavigationFinishedPtr
import godot.isTargetReachablePtr
import godot.isTargetReachedPtr
import godot.setAvoidanceEnabledPtr
import godot.setAvoidanceLayerValuePtr
import godot.setAvoidanceLayersPtr
import godot.setAvoidanceMaskPtr
import godot.setAvoidanceMaskValuePtr
import godot.setAvoidancePriorityPtr
import godot.setDebugEnabledPtr
import godot.setDebugPathCustomColorPtr
import godot.setDebugPathCustomLineWidthPtr
import godot.setDebugPathCustomPointSizePtr
import godot.setDebugUseCustomPtr
import godot.setMaxNeighborsPtr
import godot.setMaxSpeedPtr
import godot.setNavigationLayerValuePtr
import godot.setNavigationLayersPtr
import godot.setNavigationMapPtr
import godot.setNeighborDistancePtr
import godot.setPathDesiredDistancePtr
import godot.setPathMaxDistancePtr
import godot.setPathMetadataFlagsPtr
import godot.setPathPostprocessingPtr
import godot.setPathfindingAlgorithmPtr
import godot.setRadiusPtr
import godot.setSimplifyEpsilonPtr
import godot.setSimplifyPathPtr
import godot.setTargetDesiredDistancePtr
import godot.setTargetPositionPtr
import godot.setTimeHorizonAgentsPtr
import godot.setTimeHorizonObstaclesPtr
import godot.setVelocityForcedPtr
import godot.setVelocityPtr
import kotlin.Any
...
private const val ENGINECLASS_NAVIGATIONAGENT2D: Int = 388
...
public open class NavigationAgent2D : Node() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_NAVIGATIONAGENT2D, scriptIndex)
  }
