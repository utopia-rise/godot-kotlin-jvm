...
public object WorkerThreadPool : Object() {
   ...
   */
  @JvmStatic
  public final fun waitForGroupTaskCompletion(groupId: Long) {
    TransferContext.writeArguments(LONG to groupId)
  ...
  public object MethodBindings {
    internal val addTaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WorkerThreadPool", "add_task", 3_745_067_146)

    internal val isTaskCompletedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WorkerThreadPool", "is_task_completed", 1_116_898_809)

    internal val waitForTaskCompletionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WorkerThreadPool", "wait_for_task_completion", 844_576_869)

    internal val addGroupTaskPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WorkerThreadPool", "add_group_task", 1_801_953_219)

    internal val isGroupTaskCompletedPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WorkerThreadPool", "is_group_task_completed", 1_116_898_809)

    internal val getGroupProcessedElementCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WorkerThreadPool", "get_group_processed_element_count", 923_996_154)

    internal val waitForGroupTaskCompletionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("WorkerThreadPool", "wait_for_group_task_completion", 1_286_410_249)
  }
}
