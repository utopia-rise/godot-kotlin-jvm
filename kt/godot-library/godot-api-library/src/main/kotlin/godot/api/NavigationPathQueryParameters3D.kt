...
import godot.getMapPtr
import godot.getMetadataFlagsPtr
...
import godot.getStartPositionPtr
import godot.getTargetPositionPtr
import godot.setMapPtr
import godot.setMetadataFlagsPtr
...
import godot.setStartPositionPtr
...
private const val ENGINECLASS_NAVIGATIONPATHQUERYPARAMETERS3D: Int = 398

public infix fun Long.or(other: godot.api.NavigationPathQueryParameters3D.PathMetadataFlags): Long =
    this.or(other.flag)

public infix fun Long.xor(other: godot.api.NavigationPathQueryParameters3D.PathMetadataFlags): Long
    = this.xor(other.flag)

public infix fun Long.and(other: godot.api.NavigationPathQueryParameters3D.PathMetadataFlags): Long
    = this.and(other.flag)

public operator fun Long.plus(other: godot.api.NavigationPathQueryParameters3D.PathMetadataFlags):
    Long = this.plus(other.flag)

public operator fun Long.minus(other: godot.api.NavigationPathQueryParameters3D.PathMetadataFlags):
    Long = this.minus(other.flag)

public operator fun Long.times(other: godot.api.NavigationPathQueryParameters3D.PathMetadataFlags):
    Long = this.times(other.flag)

public operator fun Long.div(other: godot.api.NavigationPathQueryParameters3D.PathMetadataFlags):
    Long = this.div(other.flag)

public operator fun Long.rem(other: godot.api.NavigationPathQueryParameters3D.PathMetadataFlags):
