 ...
 *
 * Input events are propagated through the [SceneTree] from the root node to all child nodes by calling [Node.Input]. For UI elements specifically, it makes more sense to override the virtual method [_guiInput], which filters out unrelated input events, such as by checking z-order, [mouseFilter], focus, or if the event was inside of the control's bounding box.
 *
 ...
 *
 * Sets [mouseFilter] to [MOUSE_FILTER_IGNORE] to tell a [Control] node to ignore mouse or touch events. You'll need it if you place an icon on top of a button.
 *
...
public open class Control : CanvasItem() {
  ...
  /**
   * The default tooltip text. The tooltip appears when the user's mouse cursor stays idle over this control for a few moments, provided that the [mouseFilter] property is not [MOUSE_FILTER_IGNORE]. The time required for the tooltip to appear can be changed with the [ProjectSettings.gui/timers/tooltipDelaySec] setting.
   *
   * This string is the default return value of [getTooltip]. Override [_getTooltip] to generate tooltip text dynamically. Override [_makeCustomTooltip] to customize the tooltip interface and behavior.
   *
   ...
   *
   * **Note:** Tooltips customized using [_makeCustomTooltip] do not use this auto translate mode automatically.
   */
  ...
  /**
   * Controls whether the control will be able to receive mouse button input events through [_guiInput] and how these events should be handled. Also controls whether the control can receive the [signal mouse_entered], and [signal mouse_exited] signals. See the constants to learn what each does.
   */
  ...
  /**
   * When enabled, scroll wheel events processed by [_guiInput] will be passed to the parent control even if [mouseFilter] is set to [MOUSE_FILTER_STOP].
   *
   ...
   */
  @CoreTypeHelper
  public final fun customMinimumSizeMutate(block: Vector2.() -> Unit): Vector2 = customMinimumSize.apply {
     block(this)
   ...
   */
  public open fun _structuredTextParser(args: VariantArray<Any?>, text: String): VariantArray<Vector3i> {
   ...
   *
   * **Note:** If this method returns an empty [String] and [_makeCustomTooltip] is not overridden, no tooltip is displayed.
   */
  ...
  /**
   * Virtual method to be implemented by the user. Returns a [Control] node that should be used as a tooltip instead of the default one. [forText] is the return value of [getTooltip].
   *
   ...
   *
   * **Note:** If overridden, this method is called even if [getTooltip] returns an empty string. When this happens with the default tooltip, it is not displayed. To copy this behavior, return `null` in this method when [forText] is empty.
   *
   ...
   *
   * - the control is obstructed by another control on top, that doesn't have [mouseFilter] set to [MOUSE_FILTER_IGNORE];
   *
   ...
   */
  @JvmOverloads
  public final fun setAnchorsPreset(preset: LayoutPreset, keepOffsets: Boolean = false) {
   ...
   *
   * Use parameter [resizeMode] with constants from [Control.LayoutPresetMode] to better determine the resulting size of the [Control]. Constant size will be ignored if used with presets that change size, e.g. [PRESET_LEFT_WIDE].
   *
   ...
   */
  public final fun setOffset(side: Side, offset: Float) {
   ...
   */
  public final fun setBegin(position: Vector2) {
   ...
   */
  public final fun setEnd(position: Vector2) {
    TransferContext.writeArguments(VECTOR2 to position)
   ...
   */
  @JvmOverloads
  public final fun setPosition(position: Vector2, keepOffsets: Boolean = false) {
   ...
   */
  @JvmOverloads
  public final fun setSize(size: Vector2, keepOffsets: Boolean = false) {
  ...
  public final fun setCustomMinimumSize(size: Vector2) {
   ...
   */
  @JvmOverloads
  public final fun setGlobalPosition(position: Vector2, keepOffsets: Boolean = false) {
    TransferContext.writeArguments(VECTOR2 to position, BOOL to keepOffsets)
  ...
  public final fun setPivotOffset(pivotOffset: Vector2) {
  ...
  public final fun setFocusMode(mode: FocusMode) {
  ...
  public final fun setHSizeFlags(flags: SizeFlags) {
  ...
  public final fun setStretchRatio(ratio: Float) {
  ...
  public final fun setVSizeFlags(flags: SizeFlags) {
    TransferContext.writeArguments(LONG to flags.flag)
  ...
  public final fun setHGrowDirection(direction: GrowDirection) {
  ...
  public final fun setVGrowDirection(direction: GrowDirection) {
    TransferContext.writeArguments(LONG to direction.id)
  ...
  public final fun setTooltipAutoTranslateMode(mode: Node.AutoTranslateMode) {
    TransferContext.writeArguments(LONG to mode.id)
  ...
  public final fun setTooltipText(hint: String) {
  ...
  public final fun setDefaultCursorShape(shape: CursorShape) {
   ...
   */
  public final fun setFocusNeighbor(side: Side, neighbor: NodePath) {
  ...
  public final fun setFocusNext(next: NodePath) {
  ...
  public final fun setFocusPrevious(previous: NodePath) {
   ...
   */
  public final fun forceDrag(`data`: Any?, preview: Control?) {
  ...
  public final fun setMouseFilter(filter: MouseFilter) {
  ...
  public final fun setForcePassScrollEvents(forcePassScrollEvents: Boolean) {
  ...
  public final fun setClipContents(enable: Boolean) {
   ...
   * ```
   */
  public final fun grabClickFocus() {
    TransferContext.writeArguments()
   ...
   * ```
   */
  public final fun setDragPreview(control: Control?) {
  ...
  public final fun setShortcutContext(node: Node?) {
   ...
   */
  public final fun updateMinimumSize() {
    TransferContext.writeArguments()
  ...
  public final fun setLocalizeNumeralSystem(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
   ...
   * Sets the focus neighbor for the specified [Side] to the [Control] at [neighbor] node path. A setter method for [focusNeighborBottom], [focusNeighborLeft], [focusNeighborRight] and [focusNeighborTop].
   */
  public final fun setFocusNeighbor(side: Side, neighbor: String): Unit = setFocusNeighbor(side, neighbor.asCachedNodePath())

  public final fun setFocusNext(next: String): Unit = setFocusNext(next.asCachedNodePath())

  public final fun setFocusPrevious(previous: String): Unit = setFocusPrevious(previous.asCachedNodePath())
  ...
  public class SizeFlags(
    ...
    public companion object {
      /**
       * Tells the parent [Container] to align the node with its start, either the top or the left edge. It is mutually exclusive with [SIZE_FILL] and other shrink size flags, but can be used with [SIZE_EXPAND] in some containers. Use with [sizeFlagsHorizontal] and [sizeFlagsVertical].
       *
      ...
      /**
       * Tells the parent [Container] to center the node in the available space. It is mutually exclusive with [SIZE_FILL] and other shrink size flags, but can be used with [SIZE_EXPAND] in some containers. Use with [sizeFlagsHorizontal] and [sizeFlagsVertical].
       */
      @JvmField
      public val SHRINK_CENTER: SizeFlags = SizeFlags(4)

      /**
       * Tells the parent [Container] to align the node with its end, either the bottom or the right edge. It is mutually exclusive with [SIZE_FILL] and other shrink size flags, but can be used with [SIZE_EXPAND] in some containers. Use with [sizeFlagsHorizontal] and [sizeFlagsVertical].
       */
      @JvmField
  ...
  public enum class MouseFilter(
    ...
    /**
     * The control will receive mouse movement input events and mouse button input events if clicked on through [_guiInput]. The control will also receive the [signal mouse_entered] and [signal mouse_exited] signals. These events are automatically marked as handled, and they will not propagate further to other controls. This also results in blocking signals in other controls.
     */
    STOP(0),
    /**
     * The control will receive mouse movement input events and mouse button input events if clicked on through [_guiInput]. The control will also receive the [signal mouse_entered] and [signal mouse_exited] signals.
     *
     * If this control does not handle the event, the event will propagate up to its parent control if it has one. The event is bubbled up the node hierarchy until it reaches a non-[CanvasItem], a control with [MOUSE_FILTER_STOP], or a [CanvasItem] with [CanvasItem.topLevel] enabled. This will allow signals to fire in all controls it reaches. If no control handled it, the event will be passed to [Node.ShortcutInput] for further processing.
     */
    PASS(1),
    /**
     * The control will not receive any mouse movement input events nor mouse button input events through [_guiInput]. The control will also not receive the [signal mouse_entered] nor [signal mouse_exited] signals. This will not block other controls from receiving these events or firing the signals. Ignored events will not be handled automatically. If a child has [MOUSE_FILTER_PASS] and an event was passed to this control, the event will further propagate up to the control's parent.
     *
     * **Note:** If the control has received [signal mouse_entered] but not [signal mouse_exited], changing the [mouseFilter] to [MOUSE_FILTER_IGNORE] will cause [signal mouse_exited] to be emitted.
     */
    IGNORE(2),
    ;
  ...
  public companion object {
    ...
    /**
     * Sent when the control layout direction is changed from LTR or RTL or vice versa. This notification is propagated to child Control nodes as result of a change to [layoutDirection].
     */
  ...
  public object MethodBindings {
    internal val acceptEventPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "accept_event", 3_218_959_716)

    internal val getMinimumSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_minimum_size", 3_341_600_327)

    internal val getCombinedMinimumSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_combined_minimum_size", 3_341_600_327)

    internal val setAnchorsPresetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_anchors_preset", 509_135_270)

    internal val setOffsetsPresetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_offsets_preset", 3_724_524_307)

    internal val setAnchorsAndOffsetsPresetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_anchors_and_offsets_preset", 3_724_524_307)

    internal val setAnchorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_anchor", 2_302_782_885)

    internal val getAnchorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_anchor", 2_869_120_046)

    internal val setOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_offset", 4_290_182_280)

    internal val getOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_offset", 2_869_120_046)

    internal val setAnchorAndOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_anchor_and_offset", 4_031_722_181)

    internal val setBeginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_begin", 743_155_724)

    internal val setEndPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_end", 743_155_724)

    internal val setPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_position", 2_436_320_129)

    internal val setSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_size", 2_436_320_129)

    internal val resetSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "reset_size", 3_218_959_716)

    internal val setCustomMinimumSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_custom_minimum_size", 743_155_724)

    internal val setGlobalPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_global_position", 2_436_320_129)

    internal val setRotationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_rotation", 373_806_689)

    internal val setRotationDegreesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_rotation_degrees", 373_806_689)

    internal val setScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_scale", 743_155_724)

    internal val setPivotOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_pivot_offset", 743_155_724)

    internal val getBeginPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_begin", 3_341_600_327)

    internal val getEndPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_end", 3_341_600_327)

    internal val getPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_position", 3_341_600_327)

    internal val getSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_size", 3_341_600_327)

    internal val getRotationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_rotation", 1_740_695_150)

    internal val getRotationDegreesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_rotation_degrees", 1_740_695_150)

    internal val getScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_scale", 3_341_600_327)

    internal val getPivotOffsetPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_pivot_offset", 3_341_600_327)

    internal val getCustomMinimumSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_custom_minimum_size", 3_341_600_327)

    internal val getParentAreaSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_parent_area_size", 3_341_600_327)

    internal val getGlobalPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_global_position", 3_341_600_327)

    internal val getScreenPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_screen_position", 3_341_600_327)

    internal val getRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_rect", 1_639_390_495)

    internal val getGlobalRectPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_global_rect", 1_639_390_495)

    internal val setFocusModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_focus_mode", 3_232_914_922)

    internal val getFocusModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_focus_mode", 2_132_829_277)

    internal val hasFocusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_focus", 36_873_697)

    internal val grabFocusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "grab_focus", 3_218_959_716)

    internal val releaseFocusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "release_focus", 3_218_959_716)

    internal val findPrevValidFocusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "find_prev_valid_focus", 2_783_021_301)

    internal val findNextValidFocusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "find_next_valid_focus", 2_783_021_301)

    internal val findValidFocusNeighborPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "find_valid_focus_neighbor", 1_543_910_170)

    internal val setHSizeFlagsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_h_size_flags", 394_851_643)

    internal val getHSizeFlagsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_h_size_flags", 3_781_367_401)

    internal val setStretchRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_stretch_ratio", 373_806_689)

    internal val getStretchRatioPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_stretch_ratio", 1_740_695_150)

    internal val setVSizeFlagsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_v_size_flags", 394_851_643)

    internal val getVSizeFlagsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_v_size_flags", 3_781_367_401)

    internal val setThemePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_theme", 2_326_690_814)

    internal val getThemePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme", 3_846_893_731)

    internal val setThemeTypeVariationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_theme_type_variation", 3_304_788_590)

    internal val getThemeTypeVariationPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_type_variation", 2_002_593_661)

    internal val beginBulkThemeOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "begin_bulk_theme_override", 3_218_959_716)

    internal val endBulkThemeOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "end_bulk_theme_override", 3_218_959_716)

    internal val addThemeIconOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "add_theme_icon_override", 1_373_065_600)

    internal val addThemeStyleboxOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "add_theme_stylebox_override", 4_188_838_905)

    internal val addThemeFontOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "add_theme_font_override", 3_518_018_674)

    internal val addThemeFontSizeOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "add_theme_font_size_override", 2_415_702_435)

    internal val addThemeColorOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "add_theme_color_override", 4_260_178_595)

    internal val addThemeConstantOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "add_theme_constant_override", 2_415_702_435)

    internal val removeThemeIconOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "remove_theme_icon_override", 3_304_788_590)

    internal val removeThemeStyleboxOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "remove_theme_stylebox_override", 3_304_788_590)

    internal val removeThemeFontOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "remove_theme_font_override", 3_304_788_590)

    internal val removeThemeFontSizeOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "remove_theme_font_size_override", 3_304_788_590)

    internal val removeThemeColorOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "remove_theme_color_override", 3_304_788_590)

    internal val removeThemeConstantOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "remove_theme_constant_override", 3_304_788_590)

    internal val getThemeIconPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_icon", 3_163_973_443)

    internal val getThemeStyleboxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_stylebox", 604_739_069)

    internal val getThemeFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_font", 2_826_986_490)

    internal val getThemeFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_font_size", 1_327_056_374)

    internal val getThemeColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_color", 2_798_751_242)

    internal val getThemeConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_constant", 1_327_056_374)

    internal val hasThemeIconOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_icon_override", 2_619_796_661)

    internal val hasThemeStyleboxOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_stylebox_override", 2_619_796_661)

    internal val hasThemeFontOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_font_override", 2_619_796_661)

    internal val hasThemeFontSizeOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_font_size_override", 2_619_796_661)

    internal val hasThemeColorOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_color_override", 2_619_796_661)

    internal val hasThemeConstantOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_constant_override", 2_619_796_661)

    internal val hasThemeIconPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_icon", 866_386_512)

    internal val hasThemeStyleboxPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_stylebox", 866_386_512)

    internal val hasThemeFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_font", 866_386_512)

    internal val hasThemeFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_font_size", 866_386_512)

    internal val hasThemeColorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_color", 866_386_512)

    internal val hasThemeConstantPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "has_theme_constant", 866_386_512)

    internal val getThemeDefaultBaseScalePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_default_base_scale", 1_740_695_150)

    internal val getThemeDefaultFontPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_default_font", 3_229_501_585)

    internal val getThemeDefaultFontSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_theme_default_font_size", 3_905_245_786)

    internal val getParentControlPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_parent_control", 2_783_021_301)

    internal val setHGrowDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_h_grow_direction", 2_022_385_301)

    internal val getHGrowDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_h_grow_direction", 3_635_610_155)

    internal val setVGrowDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_v_grow_direction", 2_022_385_301)

    internal val getVGrowDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_v_grow_direction", 3_635_610_155)

    internal val setTooltipAutoTranslateModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_tooltip_auto_translate_mode", 776_149_714)

    internal val getTooltipAutoTranslateModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_tooltip_auto_translate_mode", 2_498_906_432)

    internal val setTooltipTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_tooltip_text", 83_702_148)

    internal val getTooltipTextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_tooltip_text", 201_670_096)

    internal val getTooltipPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_tooltip", 2_895_288_280)

    internal val setDefaultCursorShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_default_cursor_shape", 217_062_046)

    internal val getDefaultCursorShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_default_cursor_shape", 2_359_535_750)

    internal val getCursorShapePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_cursor_shape", 1_395_773_853)

    internal val setFocusNeighborPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_focus_neighbor", 2_024_461_774)

    internal val getFocusNeighborPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_focus_neighbor", 2_757_935_761)

    internal val setFocusNextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_focus_next", 1_348_162_250)

    internal val getFocusNextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_focus_next", 4_075_236_667)

    internal val setFocusPreviousPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_focus_previous", 1_348_162_250)

    internal val getFocusPreviousPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_focus_previous", 4_075_236_667)

    internal val forceDragPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "force_drag", 3_191_844_692)

    internal val setMouseFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_mouse_filter", 3_891_156_122)

    internal val getMouseFilterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_mouse_filter", 1_572_545_674)

    internal val setForcePassScrollEventsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_force_pass_scroll_events", 2_586_408_642)

    internal val isForcePassScrollEventsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "is_force_pass_scroll_events", 36_873_697)

    internal val setClipContentsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_clip_contents", 2_586_408_642)

    internal val isClippingContentsPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "is_clipping_contents", 2_240_911_060)

    internal val grabClickFocusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "grab_click_focus", 3_218_959_716)

    internal val setDragForwardingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_drag_forwarding", 1_076_571_380)

    internal val setDragPreviewPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_drag_preview", 1_496_901_182)

    internal val isDragSuccessfulPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "is_drag_successful", 36_873_697)

    internal val warpMousePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "warp_mouse", 743_155_724)

    internal val setShortcutContextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_shortcut_context", 1_078_189_570)

    internal val getShortcutContextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_shortcut_context", 3_160_264_692)

    internal val updateMinimumSizePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "update_minimum_size", 3_218_959_716)

    internal val setLayoutDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_layout_direction", 3_310_692_370)

    internal val getLayoutDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "get_layout_direction", 1_546_772_008)

    internal val isLayoutRtlPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "is_layout_rtl", 36_873_697)

    internal val setAutoTranslatePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_auto_translate", 2_586_408_642)

    internal val isAutoTranslatingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "is_auto_translating", 36_873_697)

    internal val setLocalizeNumeralSystemPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "set_localize_numeral_system", 2_586_408_642)

    internal val isLocalizingNumeralSystemPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Control", "is_localizing_numeral_system", 36_873_697)
  }
}
