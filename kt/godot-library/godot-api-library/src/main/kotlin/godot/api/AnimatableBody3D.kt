...
import godot.isSyncToPhysicsEnabledPtr
import godot.setSyncToPhysicsPtr
...
private const val ENGINECLASS_ANIMATABLEBODY3D: Int = 44
...
public open class AnimatableBody3D : StaticBody3D() {
  ...
  public override fun new(scriptIndex: Int): Unit {
    createNativeObject(ENGINECLASS_ANIMATABLEBODY3D, scriptIndex)
  }
