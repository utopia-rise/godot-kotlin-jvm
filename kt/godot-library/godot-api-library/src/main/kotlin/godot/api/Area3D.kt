...
import godot.getAngularDampPtr
import godot.getAngularDampSpaceOverrideModePtr
import godot.getAudioBusNamePtr
import godot.getGravityDirectionPtr
import godot.getGravityPointCenterPtr
import godot.getGravityPointUnitDistancePtr
import godot.getGravityPtr
import godot.getGravitySpaceOverrideModePtr
import godot.getLinearDampPtr
import godot.getLinearDampSpaceOverrideModePtr
import godot.getOverlappingAreasPtr
import godot.getOverlappingBodiesPtr
import godot.getPriorityPtr
import godot.getReverbAmountPtr
import godot.getReverbBusNamePtr
import godot.getReverbUniformityPtr
import godot.getWindAttenuationFactorPtr
import godot.getWindForceMagnitudePtr
import godot.getWindSourcePathPtr
import godot.hasOverlappingAreasPtr
import godot.hasOverlappingBodiesPtr
import godot.isGravityAPointPtr
import godot.isMonitorablePtr
import godot.isMonitoringPtr
import godot.isOverridingAudioBusPtr
import godot.isUsingReverbBusPtr
import godot.overlapsAreaPtr
import godot.overlapsBodyPtr
import godot.setAngularDampPtr
import godot.setAngularDampSpaceOverrideModePtr
import godot.setAudioBusNamePtr
import godot.setAudioBusOverridePtr
import godot.setGravityDirectionPtr
import godot.setGravityIsPointPtr
import godot.setGravityPointCenterPtr
import godot.setGravityPointUnitDistancePtr
import godot.setGravityPtr
import godot.setGravitySpaceOverrideModePtr
import godot.setLinearDampPtr
import godot.setLinearDampSpaceOverrideModePtr
import godot.setMonitorablePtr
import godot.setMonitoringPtr
import godot.setPriorityPtr
import godot.setReverbAmountPtr
import godot.setReverbBusNamePtr
import godot.setReverbUniformityPtr
import godot.setUseReverbBusPtr
import godot.setWindAttenuationFactorPtr
import godot.setWindForceMagnitudePtr
import godot.setWindSourcePathPtr
