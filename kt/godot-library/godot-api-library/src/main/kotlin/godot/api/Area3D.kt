...
public open class Area3D : CollisionObject3D() {
   ...
   */
  @CoreTypeHelper
  public final fun gravityPointCenterMutate(block: Vector3.() -> Unit): Vector3 = gravityPointCenter.apply {
     block(this)
   ...
   */
  @CoreTypeHelper
  public final fun gravityDirectionMutate(block: Vector3.() -> Unit): Vector3 = gravityDirection.apply {
     block(this)
  ...
  public final fun setGravityPointCenter(center: Vector3) {
  ...
  public final fun setGravityDirection(direction: Vector3) {
  ...
  public final fun setWindForceMagnitude(windForceMagnitude: Float) {
  ...
  public final fun setWindAttenuationFactor(windAttenuationFactor: Float) {
  ...
  public final fun setWindSourcePath(windSourcePath: NodePath) {
  ...
  public final fun setUseReverbBus(enable: Boolean) {
    TransferContext.writeArguments(BOOL to enable)
  ...
  public final fun setReverbBusName(name: StringName) {
    TransferContext.writeArguments(STRING_NAME to name)
  ...
  public final fun setReverbAmount(amount: Float) {
  ...
  public final fun setReverbUniformity(amount: Float) {
    TransferContext.writeArguments(DOUBLE to amount.toDouble())
  ...
  public final fun setWindSourcePath(windSourcePath: String): Unit = setWindSourcePath(windSourcePath.asCachedNodePath())

  public final fun setAudioBusName(name: String): Unit = setAudioBusName(name.asCachedStringName())

  public final fun setReverbBusName(name: String): Unit = setReverbBusName(name.asCachedStringName())
  ...
  public object MethodBindings {
    internal val setGravitySpaceOverrideModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_gravity_space_override_mode", 2_311_433_571)

    internal val getGravitySpaceOverrideModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_gravity_space_override_mode", 958_191_869)

    internal val setGravityIsPointPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_gravity_is_point", 2_586_408_642)

    internal val isGravityAPointPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "is_gravity_a_point", 36_873_697)

    internal val setGravityPointUnitDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_gravity_point_unit_distance", 373_806_689)

    internal val getGravityPointUnitDistancePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_gravity_point_unit_distance", 1_740_695_150)

    internal val setGravityPointCenterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_gravity_point_center", 3_460_891_852)

    internal val getGravityPointCenterPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_gravity_point_center", 3_360_562_783)

    internal val setGravityDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_gravity_direction", 3_460_891_852)

    internal val getGravityDirectionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_gravity_direction", 3_360_562_783)

    internal val setGravityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_gravity", 373_806_689)

    internal val getGravityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_gravity", 1_740_695_150)

    internal val setLinearDampSpaceOverrideModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_linear_damp_space_override_mode", 2_311_433_571)

    internal val getLinearDampSpaceOverrideModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_linear_damp_space_override_mode", 958_191_869)

    internal val setAngularDampSpaceOverrideModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_angular_damp_space_override_mode", 2_311_433_571)

    internal val getAngularDampSpaceOverrideModePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_angular_damp_space_override_mode", 958_191_869)

    internal val setAngularDampPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_angular_damp", 373_806_689)

    internal val getAngularDampPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_angular_damp", 1_740_695_150)

    internal val setLinearDampPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_linear_damp", 373_806_689)

    internal val getLinearDampPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_linear_damp", 1_740_695_150)

    internal val setPriorityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_priority", 1_286_410_249)

    internal val getPriorityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_priority", 3_905_245_786)

    internal val setWindForceMagnitudePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_wind_force_magnitude", 373_806_689)

    internal val getWindForceMagnitudePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_wind_force_magnitude", 1_740_695_150)

    internal val setWindAttenuationFactorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_wind_attenuation_factor", 373_806_689)

    internal val getWindAttenuationFactorPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_wind_attenuation_factor", 1_740_695_150)

    internal val setWindSourcePathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_wind_source_path", 1_348_162_250)

    internal val getWindSourcePathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_wind_source_path", 4_075_236_667)

    internal val setMonitorablePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_monitorable", 2_586_408_642)

    internal val isMonitorablePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "is_monitorable", 36_873_697)

    internal val setMonitoringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_monitoring", 2_586_408_642)

    internal val isMonitoringPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "is_monitoring", 36_873_697)

    internal val getOverlappingBodiesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_overlapping_bodies", 3_995_934_104)

    internal val getOverlappingAreasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_overlapping_areas", 3_995_934_104)

    internal val hasOverlappingBodiesPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "has_overlapping_bodies", 36_873_697)

    internal val hasOverlappingAreasPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "has_overlapping_areas", 36_873_697)

    internal val overlapsBodyPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "overlaps_body", 3_093_956_946)

    internal val overlapsAreaPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "overlaps_area", 3_093_956_946)

    internal val setAudioBusOverridePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_audio_bus_override", 2_586_408_642)

    internal val isOverridingAudioBusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "is_overriding_audio_bus", 36_873_697)

    internal val setAudioBusNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_audio_bus_name", 3_304_788_590)

    internal val getAudioBusNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_audio_bus_name", 2_002_593_661)

    internal val setUseReverbBusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_use_reverb_bus", 2_586_408_642)

    internal val isUsingReverbBusPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "is_using_reverb_bus", 36_873_697)

    internal val setReverbBusNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_reverb_bus_name", 3_304_788_590)

    internal val getReverbBusNamePtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_reverb_bus_name", 2_002_593_661)

    internal val setReverbAmountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_reverb_amount", 373_806_689)

    internal val getReverbAmountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_reverb_amount", 1_740_695_150)

    internal val setReverbUniformityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "set_reverb_uniformity", 373_806_689)

    internal val getReverbUniformityPtr: VoidPtr =
        TypeManager.getMethodBindPtr("Area3D", "get_reverb_uniformity", 1_740_695_150)
  }
}
