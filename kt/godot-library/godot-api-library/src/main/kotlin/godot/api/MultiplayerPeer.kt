...
import godot.generateUniqueIdPtr
import godot.getConnectionStatusPtr
import godot.getPacketChannelPtr
import godot.getPacketModePtr
import godot.getPacketPeerPtr
import godot.getTransferChannelPtr
import godot.getTransferModePtr
import godot.getUniqueIdPtr
import godot.isRefusingNewConnectionsPtr
import godot.isServerRelaySupportedPtr
import godot.pollPtr
import godot.setRefuseNewConnectionsPtr
import godot.setTargetPeerPtr
import godot.setTransferChannelPtr
import godot.setTransferModePtr
...
public open class MultiplayerPeer internal constructor() : PacketPeer() {
  ...
  public final fun getPacketPeer(): Int {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.getPacketPeerPtr, LONG)
    return (TransferContext.readReturnValue(LONG) as Long).toInt()
  }
  ...
  public final fun getPacketChannel(): Int {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.getPacketChannelPtr, LONG)
    return (TransferContext.readReturnValue(LONG) as Long).toInt()
  }
  ...
  public final fun generateUniqueId(): Long {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.generateUniqueIdPtr, LONG)
  ...
  public final fun isServerRelaySupported(): Boolean {
    TransferContext.writeArguments()
    TransferContext.callMethod(ptr, MethodBindings.isServerRelaySupportedPtr, BOOL)
    return (TransferContext.readReturnValue(BOOL) as Boolean)
  }
