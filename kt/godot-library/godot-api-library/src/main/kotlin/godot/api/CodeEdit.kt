...
import godot.addAutoBraceCompletionPairPtr
import godot.addCodeCompletionOptionPtr
import godot.addCommentDelimiterPtr
import godot.addStringDelimiterPtr
import godot.canFoldLinePtr
import godot.cancelCodeCompletionPtr
import godot.clearBookmarkedLinesPtr
import godot.clearBreakpointedLinesPtr
import godot.clearCommentDelimitersPtr
import godot.clearExecutingLinesPtr
import godot.clearStringDelimitersPtr
import godot.common.interop.VoidPtr
import godot.confirmCodeCompletionPtr
import godot.convertIndentPtr
...
import godot.createCodeRegionPtr
import godot.deleteLinesPtr
import godot.doIndentPtr
import godot.duplicateLinesPtr
import godot.duplicateSelectionPtr
import godot.foldAllLinesPtr
import godot.foldLinePtr
import godot.getAutoBraceCompletionCloseKeyPtr
import godot.getAutoBraceCompletionPairsPtr
import godot.getAutoIndentPrefixesPtr
import godot.getBookmarkedLinesPtr
import godot.getBreakpointedLinesPtr
import godot.getCodeCompletionOptionPtr
import godot.getCodeCompletionOptionsPtr
import godot.getCodeCompletionPrefixesPtr
import godot.getCodeCompletionSelectedIndexPtr
import godot.getCodeRegionEndTagPtr
import godot.getCodeRegionStartTagPtr
import godot.getCommentDelimitersPtr
import godot.getDelimiterEndKeyPtr
import godot.getDelimiterEndPositionPtr
import godot.getDelimiterStartKeyPtr
import godot.getDelimiterStartPositionPtr
import godot.getExecutingLinesPtr
import godot.getFoldedLinesPtr
import godot.getIndentSizePtr
import godot.getLineLengthGuidelinesPtr
import godot.getStringDelimitersPtr
import godot.getTextForCodeCompletionPtr
import godot.getTextForSymbolLookupPtr
import godot.getTextWithCursorCharPtr
import godot.hasAutoBraceCompletionCloseKeyPtr
import godot.hasAutoBraceCompletionOpenKeyPtr
import godot.hasCommentDelimiterPtr
import godot.hasStringDelimiterPtr
import godot.indentLinesPtr
import godot.isAutoBraceCompletionEnabledPtr
import godot.isAutoIndentEnabledPtr
import godot.isCodeCompletionEnabledPtr
import godot.isDrawLineNumbersEnabledPtr
import godot.isDrawingBookmarksGutterPtr
import godot.isDrawingBreakpointsGutterPtr
import godot.isDrawingExecutingLinesGutterPtr
import godot.isDrawingFoldGutterPtr
import godot.isHighlightMatchingBracesEnabledPtr
import godot.isInCommentPtr
import godot.isInStringPtr
import godot.isIndentUsingSpacesPtr
import godot.isLineBookmarkedPtr
import godot.isLineBreakpointedPtr
import godot.isLineCodeRegionEndPtr
import godot.isLineCodeRegionStartPtr
import godot.isLineExecutingPtr
import godot.isLineFoldedPtr
import godot.isLineFoldingEnabledPtr
import godot.isLineNumbersZeroPaddedPtr
import godot.isSymbolLookupOnClickEnabledPtr
import godot.moveLinesDownPtr
import godot.moveLinesUpPtr
import godot.removeCommentDelimiterPtr
import godot.removeStringDelimiterPtr
import godot.requestCodeCompletionPtr
import godot.setAutoBraceCompletionEnabledPtr
import godot.setAutoBraceCompletionPairsPtr
import godot.setAutoIndentEnabledPtr
import godot.setAutoIndentPrefixesPtr
import godot.setCodeCompletionEnabledPtr
import godot.setCodeCompletionPrefixesPtr
import godot.setCodeCompletionSelectedIndexPtr
import godot.setCodeHintDrawBelowPtr
import godot.setCodeHintPtr
import godot.setCodeRegionTagsPtr
import godot.setCommentDelimitersPtr
import godot.setDrawBookmarksGutterPtr
import godot.setDrawBreakpointsGutterPtr
import godot.setDrawExecutingLinesGutterPtr
import godot.setDrawFoldGutterPtr
import godot.setDrawLineNumbersPtr
import godot.setHighlightMatchingBracesEnabledPtr
import godot.setIndentSizePtr
import godot.setIndentUsingSpacesPtr
import godot.setLineAsBookmarkedPtr
import godot.setLineAsBreakpointPtr
import godot.setLineAsExecutingPtr
import godot.setLineFoldingEnabledPtr
import godot.setLineLengthGuidelinesPtr
import godot.setLineNumbersZeroPaddedPtr
import godot.setStringDelimitersPtr
import godot.setSymbolLookupOnClickEnabledPtr
import godot.setSymbolLookupWordAsValidPtr
import godot.toggleFoldableLinePtr
import godot.toggleFoldableLinesAtCaretsPtr
import godot.unfoldAllLinesPtr
import godot.unfoldLinePtr
import godot.unindentLinesPtr
import godot.updateCodeCompletionOptionsPtr
import kotlin.Any
