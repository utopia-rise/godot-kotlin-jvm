...
public open class AnimationNodeStateMachinePlayback : Resource() {
   ...
   */
  @JvmOverloads
  public final fun travel(toNode: StringName, resetOnTeleport: Boolean = true) {
   ...
   */
  @JvmOverloads
  public final fun start(node: StringName, reset: Boolean = true) {
   ...
   */
  @JvmOverloads
  public final fun travel(toNode: String, resetOnTeleport: Boolean = true): Unit = travel(toNode.asCachedStringName(), resetOnTeleport)
   ...
   */
  @JvmOverloads
  public final fun start(node: String, reset: Boolean = true): Unit = start(node.asCachedStringName(), reset)

  public companion object

  public object MethodBindings {
    internal val travelPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "travel", 3_823_612_587)

    internal val startPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "start", 3_823_612_587)

    internal val nextPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "next", 3_218_959_716)

    internal val stopPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "stop", 3_218_959_716)

    internal val isPlayingPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "is_playing", 36_873_697)

    internal val getCurrentNodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "get_current_node", 2_002_593_661)

    internal val getCurrentPlayPositionPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "get_current_play_position", 1_740_695_150)

    internal val getCurrentLengthPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "get_current_length", 1_740_695_150)

    internal val getFadingFromNodePtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "get_fading_from_node", 2_002_593_661)

    internal val getTravelPathPtr: VoidPtr =
        TypeManager.getMethodBindPtr("AnimationNodeStateMachinePlayback", "get_travel_path", 3_995_934_104)
  }
}
