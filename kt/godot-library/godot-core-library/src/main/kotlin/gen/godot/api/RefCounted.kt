...
public open class RefCounted : Object() {
  ...
  public object MethodBindings {
    internal val initRefPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RefCounted", "init_ref", 2_240_911_060)

    internal val referencePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RefCounted", "reference", 2_240_911_060)

    internal val unreferencePtr: VoidPtr =
        TypeManager.getMethodBindPtr("RefCounted", "unreference", 2_240_911_060)

    internal val getReferenceCountPtr: VoidPtr =
        TypeManager.getMethodBindPtr("RefCounted", "get_reference_count", 3_905_245_786)
  }
}
