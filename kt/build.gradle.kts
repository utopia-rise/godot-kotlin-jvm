    ...
    val generateChangelog by registering {
        ...
        doLast {
            ...
            val changeLogPrefix = """
                ...
                `godot-jvm_export_templates_$fullGodotJvmVersion.tpz` is the archive for all export templates . See [exporting](https://godot-kotl.in/en/latest/user-guide/exporting/) documentation on how to use it.
