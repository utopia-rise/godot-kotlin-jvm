...
JNI_INIT_STATICS_FOR_CLASS(PackedInt32IntArrayBridge)

PackedInt32IntArrayBridge::PackedInt32IntArrayBridge(jni::JObject p_wrapped, jni::JObject p_class_loader) :
  JavaInstanceWrapper(PACKED_INT_32_ARRAY_BRIDGE_CLASS_NAME, p_wrapped, p_class_loader) {
    ...
    jni::JNativeMethod engine_call_constructor_packed_int_32_array_method {
      const_cast<char*>("engine_call_constructor_packed_int_32_array"),
      const_cast<char*>("()J"),
      (void*) PackedInt32IntArrayBridge::engine_call_constructor_packed_int_32_array};
    ...
    jni::JNativeMethod engine_call_append_method {
      ...
      const_cast<char*>("(J)V"),
      (void*) PackedInt32IntArrayBridge::engine_call_append};
    ...
    jni::JNativeMethod engine_call_is_empty_method {
      ...
      const_cast<char*>("(J)V"),
      (void*) PackedInt32IntArrayBridge::engine_call_is_empty};
    ...
    jni::JNativeMethod engine_call_set_method {
      ...
      const_cast<char*>("(J)V"),
      (void*) PackedInt32IntArrayBridge::engine_call_set};
...
uintptr_t PackedInt32IntArrayBridge::engine_call_constructor_packed_int_32_array(JNIEnv* p_raw_env, jobject p_instance) {
