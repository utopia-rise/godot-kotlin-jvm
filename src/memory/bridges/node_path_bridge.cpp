...
JNI_INIT_STATICS_FOR_CLASS(
    NodePathBridge,
    INIT_NATIVE_METHOD(engine_call_constructor_method, "engine_call_constructor", "()J", NodePathBridge::engine_call_constructor)
    INIT_NATIVE_METHOD(engine_call_constructor_string_method, "engine_call_constructor_string", "()J", NodePathBridge::engine_call_constructor_string)
    INIT_NATIVE_METHOD(engine_call_constructor_node_path_method, "engine_call_constructor_node_path", "()J", NodePathBridge::engine_call_constructor_node_path)
    INIT_NATIVE_METHOD(engine_call_path_method, "engine_call_path", "(J)V", NodePathBridge::engine_call_path)
    INIT_NATIVE_METHOD(engine_call_getAsPropertyPath_method, "engine_call_getAsPropertyPath", "(J)V", NodePathBridge::engine_call_getAsPropertyPath)
    INIT_NATIVE_METHOD(engine_call_getName_method, "engine_call_getName", "(J)V", NodePathBridge::engine_call_getName)
    INIT_NATIVE_METHOD(engine_call_getNameCount_method, "engine_call_getNameCount", "(J)V", NodePathBridge::engine_call_getNameCount)
    INIT_NATIVE_METHOD(engine_call_getSubname_method, "engine_call_getSubname", "(J)V", NodePathBridge::engine_call_getSubname)
    INIT_NATIVE_METHOD(engine_call_getSubnameCount_method, "engine_call_getSubnameCount", "(J)V", NodePathBridge::engine_call_getSubnameCount)
    INIT_NATIVE_METHOD(engine_call_isAbsolute_method, "engine_call_isAbsolute", "(J)V", NodePathBridge::engine_call_isAbsolute)
    INIT_NATIVE_METHOD(engine_call_hash_method, "engine_call_hash", "(J)V",  NodePathBridge::engine_call_hash)
    INIT_NATIVE_METHOD(engine_call_isEmpty_method, "engine_call_isEmpty", "(J)V", NodePathBridge::engine_call_isEmpty)
    INIT_NATIVE_METHOD(engine_call_getConcatenatedSubnames_method, "engine_call_getConcatenatedSubnames", "(J)V", NodePathBridge::engine_call_getConcatenatedSubnames)
    INIT_NATIVE_METHOD(engine_call_getConcatenatedNames_method, "engine_call_getConcatenatedNames", "(J)V", NodePathBridge::engine_call_getConcatenatedNames)
    INIT_NATIVE_METHOD(engine_call_equals_method, "engine_call_equals", "(J)V", NodePathBridge::engine_call_equals)
  )
