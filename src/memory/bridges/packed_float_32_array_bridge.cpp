...
JNI_INIT_STATICS_FOR_CLASS(
    ...
    INIT_NATIVE_METHOD(engine_call_constructor_method, "engine_call_constructor", "()J", PackedFloat32ArrayBridge::engine_call_constructor)
    INIT_NATIVE_METHOD(engine_call_constructor_packed_float_32_array_method, "engine_call_constructor_packed_array", "()J", PackedFloat32ArrayBridge::engine_call_constructor_packed_array)
    INIT_NATIVE_METHOD(engine_call_constructor_array_method, "engine_call_constructor_array", "()J", PackedFloat32ArrayBridge::engine_call_constructor_array)
    INIT_NATIVE_METHOD(engine_call_append_method, "engine_call_append", "(J)V", PackedFloat32ArrayBridge::engine_call_append)
    INIT_NATIVE_METHOD(engine_call_appendArray_method, "engine_call_appendArray", "(J)V", PackedFloat32ArrayBridge::engine_call_appendArray)
    INIT_NATIVE_METHOD(engine_call_bsearch_method, "engine_call_bsearch", "(J)V", PackedFloat32ArrayBridge::engine_call_bsearch)
    INIT_NATIVE_METHOD(engine_call_clear_method, "engine_call_clear", "(J)V", PackedFloat32ArrayBridge::engine_call_clear)
    INIT_NATIVE_METHOD(engine_call_count_method, "engine_call_count", "(J)V", PackedFloat32ArrayBridge::engine_call_count)
    INIT_NATIVE_METHOD(engine_call_duplicate_method, "engine_call_duplicate", "(J)V", PackedFloat32ArrayBridge::engine_call_duplicate)
    INIT_NATIVE_METHOD(engine_call_fill_method, "engine_call_fill", "(J)V", PackedFloat32ArrayBridge::engine_call_fill)
    INIT_NATIVE_METHOD(engine_call_find_method, "engine_call_find", "(J)V", PackedFloat32ArrayBridge::engine_call_find)
    INIT_NATIVE_METHOD(engine_call_is_empty_method, "engine_call_is_empty", "(J)V", PackedFloat32ArrayBridge::engine_call_is_empty)
    INIT_NATIVE_METHOD(engine_call_get_method, "engine_call_get", "(J)V", PackedFloat32ArrayBridge::engine_call_get)
    INIT_NATIVE_METHOD(engine_call_has_method, "engine_call_has", "(J)V", PackedFloat32ArrayBridge::engine_call_has)
    INIT_NATIVE_METHOD(engine_call_insert_method, "engine_call_insert", "(J)V", PackedFloat32ArrayBridge::engine_call_insert)
    INIT_NATIVE_METHOD(engine_call_reverse_method, "engine_call_reverse", "(J)V", PackedFloat32ArrayBridge::engine_call_reverse)
    INIT_NATIVE_METHOD(engine_call_pushback_method, "engine_call_pushback", "(J)V", PackedFloat32ArrayBridge::engine_call_pushback)
    INIT_NATIVE_METHOD(engine_call_remove_at_method, "engine_call_remove_at", "(J)V", PackedFloat32ArrayBridge::engine_call_remove_at)
    INIT_NATIVE_METHOD(engine_call_resize_method, "engine_call_resize", "(J)V", PackedFloat32ArrayBridge::engine_call_resize)
    INIT_NATIVE_METHOD(engine_call_rfind_method, "engine_call_rfind", "(J)V", PackedFloat32ArrayBridge::engine_call_rfind)
    INIT_NATIVE_METHOD(engine_call_set_method, "engine_call_set", "(J)V", PackedFloat32ArrayBridge::engine_call_set)
    INIT_NATIVE_METHOD(engine_call_size_method, "engine_call_size", "(J)V", PackedFloat32ArrayBridge::engine_call_size)
    INIT_NATIVE_METHOD(engine_call_slice_method, "engine_call_slice", "(J)V", PackedFloat32ArrayBridge::engine_call_slice)
    INIT_NATIVE_METHOD(engine_call_sort_method, "engine_call_sort", "(J)V", PackedFloat32ArrayBridge::engine_call_sort)
    INIT_NATIVE_METHOD(engine_call_to_byte_array_method, "engine_call_to_byte_array", "(J)V", PackedFloat32ArrayBridge::engine_call_to_byte_array)
  )

// clang-format on

PackedFloat32ArrayBridge::PackedFloat32ArrayBridge(jni::JObject p_wrapped) : JavaInstanceWrapper(p_wrapped) {}
...
void PackedFloat32ArrayBridge::engine_call_bsearch(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    TransferContext* transfer_context {GDKotlin::get_instance().transfer_context};
    transfer_context->read_args(env, args);
    Variant ret {from_uint_to_ptr<PackedFloat32Array>(p_raw_ptr)->bsearch(args[0].operator float(), args[1].operator bool())};
...
void PackedFloat32ArrayBridge::engine_call_count(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {from_uint_to_ptr<PackedFloat32Array>(p_raw_ptr)->count(args[0].operator float())};
    transfer_context->write_return_value(env, ret);
}
...
void PackedFloat32ArrayBridge::engine_call_find(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    TransferContext* transfer_context {GDKotlin::get_instance().transfer_context};
    transfer_context->read_args(env, args);
    Variant ret {from_uint_to_ptr<PackedFloat32Array>(p_raw_ptr)->find(args[0].operator float())};
    transfer_context->write_return_value(env, ret);
}
...
void PackedFloat32ArrayBridge::engine_call_rfind(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {from_uint_to_ptr<PackedFloat32Array>(p_raw_ptr)->rfind(args[0].operator float(), args->operator int())};
}
...
void PackedFloat32ArrayBridge::engine_call_slice(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {from_uint_to_ptr<PackedFloat32Array>(p_raw_ptr)->slice(args[0].operator int(), args[1].operator int())};
    transfer_context->write_return_value(env, ret);
}
