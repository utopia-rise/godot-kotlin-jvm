...
void PackedStringArrayBridge::engine_call_bsearch(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    transfer_context->read_args(env, args);
    Variant ret {
      from_uint_to_ptr<PackedStringArray>(p_raw_ptr)->bsearch(
...
void PackedStringArrayBridge::engine_call_count(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {
      from_uint_to_ptr<PackedStringArray>(p_raw_ptr)->count(args[0].operator String())
    };
    transfer_context->write_return_value(env, ret);
}
...
void PackedStringArrayBridge::engine_call_find(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    transfer_context->read_args(env, args);
    Variant ret {
      from_uint_to_ptr<PackedStringArray>(p_raw_ptr)->find(args[0].operator String())
    };
    transfer_context->write_return_value(env, ret);
}
...
void PackedStringArrayBridge::engine_call_rfind(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {
      from_uint_to_ptr<PackedStringArray>(p_raw_ptr)->rfind(args[0].operator String(), args->operator int())
    };
}
...
void PackedStringArrayBridge::engine_call_slice(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {
      from_uint_to_ptr<PackedStringArray>(p_raw_ptr)->slice(args[0].operator int(), args[1].operator int())
    };
    transfer_context->write_return_value(env, ret);
}
...
void PackedStringArrayBridge::engine_call_to_byte_array(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    jni::Env env {p_raw_env};
    Variant ret {
      from_uint_to_ptr<PackedStringArray>(p_raw_ptr)->to_byte_array()
    };
    GDKotlin::get_instance().transfer_context->write_return_value(env, ret);
}
