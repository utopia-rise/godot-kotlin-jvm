...
JNI_INIT_STATICS_FOR_CLASS(
    ...
    INIT_NATIVE_METHOD(engine_call_constructor_method, "engine_call_constructor", "()J", PackedStringArrayBridge::engine_call_constructor)
    INIT_NATIVE_METHOD(engine_call_constructor_string_array_method, "engine_call_constructor_packed_array", "()J", PackedStringArrayBridge::engine_call_constructor_packed_array)
    INIT_NATIVE_METHOD(engine_call_constructor_array_method, "engine_call_constructor_array", "()J", PackedStringArrayBridge::engine_call_constructor_array)
    INIT_NATIVE_METHOD(engine_call_append_method, "engine_call_append", "(J)V", PackedStringArrayBridge::engine_call_append)
    INIT_NATIVE_METHOD(engine_call_appendArray_method, "engine_call_appendArray", "(J)V", PackedStringArrayBridge::engine_call_appendArray)
    INIT_NATIVE_METHOD(engine_call_bsearch_method, "engine_call_bsearch", "(J)V", PackedStringArrayBridge::engine_call_bsearch)
    INIT_NATIVE_METHOD(engine_call_clear_method, "engine_call_clear", "(J)V", PackedStringArrayBridge::engine_call_clear)
    INIT_NATIVE_METHOD(engine_call_count_method, "engine_call_count", "(J)V", PackedStringArrayBridge::engine_call_count)
    INIT_NATIVE_METHOD(engine_call_duplicate_method, "engine_call_duplicate", "(J)V", PackedStringArrayBridge::engine_call_duplicate)
    INIT_NATIVE_METHOD(engine_call_fill_method, "engine_call_fill", "(J)V", PackedStringArrayBridge::engine_call_fill)
    INIT_NATIVE_METHOD(engine_call_find_method, "engine_call_find", "(J)V", PackedStringArrayBridge::engine_call_find)
    INIT_NATIVE_METHOD(engine_call_is_empty_method, "engine_call_is_empty", "(J)V", PackedStringArrayBridge::engine_call_is_empty)
    INIT_NATIVE_METHOD(engine_call_get_method, "engine_call_get", "(J)V", PackedStringArrayBridge::engine_call_get)
    INIT_NATIVE_METHOD(engine_call_has_method, "engine_call_has", "(J)V", PackedStringArrayBridge::engine_call_has)
    INIT_NATIVE_METHOD(engine_call_insert_method, "engine_call_insert", "(J)V", PackedStringArrayBridge::engine_call_insert)
    INIT_NATIVE_METHOD(engine_call_reverse_method, "engine_call_reverse", "(J)V", PackedStringArrayBridge::engine_call_reverse)
    INIT_NATIVE_METHOD(engine_call_pushback_method, "engine_call_pushback", "(J)V", PackedStringArrayBridge::engine_call_pushback)
    INIT_NATIVE_METHOD(engine_call_remove_at_method, "engine_call_remove_at", "(J)V", PackedStringArrayBridge::engine_call_remove_at)
    INIT_NATIVE_METHOD(engine_call_resize_method, "engine_call_resize", "(J)V", PackedStringArrayBridge::engine_call_resize)
    INIT_NATIVE_METHOD(engine_call_rfind_method, "engine_call_rfind", "(J)V", PackedStringArrayBridge::engine_call_rfind)
    INIT_NATIVE_METHOD(engine_call_set_method, "engine_call_set", "(J)V", PackedStringArrayBridge::engine_call_set)
    INIT_NATIVE_METHOD(engine_call_size_method, "engine_call_size", "(J)V", PackedStringArrayBridge::engine_call_size)
    INIT_NATIVE_METHOD(engine_call_slice_method, "engine_call_slice", "(J)V", PackedStringArrayBridge::engine_call_slice)
    INIT_NATIVE_METHOD(engine_call_sort_method, "engine_call_sort", "(J)V", PackedStringArrayBridge::engine_call_sort)
    INIT_NATIVE_METHOD(engine_call_to_byte_array_method, "engine_call_to_byte_array", "(J)V", PackedStringArrayBridge::engine_call_to_byte_array)
  )
