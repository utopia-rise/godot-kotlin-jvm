...
namespace bridges {
    ...
    public:
        PackedFloat32ArrayBridge(jni::JObject p_wrapped, jni::JObject p_class_loader);
        ~PackedFloat32ArrayBridge() = default;

        static uintptr_t engine_call_constructor(JNIEnv* p_raw_env, jobject p_instance);
        static uintptr_t engine_call_constructor_packed_float_32_array(JNIEnv* p_raw_env, jobject p_instance);
