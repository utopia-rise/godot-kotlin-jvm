...
PackedVector3ArrayBridge::PackedVector3ArrayBridge(jni::JObject p_wrapped, jni::JObject p_class_loader) :
  JavaInstanceWrapper(PACKED_VECTOR3_ARRAY_BRIDGE_CLASS_NAME, p_wrapped, p_class_loader) {
    ...
    jni::JNativeMethod engine_call_constructor_packed_array_method {
      ...
      const_cast<char*>("()J"),
      (void*) PackedVector3ArrayBridge::engine_call_constructor_packed_array};
    jni::JNativeMethod engine_call_constructor_array_method {
      const_cast<char*>("engine_call_constructor_array"),
      const_cast<char*>("()J"),
      (void*) PackedVector3ArrayBridge::engine_call_constructor_array};
    ...
    jni::JNativeMethod engine_call_has_method {
      ...
      const_cast<char*>("(J)V"),
      (void*) PackedVector3ArrayBridge::engine_call_has};
    ...
    jni::JNativeMethod engine_call_rfind_method {
      ...
      const_cast<char*>("(J)V"),
      (void*) PackedVector3ArrayBridge::engine_call_rfind};
...
void PackedVector3ArrayBridge::engine_call_bsearch(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    transfer_context->read_args(env, args);
    Variant ret {
      from_uint_to_ptr<PackedVector3Array>(p_raw_ptr)->bsearch(
        args[0].operator Vector3(),
...
void PackedVector3ArrayBridge::engine_call_count(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {
      from_uint_to_ptr<PackedVector3Array>(p_raw_ptr)->count(args[0].operator Vector3())
    };
    transfer_context->write_return_value(env, ret);
}
...
void PackedVector3ArrayBridge::engine_call_find(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    transfer_context->read_args(env, args);
    Variant ret {
      from_uint_to_ptr<PackedVector3Array>(p_raw_ptr)->find(args[0].operator Vector3())
    };
    transfer_context->write_return_value(env, ret);
}
...
void PackedVector3ArrayBridge::engine_call_rfind(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {
      from_uint_to_ptr<PackedVector3Array>(p_raw_ptr)->rfind(args[0].operator Vector3(), args->operator int())
    };
}
...
void PackedVector3ArrayBridge::engine_call_slice(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    ...
    Variant ret {
      from_uint_to_ptr<PackedVector3Array>(p_raw_ptr)->slice(args[0].operator int(), args[1].operator int())
    };
    transfer_context->write_return_value(env, ret);
}
...
void PackedVector3ArrayBridge::engine_call_to_byte_array(JNIEnv* p_raw_env, jobject p_instance, jlong p_raw_ptr) {
    jni::Env env {p_raw_env};
    Variant ret {
      from_uint_to_ptr<PackedVector3Array>(p_raw_ptr)->to_byte_array()
    };
    GDKotlin::get_instance().transfer_context->write_return_value(env, ret);
}