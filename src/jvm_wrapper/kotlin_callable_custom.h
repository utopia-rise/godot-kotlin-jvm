...
JVM_INSTANCE_WRAPPER(LambdaCallable, "godot.core.LambdaCallable") {
    ...
    INIT_JNI_BINDINGS(
        ...
        INIT_JNI_METHOD(ON_DESTROY, "onDestroy", "()V")
    )
...
public:
    ...
    LambdaCallable(jni::Env& p_env, jni::JObject p_wrapped, Variant::Type return_type, int p_hash_code, bool p_has_on_destroy);
