...
KtPropertyInfo::KtPropertyInfo(jni::JObject p_wrapped) : JavaInstanceWrapper(p_wrapped) {
...
KtProperty::KtProperty(jni::JObject p_wrapped) : JavaInstanceWrapper(p_wrapped) {
    jni::Env env {jni::Jvm::current_env()};
