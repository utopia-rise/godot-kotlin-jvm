    ...
    override fun Context.init() {
        with(registry) {
            registerClass<Invocation>(Invocation::class.qualifiedName!!, "Spatial") {
                ...
                property(Invocation::x::get, Invocation::x::set, ::KtVariant, KtVariant::asInt) {
                    name = "x"
                    type = KtVariant.Type.LONG
                    className = "Int"
                }
                property(Invocation::y::get, Invocation::y::set, ::KtVariant, KtVariant::asDouble) {
                    name = "y"
                    type = KtVariant.Type.DOUBLE
                    className = "Double"
                }
                property(Invocation::z::get, Invocation::z::set, ::KtVariant, KtVariant::asFloat) {
                    name = "z"
                    type = KtVariant.Type.DOUBLE
                    className = "Float"
                }
                property(getMethod = Invocation::name::get, getValueConverter = ::KtVariant, setValueConverter = KtVariant::asString) {
                    name = "name"
