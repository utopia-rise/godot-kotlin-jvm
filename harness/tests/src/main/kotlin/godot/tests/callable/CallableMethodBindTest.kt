...
class CallableMethodBindTest : Node() {
    ...
    fun callWithMethodWithAllBinds() {
        val unboundCallable: Callable3<Unit, Int, Int, Int> = methodCallable3(this, CallableMethodBindTest::readySignalMethodBindTest)
    ...
    fun callWithMethodWithNoBind() {
        methodCallable3(this, CallableMethodBindTest::readySignalMethodBindTest).call(10, 11, 12)
    }
