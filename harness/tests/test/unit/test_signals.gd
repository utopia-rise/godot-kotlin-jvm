...
func test_signal_emitted_witt_multiple_targets():
	...
	assert_eq(invocation_script.array[8], Vector2(0,0))
	assert_eq(invocation_script.array[9], Vector2(1,1))
	assert_eq(invocation_script.array[10], Vector2(1,2))
	assert_eq(invocation_script.array[11], Vector2(1,3))
	assert_eq(invocation_script.array[12], Vector2(1,4))
	assert_eq(invocation_script.array[13], Vector2(1,5))
	assert_eq(invocation_script.array[14], Vector2(1,6))
	assert_eq(invocation_script.array[15], Vector2(1,7))
	invocation_script.free()
