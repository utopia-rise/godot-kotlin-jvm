...
#	var test_instance = godot_tests_MultiArgsConstructorTest.new(42)
...
#	var test_instance = godot_tests_MultiArgsConstructorTest.new(42, "hello")
#	assert_eq(test_instance.three_args_constructor_has_been_called, "Three args constructor should have been called")
#	test_instance.free()
