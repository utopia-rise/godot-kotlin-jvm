...
func test_call_parent_closed_method_from_child() -> void:
	var child_script = load("res://src/main/kotlin/godot/tests/inheritance/ClassInheritanceChild.kt").new()
...
func test_call_parent_open_method_from_parent() -> void:
	var parent_script = load("res://src/main/kotlin/godot/tests/inheritance/ClassInheritanceParent.kt").new()
