...
func test_packed_byte_array_bulk_conversion() -> void:
   	...
   	assert_eq(packed.get(0), 0, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
   	assert_eq(packed.get(1), 1, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
   	assert_eq(packed.get(2), 2, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
   	assert_eq(packed.get(3), 4, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
   	assert_eq(packed.get(4), 8, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
   	assert_eq(packed.get(5), 16, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
   	assert_eq(packed.get(6), 32, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
   	assert_eq(packed.get(7), 64, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
   	assert_eq(packed.get(8), 127, "The Godot PackedArray value should match the values in the original Kotlin ByteArray")
...
func test_packed_int_array_bulk_conversion() -> void:
   	...
   	assert_eq(packed.get(0), 0, "The Godot PackedArray value should match the values in the original Kotlin IntArray")
   	assert_eq(packed.get(1), 1, "The Godot PackedArray value should match the values in the original Kotlin IntArray")
   	assert_eq(packed.get(2), 2, "The Godot PackedArray value should match the values in the original Kotlin IntArray")
   	assert_eq(packed.get(3), 4, "The Godot PackedArray value should match the values in the original Kotlin IntArray")
   	assert_eq(packed.get(4), 8, "The Godot PackedArray value should match the values in the original Kotlin IntArray")
   	assert_eq(packed.get(5), 16, "The Godot PackedArray value should match the values in the original Kotlin IntArray")
   	assert_eq(packed.get(6), 32, "The Godot PackedArray value should match the values in the original Kotlin IntArray")
   	assert_eq(packed.get(7), 64, "The Godot PackedArray value should match the values in the original Kotlin IntArray")
   	assert_eq(packed.get(8), 127, "The Godot PackedArray value should match the values in the original Kotlin IntArray")

   	assert_eq(script.get_byte_array_value(packed, 0), 0, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
    assert_eq(script.get_byte_array_value(packed, 1), 1, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
    assert_eq(script.get_byte_array_value(packed, 2), 2, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
    assert_eq(script.get_byte_array_value(packed, 3), 4, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
    assert_eq(script.get_byte_array_value(packed, 4), 8, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
    assert_eq(script.get_byte_array_value(packed, 5), 16, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
    assert_eq(script.get_byte_array_value(packed, 6), 32, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
    assert_eq(script.get_byte_array_value(packed, 7), 64, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
    assert_eq(script.get_byte_array_value(packed, 8), 127, "The original Godot PackedArray value should match the values in the Kotlin IntArray")
...
func test_packed_long_array_bulk_conversion() -> void:
   	...
   	assert_eq(packed.get(0), 0, "The Godot PackedArray value should match the values in the original Kotlin LongArray")
   	assert_eq(packed.get(1), 1, "The Godot PackedArray value should match the values in the original Kotlin LongArray")
   	assert_eq(packed.get(2), 2, "The Godot PackedArray value should match the values in the original Kotlin LongArray")
   	assert_eq(packed.get(3), 4, "The Godot PackedArray value should match the values in the original Kotlin LongArray")
   	assert_eq(packed.get(4), 8, "The Godot PackedArray value should match the values in the original Kotlin LongArray")
   	assert_eq(packed.get(5), 16, "The Godot PackedArray value should match the values in the original Kotlin LongArray")
   	assert_eq(packed.get(6), 32, "The Godot PackedArray value should match the values in the original Kotlin LongArray")
   	assert_eq(packed.get(7), 64, "The Godot PackedArray value should match the values in the original Kotlin LongArray")
   	assert_eq(packed.get(8), 127, "The Godot PackedArray value should match the values in the original Kotlin LongArray")

   	assert_eq(script.get_byte_array_value(packed, 0), 0, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
    assert_eq(script.get_byte_array_value(packed, 1), 1, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
    assert_eq(script.get_byte_array_value(packed, 2), 2, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
    assert_eq(script.get_byte_array_value(packed, 3), 4, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
    assert_eq(script.get_byte_array_value(packed, 4), 8, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
    assert_eq(script.get_byte_array_value(packed, 5), 16, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
    assert_eq(script.get_byte_array_value(packed, 6), 32, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
    assert_eq(script.get_byte_array_value(packed, 7), 64, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
    assert_eq(script.get_byte_array_value(packed, 8), 127, "The original Godot PackedArray value should match the values in the Kotlin LongArray")
...
func test_packed_float_array_bulk_conversion() -> void:
   	...
   	assert_eq(packed.get(0), 0.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")
   	assert_eq(packed.get(1), 1.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")
   	assert_eq(packed.get(2), 2.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")
   	assert_eq(packed.get(3), 4.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")
   	assert_eq(packed.get(4), 8.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")
   	assert_eq(packed.get(5), 16.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")
   	assert_eq(packed.get(6), 32.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")
   	assert_eq(packed.get(7), 64.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")
   	assert_eq(packed.get(8), 127.0, "The Godot PackedArray value should match the values in the original Kotlin FloatArray")

   	assert_eq(script.get_byte_array_value(packed, 0), 0.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
    assert_eq(script.get_byte_array_value(packed, 1), 1.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
    assert_eq(script.get_byte_array_value(packed, 2), 2.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
    assert_eq(script.get_byte_array_value(packed, 3), 4.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
    assert_eq(script.get_byte_array_value(packed, 4), 8.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
    assert_eq(script.get_byte_array_value(packed, 5), 16.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
    assert_eq(script.get_byte_array_value(packed, 6), 32.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
    assert_eq(script.get_byte_array_value(packed, 7), 64.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
    assert_eq(script.get_byte_array_value(packed, 8), 127.0, "The original Godot PackedArray value should match the values in the Kotlin FloatArray")
...
func test_packed_double_array_bulk_conversion() -> void:
   	...
   	assert_eq(packed.get(0), 0.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")
   	assert_eq(packed.get(1), 1.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")
   	assert_eq(packed.get(2), 2.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")
   	assert_eq(packed.get(3), 4.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")
   	assert_eq(packed.get(4), 8.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")
   	assert_eq(packed.get(5), 16.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")
   	assert_eq(packed.get(6), 32.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")
   	assert_eq(packed.get(7), 64.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")
   	assert_eq(packed.get(8), 127.0, "The Godot PackedArray value should match the values in the original Kotlin DoubleArray")

   	assert_eq(script.get_byte_array_value(packed, 0), 0.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
    assert_eq(script.get_byte_array_value(packed, 1), 1.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
    assert_eq(script.get_byte_array_value(packed, 2), 2.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
    assert_eq(script.get_byte_array_value(packed, 3), 4.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
    assert_eq(script.get_byte_array_value(packed, 4), 8.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
    assert_eq(script.get_byte_array_value(packed, 5), 16.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
    assert_eq(script.get_byte_array_value(packed, 6), 32.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
    assert_eq(script.get_byte_array_value(packed, 7), 64.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
    assert_eq(script.get_byte_array_value(packed, 8), 127.0, "The original Godot PackedArray value should match the values in the Kotlin DoubleArray")
