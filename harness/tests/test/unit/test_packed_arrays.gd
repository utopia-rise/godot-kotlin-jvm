...
func test_packed_byte_array_bulk_conversion() -> void:
   	...
   	assert_eq(packed.get(0), 0, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	assert_eq(packed.get(1), 1, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	assert_eq(packed.get(2), 2, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	assert_eq(packed.get(3), 4, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	assert_eq(packed.get(4), 8, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	assert_eq(packed.get(5), 16, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	assert_eq(packed.get(6), 32, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	assert_eq(packed.get(7), 64, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	assert_eq(packed.get(8), 127, "The Godot PackedArray value should match the values in origin the Kotlin ByteArray")
   	script.free()
