...
func test_packed_int_array_bulk_conversion() -> void:
   	...
   	assert_eq(packed.get(0), 0, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	assert_eq(packed.get(1), 1, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	assert_eq(packed.get(2), 2, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	assert_eq(packed.get(3), 4, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	assert_eq(packed.get(4), 8, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	assert_eq(packed.get(5), 16, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	assert_eq(packed.get(6), 32, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	assert_eq(packed.get(7), 64, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	assert_eq(packed.get(8), 127, "The Godot PackedArray value should match the values in origin the Kotlin IntArray")
   	script.free()

func test_packed_long_array_bulk_conversion() -> void:
   	var script = PackedArrayTest.new()
   	var packed = script.convert_long_array()
   	assert_eq(packed.get(0), 0, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	assert_eq(packed.get(1), 1, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	assert_eq(packed.get(2), 2, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	assert_eq(packed.get(3), 4, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	assert_eq(packed.get(4), 8, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	assert_eq(packed.get(5), 16, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	assert_eq(packed.get(6), 32, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	assert_eq(packed.get(7), 64, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	assert_eq(packed.get(8), 127, "The Godot PackedArray value should match the values in origin the Kotlin LongArray")
   	script.free()

func test_packed_float_array_bulk_conversion() -> void:
   	var script = PackedArrayTest.new()
   	var packed = script.convert_float_array()
   	assert_eq(packed.get(0), 0.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	assert_eq(packed.get(1), 1.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	assert_eq(packed.get(2), 2.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	assert_eq(packed.get(3), 4.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	assert_eq(packed.get(4), 8.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	assert_eq(packed.get(5), 16.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	assert_eq(packed.get(6), 32.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	assert_eq(packed.get(7), 64.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	assert_eq(packed.get(8), 127.0, "The Godot PackedArray value should match the values in origin the Kotlin FloatArray")
   	script.free()

func test_packed_double_array_bulk_conversion() -> void:
   	var script = PackedArrayTest.new()
   	var packed = script.convert_double_array()
   	assert_eq(packed.get(0), 0.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	assert_eq(packed.get(1), 1.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	assert_eq(packed.get(2), 2.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	assert_eq(packed.get(3), 4.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	assert_eq(packed.get(4), 8.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	assert_eq(packed.get(5), 16.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	assert_eq(packed.get(6), 32.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	assert_eq(packed.get(7), 64.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	assert_eq(packed.get(8), 127.0, "The Godot PackedArray value should match the values in origin the Kotlin DoubleArray")
   	script.free()
