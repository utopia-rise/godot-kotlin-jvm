...
class NotRegisteredButMembersFixtureExplicit : Node() {
...
// Godot class name.
@Script(className = "DuplicateIdeRegistrationNameExplicit")
class DuplicateRegisteredNameFixtureOneExplicit : Node()

@Script(className = "DuplicateIdeRegistrationNameExplicit")
class DuplicateRegisteredNameFixtureTwoExplicit : Node()

// Expected red: generic classes cannot be registered.
@Script
class GenericRegisteredClassFixtureExplicit<T> : Node()

// Method registration checks.
@Script
class NotificationFunctionWithoutRegisterFixtureExplicit : Node() {
...
@Script
class RegisterProblemFixtureExplicit : Node() {
...
@Script
class VisibleProblemFixtureExplicit : Node() {
...
@Script
class PropertyHintProblemFixtureExplicit : Node() {
...
@Script
class RpcAnnotationProblemFixtureExplicit : Node() {
...
@Script
class CallableReferenceProblemFixtureExplicit : Node() {
    @Emit
