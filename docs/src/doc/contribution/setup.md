...
1. Clone godot repo with the stable tag you want do deveop for (3.4.2-stable in this example). `git clone git@github.com:godotengine/godot.git 3.4.2-stable --recursive`
